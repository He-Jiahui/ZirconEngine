...
Review D9 要求 editor/runtime mirror consumer 走 SDK declaration；`authoring_plugin!` 与 `EditorRuntimeClient` 当前没有 typed event subscription/consumer 注册面和 lifecycle 解绑语义。
