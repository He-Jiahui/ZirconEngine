...
related_code:
  ...
  - tools/tests/test_plugin_docs_current_status_interfaces_gate.py
...
Open state: `272 个现存 current-status tests / 23,122 行仍待 Plugins13 归类收敛`；本轮只建立 canonical handoff，未运行 Plugins Cargo，也未声称该 failure fixed。
