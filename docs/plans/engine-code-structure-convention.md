...
- production owner 当前为 source cache 722 行、LRU leaf 243、atlas page 527、page residency 208、slot cache 93、render state 396，全部低于 800 行 production review warning。规模/驻留测试按语义拆到 844 行父 owner 与 216 行 `tests/source_cache/residency.rs` 子 owner，均低于 1000 行测试阈值。
