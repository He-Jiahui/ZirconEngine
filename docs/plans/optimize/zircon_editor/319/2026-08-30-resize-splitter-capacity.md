---
title: Editor319 Resize Splitter Capacity
category: zircon_editor
report_id: Editor319-resize-splitter-capacity-2026-08-30
date: 2026-08-30
...
# Editor319 Resize Splitter Capacity

`collect_resize_splitters` now reserves the fixed three-entry output capacity used by the left,
right, and bottom splitter frames. Splitter identity, frame data, metadata, and left-right-bottom
ordering are unchanged.

Regression coverage checks the fixed capacity and output order. The ignored Windows Release
benchmark emits `EDITOR319_RESIZE_SPLITTER_CAPACITY_BENCH_V1` over 17 paired samples with three
splitters per sample and requires `optimized_p95_ns <= legacy_p95_ns * 0.70`.
...
Editor319 is submitted in the six-task batch under request
