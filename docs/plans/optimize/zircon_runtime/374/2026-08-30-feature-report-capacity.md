---
title: Runtime374 Feature Report Capacity
category: zircon_runtime
report_id: Runtime374-feature-report-capacity-2026-08-30
date: 2026-08-30
...
# Runtime374 Feature Report Capacity

`from_feature` now reserves one diagnostic-vector slot per feature manifest module before
validation and registration. Manifest projection, extension registration, validation order, and
...
benchmark emits `RUNTIME374_FEATURE_REPORT_CAPACITY_BENCH_V1` over 17 paired samples with 128
modules per sample and requires `optimized_p95_ns <= legacy_p95_ns * 0.70`.
...
Runtime374 is submitted in the six-task batch under request
