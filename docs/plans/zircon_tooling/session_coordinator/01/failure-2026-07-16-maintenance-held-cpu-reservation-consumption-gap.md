...
2026-07-16 implementation evidence: focused red-to-green tests now cover held scoped
CPU/GPU consume, canonical binding/idempotence, foreign-owner preservation, immutable GPU
target binding, server override rejection, schema 42 migration, and coalesced-drain startup
scope restoration. `37` focused coordinator tests passed. Schema 42 was loaded under a
persistent hold; the completed CPU job `f1c822b416184a778bb07b064e246f5a` released exit 0
through the managed runner with no live PID.

Current live state: Render18 holds GPU reservation `9124e8fb75964c1f92f7278fa2a62da8`, bound
to unstarted job `fa38ad298d534d16b9b6c17678108464`; compatibility is
`fd9ba63b67ac508ce0aa8dc153fe9d8d84f03017da2a72f900891be5c0f7fd00` and target is
`E:\cargo-targets\zircon-engine\render18-af-m3-plugin`. The job has no PID or start time.
Render18 must use only the reservation-bound run path for its plugin/layout, ignored DX12
exporter and offscreen RenderDoc capture sequence; no pass is claimed before that managed
run completes and releases.
