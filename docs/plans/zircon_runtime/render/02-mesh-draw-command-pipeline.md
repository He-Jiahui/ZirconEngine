...
pub(crate) enum MeshPassPipelineKind {
    ...
    ShadowDepth,           // MeshPipelineCache shadow variant pipeline
    ShadowDepthAlphaMask,  // MeshPipelineCache shadow alpha-test variant pipeline
