...
- `cargo test -p zircon_runtime --lib tasks --locked` 通过数基线：待 clean cargo window；2026-06-20 空闲窗口复跑 1200s + 650s 仍停留在 lib-test 编译且无测试二进制/测试结果，本轮 Cargo/rustc 残留已停止
