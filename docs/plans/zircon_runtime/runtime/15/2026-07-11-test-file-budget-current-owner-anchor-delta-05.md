# Runtime 15 test-file-budget current-owner anchor delta 05

Date: 2026-07-11

Status: `runtime_15_test_file_budget_current_owner_anchor_delta_05_static_reconciled`

## Scope and claim boundary

This numbered output record captures the final current-owner anchor delta exposed by the 1080/1109 test-file-budget rerun, including the complete typed-error guard source-path inventory. It is source-routing evidence only and does not promote historical Cargo, WGPU, RenderDoc, or package-level results.
