...
2026-07-10 当前审计 owner 同步：`expected_source_file_count = 25`、`expected_guard_file_count = 22`、`test_anchor_count = 28`、`behavior_test_anchor_count = 24`、`artifact_store_roundtrips_scene_assets_with` 4/4、`missing_behavior_test_anchors = []`、`mirror_docs_guard_present = true`、`risks = []`。22 个 guard/test owner 显式包含 artifact scene children、asset facade query、worker policy、mirror docs 与 Runtime 04 Cargo-gate child；此计数取代下文保留的 11-owner 历史镜像，计划仍因 broader `asset::` / `worker_pool` Cargo filters 保持 `in_progress`。
...
those child bodies. The declared Python audit consequently reported six missing
...
5. 基线记录：`.\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_runtime -SkipBuild -LibTests -TestFilter asset` 通过数记入状态节。
...
- `.\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_runtime -SkipBuild -LibTests -TestFilter worker_pool`（去重合并、背压行为、失败传播三组）
- `.\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_runtime -SkipBuild -LibTests -TestFilter asset::`（全族无回归）
- 验收证据：计数断言测试 + 并发加载冒烟。
...
- `.\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_runtime -SkipBuild -LibTests -TestFilter watch`
- `.\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_runtime -SkipBuild -LibTests -TestFilter asset::`
...
- fixed 已修复：[asset-migration-single-parse-document-artifact](../../performance/01/fixed-2026-07-23-asset-migration-single-parse-document-artifact.md)
- fixed 已修复：[asset-pipeline-audit-behavior-test-discovery](04/fixed-2026-07-31-asset-pipeline-audit-behavior-test-discovery.md)
- open/待修复：[virtual-geometry-runtime-support-compute-workload-drift](../../zircon_plugins/13/failure-2026-07-15-virtual-geometry-runtime-support-compute-workload-drift.md)
- coordinator-open failure：[virtual-geometry-debug-snapshot-project-toml-consumer-drift](04/failure-2026-07-15-virtual-geometry-debug-snapshot-project-toml-consumer-drift.md)
- coordinator-open failure：[project-root-symlink-privilege-fixture](04/failure-2026-07-17-project-root-symlink-privilege-fixture.md)
- coordinator-open failure：[woc-gltf-meshopt-webp-import](04/failure-2026-07-17-woc-gltf-meshopt-webp-import.md)
- coordinator-open failure：[project-source-index-targeted-import](04/failure-2026-07-18-project-source-index-targeted-import.md)
- coordinator-open failure：[pbr-viewer-generated-project-rebuild](04/failure-2026-07-19-pbr-viewer-generated-project-rebuild.md)
- coordinator-open failure：[asset-artifact-chunked-generation-store](04/failure-2026-07-22-asset-artifact-chunked-generation-store.md)
- coordinator-open failure：[asset-importer-generation-index](04/failure-2026-07-22-asset-importer-generation-index.md)
- coordinator-open failure：[asset-management-generation-projection](04/failure-2026-07-22-asset-management-generation-projection.md)
- coordinator-open failure：[asset-migration-streaming-transaction-journal](04/failure-2026-07-22-asset-migration-streaming-transaction-journal.md)
- coordinator-open failure：[asset-readiness-generation-snapshot](04/failure-2026-07-22-asset-readiness-generation-snapshot.md)
- coordinator-open failure：[asset-watch-bounded-debounce-generation](04/failure-2026-07-22-asset-watch-bounded-debounce-generation.md)
- coordinator-open failure：[dynamic-scene-asset-reload-bounded-singleflight](04/failure-2026-07-22-dynamic-scene-asset-reload-bounded-singleflight.md)
- coordinator-open failure：[dynamic-scene-session-archive-artifact](04/failure-2026-07-22-dynamic-scene-session-archive-artifact.md)
- coordinator-open failure：[project-generation-lazy-residency-publish](04/failure-2026-07-22-project-generation-lazy-residency-publish.md)
- coordinator-open failure：[typed-asset-event-shared-bounded-dispatch](04/failure-2026-07-22-typed-asset-event-shared-bounded-dispatch.md)
- coordinator-open failure：[virtual-geometry-cook-generation-policy](04/failure-2026-07-22-virtual-geometry-cook-generation-policy.md)
- coordinator-open failure：[asset-meta-preview-state-field-cas](04/failure-2026-07-23-asset-meta-preview-state-field-cas.md)
- coordinator-open failure：[asset-migration-indexed-resolver-generation](04/failure-2026-07-23-asset-migration-indexed-resolver-generation.md)
