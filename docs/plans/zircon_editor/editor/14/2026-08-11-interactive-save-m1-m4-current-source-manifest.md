...
status: invalidated_for_source_bound_validation
owner_plan: docs/plans/zircon_editor/editor/14-threading-and-job-scheduling.md
milestone: interactive-save-after-m4-hard-cut
supersedes_for_validation:
  - docs/plans/zircon_editor/editor/14/2026-08-10-interactive-save-batch-admission-lane.md
exact_path_count: 47
input_path_count: 46
---

# Editor14 InteractiveSave M1-M4 Local Input Manifest (Invalidated)

This manifest records the InteractiveSave adapter and M1/M3/M4 JobSystem input
set as it existed after the hard cut. The table has 46 inputs; this manifest is
the 47th listed path. It supersedes the pre-hard-cut 16-path candidate only as
a local source inventory, not as a validation snapshot.

All M1/M3/M4 `system/mod.rs` leaf owners introduced by this source overlay are
listed. This table is not self-contained for a source-bound Cargo gate: the
dirty `save_batch/tests.rs` autosave fixture and the dirty Settings startup/
defaults APIs consumed by `quota_settings_contract.rs` are owned outside this
candidate. They must be committed by their owners or explicitly composed into
a new, leased successor before validation. No compatibility facade, second save
queue, or synchronous fallback is part of this inventory. The failure remains
open pending that successor, managed Cargo, scale/WPR evidence, Editor06/09
upstream acceptance, and an independent second review of the successor.

| Path | SHA-256 |
| --- | --- |
| `docs/plans/zircon_editor/editor/14/2026-08-10-interactive-save-batch-admission-lane.md` | `d7936e3ca44b247b47c1085aef09d6b2147370ceee875679092bb2ae1adc3596` |
...
| `docs/plans/zircon_editor/editor/14/failure-2026-08-01-interactive-save-batch-admission-lane.md` | `3cd01369384ba72e15ac28238c0c28a4b2d7194f24391f6a2901d2859f149cac` |
| `tools/tests/test_editor14_interactive_save_job_adapter_contract.py` | `618c0002027d0d51b6427305ac3892fbb2314155eff3a145ce3d35d0a7267118` |
| `zircon_editor/src/core/asset/dirty/mod.rs` | `c42888e41f1581f9b2074eae10b8527887d5b78be629152f3f9b53a4a4525bee` |
| `zircon_editor/src/core/asset/dirty/save_batch.rs` | `302ef965b5e44e11cc5864664beca07d59b0015097fa4d72aa00de4a268546d4` |
| `zircon_editor/src/core/asset/dirty/save_job_adapter.rs` | `0c428802c548ecbee3af26d17eca62692df74a5396380a59eb8397a62fe87a01` |
| `zircon_editor/src/core/asset/dirty/save_job_adapter/tests.rs` | `0902e47c5e51b228a66d3c21967e1e18d04d004d7487e79b5eee155e58bbf28a` |
...
- current-source `zircon_editor` library validation, then the existing 1/100/10k document, payload, writer, stall, and Windows WPR matrix.
