...
- open 待修复（Editor08 operation path serde 验证绕过）：[editor-operation-path-deserialize-validation-bypass](08/failure-2026-07-14-editor-operation-path-deserialize-validation-bypass.md)
...
- open 待修复（Plugins12 structure audit report fixture 漂移）：[plugin-structure-audit-report-fixture-drift](../../zircon_plugins/12/failure-2026-07-13-plugin-structure-audit-report-fixture-drift.md)
- open 待修复（Plugins01 extension registry finalize coverage guard 漂移）：[extension-registry-finalize-coverage-guard-drift](../../zircon_plugins/01/failure-2026-07-13-extension-registry-finalize-coverage-guard-drift.md)
...
- open 待修复（Editor01 产出归档超限）：[plan-output-record-archive-limit](01/failure-2026-07-13-plan-output-record-archive-limit.md)
