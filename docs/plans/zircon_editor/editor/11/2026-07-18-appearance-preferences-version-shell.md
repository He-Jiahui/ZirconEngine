...
related_code:
  ...
  - zircon_editor/src/ui/preferences/tests/persistence.rs
  - tests/fixtures/serialization/editor-appearance-preferences/v0/appearance-v1.toml
tests:
  - tools/tests/test_editor11_appearance_preferences_version_shell_contract.py
---
