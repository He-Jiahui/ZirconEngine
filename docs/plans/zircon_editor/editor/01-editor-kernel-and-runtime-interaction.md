...
- fixed 已修复：[oit-buffer-plan-export](01/fixed-2026-07-12-oit-buffer-plan-export.md)
- fixed 已修复：[collider-shape-consumer-exhaustiveness](01/fixed-2026-07-12-collider-shape-consumer-exhaustiveness.md)
- open 待修复：[plan-output-record-archive-limit](01/failure-2026-07-13-plan-output-record-archive-limit.md)
- open 待修复（EditorUI08 runtime diagnostics physics state formatter）：[runtime-diagnostics-physics-state-format](../editor_ui/08/failure-2026-07-11-runtime-diagnostics-physics-state-format.md)
