...
import { actionButton, moduleTable, settingsRows, tag } from "./module-components.js";
...
export function extensionHandoffPanel(config) {
  return `<div class="zr-module-output-grid" data-extension-handoff="${esc(config.id)}">
    ${moduleTable(["Gate", "Evidence", "State"], extensionHandoffRows(config), "1fr 1.35fr 0.85fr")}
    ${settingsRows([
    ...
    <div class="zr-module-log">
      ...
      ${actionButton("Open Native Gate", "check")}
      ${actionButton("Review Matrix", "history")}
