...
try {
  ...
  const checks = [
    ...
    },
    {
      ...
      startPage: "hub-projects-detail",
      selector: ".project-detail-actions-section .project-action-stack .button[data-route='hub-editor']",
      expectedPage: "hub-editor",
      expectedText: "Editor",
    },
    {
      name: "detail remove action opens empty state",
      startPage: "hub-projects-detail",
      selector: ".project-detail-actions-section .project-action-stack .button[data-route='hub-state-empty']",
    ...
    },
    {
      ...
      startPage: "hub-projects-detail",
      selector: ".project-detail-actions-section .project-action-stack .button[data-route='hub-projects-detail-delete-confirm']",
      expectedPage: "hub-projects-detail-delete-confirm",
      expectedText: "Delete project from Hub?",
    },
    {
    ...
    },
    {
      ...
      startPage: "hub-editor",
      selector: ".control-stack .action-row:nth-child(2)",
      expectedPage: "hub-state-loading",
      expectedText: "Preparing project workspace",
    },
    {
      ...
      selector: ".build-actions-list .action-row:nth-child(4)",
      expectedPage: "hub-cloud",
      expectedText: "Cloud",
    },
    {
    ...
    },
    {
      ...
      startPage: "hub-cloud",
      selector: ".cloud-actions-panel .action-row:nth-of-type(2)",
      expectedPage: "hub-state-loading",
      expectedText: "Preparing project workspace",
    },
    {
  ...
  const searchChecks = [
    ...
    },
    {
      ...
      selector: ".toolbar .search-box input",
      query: "Door",
      visibleSelector: ".catalog-row:not(.is-filter-hidden), .catalog-column-row:not(.is-filter-hidden), .catalog-data-table .data-table-row:not(.is-filter-hidden)",
