...
related_code:
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/bind_group_layouts/depth_of_field_prepare.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/bind_group_layouts/velocity_camera.rs
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/bind_group_layouts/motion_vector_neighbor_max.rs
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_buffer_bundle/depth_of_field_prepare_params_buffer.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_buffer_bundle/velocity_camera_params_buffer.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/build.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_fallback_texture_views/create.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_fallback_texture_views/effect_lut_texture_view.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/depth_of_field_prepare_pipeline.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/prepare_frame/prepared_visible_clusters.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_hardware_rasterization_pass/output.rs
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_hardware_rasterization_pass/store_parts.rs
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_hardware_rasterization_pass/execute.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_hardware_rasterization_pass/buffer.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_executed_cluster_selection_pass/execute.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_executed_cluster_selection_pass/selection_filter.rs
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_executed_cluster_selection_pass/buffer.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_executed_cluster_selection_pass/seed_backed_execution_selection/record.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_visbuffer64_pass/output.rs
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_visbuffer64_pass/store_parts.rs
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_visbuffer64_pass/execute.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/virtual_geometry_visbuffer64_pass/buffer.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/gpu_readback/pending_readback/mod.rs
  ...
  - zircon_plugins/hybrid_gi/runtime/src/hybrid_gi/renderer/gpu_readback/pending_readback/mod.rs
  ...
  - zircon_runtime/src/scene/render_extract/producer.rs
  - zircon_runtime/src/scene/tests
  - zircon_runtime/src/graphics/mod.rs
  - zircon_runtime/src/graphics/runtime_builtin_graphics/host/module_host/mod.rs
  - zircon_runtime/src/graphics/types/mod.rs
  - zircon_runtime/src/graphics/runtime/mod.rs
  - zircon_runtime/src/graphics/runtime/history/mod.rs
  - zircon_runtime/src/graphics/runtime/offline_bake/mod.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/normalized_page_table_entries.rs
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/declarations/mod.rs
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/declarations/virtual_geometry_runtime_state/mod.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/declarations/virtual_geometry_runtime_state/budget.rs
  ...
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/declarations/virtual_geometry_runtime_state/request_state.rs
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/declarations/virtual_geometry_runtime_state/hot_frontier.rs
  - zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/declarations/virtual_geometry_runtime_state/slot_allocator.rs
  ...
  - zircon_runtime/src/graphics/runtime/render_framework/capture_frame/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/destroy_viewport/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/compile_options_for_profile/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/compiled_feature_names/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/create_viewport/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/query_stats/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/queue_capability/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/reload_pipeline/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/render_framework_trait_binding/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/set_pipeline_asset/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/set_quality_profile/mod.rs
  ...
  - zircon_runtime/src/graphics/runtime/render_framework/submit_frame_extract/build_frame_submission_context/mod.rs
  - zircon_runtime/src/graphics/runtime/render_framework/submit_frame_extract/prepare_runtime_submission/mod.rs
  ...
  - zircon_runtime/src/graphics/feature/builtin_render_feature_descriptor/dispatch/mod.rs
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/core/create_depth_texture/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/runtime_features/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/scene_renderer_history/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/scene_renderer_core_render_scene/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/scene_renderer_core_render_compiled_scene/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/scene_renderer_core_write_scene_uniform/mod.rs
  - zircon_plugins/hybrid_gi/runtime/src/hybrid_gi/renderer/root_output_sources/scene_renderer_hybrid_gi/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/scene_renderer_construct/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/scene_renderer_target/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/target_extent/mod.rs
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/core/scene_renderer_render/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/scene_renderer_render_with_pipeline/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/core/scene_renderer_runtime_outputs/mod.rs
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/clear_render_target/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/fallback_texture/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/params/bloom_params.rs
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/gpu_data/reflection_probe_gpu.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_bloom/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_post_process/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_post_process/camera_matrices/mod.rs
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_post_process/encode_hybrid_gi_trace_regions/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_post_process/encode_reflection_probes/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_post_process/execute/build_post_process_params/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_post_process/execute/create_bind_group/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_post_process/execute/run/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_post_process/execute/write_hybrid_gi_buffers/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/execute_post_process/execute/write_reflection_probes/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/construct/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/buffer_bundle/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/fallback_texture_views/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/pipeline_bundle/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_buffer_bundle/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_fallback_texture_views/mod.rs
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/shaders/bloom.wgsl
...
plan_sources:
  ...
  - user: 2026-05-04 Task 1 retry implement neutral advanced-plugin runtime prepare collector boundary
  - user: 2026-05-04 Task 2 register public neutral runtime prepare collectors for VG/HGI plugins
  - user: 2026-05-04 expand runtime prepare collector context with neutral prepared sidebands
...
tests:
  ...
  - zircon_runtime/src/core/framework/render/post_process/volume_evaluator.rs::tests
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_fallback_texture_views/effect_lut_texture_view.rs::tests::generated_effect_lut_3d_is_identity_cube
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/post_process_pipeline.rs::tests::post_process_shader_parses_after_lut_binding_expansion
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/post_process_pipeline.rs::tests::post_process_shader_samples_bound_effect_lut_texture_3d
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/post_process_pipeline.rs::tests::post_process_shader_samples_bound_scene_normal_texture_for_ssr
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/post_process_pipeline.rs::tests::post_process_shader_samples_bound_depth_of_field_coc_texture
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/post_process_pipeline.rs::tests::post_process_shader_samples_bound_depth_of_field_bokeh_texture
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/post_process_pipeline.rs::tests::post_process_shader_samples_bound_scene_motion_vector_for_motion_blur
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/post_process_pipeline.rs::tests::post_process_shader_samples_bound_scene_material_texture_for_ssr_roughness
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/post_process_pipeline.rs::tests::post_process_shader_attenuates_ssr_with_ambient_occlusion
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/screen_space_reflection_specular_occlusion_pipeline.rs::tests::post_process_shader_exposes_split_ssr_specular_occlusion_entry_point
  ...
  - zircon_runtime/src/graphics/scene/scene_renderer/core/runtime_features/runtime_features_from_pipeline.rs::tests::descriptor_only_builtin_tokens_do_not_enable_pluginized_runtime_flags
  ...
  - zircon_runtime/src/graphics/scene/render_product_streamer_tests/material_runtime/pbr_projection.rs::render_product_pbr_streamer_projects_standard_material_into_runtime_key
  ...
  - cargo test -p zircon_runtime --locked render_debugger_and_history
  ...
  - cargo test -p zircon_editor retained_viewport_toolbar_pointer --locked
  - cargo test -p zircon_editor ui::retained_host::viewport
  ...
  - 2026-05-04: cargo check -p zircon_runtime --lib --no-default-features --features target-client --target-dir E:\zircon-build\targets\runtime\lib --locked --jobs 1 --message-format short --color never (passed with existing warnings)
  - 2026-05-04: cargo check -p zircon_app --bin zircon_runtime --no-default-features --features target-client --target-dir E:\zircon-build\targets\runtime\bin --locked --jobs 1 --message-format short --color never (passed with existing warnings)
  ...
  - 2026-05-04: cargo check -p zircon_runtime --lib --locked --offline --jobs 1 --target-dir target\codex-shared-a --message-format short --color never (passed with existing warnings)
  - 2026-05-04: cargo check --manifest-path zircon_plugins\Cargo.toml -p zircon_plugin_particles_runtime --tests --locked --offline --jobs 1 --target-dir target\codex-shared-a --message-format short --color never (passed with existing runtime warnings)
  - 2026-05-04: Get-PSDrive -Name E (reported 133.51 GB free before milestone validation)
...
`zircon_app::EntryConfig` carries an optional render request; `resolve()` derives the role/profile default and produces an immutable `ResolvedProductHostConfig`. Runtime and editor roles default to `DefaultRender`, server defaults to `Headless`, and contradictory server render requests fail before composition. `BuiltinEngineEntry` stores only the resolved bundle before module activation. The module-detail contract is documented in [Runtime Render Profile Contracts](../zircon_runtime/core/framework/render/profile.md).

## 2026-05-09 M3A Product Asset Contracts

M3A adds neutral asset-product contracts under `zircon_runtime::core::framework::render::{image,mesh,shader,material}` and keeps asset-side projection under `zircon_runtime::asset::assets::{texture,model,shader,material}`. Texture assets now expose image format, color space, sampler, usage, mip/layer counts, and fallback class. Model primitives expose topology, bounds, primitive kind, 2D/3D suitability, primitive counts, and optional Virtual Geometry payload presence.
...
Runtime scene data now has folder-backed `render2d` components. `Sprite2dComponent` stores image/material handles, atlas region, source rect, flip flags, anchor, custom size, image mode, tint, z order, and alpha policy; `Mesh2dComponent` reserves the parallel 2D mesh shape but does not count as a sprite in M6A. `World` extraction filters sprites through the active camera render layers, sorts by `(z_order, entity)`, writes `SpriteExtract::from_sprites(...)`, and adds visible sprites to `VisibilityInput` as dynamic renderables for renderer/debug parity.
...
The 2026-06-07 sprite image-mode follow-ups add the first Bevy-style image scaling contract without changing the shader ABI. `RenderSpriteImageMode` defaults to `Stretch` for the old single-quad behavior, `Scale(RenderSpriteScalingMode)` adds Fill/Fit center/start/end aspect handling, `Tiled` splits an oversized sprite rect into repeated CPU quads, and `Sliced(RenderSpriteSlicer)` carries left/right/top/bottom borders plus center/side stretch-or-tile policy for nine-slice panels. `Sprite2dComponent` forwards the mode into `RenderSpriteSnapshot`, and `build_sprite_vertices(...)` expands scaled/tiled/sliced modes into CPU vertex slices before batching by adjacent texture. Fit modes shrink and align the drawn quad while keeping the full source rect; Fill modes keep the authored draw rectangle and crop the source rect. This makes basic aspect-preserving sprites, UI panels, and tiled-image rendering visible through existing Core2d WGPU sprite passes; it does not add atlas importer metadata, editor image-mode handles, new sampler/material variants, per-alpha GPU pipeline specialization, or Bevy-like binned sprite batching.

Telemetry is explicit. `ResourceStreamer::ensure_scene_resources(...)` records sprite count, texture-ready count, and texture fallback count independently from material stats. `RenderStats` records those fields plus `last_sprite_graph_executed_pass_count`. M6 renderer-side queue preparation now also surfaces `last_sprite_draw_batch_count`, `last_sprite_batched_sprite_count`, `last_sprite_image_slice_count`, `last_sprite_expanded_image_slice_count`, `last_sprite_vertex_count`, and per-phase sprite batch counts from the same adjacent-texture batching contract used by the concrete WGPU sprite pass. `collect_runtime_diagnostics(...)` mirrors this sprite telemetry as `render.sprite.*` and `render.sprite.queue.*` count rows. Focused M6A submit evidence proves sprite graph passes execute while particle graph passes stay at zero. This still leaves atlas asset import, Bevy-like binned batching, per-alpha-mode GPU pipelines, alpha-mask fragment discard, and materialized `Mesh2d` rendering to later milestones; it does not enable Virtual Geometry, Hybrid GI, or Solari by default.

## 2026-05-18 M7A Runtime UI Product Graph Placement

M7A moves runtime screen-space UI placement under the product graph while preserving `UiRenderExtract` as the shared runtime/editor input contract. `BuiltinRenderFeature::Ui` now contributes a `runtime-ui` pass at `RenderPassStage::Ui` with executor id `ui.screen-space`, `QueueLane::Graphics`, a read of `PostProcessGraphResourceNames::FINAL_COLOR`, and a write to external `viewport-output`. The graph descriptor therefore states the intended product ordering directly: postprocess produces final color, and each pipeline asset decides whether runtime UI composites before later overlay work (Core2D) or after scene overlay/debug work (default 3D).

Core2d, Forward+, and Deferred all compile the UI pass. The 3D defaults also keep the base `PostProcess` feature present even when bloom, color grading, and history are disabled, so lightweight `DefaultRender` submissions still have an executed `post-process` anchor before `runtime-ui`. The base `post-process` pass is side-effectful for placement evidence, while optional effect executors no-op when their corresponding validated post-process node is absent from the current extract. This avoids treating optional post effects as the only evidence that UI is after postprocess.

Execution is graph-owned. `RenderPassGpuExecutionContext` carries the renderer-owned `ScreenSpaceUiRenderer`, `RenderPassExecutorRegistry` registers `ui.screen-space`, and the executor records the existing screen-space UI renderer into the named final-color resource during graph execution. The previous manual late UI record call after overlay is no longer the product placement authority. `RenderStats` reports both shared extract payload counts and graph placement evidence: `last_ui_graph_executed_pass_count`, `last_ui_target_size`, and `last_ui_graph_pass_order`. `collect_runtime_diagnostics(...)` mirrors command, quad, text, image, clipped-command, and graph-pass counts as `render.ui.*`. The order field becomes `postprocess-ui-overlay` for Core2D when the real executed pass list contains `post-process`, `runtime-ui`, and `overlay-gizmo` in that order, and `postprocess-overlay-ui` for default 3D when `overlay-gizmo` precedes terminal `runtime-ui`. The 2026-06-07 and 2026-06-20 submitted-frame regressions cover the dynamic-resolution final-target split for both primary and texture targets: scene/postprocess internals scale through `last_frame_render_size`, while `runtime-ui` composites to the unscaled presentation target reported by `last_ui_target_size`. The direct-import texture case also requires `DirectImported` graph-import telemetry, `SkippedDirectImport` writeback, and `TextureDirectGraphImport` capture source to agree with the resolved texture extent.

Focused M7A validation passed on 2026-05-18 using `CARGO_TARGET_DIR=target/codex-native-material-painter`: `cargo check -p zircon_runtime --lib --locked --jobs 1 --color never`, `cargo check -p zircon_editor --lib --locked --jobs 1 --color never`, `cargo test -p zircon_runtime --lib builtin_registry_covers_runtime_ui_executor_id --locked --jobs 1 --message-format short --color never` (1 passed), `cargo test -p zircon_runtime --locked render_product_ui --jobs 1 --message-format short --color never` (2 passed), and `cargo test -p zircon_runtime --locked runtime_ui --jobs 1 --message-format short --color never` (23 runtime lib tests plus 6 `runtime_ui_text_render_contract` tests). The runtime UI graph gate was revalidated on 2026-05-19 after editor-side binding cleanup with `cargo test -p zircon_runtime --locked render_product_ui --jobs 1 --message-format short --color never` (2 passed, `CARGO_TARGET_DIR=E:\Git\ZirconEngine\target\codex-render-m9b-solari`) and `cargo test -p zircon_runtime --locked runtime_ui --jobs 1 --message-format short --color never` (23 runtime lib tests plus 6 text-contract tests, `CARGO_TARGET_DIR=D:\cargo-targets\zircon-codex-render-damage`). The app-level linked-plugin regression was also revalidated after the test fixture was brought back in line with provider-backed advanced feature gating: `cargo test -p zircon_app --lib linked_runtime_render_feature_descriptors_rebuild_default_pipelines --locked --jobs 1 --message-format short --color never` (1 passed) and `cargo test -p zircon_app --lib --locked --jobs 1 --message-format short --color never` (70 passed).
...
Shader and material authoring truth stays in `.zshader` and `.zmaterial` runtime assets. `RenderPipelineAsset::compile_with_asset_context(...)` resolves feature shader/material references through an abstract `RenderPipelineAssetContext`, delegates hard graph validation to `compile_with_options(...)`, and returns a `RenderPipelineCompileReport` with non-fatal `RendererFeatureContractDiagnostic` rows for missing feature shader/material assets, missing material-owned shaders, material-shader mismatches, missing entry points, missing properties, missing texture slots, material-local validation errors, stored material diagnostics, material shader-contract validation errors, and shader readiness diagnostics from `ShaderAsset::readiness_report()`. The compile report now exposes read-only grouping helpers by runtime feature, `.zmaterial`, `.zshader`, `RenderMaterialDiagnosticSource`, and `RendererFeatureContractDiagnosticSeverity`, backed by centralized `RendererFeatureContractDiagnostic` ownership/source/severity accessors so runtime tools, asset-management views, and editor projections do not need to re-decode the flat diagnostic enum independently. Material-shader mismatch, material validation, and stored material diagnostic rows carry the owning `.zmaterial` reference so editor projections can group local material errors and shader-contract failures by asset instead of only by renderer feature. Material validation rows also retain the shader reference when the row came from shader-contract validation, keeping editor grouping precise for `.zshader` repair workflows; duplicate shader references are collapsed when a material validation error and its shader-contract source name the same shader. Source grouping keeps dependency-resolution, shader-schema, texture-slot, and WGSL-capture rows classified while leaving material-local controls and stored string diagnostics unclassified; severity grouping marks structural repair rows as errors and stored material/shader validation strings as warnings. A feature-level shader reference remains the source for explicit feature shader expectations; when a feature only references a material, compile diagnostics now load `MaterialAsset.shader`, validate the material against that material-owned shader, forward shader readiness diagnostics as `ShaderValidation`, and report `MaterialShaderMissing` with both material and shader references if the owned shader cannot be resolved. Descriptor, stage, phase, resource, and core-pipeline graph errors remain hard compile failures.

The shader-readiness projection closes a renderer contract gap without moving GPU responsibility upward. RendererData now surfaces missing runtime WGSL, invalid shader entry stages, empty or duplicate shader definitions, and copied shader-side validation diagnostics through `ShaderValidation`, while WGSL import composition, typed shader-def specialization, shader-module creation, bind-group layout allocation, and pipeline cache invalidation remain renderer-prepare/cache work.
...
M8A makes `RenderProductFeature::AntiAlias` concrete for the default 3D product path. The neutral framework contract now lives under `zircon_runtime::core::framework::render::anti_alias` and exposes `AntiAliasMode`, `AntiAliasSettings`, and `AntiAliasFallbackReport`. `RenderViewExtract` carries the requested AA mode beside camera/core-pipeline state: default cameras request `Auto`, while cameras with `msaa_samples > 1` request `Msaa { samples }` and must be resolved before concrete rendering claims any MSAA behavior.

Backend capability validation now has a default screen-space AA capability. `RenderCapabilityKind::ScreenSpaceAntiAlias` / `RenderFeatureCapabilityRequirement::ScreenSpaceAntiAlias` are satisfied by `RenderCapabilitySummary.supports_fxaa`; WGPU capability summaries set FXAA support when offscreen rendering is available and keep SMAA, TAA, CAS, DLSS, and MSAA sample counts unimplemented for now. `DefaultRender` therefore proves its anti-alias product claim through Auto-to-FXAA on supported backends, and unsupported requested modes degrade through structured fallback reasons instead of silent success.

The first concrete implementation is FXAA in the product postprocess graph. `BuiltinRenderFeature::AntiAlias` contributes a `fxaa` pass at `RenderPassStage::PostProcess` with executor id `post.fxaa`; Forward+ and Deferred insert it after the base `post-process` pass and before runtime UI. When settings resolve to FXAA, `PostProcessStackDescriptor` makes `final-composite` produce `postprocess.final-composited`, then adds an `fxaa` node that produces `final-color`. The renderer imports both names for the same frame target while the current WGPU shader remains a single concrete postprocess pass with an AA uniform lane.

Telemetry is explicit. `RenderStats.last_anti_alias_fallback` records requested/effective mode plus fallback reason, and `last_anti_alias_graph_executed_pass_count` counts `post.fxaa` executor participation from the real graph execution record. `last_post_process_graph_executed_nodes` includes `fxaa` only when the effective postprocess graph enables it. Focused M8A validation currently passes with `CARGO_TARGET_DIR=target/codex-render-m8a-aa`: `cargo check -p zircon_runtime --lib --locked --jobs 1 --color never`; `cargo test -p zircon_runtime --locked render_product_anti_alias --jobs 1 --message-format short --color never` (3 passed); `cargo test -p zircon_runtime --locked render_product_post_process --jobs 1 --message-format short --color never` (9 passed); `cargo test -p zircon_runtime --locked render_product_pipeline --jobs 1 --message-format short --color never` (2 passed); `cargo test -p zircon_runtime --locked render_product_ui --jobs 1 --message-format short --color never` (2 passed); `cargo test -p zircon_runtime --lib builtin_registry_covers_product_postprocess_executor_ids --locked --jobs 1 --message-format short --color never` (1 passed); `cargo test -p zircon_runtime --lib capability_validation --locked --jobs 1 --message-format short --color never` (3 passed); and `cargo test -p zircon_runtime --locked pipeline_compile --jobs 1 --message-format short --color never` (39 passed). MSAA render targets, TAA history jitter/resolution, SMAA, CAS, and DLSS remain future milestones.

## 2026-05-18 M9A Advanced Profile Neutral Contract

M9A begins by giving `AdvancedRender` a neutral runtime planning surface before touching app provider bootstrap or plugin manifests. `zircon_runtime::core::framework::render::advanced` now owns `AdvancedRenderFeature`, `AdvancedRenderDegradation`, `AdvancedProviderReport`, `AdvancedProviderAvailability`, and `AdvancedProfileRuntimePlan`. The plan evaluates a `RenderProfileBundle`, backend `RenderCapabilitySummary`, and provider IDs into one report for Virtual Geometry and one for Hybrid Global Illumination.

The report vocabulary is intentionally explicit: `DefaultRender` reports VG/HGI as `NotRequested` with no degradation, while `AdvancedRender` only marks a feature ready when it is requested, every required backend capability is present, and a provider ID exists. Missing provider and missing backend capability are independent degradation records, so diagnostics do not hide one behind the other.

The backend capability vocabulary also gained the concrete M9A requirements needed by current advanced render paths: `StorageBuffers`, `IndirectDraw`, and `BufferReadback`. These are exposed through `RenderCapabilityKind`, `RenderCapabilitySummary`, `RenderFeatureCapabilityRequirement`, RHI `RenderBackendCaps`, and WGPU capability projection. Virtual Geometry currently requires `VirtualGeometry + StorageBuffers + IndirectDraw + BufferReadback`; Hybrid GI requires `HybridGlobalIllumination + StorageBuffers + BufferReadback`. Async compute remains separate because queue fallback can run async-declared work on graphics; ray-query remains reserved for providers or Solari paths that actually require it. `RenderCapabilitySummary::capability_class_report(...)` now splits default, advanced, and experimental capability reports into satisfied and missing lists for diagnostics.

Provider arbitration is now deterministic inside the runtime framework once providers are supplied. VG/HGI provider registrations carry a priority; duplicate provider IDs and ties at the highest priority reject `WgpuRenderFramework` construction with `GraphicsError::AdvancedProviderSelection`; the selected provider IDs are stored in `RenderStats::advanced_provider_availability`. Submit-time gating consumes the same availability: quality-profile advanced flags only opt in capability-gated plugin features when the backend capability and selected provider are both present, `FrameSubmissionContext` gates VG/HGI sidebands through `AdvancedProfileRuntimePlan`, and `RenderStats::last_advanced_provider_reports` records the per-feature reports from the last submit.

M9A now also has runtime-framework submit acceptance around the provider boundary. `plugin_render_feature_fixtures.rs` keeps descriptor-only advanced fixtures separate from descriptor-plus-no-op-provider fixtures, so a compiled plugin descriptor no longer implies that VG/HGI are runnable. The bridge tests prove both sides: provider-backed `AdvancedRender` records selected provider IDs, ready reports, authored payload sources, and VG/HGI graph pass execution; descriptor-only `AdvancedRender` records provider-missing degradations, clears payload-source stats to `None`, and executes zero VG/HGI graph passes. Capability-missing bridge tests use a capability summary with default AA and concrete advanced support dependencies enabled, so they isolate the missing VG/HGI capability under test instead of accidentally failing on unrelated default requirements.

Focused M9A validation currently passes with `CARGO_TARGET_DIR=target/codex-render-m9a-advanced`: `cargo check -p zircon_runtime --lib --locked --jobs 1 --color never`; `cargo test -p zircon_runtime --lib advanced --locked --jobs 1 --message-format short --color never` (39 passed); `cargo test -p zircon_runtime --lib capability --locked --jobs 1 --message-format short --color never` (23 passed); `cargo test -p zircon_runtime --lib compile_options_ --locked --jobs 1 --message-format short --color never` (6 passed); `cargo test -p zircon_runtime --lib payload_source --locked --jobs 1 --message-format short --color never` (9 passed); `cargo test -p zircon_runtime --lib resolve_enabled_features --locked --jobs 1 --message-format short --color never` (3 passed); `cargo test -p zircon_runtime --lib collect_runtime_feedback --locked --jobs 1 --message-format short --color never` (3 passed); and `cargo test -p zircon_runtime --lib render_framework_bridge --locked --jobs 1 --message-format short --color never` (32 passed). App-side first-party VG/HGI provider collection and runtime catalog/manifest declarations remain open M9A slices.
...
`RenderFramework::capture_frame_if_newer(viewport, last_generation)` is the generation-aware polling contract for retained editor and dynamic-runtime consumers. Its default implementation preserves compatibility by filtering the existing owned capture result; `WgpuRenderFramework` overrides it and compares the viewport's stored capture generation before cloning the owned RGBA buffer under the framework state lock. Retained viewport polling and `RuntimeRenderBridge` pass their last consumed generation, so UI ticks without a newly submitted frame return `None` without copying the previous full framebuffer. `capture_frame()` remains the unconditional screenshot/test API and delegates to the same backend path with no generation filter.
...
基础 renderer 不再命名 concrete GI/VG GPU resource 或 readback part。`SceneRendererAdvancedPluginResources` 与 `SceneRendererAdvancedPluginReadbacks` 收束成中立资源/输出边界；root render path 只保留 descriptor/executor/capability 驱动的 public render/debug DTO 和 erased provider contract。旧 root `graphics::scene::scene_renderer::{hybrid_gi, virtual_geometry}`、`graphics::runtime::{hybrid_gi, virtual_geometry}` 目录已断开，VG render pass 源码迁入 `zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/renderer/root_render_passes/`，HGI/VG renderer GPU 源码迁入各自插件的 `renderer/` 目录。

本次迁移后的验证记录：`cargo check -p zircon_runtime --lib --locked --offline` 已通过；`cargo check --manifest-path zircon_plugins/Cargo.toml -p zircon_plugin_virtual_geometry_runtime -p zircon_plugin_hybrid_gi_runtime --locked --offline` 已通过；最终单元测试 `cargo test -p zircon_runtime --lib --locked --offline` 已通过 562/562，`cargo test --manifest-path zircon_plugins/Cargo.toml -p zircon_plugin_virtual_geometry_runtime -p zircon_plugin_hybrid_gi_runtime --lib --locked --offline` 已通过 Hybrid GI 3/3 与 Virtual Geometry 8/8。由于现有 manifest 已引入 `fontsdf` 但 lockfile 未同步，本轮先用 offline non-locked check 刷新 lockfile，再回到 `--locked --offline` 验证。
...
2026-05-04 的 editor/runtime export build repair 只恢复 compiled-scene wiring 的局部可见性和 import authority，没有改变 graph semantics。`execute_graph_stage.rs` 从 `crate::graphics::pipeline` 导入 `CompiledRenderPipeline`，并把 `RenderGraphStageExecution`、`import_frame_targets(...)`、`execute_graph_stage(...)` 的 visibility 限定在 `scene_renderer_core_render_compiled_scene` 子树；`render/mod.rs` 只对同一子树公开 `execute_graph_stage` module，同时继续把 `merge_plugin_renderer_outputs` re-export 到 core 范围，供 `render_frame_with_pipeline(...)` 的 existing path 合并 neutral plugin renderer outputs。这个 repair 对应用户粘贴的 `render_frame_with_pipeline.rs` call-site mismatch 阻塞：目标是让当前 compiled pipeline render path 重新 type-check，而不是接管 active VG/HGI/readback refactor sessions 或扩大 executor registry policy。

2026-05-04 particles M6 full graph refactor replaced the old metadata-only executor loop with renderer-owned staged execution. Its former `CompiledRenderPipelinePassStage` surface was later hard-cut: `CompiledRenderPipeline` now owns one immutable `RenderGraphExecutionPacket`, whose stage entries point at dense compiled-graph pass indices. `RenderPassExecutorRegistry` stores executor objects behind `Arc<dyn RenderPassExecutor>` and still adapts function-pointer registrations, but all executors now receive a mutable `RenderPassExecutionContext<'_>`. That context keeps pass metadata available and can optionally carry a renderer-owned `RenderPassGpuExecutionContext` with `wgpu::Device`, `wgpu::Queue`, live `wgpu::CommandEncoder`, frame extract access, scene bind group, named `RenderGraphExecutionResources`, and a neutral `RenderPluginRendererOutputs` sink. The root context file owns metadata, queue flags, declared resource access, and graph attachment-op lookup; `render_pass_execution_context/gpu.rs` owns the common renderer payload plus non-postprocess concrete `record_*` calls, while `render_pass_execution_context/gpu/reports.rs` owns compute dispatch records plus HZB occlusion, light-grid, and motion-vector status extraction so the root GPU context stays below the structure budget. `render_pass_execution_context/gpu/post_process.rs` owns `RenderPassPostProcessStackContext`, postprocess target/resource resolution, SSAO/clustered compute-dispatch recording, and the concrete shared postprocess, motion-vector, and DoF record bridges. SSR-specific postprocess graph bridges now live under `render_pass_execution_context/gpu/post_process/screen_space_reflection.rs` so the root postprocess bridge remains structural as the SSR pass family grows.

2026-06-28 的 F16 render_compiled_scene structure split status guard 继续锁定既有拆分：`bind_compiled_scene_graph_resources.rs` 拥有 frame/history/transient/execution/plugin resource binding，`execute_compiled_scene_graph_stages.rs` 拥有 early/lighting/scene/post/history/late graph stage execution，`submit_compiled_scene_frame.rs` 拥有 `queue.submit([encoder.finish()])`、HZB/readback 统计与 transient-pool release。2026-07-14 Runtime15 follow-up 把 sprite graph stage 选择及其夹具迁入 `sprite_stage_selection.rs`，把 GBuffer/TAA/SSR/HZB/exposure/volumetric 共用的 resource-write 判定迁入 `pipeline_resource_usage.rs`，`render.rs` 只保留 compiled-scene orchestration。`review_f16_compiled_scene_render_path_uses_split_owners` 锁定两个 focused children，并继续禁止 `execute_graph_stage(...)`、`active_late_graph_stages(...)` 或 submit/readback/pool-release 行为回流；保留历史状态锚 `compiled_scene_render_split_review_guard_static_passed_cargo_deferred` 与 `compiled_scene_render_split_coremin_and_focused_tests_passed`，本次状态为 `runtime_15_render_owner_budget_split_current_source_managed_build_passed`。
...
This slice also finished the neutral runtime-prepare collector propagation needed by the staged graph path. `RuntimePrepareCollectorRegistration` now travels from plugin extension registries through `runtime_modules.rs`, `GraphicsModule`, module-host descriptor creation, `WgpuRenderFramework::new_with_plugin_render_extensions(...)`, `SceneRenderer::new_with_plugin_render_extensions(...)`, and finally `SceneRendererAdvancedPluginResources::new(...)`. The collector contract remains runtime-owned and plugin-agnostic: it receives `RuntimePrepareCollectorContext` with WGPU handles plus the full `ViewportRenderFrame` context projected as neutral accessors, returns `RenderPluginRendererOutputs`, and is merged with the same non-empty packet replacement rules as graph-stage executor outputs. `RenderPreparedRuntimeSidebands` is the neutral frame-carried package for already-prepared runtime-provider data: it exposes `RenderPluginRendererOutputs`, HGI/VG readback DTO accessors, and evictable probe/page id lists without making `PreparedRuntimeSubmission`, `ResourceStreamer`, or concrete plugin resources public. `build_runtime_frame(...)` copies that package from `PreparedRuntimeSubmission` into `ViewportRenderFrame`, and `RuntimePrepareCollectorContext` exposes viewport size, scene snapshot, frame extract, and prepared sidebands to registered collectors. This does not make runtime depend on VG/HGI/particles concrete state; it only keeps linked plugin neutral packets reachable while the command encoder is live.
...
2026-06-24 的 RenderGraph resources transient aliasing tests owner split 把 `render_graph/tests/resources.rs` 收束为 633 行基础 resource contract parent，并把 non-overlapping transient aliasing、descriptor bucket、bucket-local reserved bytes、dense byte totals 与 sparse virtual byte accounting coverage 移入 `render_graph/tests/resources/transient_aliasing.rs`。`runtime_15_render_graph_resources_transient_aliasing_tests_are_child_owner` 锁定 moved-test ownership、父/子 800 行预算和 docs/status 锚点；状态锚为 `render_graph_resources_transient_aliasing_tests_owner_split_static_passed_cargo_deferred_implementation_cadence`，Cargo/WGPU/RenderDoc 仍按 milestone implementation cadence deferred。
...
`SceneRendererAdvancedPluginResources` 的 owner 类型和 `new(...)` 构造现在也只在 `crate::graphics::scene::scene_renderer::core` 内可命名，不再通过 crate-wide 或 renderer-wide re-export 暴露给外层提交、runtime 或测试辅助路径。资源 owner 仍是 core 内部构造、compiled-scene draw assembly、runtime prepare/readback 调度和 VG indirect stats collection 的唯一高级资源入口；外层路径只能通过 renderer/core facade 间接触发这些行为。2026-05-04 的 retry slice 在这个 owner 内加入 runtime-owned neutral prepare collector list：collector 是 mutable `FnMut` boundary，只返回 `RenderPluginRendererOutputs`，不命名 `zircon_plugins` 或任何 VG/HGI concrete plugin resource type；没有 collector 时 `execute_runtime_prepare_passes(...)` 继续返回空 `SceneRendererAdvancedPluginReadbacks`，有 collector 时会按 compiled-scene 的既有 neutral merge 规则把非空 feature packet 整包替换进聚合输出，再通过 `SceneRendererAdvancedPluginReadbacks::from_outputs(...)` 交给后续 readback collection。

同一 owner 现在还把 linked render descriptor capability metadata 固化成 runtime 侧的中立 activation state：`SceneRenderer::new_with_plugin_render_features(...)` 会把 linked descriptors 传给 `SceneRendererCore::new_with_icon_source(...)`，再由 `SceneRendererAdvancedPluginResources::new(...)` 记录 `VirtualGeometry` 与 `HybridGlobalIllumination` capability bit。没有 linked VG/GI descriptor 的基础 renderer 仍保留 base render、mesh、post-process、overlay 和 UI resources；runtime 侧不会提前创建或命名插件私有 `VirtualGeometryGpuResources` / `HybridGiGpuResources`，mesh indirect path 也会在 feature enablement 与 VG resource capability 同时成立时才开启。runtime prepare 现在具备中立 collector sideband：默认 collector 列表为空且保持 no-op，真实 producer 接线必须通过注册 runtime-owned neutral collector 并填充 `RenderPluginRendererOutputs`。
...
Hybrid GI scene-prepare resource sample lookup 也开始从字段遍历收束到 snapshot query 方法：post-process probe encoding 现在通过 `capture_slot_rgba_sample(...)`、`atlas_slot_rgba_sample(...)`、`voxel_clipmap_rgba_sample(...)`、`voxel_clipmap_cell_rgba_sample(...)` 与 `voxel_clipmap_cell_dominant_rgba_sample(...)` 查询采样结果，不再直接遍历 `HybridGiScenePrepareResourcesSnapshot` 的 sample vectors。runtime surface-cache rehydration 也改为按 atlas/capture slot 调用这些 sample query 方法，而不是先读取完整 atlas/capture sample vectors 再自行建 map；完整 atlas/capture sample-vector accessors 因此只保留为 `#[cfg(test)]` inspection helpers。pending readback collect 侧也通过 `store_texture_slot_rgba_samples(...)` 写回 atlas/capture texture sample 结果，而不是直接赋值 sample vectors。scene-prepare GPU resource producer 侧的 voxel radiance、occupancy、dominant node 和 dominant-radiance sample vectors 也通过 `store_voxel_resource_samples(...)` 写入 snapshot，atlas/capture texture samples 同样复用 `store_texture_slot_rgba_samples(...)`。voxel cell / dominant sample vector accessors 现在作为生产中立 readback projection 的输入保留，因为 `RenderHybridGiScenePrepareReadbackOutputs` 已经显式承载 cell sample、dominant-node 和 dominant-sample records。snapshot base metadata 现在通过 `HybridGiScenePrepareResourcesSnapshot::new(...)` 创建，production producer 与 post-process 测试 fixture 都不再使用 struct literal；这让消费侧、readback 完成侧、GPU resource producer、runtime surface-cache rehydration 和测试 inspection fixture 都脱离资源 snapshot 的内部集合布局，为后续把 scene-prepare resource DTO 拆成插件-owned completion/inspection surface 留出边界。

runtime-side `VirtualGeometryGpuCompletion` / neutral `HybridGiGpuCompletion` 现在同样保持字段私有，并分别归属 `graphics/virtual_geometry_runtime_provider/gpu_completion.rs` 与 `graphics/hybrid_gi_runtime_provider/gpu_completion.rs`，不再由 `submit_frame_extract` 包声明 feature runtime DTO。Virtual Geometry 的运行期反馈进一步收束到 `graphics/virtual_geometry_runtime_provider/runtime_feedback.rs`：它把可选 GPU completion 与 node-and-cluster-cull page-request feedback 作为一个 feature-runtime-owned handoff 交给 record/update，而不是让 submit/record 层继续传递散开的 `Vec<u32>`。Hybrid GI 的运行期反馈则收束到 `graphics/hybrid_gi_runtime_provider/runtime_feedback.rs`，submit/record 层不再把 `Option<HybridGiGpuCompletion>` 或 fallback `VisibilityHybridGiFeedback` 作为裸参数穿过记录边界；`collect_runtime_feedback(...)` 现在先从 `SceneRenderer` 取走中立 `RenderHybridGiReadbackOutputs`，通过 `HybridGiGpuCompletion::from_readback_outputs(...)` 投影 cache entries、completed probe/trace ids、probe RGB、scene-prepare atlas/capture readback 以及 voxel-only / voxel-cell-only scene-prepare payload，再和 visibility fallback 一起组合进中立 `HybridGiRuntimeFeedback`。`record_submission(...)` 已经把 feedback 交给插件 provider 的 `update_after_render(...)` 消费。collect 阶段只能用 `new(...)` 创建，Hybrid GI / VG runtime update 只能通过 completion/feedback accessors 读取 cache/page-table/completed-update 数据和 page-request/visibility feedback。`RuntimeFeedbackBatch` 的 submit-to-record handoff 字段也收回到 owner 内部，两个 submit entry point 只能通过 `into_parts(...)` 一次性拆包后调用 `record_submission(...)`。Hybrid GI 的 scene/surface/voxel/screen-probe/radiance-cache snapshot 现在留在 `zircon_plugins/hybrid_gi/runtime` 内部，runtime 只读取 provider 返回的 `HybridGiRuntimeStats` 并投影成 `HybridGiStatSnapshot`；提交统计链只读取 `cache_entry_count()`、`scene_card_count()`、`scene_screen_probe_count()`、`scene_radiance_cache_entry_count()`、surface-cache/voxel count accessors 等命名 projection。Virtual Geometry runtime host 的 `VirtualGeometryRuntimeSnapshot` 现在对齐同一 owner boundary：`snapshot.rs` 通过 `VirtualGeometryRuntimeSnapshot::new(...)` 构造 page-table/resident/pending-request 统计，record/update 和 graphics tests 只读取 `page_table_entry_count()`、`resident_page_count()`、`pending_request_count()`。同一层的运行期上传请求 DTO 也不再裸露字段：`VirtualGeometryPageRequest` 与 `HybridGiProbeUpdateRequest` 只在对应插件 runtime owner 内用 `new(...)` 创建，prepare-frame 构造、extract cleanup、resolve-runtime seed 收集和 graphics tests 只能通过 `page_id()` / `size_bytes()` / `generation()` 或 `probe_id()` / `ray_budget()` / `generation()` projection 读取。这样 renderer completion-parts 的 one-shot deconstruction、runtime-provider-owned completion/feedback DTO、submit-level runtime feedback batch handoff、runtime stats projection、runtime pending-request projection 与 runtime submission record update 的 read-only projection 分开，避免 frame-submission 或 record-submission 代码重新耦合到 runtime completion/snapshot/request DTO 字段布局。
...
submit 阶段的 history handle 解析也收束为 owner DTO：`resolve_history_handle.rs` 保留 `ResolvedHistoryHandle` 的 `allocated_history` 与 `current_history_handle` 字段布局，`submit.rs` / `submit_runtime_frame.rs` 只能通过 `allocated_history()` 和 `current_history_handle()` 读取命名 projection，再分别传给 renderer history binding 和 record/update。history compatibility 与 history recording 也通过 `FrameSubmissionContext::size()`、`render_size()`、`pipeline_handle()`、`compiled_pipeline()` 和 `visibility_context()` 读取 frame metadata，而不是直接依赖 context 字段布局；其中 `size()` 是 imported/presentation target，`render_size()` 是动态分辨率后的内部 graph extent。这样 history rotation 判断、handle 分配、history recording 和 submit entry point 之间不再共享 raw DTO 字段，也不会把动态 render-scale 改变误判成可复用 history。
...
descriptor override 还会拒绝空 descriptor/pass/executor/resource 名称，确保 compiled graph、executor registry 和 stats 里不会出现不可追踪的匿名节点。2026-06-02 的 registry modularization 保持 executor id、错误文本和注册顺序不变，但把 post-process、scene、preview-sky executor bodies 与 registry tests 分离，后续新增 renderer 专用 executor 时应优先进入对应语义子模块，而不是继续扩大 `render_pass_executor_registry.rs`。
...
- `QueueLane`
- `PassFlags`
- `RgTextureHandle` / `RgBufferHandle` / `ExternalResource`
- `CompiledRenderGraph`
...
`RenderFramework` 还暴露 `request_graphics_debugger_capture(viewport)` 与 `query_graphics_debugger_status()`。trait 的默认实现保持 backend-neutral no-op，真正的 wgpu 路径由 `WgpuRenderFramework` 在下一次匹配 viewport submit 时消费 pending request：录制前调用 `Device::start_graphics_debugger_capture()`，提交/读回完成后 poll GPU 并调用 `Device::stop_graphics_debugger_capture()`。阻塞的 wgpu stop/poll 不在 framework state mutex 内执行；submit path 会先准备可独立停止的 capture handle、释放 state mutex，再在仍持有 operation lock 的情况下等待 GPU，防止另一帧或 viewport/pipeline mutation 进入 active capture。销毁带 pending/queued capture 的 viewport 会清空 debugger state 并记录 destroyed error，避免 `capture_pending` 卡住。状态只报告 `available / backend_name / capture_pending / active_capture / last_capture_frame / last_error`，不把 RenderDoc DLL 或 `renderdoc-sys` 变成运行时依赖；其中 `available` 只表示 wgpu capture hook 可调用，不证明 RenderDoc 已附加。若匹配 submit 在 capture 打开前的 preflight 阶段失败，pending request 会被消费并把 preflight error 写入 `last_error`；若 submit 在 capture 打开后失败，submit path 会停止 capture、清空 pending/active 状态，并把 submit/stop error 合并写入 `last_error`。

RenderDoc 启动路径通过环境变量而不是新 editor/dynamic API 扩展 façade：`WGPU_BACKEND=dx12|vulkan` 进入 `RenderBackendConfig` 后约束 `wgpu::InstanceDescriptor.backends`，`WGPU_DEBUG=1` 和 `WGPU_VALIDATION=1` 映射到 `wgpu::InstanceFlags`。`ZR_RENDERDOC_CAPTURE_NEXT=1` 兼容地把第一个创建的 viewport 预置成单帧 pending capture；`ZR_RENDERDOC_CAPTURE_FRAME_COUNT=<0..8>` 则为同一 viewport 排有界连续帧序列，显式 count 优先且大值钳制为 8，任一 submit/stop 错误或 viewport 销毁会取消剩余自动 capture。当前 live trigger surface 是 `RenderFramework::request_graphics_debugger_capture(viewport)`、单帧环境开关和有界序列环境开关。`GraphicsDebuggerStatus.backend_name` 记录实际 adapter backend，例如 `wgpu(dx12)` 或 `wgpu(vulkan)`，focused tests 在对应 `WGPU_BACKEND` 下断言 exact status string，方便手工捕获时确认 RenderDoc 正在观察预期 API。

PF-M2 并行录制基础设施由 `RenderSubmissionConfig.parallel_record` 与 `min_passes_per_bucket` 控制；两者分别默认 `false` 与 `2`，旧序列化配置仍保持单 encoder 行为。`graph_execution::ParallelEncoderSet` 从 compiled pass dependency 计算拓扑层，只收集未 culled pass，并且只在拓扑层边界合并达到最小 pass 阈值的 bucket；同一层不会被拆开，尾部不足阈值时并入前桶。关闭开关、共享 `TaskPool` 只有一个 worker 或不足两个可盈利桶时，全部 bucket 依次录入一个 encoder。并行路径一桶一 encoder，借助 indexed rayon collection 保持 command buffer 拓扑序，供调用方在一次 `Queue::submit` 中提交。该类型只接受已经准备完成、可独立借用的 immutable pass 输入；当前 live compiled-scene stage 仍共享 `RenderGraphExecutionResources`、execution record 与多个 mutable renderer cache，因此产品提交继续使用单 encoder，直到 Render01/02 把这些 owner 拆成独立 prepared pass data。禁止以 mutex 包裹现有 stage executor 来宣称 PF-M2 产品并行完成。

2026-06-25 Plan 08 offscreen backend follow-up changes the no-env `RenderBackendConfig` default to `wgpu::Backends::PRIMARY` while keeping explicit `WGPU_BACKEND=gl` for GL regression coverage. Status is `render_plan08_offscreen_backend_primary_default_implemented_recompile_not_closed`: the generated WSL lib-test binary showed old default/GL device filters exiting 139, while `WGPU_BACKEND=vulkan` passed Shadow, Velocity, TAA, GBuffer, and DepthPrepass device filters. The code and config test update are present, but the new default-path test binary did not recompile in the current WSL window, so default-path WGPU validation is not counted as passing yet.

固定 renderer path 和 graph executor path 共享 `zircon_runtime/src/graphics/debug_markers.rs` 的 marker vocabulary。命令流会插入 `zircon::FrameExtract`、`zircon::Clear`、`zircon::Prepass`、`zircon::MainScene`、`zircon::Lighting`、`zircon::DeferredLighting`、`zircon::PostProcess`、`zircon::HistoryCopy`、`zircon::Overlay`、`zircon::UI` 与 `zircon::Readback`，这样 RenderDoc event browser 可以按相同 stage 名称定位 history texture copy、postprocess pass、overlay/UI 叠加和最终 readback。Graph `RenderPassStage::Lighting` 使用 generic `zircon::Lighting`，避免 Forward+ lighting 被误标成 deferred；固定 deferred lighting pass 仍明确使用 `zircon::DeferredLighting`。
...
M7 后处理参数链先落中立接口，再接入基础 shader 消费：`RenderPostProcessEffectStackSettings` 把 tonemap、LUT、blur、motion blur、depth of field、screen-space reflection、vignette、film grain、dither、chromatic aberration 与 fog 参数挂到 `PostProcessExtract`，submit context 会把它们和 bloom/color-grading 一起派生有效 `PostProcessStackDescriptor`。只有参数非默认时才插入 `effect-stack` product node，并通过 `postprocess.effect-stacked` 资源别名进入 final composite；motion blur 启用时该节点声明 `scene-depth` 与 `postprocess.motion-vector.neighbor-max` 输入，raw `scene-motion-vector` 仍由 clear/camera/reconstruction 链路维护，DoF 启用时该节点还声明 `postprocess.depth-of-field.coc` 与 `postprocess.depth-of-field.bokeh` 两个 graph-owned product output，renderer 从 compiled graph descriptors materialize 同名 transient scratch targets；默认路径不新增 skipped placeholder。当前这一步提供图节点、资源名、executor id、`RenderStats.last_post_process_graph_executed_nodes`、`RenderStats.last_post_process_effect_stack_report` 与 `RenderStats.last_post_process_lut_{request,ready,fallback}_count` 证据；effect-stack report 按帧记录 active families、当前仍是 approximation-backed 的 families，以及 LUT handle / invalid LUT layout / graph-missing SSR normal / motion-blur velocity-prepass 资源标签。SSR normal 现在由 postprocess graph 资源状态驱动：当 `effect-stack` 节点声明 `gbuffer-normal` 输入时，submit stats 会清掉 `effect-stack.ssr.normal` 缺口；temporal SSR history 由 `history.previous.screen-space-reflection` 驱动；motion-vector target 也由 graph 状态驱动，声明 `postprocess.motion-vector.neighbor-max` 后会清掉 `effect-stack.motion-blur.motion-vector`，但 `effect-stack.motion-blur.velocity-prepass` 只有在 `post.motion-vector-camera`、`post.motion-vector-tile-max`、`post.motion-vector-tile-max-coarse` 与 `post.motion-vector-neighbor-max` 同帧执行后才会清掉。LUT counters 则记录启用 LUT family 后 authored texture 是否准备成功或回退到 renderer fallback。`collect_runtime_diagnostics(...)` 同步把 enabled、active family count、approximated family count、missing resource count 写入 runtime `DiagnosticStore`，并把 LUT request/ready/fallback 写入 `render.post_process.lut.*`，让工具侧可以读稳定 count/bool path，而不需要解析 renderer 私有状态。同时 `build_post_process_params(...)` 已把有效 effect-stack、camera depth、camera projection、camera view-basis 和 motion-blur shutter/sample 参数编入 `PostProcessParams`，`post_process.wgsl` 会消费这些 uniform 执行基础 tonemap/exposure、authored-or-fallback LUT texture sampling、blur、camera-linearized scene-depth DoF-radius sampling、graph-reconstructed motion-vector bounded gather 并用 scene-depth 衰减 foreground samples、view-space-normal/material/depth-backed projection-aware bounded SSR march、valid-history SSR feedback reprojection、split specular-occlusion target、SSR mip-chain depth-pyramid range gating、vignette、grain、dither、chromatic aberration 与 view-depth-weighted fog；motion blur 当前已有 final-stack consumer，可以消费 `motion-vector-camera` 写入且经 `motion-vector-tile-max` / `motion-vector-tile-max-coarse` / `motion-vector-neighbor-max` 重建的 camera/background vectors，并在 gather 中衰减前景 depth samples，但 object/skinned/particle velocity 仍未实现。WGPU postprocess bind group 现在会在 binding 10 优先采样 `ResourceStreamer` 已准备的 2D/2D-strip authored LUT texture view，缺失时回到 renderer-owned 64x1 S-curve fallback LUT；binding 12 绑定 decoded 3D LUT texture view 或 2x2x2 identity cube，binding 13 绑定 clamp/linear sampler 并用 `textureSampleLevel(...)` 做 3D LUT texel-center 线性采样；binding 11 在非 GL 路径绑定 graph `scene-depth`，GL/WebGL/ANGLE 路径通过 `PostProcessDepthSamplingMode` 编译 viewport-depth fallback shader 并绑定普通 float fallback texture，避免 WGPU/Naga GLSL shadow-sampler 形状失败；binding 14 绑定 graph `gbuffer-normal` 供 SSR direction 使用，binding 16 在 active graph 写入材质 G-buffer 时绑定 `gbuffer-material` 供 roughness attenuation 使用，binding 17/18 绑定 graph-owned CoC/bokeh scratch resources，binding 19 绑定 `postprocess.motion-vector.neighbor-max` 供 motion blur 与 SSR reproject 使用，binding 20 绑定 `history.previous.screen-space-reflection` 供 temporal SSR feedback 使用，binding 21 绑定 current graph-owned `postprocess.screen-space-reflection.history` 供 final composition，binding 22 绑定 `postprocess.screen-space-reflection.specular-occlusion`，binding 23 绑定 full-mip `postprocess.screen-space-reflection.depth-pyramid` parent view，binding 24 绑定 full-mip `postprocess.screen-space-reflection.reflection-pyramid` parent view，binding 25/26 保留无 parent mip alias 时的 explicit coarse fallback views。基础 `.cube` 文本导入已经进入资产层：`zircon.builtin.texture.cube_lut` 会把 LUT 解成 linear D3 RGBA8 `TextureAsset`，明确拒绝 1D shaper section，再走同一 authored 3D LUT 路径。DoF 现在已有 focus/lens/bokeh 参数、CoC/bokeh 资源名、graph-owned scratch targets、`depth-of-field-prepare` signed CoC/bokeh-seed writer，以及 final-pass CoC far/near layer-weighted bokeh sampling；motion blur 已有 shutter-angle/sample 设置、graph-owned raw motion-vector target、camera/background vector writer、graph-owned half-resolution tile-max pass、graph-owned quarter-resolution coarse tile-max pass、full-resolution neighbor-max pass、final-stack shader consumer 与 depth-aware sample weighting；SSR 已有 split SSR depth/reflection parent-pyramid passes、split coarse-pyramid executors that iterate every owned parent mip, split specular-occlusion pass、split SSR resolve pass、dedicated previous SSR history reprojection through motion vectors、current graph-owned `postprocess.screen-space-reflection.history` writer/copy-back、binding 21 final composition、binding 22 specular attenuation 与 binding 23/24 full-mip parent pyramid sampling；但 object/skinned/particle velocity writer、full dynamic multi-level tile-max/neighbor-max motion blur pyramid、graph-native bokeh simulation/prefilter pass、half-resolution bokeh policy、temporal CoC history、dedicated near/far combine、GL 路径的线性深度颜色资源、half-float/shaper/baked LUT authoring policy、hierarchical SSR quality policy/readback evidence 和 dedicated split passes 仍属于后续 M7/M8 子切片。

2026-06-05 SSR reflection-pyramid follow-up：`screen-space-reflection-reflection-pyramid` / `post.screen-space-reflection-reflection-pyramid` 现在在 specular occlusion 与 resolve 之前写入 half-resolution parent mip 0 的 `postprocess.screen-space-reflection.reflection-pyramid`，WGPU bind group binding 24 把该 2x2 scene-color average 暴露给 resolve。后续 coarse-pyramid execution bridge 会把 graph alias mip 1 以及父 texture 暴露的更高 mip 逐级写入同一 parent texture；当前剩余缺口是 hierarchical SSR 的质量策略、GPU-visible coverage 和更完整的 ray traversal policy，不是 parent mip-chain resource execution。

SSR temporal 路径也会使用同一 reconstructed motion-vector 链：WGPU postprocess execution bridge 现在在 motion blur 或 screen-space reflection 任一启用时都会请求 camera/tile/coarse/neighbor producers，避免 SSR-only graph 声明并消费 `postprocess.motion-vector.neighbor-max` 但 producer 仍被 motion-blur-only gate 关掉。

2026-06-07 的 effect-stack stylistic contract follow-up 只加强证据，不扩大功能面。Unity Graphics 的 URP vignette、chromatic aberration、film grain override 说明这些属于 volume/post-processing family，Bevy 的 custom post-processing 示例说明 Rust/WGPU 侧可以把提取后的 setting uniform 送入 fullscreen pass；Zircon 当前沿用这个边界，把 vignette、film-grain、dither、chromatic-aberration、fog 保持为 `RenderPostProcessEffectStackSettings` -> `PostProcessParams` -> `post_process.wgsl` 的 final-stack 消费路径。新增 coverage 现在同时锁定 CPU packing 的四个 effect uniform vectors 和 WGSL final composition 顺序：chromatic aberration 先于 resolved SSR mix，fog / vignette / grain+dither 在 resolved SSR 之后。该切片不声明 physical film-grain texture、aerial perspective、per-effect graph pass split 或 editor authoring UI。

同日的 diagnostics coverage 也把 `RenderPostProcessEffectStackReport.active_families` 与这组 final-stack consumer 对齐：framework report test 和 WGPU bridge stats test 现在一起覆盖 `vignette`、`film-grain`、`dither`、`chromatic-aberration`、`fog`，而 approximation-backed list 继续只包含 depth-of-field / motion-blur / screen-space-reflection。

Volume evaluator coverage 也同步到这组字段：`render_volume_evaluator_*` 覆盖优先级、global/box/sphere influence、layer mask、unset override 保留和未知组件错误，确保 Unity SRP 风格 volume override path 解析出的 settings 与 final WGPU upload contract 使用同一组中立字段。

style family enablement 也收束成 settings-owned contract：vignette、film-grain、dither、chromatic-aberration、fog 现在都通过各自 `is_enabled()` 驱动 effect-stack product-node activation 与 active-family reporting，避免 report、volume、shader upload 后续各自复制 intensity/density 判断。

同日 renderer-upload cleanup 把 style-family 的上传 sanitize 也收束到 neutral settings：vignette intensity/smoothness/roundness、film-grain intensity/response、dither intensity/scale、chromatic-aberration intensity/sample-spread、fog density/height/color 都通过 `effect_stack_settings/style_settings.rs` 内的 settings-owned `render_*` helper 进入 `build_post_process_params(...)`，WGPU packer 不再复制这些 clamp literal。该切片只收束 final-stack upload contract，不新增 per-effect graph executor 或 editor authoring UI。

同一 upload-boundary cleanup 也把 DoF、motion blur、SSR 的上传 sanitize 从 WGPU packer 收回到各自 neutral settings module：`depth_of_field_settings.rs` 负责 focus/aperture/radius/lens clamp，`motion_blur_settings.rs` 负责 shutter/sample clamp，`screen_space_reflection_settings.rs` 负责 intensity/thickness/ray-distance/temporal/roughness clamp。`build_post_process_params(...)` 现在只调用 settings-owned helper，不再在 final pass packer 里复制这些 family policy；graph/pass/shader 拓扑不变。

同日 color-transform family 也完成同一边界收束：`effect_stack_settings/color_transform_settings.rs` 现在持有 `RenderTonemapSettings`、`RenderColorLookupSettings`、LUT layout contract、tonemap operator id、white-point clamp 和 LUT intensity clamp；`build_post_process_params(...)` 只调用这些 settings-owned helper 来填写 `effect_flags` 与 `effect_tonemap_lut`。这保持最终 postprocess pass 与 LUT residency/binding 路径不变，只把上传策略从 WGPU packer 中移出。

同日 scalar blur family 也完成同一收束：`effect_stack_settings/blur_settings.rs` 现在持有 `RenderBlurSettings::is_enabled()` 与 `render_radius()`，`build_post_process_params(...)` 在 `effect_blur_dof` 中只读取 settings-owned upload 半径，不再复制 blur radius clamp。

postprocess shader 现在通过 `post_process::resources::shader_sources::POST_PROCESS_SHADER` 组装：base `post_process.wgsl` 保留 final pass entry point、split SSR depth-pyramid / resolve entry points 与共享 effect-stack 消费，`post_process_screen_space_reflection.wgsl` 承载 SSR helper family，包括 dedicated SSR history feedback、split specular occlusion、parent depth/reflection pyramid prepare、coarse mip prepare 和 mip-selected range/color sampling。production final pipeline、split SSR depth-pyramid pipeline、split SSR resolve pipeline 与 GL/WebGL/ANGLE depth-fallback rewrite 读取同一份 assembled source；shader ownership split 本身只收束模块尺寸，当前 SSR history 写入边界由 `screen-space-reflection-resolve` pass 承担，hierarchical SSR 的质量策略/readback evidence 仍未完成。

motion-vector 诊断现在区分六层状态：raw `scene-motion-vector` graph target 已存在，`post.motion-vector-camera` 写入 camera/background velocity，`post.motion-vector-tile-max` 写入 half-resolution `postprocess.motion-vector.tile-max`，`post.motion-vector-tile-max-coarse` 写入 quarter-resolution `postprocess.motion-vector.tile-max.coarse`，`post.motion-vector-neighbor-max` 写入 full-resolution `postprocess.motion-vector.neighbor-max`，object/skinned/particle velocity writer 仍是独立缺口。`motion-vector-camera` 复用 previous camera 前会检查 projection mode / target / viewport / dynamic-resolution、FOV / orthographic size / clip-plane 跳变，以及大平移和大旋转 cut gate；不兼容时保留 `motion-vector-clear` 写入的 neutral zero，避免 camera/projection cut 复用陈旧 history。

effect-stack report 现在也把这条链路的执行缺口拆成 stage-level labels：保留聚合的 `effect-stack.motion-blur.velocity-prepass`，同时在缺口存在时补充 `.camera`、`.tile-max`、`.tile-max-coarse`、`.neighbor-max` 后缀，工具侧无需解析 executor list 也能定位缺失的 motion-vector pass。

motion-vector camera readiness 现在不再只看 executor 是否执行。`MotionVectorCameraStatus` 会记录 not requested、missing previous camera、camera cut / invalid projection，以及 ready 四种状态；只有 ready 加上 tile-max / coarse tile-max / neighbor-max 都执行时，`effect-stack.motion-blur.velocity-prepass` 才会被视为可用。首帧、camera cut、projection/FOV/clip invalid 仍保留 neutral zero motion vector，并通过 `effect-stack.motion-blur.velocity-prepass.camera-history` 或 `.camera-cut-or-invalid` 诊断给工具侧。

temporal SSR 诊断现在复用同一 graph 状态但使用独立标签：`history.previous.screen-space-reflection` 未进入 `effect-stack` 时报告 `effect-stack.ssr.temporal-history`；previous SSR history 已声明但 motion-vector 输入或 producer chain 不完整时报告 `effect-stack.ssr.temporal-motion-vector`、`effect-stack.ssr.temporal-velocity-prepass` 以及 `.camera`、`.camera-history`、`.camera-cut-or-invalid`、`.tile-max`、`.tile-max-coarse`、`.neighbor-max` 后缀。这样工具侧可以区分 SSR 只能走单帧 ray-march、SSR history 已可用但 velocity 重投影不可用、以及 motion blur 自身的 velocity-prepass 缺口。

invalid / non-finite projection 数据也进入同一 neutral 路径：`MotionVectorCameraParams` 会先校验 FOV 与 near/far clip range，再检查生成的 current/previous projection matrices 和 current inverse matrix 是否有限；失败时禁用 `post.motion-vector-camera`，并把 disabled uniform 中的 clip matrices 回退为 identity，避免 NaN camera 参数进入 motion-vector shader。

2026-06-05 更新：SSR 现在还声明并消费 `gbuffer-material`。最终 postprocess bind group 在 binding 16 只有当 active compiled graph 存在未裁剪的 `gbuffer-material` writer 时才绑定材质 G-buffer，否则绑定 renderer-owned black fallback，shader 将其解释为 roughness 1.0，从而在 forward / 未写材质缓冲路径中关闭该反射贡献。同日后续切片还把旧单点 reflected-coordinate seed 替换为 final-pass bounded screen-space ray march：shader 会按 authored max steps / max distance / thickness 在深度缓冲中寻找首个命中，并按距离与屏幕边缘淡出。随后 projection follow-up 又把 camera-derived `effect_projection` 编入 postprocess uniform，shader 先由 depth 重建 view-space origin，再把 view-space ray candidate 投影回屏幕像素采样。normal-space follow-up 继续保留 `gbuffer-normal` 的 world-space contract，但把 camera-derived `effect_view_x/y/z` 编入 postprocess uniform，让 SSR 在 view-space ray march 前把 sampled world normal 转成 view-space normal。temporal-history/history-target/history-writer/history-feedback follow-ups 让 active SSR 在 valid history 下声明 `history.previous.screen-space-reflection` 与 `postprocess.motion-vector.neighbor-max`，resolve shader 用 current-minus-previous motion vector 重投影 previous SSR history，clamp 到当前 3x3 scene-color neighborhood 后做小权重稳定混合，并把当前帧结果写入 graph-owned `postprocess.screen-space-reflection.history`，history-copy 阶段再复制到 persistent per-viewport SSR history 供下一帧 import；specular-occlusion split follow-up 已把 AO/material/depth attenuation 写入 graph resource `postprocess.screen-space-reflection.specular-occlusion` 并在 binding 22 供 resolve 消费，depth/reflection pyramid follow-ups 现在写入 parent mip 0、alias mip 1 和所有 parent-owned later mips，resolve 通过 full-mip parent views 按 roughness/distance 选择深度范围与粗反射颜色。DoF follow-up 已把 focus range / focal length / bokeh blades / rotation 编入中立设置与 final-pass shader，并继续补上 `postprocess.depth-of-field.coc` / `postprocess.depth-of-field.bokeh` product-resource names；当前由 render graph materialize graph-owned CoC/bokeh scratch targets，`depth-of-field-prepare` 会写入 signed CoC scratch target，并把 scene-color bokeh seed 与 CoC alpha 写入 bokeh target，final postprocess binding 17/18 会消费 CoC 与 bokeh scratch 且按 CoC far/near channels 加权 prepared bokeh samples。motion-vector follow-up 也已经让 graph-owned raw `scene-motion-vector` 先经过 `motion-vector-tile-max` 写出 half-resolution `postprocess.motion-vector.tile-max`，再由 `motion-vector-tile-max-coarse` 写出 quarter-resolution `postprocess.motion-vector.tile-max.coarse`，最后由 `motion-vector-neighbor-max` 写出 full-resolution `postprocess.motion-vector.neighbor-max` 并接到 final postprocess binding 19，通过 `effect_motion_blur` shutter/sample 参数做 bounded gather；`motion-vector-camera` 现在写入 camera/background velocity，`post.motion-vector-object` 写入有 previous transform 的非透明 dynamic mesh object velocity，tile-max pass 选择 2x2 dominant vector，coarse tile pass 再做一次 2x2 dominant vector，neighbor-max pass 从 coarse tile target 选择 center-plus-eight-neighbor dominant vector，final gather 用 scene-depth 衰减 foreground samples；large FOV / orthographic-size / clip-plane jump gate 与 large translation / large rotation camera-cut gate 都会让 camera producer 保留 neutral clear value。mesh queue diagnostics 另有 previous/missing motion-vector transform counters，它们统计 dynamic draw profile 的 history readiness，早于 object velocity executor 的 non-transparent draw 过滤；同一 queue profile 现在也统计 `render.mesh.queue.lod_draw_count`，用于观测 conventional distance-based `MeshRenderer.lods` selection 进入真实 draw queue 的数量，并且不复用 Virtual Geometry cluster `lod_level`。2026-06-08 standard material ABI follow-up 已把 renderer material texture bind group 扩到 base-color、normal、metallic-roughness、occlusion、emissive 五组 texture/sampler，并让 renderer-owned standard material uniform 扩到 128 字节：`data0/1` 保持 metallic、roughness、occlusion、emissive 与 unlit 标量，`data2..data6` 分别携带五个标准贴图槽的 scale/offset UV transform。fallback/deferred/normal-prepass/shadow alpha-mask/motion-vector alpha-discard 内置 WGSL 都会在采样对应标准贴图前应用这些 transform，custom shader property uniform 仍保持独立 payload offset 并只 pad 到当前 binding size。仍没有 particle velocity writer、full dynamic multi-level tile-max/neighbor-max pyramid、half-resolution bokeh simulation/gather、temporal CoC history、dedicated near/far combine、hierarchical SSR quality/readback policy、Bevy 完整 StandardMaterial GPU ABI、bindless material allocator 或 dedicated split pass。

2026-06-06 SSR pyramid execution 补充：SSR split chain 现在除了 binding 22 specular attenuation 外，还用 binding 23/24 读取 full-mip depth/reflection parent pyramid views。`RenderGraphExecutionResources` 会在 parent texture 暴露 mip 1 时把 `*.coarse` graph resource alias 到 parent mip 1，coarse executors 在 `render_pass_execution_context/gpu/post_process/screen_space_reflection.rs` 中从 mip 0->1、1->2 继续逐级记录 render pass，直到 parent mip count 耗尽；resolve shader 用 `textureNumLevels(...)` 选择可用 depth/reflection mip。无 parent mip alias 时 binding 25/26 仍作为显式 coarse fallback resource。该切片不声明 new material ABI、object/skinned/particle velocity writer 或最终 SSR traversal/quality policy。

2026-06-05 更新补充：motion-vector camera 参数现在对 invalid/non-finite projection data 有显式保护。FOV、clip range 或生成矩阵无效时，producer 会走 neutral clear / identity params，而不是把 NaN clip matrix 上传给 `post.motion-vector-camera`。

M8 neural network support 现在只落成主链能力槽，而不是算法交付。`RenderCapabilityKind::NeuralCompute`、`RenderFeatureCapabilityRequirement::NeuralCompute` 和 `RenderBackendCaps.supports_neural_compute` 让未来 ML denoiser/upscaler/inference pass 可以声明 compute-backed backend requirement；`BuiltinRenderFeature::NeuralCompute` 以及 `feature_descriptors::neural_compute` 只是 descriptor-only 的 SRP 插槽，显式 feature opt-in 后只把 `neural_compute` 能力要求纳入 compiled pipeline，不新增 graph pass、executor 或 runtime 状态。插件 neural descriptor 才能声明真实 async-compute pass，并且 `RenderPipelineCompileOptions` 把 `NeuralCompute` 视作强能力门，未显式 capability opt-in 时插件 pass 不会进入 graph。runtime 激活边界同时检查三件事：只有 descriptor 的 neural pass 不能通过 `register_pipeline_asset(...)` 自动获得 no-op executor；显式注册 `plugin.neural.*` executor 后，`set_pipeline_asset(...)` 仍要按 backend capability summary 拒绝缺失 `neural_compute` 的 WGPU/headless 后端。WGPU capability summary 默认不支持该能力，compiled pipeline validation 会在 descriptor 要求 `neural_compute` 而 backend 未声明时失败，runtime diagnostics 通过 `render.capability.neural_compute_supported` 暴露当前 truth。runtime 不保存 model weights、tensor allocator、inference session 或插件私有 neural renderer state。Sparse texture 现在也只落成主链能力门控：`RenderCapabilityKind::SparseTexture`、`RenderFeatureCapabilityRequirement::SparseTexture` 与 `RenderBackendCaps.supports_sparse_texture` 让未来 sparse residency / page-table / tile upload 专项可以先声明 backend truth；`BuiltinRenderFeature::SparseTexture` 保持 descriptor-only，不新增 pass、executor、history 或 runtime state，但必须同时 feature opt-in 与 capability opt-in 才会进入 compiled pipeline。当前 WGPU backend 明确报告不支持 sparse texture，runtime diagnostics 通过 `render.capability.sparse_texture_supported` 暴露该 truth，compiled pipeline validation 会拒绝缺失 `sparse_texture` 的 backend。

2026-06-05 DoF prepare-pass clarification: the renderer now has a graph-visible `depth-of-field-prepare` pass that writes signed near/far normalized CoC into the CoC scratch target and writes a scene-color bokeh seed into the bokeh scratch target before `post.stack`; final postprocess samples those targets with a CoC-aware near/far weighting approximation. Older "dedicated writer pass" wording in this section refers to the still-missing half-resolution bokeh simulation/gather, dedicated near/far combine, half-resolution policy, temporal CoC history, and dedicated postfilter/combine stages, not to the landed CoC/bokeh seed producer.

同一 M7/Plan 07 方向现在接入了 Unity SRP 风格的中立 planned volume DTO。`PostProcessExtract.volumes` 携带 global/box/sphere shape snapshot、priority、weight、volume mask 与 component override vector；`build_frame_submission_context(...)` 会按当前 camera position/render layers 调用 `resolved_settings_for_camera(...)`，通过 `VolumeEvaluator` 解析为有效 per-camera settings，再执行 quality/profile feature gates 和 history key 构造。renderer frame 收到的是已解析设置与有效 graph，raw planned volume DTO 会被清空，避免后续 concrete shader path 绕过主链解析规则。local volume 的空间影响力由 evaluator 根据 `VolumeShapeExtract` 和 camera position 计算；scene extract 只负责从同实体 box/sphere collider 投影形状，capsule/convex projection、完整 project/editor authoring、trigger lifecycle 和序列化仍留给后续 scene-volume 子计划。

`RenderStats` 当前还会带上 `last_frame_history`。`FrameHistoryHandle` 定义在 `zircon_runtime::core::framework::render` 的稳定 handle 层，并由 `zircon_runtime::graphics` 在 extract 子域重导出给 renderer/SRP 侧继续使用。这样 viewport history 生命周期既能被 façade 侧观测，又不会把 backend 私有资源类型推给上层。`RenderFeatureQualitySettings.history_resolve` 的默认值是 `false`；只有显式 quality profile 或 compile option opt-in 才会把 `HistoryResolve` 编进有效 pipeline，避免默认 3D 路径在没有 motion vectors、reprojection、camera-cut 和 disocclusion support 时混入上一帧 scene color。Renderer history copy 保持 slot 语义：`FrameHistorySlot::SceneColor` 从 `OffscreenTarget.scene_color` 复制，而不是从 post-processed `final_color` 复制。
...
`scene/render_extract/mod.rs` 仅挂载具名 owner；`scene/render_extract/producer.rs` 负责 `World` 的当前提取入口和 `RenderExtractProducer` 实现。该 owner 切分不改变现有 whole-World clone 基线，也不把它声明为性能优化；persistent render scene 与 generation-qualified `SceneRenderDelta` 仍由 Runtime62/Runtime09B 的后续架构里程碑替换。
...
- `zircon_editor::ui::retained_host::viewport::RetainedViewportController` 在初始化时直接 `resolve_render_framework(...)`
- `EditorState` / `EditorEventRuntime` 现在直接暴露 `render_frame_extract()`，把旧 `RenderSceneSnapshot` 适配压回状态层
- editor viewport 不再走 shared texture + `wgpu` 导入，而是提交 `RenderFrameExtract`，然后把 `CapturedFrame.rgba` 存入 retained `HostViewportImageData` 供 native painter 绘制
...
其中 `VirtualGeometry`、`GlobalIllumination` 与 `HistoryResolve` 当前属于 “声明在 built-in renderer 里，但默认不进入有效编译结果” 的显式 opt-in 槽位。它们只有在 compile/profile options 显式 opt-in 时才会真正贡献 pass 和 history binding。
...
- `VirtualGeometry / GlobalIllumination / RayTracing / HistoryResolve` 这类非安全默认 feature 现在可以沿同一套 descriptor 系统挂进 pipeline，但不会反向污染基础 renderer 默认结果
...
- `ShadowMapRenderer` 现在作为 runtime renderer 内部资源接入 `shadow.map` graph executor：它使用私有 light-space scene uniform，把 opaque caster 走 depth-only WGPU pipeline，并把 alpha-mask caster 走 cutoff-aware shadow pipeline 写入 graph-owned `shadow-map` depth target；deferred lighting 已用 compare sampler 读取该 target，后续仍保留 cascades/filtering policy 与 point/spot shadow families
- 2026-06-05 M6 root gate 复查中，`shadow_bounds_from_frame(...)` 的半径 accumulator 已显式标为 `Real`，避免从 `0.0` 起步的 `radius.max(...)` 在 workspace/test-target 编译中退化成模糊浮点类型；该修复只恢复 shadow-map helper 的编译边界，不改变 light-space bounds 语义
- 2026-06-05 alpha-mask shadow cutoff follow-up 的 scoped validation 已完成 source-level gate：`rustfmt --edition 2021 --check`、shadow shader/renderer/source-contract scans、conflict-marker scan、trailing-whitespace scan 与 path-scoped `git diff --check` 通过，`git diff --check` 仅有既有 LF/CRLF notices；focused `cargo test -p zircon_runtime --lib shadow_params --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never -- --test-threads=1 --nocapture` 超时 604.3s 且无可用 compiler/test output，因此不声明 clean Cargo validation
...
- `NormalPrepassPipeline` 只对 opaque 与 alpha-mask draw 写入 `normal + depth`
- `ShadowMapRenderer` 对 opaque caster 走 depth-only path，对 alpha-mask caster 走 base-color alpha cutoff path 写入 `shadow-map`，保持 shadow target graph-visible 而不进入 material/shader asset ownership
...
- `ScenePostProcessResources::execute_post_process(...)`：读取 `scene_color + ambient_occlusion + previous scene color history + previous screen-space-reflection history + cluster_buffer`，输出 `final_color`、`global_illumination` 与 `postprocess.screen-space-reflection.history`；当前 `cluster_buffer` 作为 cluster pass 数据路径输入存在，但不会直接给最终颜色叠加 tile tint
...
- history resolve 当前先落 `scene_color -> scene color history` 与 `ambient_occlusion -> ambient occlusion history` 两条跨帧 history copy，而不是把 post-processed `final_color` 当作 scene history 或直接宣称 TAA 完成

### Viewport Runtime History Host

`zircon_runtime::graphics::runtime` 当前持有 `ViewportFrameHistory`，由 `WgpuRenderFramework` 为每个 viewport 维护：
...
- `FrameHistoryValidationKey` 变化时轮换；该 key 包含 world handle、camera snapshot、mesh entity/transform/model/material/tint/mobility/layer mask、lighting extract、animation pose extract、post-process settings、particle extract，以及有效 feature 名称
- 兼容时只更新 `generation / bindings / visibility`

同一判断也会投射成 `RenderStats.last_frame_history_status`。这个状态记录当前 handle、上一帧 handle、上一帧是否可读，以及 `no_previous_frame / viewport_resized / pipeline_changed / history_binding_changed / frame_inputs_changed` 之一的失效原因。renderer 接收 `previous_history_available` 作为显式输入，`SceneFrameHistoryTextures` 不再只因为同一个 handle 下已有相同尺寸纹理就导入 previous history。
...
这意味着 `clustered lighting / SSAO / history resolve` 现在已经不再只是 pipeline compile-time 元数据，而是正式拥有了 per-viewport runtime 宿主和真实跨帧 texture copy 行为。为了降低 temporal ghosting 风险，history compatibility 不再只看 viewport/pipeline/bindings；相机移动、mesh transform/material/tint/layer 变化、light / animation pose / post-process / particle 变化、world 切换、effective feature 变化或动态 render size 变化都会强制轮换 handle，而不是把上一帧 scene color 当作当前帧的合法 history。target size 变化仍记为 `viewport_resized`，动态分辨率导致的内部 render size 变化记为 `render_size_changed`，并通过 `FrameHistoryStatus` 与 `RenderStats.last_frame_target_size` / `last_frame_render_size` 对外可见。Scene-color history copy 的源头是当前帧 `OffscreenTarget.scene_color`，不是 bloom/color grading 后的 `final_color`，所以后处理结果不会在下一帧被再次作为 scene history 输入。

`WgpuRenderFramework` 当前还会把 `RenderQualityProfile + RenderCapabilitySummary` 映射成 `RenderPipelineCompileOptions`：

- quality profile 可以禁用 `clustered lighting / SSAO / history resolve`，其中 `history_resolve` 默认关闭并且需要显式 opt-in 才能进入有效 compile result
...
- `RenderStats.last_effective_features` 与 `last_async_compute_pass_count` 会记录这一结果；compute pass 还会把 SRP/RenderGraph 声明的 workload 与 renderer 实际 dispatch 对账，输出 planned/matched/missing/mismatch/unexpected 计数
...
- `post_process.wgsl` 不再只做 `AO + clustered + history` composite，而是继续消费：
  ...
  - baked lighting 参数
- resolved effect-stack uniform，包括 tonemap/exposure、authored-or-fallback LUT texture sampling、camera-linearized blur/DoF radius、graph-resolved SSR contribution、vignette、grain、dither、chromatic aberration 与 fog
...
- linked `PluginVirtualGeometryRuntimeProvider` 创建的 erased `VirtualGeometryRuntimeState` 现在作为 viewport 级宿主，持有 plugin-owned concrete state：
...
- 当前 contract cutover 后，runtime render 只提供中性的 `ViewportRenderSettings` 与 `SceneViewportExtractRequest`；editor-owned scene mode、transform handle、space/orientation/grid authoring 状态不再进入 framework 公共契约。`zircon_scene` 保留 world/render authority，但不转发 editor authoring 类型。
...
- 继续收尾到 `zircon_scene` 自身之后，root `lib.rs` 里剩余的 framework-owned render re-export 也已删除；`zircon_runtime/src/scene/tests` 与 `zircon_runtime/src/scene/tests` 现在同样直接从 `zircon_framework::render` 导入这些 DTO，不再经 `zircon_scene` 根级入口旁路 owner
...
- `RenderStats.last_frame_history_status` 与 `DiagnosticStore` 的 `render.history.*`：render façade 现在把 current/previous handle presence、previous availability、aggregate invalidation 和 one-hot invalidation reason 暴露给工具侧，便于识别 resize、pipeline、history binding 或 frame input 变化切断 history 的情况
...
- `RenderStats.capabilities` 与 `DiagnosticStore` 的 `render.capability.*`：render façade 现在把 queue class、surface/offscreen、async、cache/storage/readback/indirect、raytracing/resource-indexing、AA、MSAA、VG/HGI support 作为中立 bool/count rows 暴露给工具侧
- `RenderStats.last_graph_*` 与 `DiagnosticStore` 的 `render.graph.*`：render façade 现在把 planned pass、culled pass、queue fallback、resource lifetime、sparse texture reservation lifetime、planned/executed resource access、planned/executed dependency、dense transient texture slot、sparse texture reservation slot、transient buffer slot、executed pass count、compute dispatch evidence、compute workload audit planned/matched/missing/mismatch/unexpected counts，以及 AA/VG/HGI/particle/transparent/async-compute executed family count 稳定暴露给工具侧，同时保留 legacy `render.last_graph_executed_pass_count`
- `RenderStats.last_post_process_graph_executed_nodes`：render façade 现在能暴露 bloom/color-grading/history/effect-stack/final-composite/FXAA 这些 product postprocess 节点的执行证据，避免后处理参数只停留在 extract DTO 上
- `RenderStats.last_post_process_graph_*` 与 `DiagnosticStore` 的 `render.post_process.graph.*`：render façade 现在把 product postprocess node count、skipped node count、executed node count 和 final composite presence 稳定暴露给工具侧，节点名列表仍保留在 `RenderStats`
- `RenderStats.last_post_process_effect_stack_report` 与 `DiagnosticStore` 的 `render.post_process.effect_stack.*`：render façade 现在会同时暴露 effect-stack 是否启用、active family 数、approximation-backed family 数和 missing resource 数，方便 editor/devtools 在不接触 WGPU 私有资源的情况下显示 M7 后处理 readiness
- `RenderStats.last_post_process_lut_{request,ready,fallback}_count` 与 `DiagnosticStore` 的 `render.post_process.lut.*`：LUT family 启用后，renderer 会暴露 authored texture 是否准备成功，或者本帧是否实际回退到 64x1 fallback LUT
- `RenderStats.last_material_*` / `RenderStats.last_*_light_*` / `RenderStats.last_mesh_*` / `RenderStats.last_sprite_*` / `RenderStats.last_ui_*` 与 `DiagnosticStore` 的 `render.material.*`、`render.light.<family>.*`、`render.mesh.queue.*`、`render.sprite.*`、`render.sprite.queue.*`、`render.ui.*`：render façade 现在把 M5/M6 material readiness、light readiness、queue-preparation、early-z、batching、instancing、sprite fallback、sprite batching 和 UI payload/graph-pass 计数稳定暴露给工具侧
...
- `zircon_runtime/src/graphics/tests/project_render.rs` 当前也已经直接从 `zircon_framework::render` 导入 viewport request / scene packet DTO，避免再通过 `zircon_scene` 根级入口旁路 render contract ownership
...
- `zircon_runtime/src/scene/mod.rs` 当前也已经彻底收掉 root render contract re-export；repo 内剩余从 `zircon_scene` 导入的 surface 仅保留 `World`、`Mobility`、`EntityId`、`NodeKind`、`SceneProjectError` 等 runtime authority / scene domain 类型
...
- linked `virtual_geometry` provider 的 prepare snapshot：当前 plugin-owned runtime state 已经能把 resident/pending/evictable page 与 visible cluster 合成为 `VirtualGeometryPrepareFrame`，并直接消费 visibility-owned `draw_segments` 生成显式 `cluster_draw_segments + available_slots`
...
- linked `virtual_geometry` provider 的 feedback consumption baseline：当前 pending page request 会在 resident budget 内消费 feedback 并推进为 resident；没有可回收 budget 时则会继续保持 pending
...
- `zircon_plugins/virtual_geometry/runtime/src/virtual_geometry/types/virtual_geometry_prepare/frame.rs::VirtualGeometryPrepareFrame` 的 prepare-owned unified indirect ownership：当前 `unified_indirect_draws()` 已经退化成 prepare snapshot 投影层，只在旧 helper 没有显式写出 `page_id / resident_slot` 时从 `visible_clusters` 回填 ownership；真正的 compaction authority 固定留在 `prepare_visible_clusters(...)` 里，因此不同 resident page 不会被错误并入同一条 indirect draw，而显式 prepare segment 也不会再在 renderer 路径里被重新合并
...
- `zircon_runtime` 的 M9A advanced profile submit boundary 现在已经把 provider-backed `AdvancedProfileRuntimePlan` 下沉到 `FrameSubmissionContext`：`resolve_enabled_features(...)` 同时要求 compiled feature capability metadata 与 ready runtime-plan state，VG/HGI 只有在 profile、backend capability 与选中 provider 同时满足时才保留 sideband；VG 通过 `RenderVirtualGeometryPayloadSource` 报告当前提交使用 authored extract、automatic fallback extract，或没有 VG payload；HGI 通过 `RenderHybridGiPayloadSource` 报告 authored extract 或 none，因为当前没有 HGI automatic fallback extract path。`build_frame_submission_context(...)` 保持 authored VG 优先，只有没有 authored extract 时才请求 provider 从 mesh 输入生成 fallback；两个 payload-source stats 都消费同一份 gated context，所以 degraded feature 不会留下上一帧 stale authored/fallback 标签。`collect_runtime_feedback(...)` 现在还会在生产路径合并 renderer readback 与 `PreparedRuntimeSubmission` 中的 HGI/VG neutral sideband readback，再交给对应 runtime feedback/completion owner 消费。
- `zircon_app` 的 M9A advanced profile provider collection 接在 resolved product config 边界：`first_party_runtime_plugin_registrations_for_config(...)` 只接收 `ResolvedProductHostConfig`，从其 render bundle 投影 target-scoped VG/HGI selections；`DefaultRender` 不收集 advanced providers，显式 manifest selection 不会被覆盖。
- `zircon_runtime` 的 `render_product_advanced` product gate 现在补齐：同一份 AdvancedRender extract 在 provider-backed framework 中必须同时进入 `virtual_geometry` / `hybrid_gi` effective features、执行 VG/HGI graph passes，并把 payload source 记录为 authored；在 descriptor-only framework 中必须降级为 `ProviderMissing`，不执行 VG/HGI graph passes，并清空 payload-source stats。原计划里的 `cargo test -p zircon_runtime --locked render_product_advanced` 现在实际运行 2 个测试，不再是 0-test 或无诊断失败。
- `zircon_runtime` 的 advanced-plugin resource owner 现在把 render-feature capability scan 收成显式 state，而不是在 construction 阶段扫描后丢弃：`SceneRendererAdvancedPluginResources` 会持有 `VirtualGeometry` / `HybridGlobalIllumination` capability bit，mesh draw path 只有在 VG feature 与 resource capability 同时存在时才进入 VG draw build。`execute_runtime_prepare_passes(...)` 在没有 collector 时仍然只返回中立空 readback 包；collector 存在时只通过 runtime-owned mutable neutral function boundary 汇入 `RenderPluginRendererOutputs`，并复用 compiled-scene neutral merge 的非空 feature packet 替换语义。这里不引入 runtime -> plugin 依赖，也不提前初始化 HGI/VG 私有重状态。
- `zircon_plugins/hybrid_gi` 的中立 readback 投影：插件私有 `HybridGiGpuReadback` 现在可以直接转换成 runtime 中立 `RenderHybridGiReadbackOutputs`，覆盖 cache entries、completed probe/trace ids、probe irradiance/RT RGB、scene-prepare atlas/capture samples，以及 voxel clipmap sample、occupancy count、原始 `u64` occupancy mask、cell occupancy records、cell RGBA samples、dominant-node records 与 dominant RGBA samples。`HybridGiReadbackOutputs::take_neutral_readback_outputs(...)` 也已经把这份 DTO 接到插件 readback owner 上，并在取出后清空完成态 GPU readback，保持与 completion-parts handoff 相同的一次性消费语义。runtime 的 `HybridGiGpuCompletion::from_readback_outputs(...)` 已经能消费这些 DTO，并会保留 voxel-only / voxel-cell-only scene-prepare payload；剩余接线是把 `SceneRendererAdvancedPluginResources::execute_runtime_prepare_passes(...)` 从空 readback 包推进到真实插件资源执行并写入 `RenderPluginRendererOutputs.hybrid_gi`。
- `zircon_plugins/hybrid_gi` 的 provider readback 回灌：中立 `RenderHybridGiScenePrepareReadbackOutputs` 里的 cell occupancy、dominant-node、dominant-RGBA / aggregate-RGBA records、clipmap occupancy mask、clipmap aggregate occupancy count 和 clipmap aggregate sample 现在会在插件 provider 内部重建为 `HybridGiPrepareVoxelCell`。明确 cell records 优先，occupancy mask 会展开成 coarse occupied cells；当只有 `voxel_clipmap_ids / voxel_occupancy` aggregate count 时，provider 会落到固定 low-detail fallback cell 0，继续复用 clipmap aggregate sample 作为 radiance seed，再通过 `HybridGiRuntimeScenePrepareResources::voxel_cells()` 写回 `HybridGiVoxelSceneState`。这条链路仍然只跨中立 DTO：runtime 不读取插件 voxel scene 字段，插件也不会把私有 readback snapshot 泄回 runtime。stable scene synchronize 会继续合并这些 readback cell overrides，scene/card/clipmap layout 改变时才清除旧 override；因此下一帧 HGI prepare 能消费上一帧 GPU scene-prepare 的 coarse voxel authority，而不是只保留 atlas/capture page truth。
- 该 provider 回灌与 runtime capability-state slice 已通过针对 touched HGI / advanced-plugin resource files 的 `rustfmt`；按用户本轮要求未补跑 Cargo。新增的 provider projection、aggregate low-detail fallback、voxel-scene stable-sync tests 和 capability-state checks 记录为下一次 focused rerun 的计划项，而不是本轮 acceptance evidence。
- `zircon_plugins/virtual_geometry` 的中立 readback 投影也对齐到同一边界：插件私有 `VirtualGeometryGpuReadback` 现在可以转换成 runtime 中立 `RenderVirtualGeometryReadbackOutputs`，覆盖 page-table entry、completed page assignment/replacement、selected cluster、VisBuffer64 entry、hardware-raster typed records 与 NodeAndClusterCull traversal/worklist/page-request payload。`VirtualGeometryNodeAndClusterCullPassOutput::to_neutral_readback_outputs()` 先把插件 pass output 投影成这份中立 NodeAndClusterCull package，`VirtualGeometryIndirectStats::node_and_cluster_cull_readback_outputs()` 从 indirect-stats owner 暴露该 package，`VirtualGeometryReadbackOutputs::store_node_cluster_cull_readback(...)` 则允许 NodeAndClusterCull-only payload 在没有页表 completion readback 的帧里也进入 one-shot readback owner。`VirtualGeometryReadbackOutputs::take_neutral_readback_outputs(...)` 使用一次性 take 语义把插件 owner 的完成态 GPU readback 投影出去；runtime 侧 `SceneRenderer::take_last_virtual_geometry_readback_outputs(...)` 再把 `RenderPluginRendererOutputs.virtual_geometry` 交给 submit-time feedback collector。collector 会先通过 `RenderVirtualGeometryReadbackOutputs::take_node_and_cluster_cull_page_request_ids(...)` 取走 NodeAndClusterCull 页请求并写入 `VirtualGeometryRuntimeFeedback`，再把剩余 page-table/completion payload 交给 `VirtualGeometryGpuCompletion::from_readback_outputs(...)`。`SceneRendererAdvancedPluginOutputs::has_virtual_geometry_gpu_readback()` 同步识别 completion-only、render-path 和 NodeAndClusterCull neutral payload，不再只把 page-table/selected/VisBuffer64 当成有效 VG readback。这一步只移动中立 DTO、page-request handoff 与 completion handoff，不让 runtime 读取 VG 插件私有状态；仍待推进的是真实插件 prepare/resource 执行把这些 neutral outputs 填进 renderer last-output，并把 live pass output 接到 `VirtualGeometryGpuReadback` 的 render-path/NodeAndClusterCull writeback 方法上。
...
- `zircon_runtime` 的 M6 mesh queue preparation 现在在 renderer 内部形成显式 draw profile：`PendingMeshDraw` 透传 `RenderMeshSnapshot.mobility`，`MeshDraw` 保留 prepared/dynamic geometry source、mobility、material phase 与 indirect 状态，`prepare_mesh_queue(...)` 汇总 early-z、shadow caster、alpha-mask shadow caster、static/dynamic batch、GPU instancing 候选。compiled-scene graph 的 depth/normal prepass 直接消费 early-z 候选，只让 opaque 与 alpha-mask mesh 进入 prepass；shadow caster 诊断也服从同一个 `MeshDrawQueuePhase::casts_shadow()` phase policy，让工具能区分所有 shadow-casting mesh 与 alpha-mask caster 规模。queue-prep counters 会通过 `SceneRendererCompiledSceneOutputs` 写入 `RenderStats.last_mesh_*`，并由 `collect_runtime_diagnostics(...)` 投射为 `render.mesh.queue.*`，作为 submit 级公开诊断，而不是等 mesh allocator/slab 或 shadow-map GPU timing 诊断完成后才可见。
- `zircon_runtime` 的 M6 sprite renderer 现在也有 renderer-side batching 输入与公开诊断：`prepare_sprite_draw_batches(...)` 在不重排 `SpriteExtract.phase_queue` 的前提下只合并相邻且纹理相同的 sprite，把多个 quad 追加到同一个 vertex buffer / render pass；`prepare_sprite_queue_stats(...)` 复用同一排序语义，统计 draw batch、batched sprite、image slice、expanded image slice、vertex 与分 phase batch 数，并通过 `SceneRendererCompiledSceneOutputs` 写入 `RenderStats.last_sprite_*`，再由 `collect_runtime_diagnostics(...)` 投射为 `render.sprite.*` 与 `render.sprite.queue.*`。2026-06-07 的 image-mode follow-ups 让同一路径在 CPU 顶点构建阶段展开 `Stretch`、`Scale(RenderSpriteScalingMode)`、`Tiled` 与 `Sliced(RenderSpriteSlicer)`；Fit/Fill 仍是单 image slice，九宫格/平铺图片会自然提高 image-slice/expanded-slice/vertex 计数并继续走相邻纹理 batch 规则。这样能减少最小 Core2d 路径的逐 sprite pass 开销，同时保留 z/order/layer 语义；非相邻同纹理 sprite 不会为了 batching 被跨越重排，完整 Bevy-like binned batching、导入器九宫格/缩放元数据、编辑器 handles 和 per-view pipeline specialization 仍是后续要求。
- `zircon_runtime` 的动态分辨率主链接口现在先固定为中立 DTO 与 graph resource extent 合同：`ViewportCameraSnapshot.dynamic_resolution` 保存 `RenderDynamicResolutionSettings`，`RenderViewExtract::effective_view_size()` 继续表示物理 viewport / present / UI damage 尺寸，`RenderViewExtract::effective_render_size()` 才应用 clamped render scale。`RenderPipelineAsset::compile(...)` 用 render size 派生 `scene-color`、`scene-depth` 等 transient texture/buffer descriptor，而 external `viewport-output`、`postprocess.upscaled` 和 terminal AA input `postprocess.final-composited` 保持 presentation/view 尺寸，不被内部 render scale 缩小。submit context/status 同步保留两套尺寸：`FrameSubmissionContext::size()` / `RenderStats.last_frame_target_size` 是呈现目标尺寸，`FrameSubmissionContext::render_size()` / `RenderStats.last_frame_render_size` 是内部 graph 尺寸；runtime UI 也保持在 presentation target 侧，新的 submitted-frame coverage 要求动态分辨率下 `last_ui_target_size` 仍等于 unscaled viewport，并按 pipeline 记录 `postprocess-ui-overlay` 或 `postprocess-overlay-ui`。history 记录同样保存 `target_size` 和 `render_size`，target 变化报告 `viewport_resized`，render-size 变化报告 `render_size_changed`。这一步只给后续 FSR/TAA/upscaler、动态分辨率策略和 history resize 判定留下稳定接口，不声明当前已经有动态质量控制算法。
- 该动态分辨率 history-size follow-up 已通过 touched Rust/docs 的 scoped rustfmt、conflict-marker scan、`git diff --check`，以及 `cargo check -p zircon_runtime --lib --locked --jobs 1 --target-dir F:\cargo-targets\zircon-render-main-chain-history --message-format short --color never`。focused `render_framework_invalidates_history_when_dynamic_render_size_changes` lib-test 还没有执行成功，因为当前 lib test harness 先被并行 static manifest contract 改动阻塞在 `E0364` private re-export 与 `E0282` type inference errors；这不是 render history 尺寸切片的代码路径失败。
- `zircon_runtime` 的 M7 post-process effect-stack 现在补上 submit 级诊断报告并接入 renderer-owned fallback resources：`RenderPostProcessEffectStackReport` 从 volume/direct extract 解析后的有效 settings 生成，公开 active families、approximation-backed families 与缺失 authored-resource 标签，并通过 `RenderStats.last_post_process_effect_stack_report` 暴露给 façade；LUT family 由正 intensity 请求，texture handle 和 `RenderColorLookupTextureLayout` 决定 binding 10 是否采样已准备 2D/2D-strip authored LUT texture view，或 binding 12 是否采样 decoded 3D LUT texture view。当前 3D LUT 路径已经进入 renderer-private WGPU `texture_3d` bind group/shader 分流，binding 13 提供 clamp/linear sampler，shader 用 texel-center normalized coordinate 做 `textureSampleLevel(...)`，fallback 同时保留 64x1 S-curve 2D LUT 与 2x2x2 identity cube；unsupported shape 仍保持 renderer fallback。基础 `.cube` 文本导入也已经进入资产主链，默认 importer 会生成 linear D3 RGBA8 `TextureAsset`，并明确拒绝 1D shaper section，不让上层直接接触 WGPU。WGPU postprocess pass 同时绑定 graph `scene-depth`，并用 `PostProcessParams.effect_depth` / `effect_projection` / `effect_view_x/y/z` 把 DoF/SSR/fog baseline 转成 camera-linearized view-depth 与 view-space SSR normal 语义；DoF lens/bokeh follow-up 把 `RenderDepthOfFieldSettings.focus_range` / `focal_length_mm` / `bokeh_blade_count` / `bokeh_rotation_radians` 通过 volume blending 和 `PostProcessParams.effect_dof_lens` 传给 final-pass shader，shader 用 focal-length scale 与旋转 blade-shaped disk kernel 替代原来的四向 cross blur；DoF resource-contract follow-up 又让 active DoF `effect-stack` 输出 `postprocess.depth-of-field.coc` 与 `postprocess.depth-of-field.bokeh`，compiled RenderGraph 现在按同名 descriptor 物化 graph-owned scratch textures，当前 `depth-of-field-prepare` continuation 已通过 `depth_of_field_prepare.wgsl` / `DepthOfFieldPrepareParams` 写入 signed CoC，并把 CoC-weighted center-plus-four-neighbor bokeh prefilter seed 写入 bokeh scratch；final postprocess binding 17/18 现在会采样 CoC 与 bokeh scratch，用 CoC far/near channels 对 prepared bokeh samples 分层加权，并用 center-plus-four-neighbor CoC dilation 驱动最终 radius/mix 判定。SSR current `postprocess.screen-space-reflection.history` writer 已由 `screen-space-reflection-resolve` / `post.screen-space-reflection-resolve` 独立承载，`history.previous.screen-space-reflection` binding 20 feedback、binding 21 final composition、binding 22 split specular occlusion 与 binding 23 first-level depth range target 已打通。`last_post_process_lut_{request,ready,fallback}_count`、`last_post_process_lut_2d_strip_ready_count`、`last_post_process_lut_3d_request_count`、`last_post_process_lut_unsupported_shape_count` 与 `render.post_process.lut.*` 诊断让 authored LUT 准备失败、缺少 handle、2D strip 命中、3D binding request 和 unsupported shape 都可见。半分辨率 bokeh simulation/gather、dedicated near/far combine、temporal CoC history、full hierarchical SSR depth pyramid / reflection pyramid、half-float/shaper/baked LUT authoring 这些后续资源接线仍有稳定 regression label，不会只被一个 `effect-stack` graph node 掩盖。
- 2026-06-06 submitted-frame advanced postprocess evidence now covers the active DoF, motion-vector, SSR, and final-stack chain through `WgpuRenderFramework`. `render_framework_submits_advanced_postprocess_graph_passes` submits the same authored frame twice, expects first-frame `MissingPreviousCamera` and second-frame `Ready`, asserts executed pass names plus executor ids for the motion-vector clear/camera/tile/coarse/neighbor passes, DoF prepare, split SSR depth/reflection/coarse/specular/resolve passes, and `post.stack`, then requires zero graph coverage gaps, active DoF/motion-blur/SSR effect-stack families, final-composite graph execution, and no `effect-stack.motion-blur.velocity-prepass` missing-resource label once the second-frame producer chain is ready. This is WGPU submit-path evidence only; object/skinned/particle velocity, dynamic multi-mip pyramids, full DoF gather/combine, and richer temporal policy remain open renderer work.
- 2026-06-05 SSR reflection-pyramid follow-up adds the matching first-level color product beside the depth range product. `screen-space-reflection-reflection-pyramid` reads scene color, writes a half-resolution `Rgba16Float` `postprocess.screen-space-reflection.reflection-pyramid` target, binding 24 exposes it to resolve, and rougher SSR hits blend toward that coarse 2x2 average. This closes the first graph-visible color-pyramid handoff only; complete multi-mip SSR depth/reflection pyramids remain open.
- 2026-06-05 SSR coarse-pyramid follow-up adds the fixed second hierarchy level beside the first depth/reflection products. `screen-space-reflection-depth-pyramid-coarse` reads first-level depth ranges and writes quarter-resolution `postprocess.screen-space-reflection.depth-pyramid.coarse`; `screen-space-reflection-reflection-pyramid-coarse` reads first-level color and writes quarter-resolution `postprocess.screen-space-reflection.reflection-pyramid.coarse`. Bindings 25 and 26 expose those coarse products to resolve, which now combines first-level plus coarse depth-range visibility and blends rougher hits toward first-level then coarse color. This is a fixed two-level SSR hierarchy, not the final dynamic multi-mip pyramid, new material ABI, or object/skinned/particle velocity path.
- 2026-06-05 follow-up: SSR material roughness is now part of the renderer-owned postprocess resource path. `effect-stack` declares `gbuffer-material` beside `gbuffer-normal`, binding 16 samples the graph-written material buffer only when the active compiled graph has an unculled writer, and the shader uses the roughness channel to suppress the graph-resolved SSR reflection blend as surfaces approach fully rough. Forward or otherwise unwritten material-buffer paths bind the black fallback and resolve to roughness 1.0. Scoped `rustfmt --edition 2021 --check`, standalone Naga validation for `post_process.wgsl`, and `cargo check -p zircon_runtime --lib --tests --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never` passed with existing warning noise only.
- The same 2026-06-05 SSR continuation replaced the old one-sample reflection coordinate with a bounded shader ray march over screen depth. `trace_screen_space_reflection(...)` caps the loop to 128 shader steps, uses the authored `max_steps`, `max_ray_distance`, and `thickness` settings, fades candidate hits by distance and edge proximity, and keeps roughness attenuation from binding 16. The projection follow-up added `PostProcessParams.effect_projection` so the shader reconstructs view-space origin from depth, marches in view space, and projects candidates back to screen pixels before depth/thickness acceptance. The hit-refinement follow-up then split out a shared depth/thickness visibility helper and added `refine_screen_space_reflection_hit(...)`, a four-step bounded interval search that refines the first coarse hit before sampling reflected color. Standalone raw/fallback Naga validation for `post_process.wgsl`, scoped Rust formatting over the source-contract tests, `cargo check -p zircon_runtime --lib --tests --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never`, focused `effect_stack_settings_are_encoded_into_post_process_params`, and focused `post_process_shader_ray_marches_ssr_with_bounds_and_edge_fade` passed with existing warnings only for the projection slice. For hit refinement, `rustfmt --edition 2021 --check zircon_runtime/src/graphics/scene/scene_renderer/post_process/resources/construct/create_pipeline_bundle/post_process_pipeline.rs` passed; `cargo test -p zircon_runtime --lib post_process_shader --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never -- --test-threads=1 --nocapture` passed 8 shader tests including the new refinement contract and raw Naga validation; `cargo test -p zircon_runtime --lib post_process_viewport_depth_fallback_shader_parses_for_gl_backends --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never -- --test-threads=1 --nocapture` passed fallback Naga validation; and the scoped `cargo check` passed with existing warnings only. Broad postprocess tests remain for the milestone testing stage.
- The 2026-06-05 SSR normal-space follow-up keeps normal prepass/deferred lighting on world-space `gbuffer-normal`, but passes camera-derived `effect_view_x/y/z` rows through `PostProcessParams` so the SSR helper family transforms the sampled world normal into the same view space as its reconstructed ray origin and direction. Scoped `rustfmt --edition 2021 --check` passed over the touched postprocess Rust files. `cargo test -p zircon_runtime --lib camera_view_basis_is_encoded_for_post_process_normals --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never -- --test-threads=1 --nocapture` passed the rotated-camera uniform regression with existing warnings only. Direct `E:\cargo-targets\zircon-render-main-chain\debug\deps\zircon_runtime-b34ee8d8fc52f1fd.exe post_process_shader --test-threads=1 --nocapture` passed 8 shader tests including raw Naga validation and the updated SSR normal contract; the same binary passed `post_process_viewport_depth_fallback_shader_parses_for_gl_backends --test-threads=1 --nocapture`.
- The 2026-06-05 SSR temporal-history follow-up first added temporal reuse to the then-current composition path, and the later history-feedback plus resolve split replaced that with dedicated `history.previous.screen-space-reflection` input and current `postprocess.screen-space-reflection.history` output. Active SSR with valid previous history now feeds `ScreenSpaceReflectionResolve`; the resolve shader reprojects previous SSR history with the current-minus-previous motion-vector target, rejects unavailable/offscreen history, clamps reused color to the current 3x3 scene-color neighborhood, and blends it into the refined SSR result with a bounded stability weight before writing the resolved target.
- The 2026-06-05 postprocess shader-source split moved the SSR helper family into `post_process_screen_space_reflection.wgsl`. `resources/shader_sources.rs` now assembles the base `post_process.wgsl` plus the SSR module into the single `POST_PROCESS_SHADER` consumed by final and resolve pipeline creation plus depth-fallback source rewrites, with a source-ownership unit test guarding the split. Scoped rustfmt format/check, base/SSR ownership scans, assembled-source routing scans, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` passed with expected LF/CRLF warnings only. Cargo/Naga validation is not claimed for this split because unrelated Cargo/Rust compiler lanes were active and no standalone `naga`, `wgsl_analyzer`, or `wgpu-info` command was installed.
- The 2026-06-05 SSR specular-occlusion follow-up first kept AO-backed attenuation in the SSR helper family and reused the existing AO binding; the later split pass supersedes that inline-only shape. The current path writes AO plus material/depth response into graph resource `postprocess.screen-space-reflection.specular-occlusion` and exposes it to resolve at binding 22. That remains the formula origin, while the product resource is now graph-visible. Validation for the earlier inline slice passed scoped rustfmt format/check, shader/test/docs source scans, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` with expected line-ending warnings only; Cargo/Naga validation is not claimed because active compiler lanes remained in this checkout and no standalone WGSL validator was installed.

- The 2026-06-05 SSR history-target contract follow-up reserved the dedicated graph product now written by split SSR resolve. `PostProcessGraphResourceNames` includes `postprocess.screen-space-reflection.history`, active SSR resolve/final nodes route through it, and the compiled graph materializes it as a renderer-owned transient texture instead of importing a fixed `OffscreenTarget` view.
- The 2026-06-05 SSR history-writer follow-up made the dedicated target real at the WGPU pass boundary, and the later resolve split supersedes the old final-composition writer. The current production descriptor and plugin fixture declare `screen-space-reflection-resolve` / `post.screen-space-reflection-resolve` as the graph transient writer for `postprocess.screen-space-reflection.history`; final `post-process` reads that target and writes only final composited/color plus global illumination.
- The 2026-06-05 SSR history-feedback follow-up gives SSR a dedicated previous-frame source. Renderer history storage includes a screen-space-reflection texture, active SSR feedback allocation/copy stores current `postprocess.screen-space-reflection.history` after the resolve pass, valid history imports that texture as `history.previous.screen-space-reflection`, binding 20 exposes `history_screen_space_reflection_tex`, and the SSR shader reprojects/clamps that history while preserving alpha as confidence.
- The 2026-06-05 SSR resolve split follow-up adds graph-visible `ScreenSpaceReflectionSpecularOcclusion` and `ScreenSpaceReflectionResolve` product nodes. `screen-space-reflection-specular-occlusion` reads scene depth, G-buffer material, and ambient occlusion, then writes `postprocess.screen-space-reflection.specular-occlusion` through a concrete frame-size `Rgba8Unorm` target and `fs_screen_space_reflection_specular_occlusion`; `screen-space-reflection-resolve` reads that product with scene color/depth, G-buffer normal/material, reconstructed motion vectors, and optional previous SSR history. Binding 22 exposes the split specular-occlusion texture to the shared postprocess bind group, while binding 20 remains previous-history feedback and binding 21 stays on fallback inside resolve to avoid sampling the render attachment it writes. Final `post.stack` samples the resolved SSR history at binding 21 and still reads AO separately for ambient occlusion.
- The 2026-06-05 SSR depth-pyramid follow-up adds graph-visible `ScreenSpaceReflectionDepthPyramid` before specular occlusion and resolve. `screen-space-reflection-depth-pyramid` reads `scene-depth`, writes first-level half-resolution min/max linear view depth into `postprocess.screen-space-reflection.depth-pyramid` through a concrete `Rgba16Float` target, and exposes that target at binding 23 so resolve can reduce visibility when a coarse cell's depth range does not contain the ray depth. This is the first explicit SSR depth range product, not a full hierarchical depth pyramid or reflection pyramid; new material ABI and object/skinned/particle velocity also remain open.
- The 2026-06-05 SSR reflection-pyramid follow-up adds graph-visible `ScreenSpaceReflectionReflectionPyramid` before specular occlusion and resolve. `screen-space-reflection-reflection-pyramid` reads `scene-color`, writes first-level half-resolution 2x2 average color into `postprocess.screen-space-reflection.reflection-pyramid` through a concrete `Rgba16Float` target, and exposes that target at binding 24 so rougher resolve hits can sample coarse reflection color. This is not a full hierarchical reflection pyramid; new material ABI and object/skinned/particle velocity also remain open.
- The 2026-06-05 SSR coarse-pyramid follow-up adds graph-visible `ScreenSpaceReflectionDepthPyramidCoarse` and `ScreenSpaceReflectionReflectionPyramidCoarse` before resolve. The coarse passes read the first-level depth/reflection pyramid products, write quarter-resolution `Rgba16Float` `postprocess.screen-space-reflection.depth-pyramid.coarse` and `postprocess.screen-space-reflection.reflection-pyramid.coarse` graph transients, and expose them at bindings 25/26. Resolve now depends on all four pyramid nodes plus split specular occlusion, then writes the current SSR history target. This is a fixed two-level hierarchy only; a dynamic multi-mip SSR pyramid, new material ABI, and object/skinned/particle velocity remain open.
- The 2026-06-05 SSR bridge modularization moves the SSR WGPU graph bridge methods into `render_pass_execution_context/gpu/post_process/screen_space_reflection.rs`. This is a behavior-preserving module split: resolve, split specular occlusion, first-level depth/reflection pyramid, and coarse depth/reflection pyramid record helpers keep the same executor call sites and resource contracts, while `render_pass_execution_context/gpu/post_process.rs` returns to shared postprocess stack, SSAO/clustered, bloom, DoF, and motion-vector orchestration.
- The 2026-06-05 SSR motion-vector execution-gate follow-up makes the concrete postprocess WGPU producer gate match the graph contract. `render_pass_execution_context/gpu/post_process.rs` now requests reconstructed motion vectors when either motion blur or screen-space reflection is active, so an SSR-only frame no longer declares and consumes `postprocess.motion-vector.neighbor-max` while the camera/tile/coarse/neighbor producer chain stays disabled by a motion-blur-only predicate. This is not object/skinned/particle velocity, a full dynamic motion-vector pyramid, or a full hierarchical SSR reflection/depth pyramid.
- The 2026-06-05 DoF lens/bokeh follow-up moves focus/lens/bokeh controls from "missing authoring concept" to a neutral runtime/render uniform contract, while still keeping DoF in the approximation-backed report until real CoC resources exist. `RenderDepthOfFieldSettings` now carries `focus_range`, `focal_length_mm`, `bokeh_blade_count`, and `bokeh_rotation_radians`; volume blending handles those fields; `PostProcessParams.effect_dof_lens` uploads sanitized focal/focus/blade values; and the final-pass shader uses a rotated blade-shaped disk kernel instead of a four-direction blur. Validation used a fresh `E:\cargo-targets\zircon-dof-lens-0605` target dir after the shared render target hit a stale fingerprint path error: `cargo check -p zircon_runtime --lib --locked --jobs 1 --target-dir E:\cargo-targets\zircon-dof-lens-0605 --message-format short --color never` passed with existing warnings, direct runtime test binary `effect_stack` passed 23 tests, `depth_of_field` passed 2 tests, `post_process_shader` passed 9 tests, and `post_process_viewport_depth_fallback_shader_parses_for_gl_backends` passed 1 test. Scoped rustfmt, diff whitespace, and conflict-marker scans also passed.
- The same 2026-06-05 DoF resource-contract follow-up reserves the split-pass resource names without claiming the finished physical DoF algorithm. `PostProcessGraphResourceNames` now includes `postprocess.depth-of-field.coc` and `postprocess.depth-of-field.bokeh`; active DoF effect-stack nodes produce both outputs; and the current cutover materializes both scratch resources from compiled graph descriptors as graph-owned transient textures. The first prepare-pass follow-up adds `depth-of-field-prepare` to the SRP graph, registers `post.depth-of-field-prepare`, requires graph `scene-depth`, and writes the CoC/bokeh scratch views through real WGPU attachment writes before `post.stack`. The current CoC-prepare continuation replaces the CoC clear with `depth_of_field_prepare.wgsl`, uploads `DepthOfFieldPrepareParams`, rewrites the shader for GL/WebGL/ANGLE viewport-depth fallback, and writes signed near/far normalized CoC into the CoC scratch target. The bokeh prefilter follow-up now makes that prepare pass read scene color, write a CoC-weighted center-plus-four-neighbor bokeh prefilter seed into the bokeh scratch target, and makes final postprocess binding 17/18 consume CoC plus bokeh scratch while keeping the scene-depth-derived fallback. The final-pass layer-weighting/dilation continuation uses those CoC channels during prepared bokeh sampling: far samples are gated by the smaller center/sample far CoC, near samples can contribute from the sample foreground CoC, and the final radius/mix decision uses a center-plus-four-neighbor max CoC dilation. This still does not claim half-resolution bokeh simulation/gather, temporal CoC history, a dedicated near/far combine pass, or a dedicated postfilter/combine pass. For the final-pass layer-weighting continuation, scoped rustfmt, conflict-marker scan, trailing-whitespace scan, and path-scoped `git diff --check` passed with only expected line-ending warnings; focused `post_process_shader_samples_bound_depth_of_field_bokeh_texture` Cargo testing timed out without compiler or test output in `E:\cargo-targets\zircon-dof-near-far-0605`, then matching Cargo/Rust timeout processes were stopped and no matching process remained. For the CoC consumption slice, scoped `rustfmt --edition 2021 --check`, conflict-marker scan, trailing-whitespace scan, and path-scoped `git diff --check` passed with only expected line-ending warnings. Clean Cargo validation is not claimed for CoC consumption: focused `post_process_shader_samples_bound_depth_of_field_coc_texture` Cargo test runs timed out without compiler or test output in both fresh and warmed target dirs, with no scoped Cargo/Rust process left running. Clean Cargo validation is also not claimed for the prior prepare continuation: focused `depth_of_field_prepare` testing first exited without usable diagnostics after dependency compilation and then timed out on rerun, while scoped `cargo check -p zircon_runtime --lib --locked --jobs 1` timed out in both fresh and warmed target dirs before stale scoped wrappers were stopped.
- The 2026-06-05 motion-vector target-contract follow-up adds `scene-motion-vector` as a graph-visible resource name; the current cutover materializes raw, tile, coarse-tile, and neighbor-max motion-vector resources as graph-owned `Rgba16Float` transient textures. The motion-blur authoring/report follow-up adds disabled-by-default `RenderMotionBlurSettings` with shutter-angle/sample controls, volume blending, active/approximation report labels, graph `scene-depth` plus `scene-motion-vector` inputs, and the explicit `effect-stack.motion-blur.velocity-prepass` gap. The clear-pass follow-up adds `motion-vector-clear` in the 3D depth-prepass stage, registers `post.motion-vector-clear`, and records a WGPU clear/store to neutral zero. The final-stack consumer follow-up adds `PostProcessParams.effect_motion_blur` and a bounded shutter/sample-count vector gather; the neighbor-max reconstruction follow-up moves the former center-plus-eight-neighbor dominant-vector selection out of the final shader into `motion-vector-neighbor-max` / `post.motion-vector-neighbor-max`, writes `postprocess.motion-vector.neighbor-max`, and binds that reconstructed texture at final postprocess binding 19. The depth-aware gather follow-up samples `scene-depth` for the center pixel and candidate taps and attenuates foreground samples during the bounded gather. The tile-max continuation inserts `motion-vector-tile-max` / `post.motion-vector-tile-max` and concrete half-resolution `postprocess.motion-vector.tile-max` between raw camera/background velocity and full-resolution neighbor-max reconstruction, and the coarse continuation inserts `motion-vector-tile-max-coarse` / `post.motion-vector-tile-max-coarse` plus concrete quarter-resolution `postprocess.motion-vector.tile-max.coarse` so neighbor-max reconstructs from coarse tiles. The camera-producer follow-up adds `motion-vector-camera` / `post.motion-vector-camera`, `MotionVectorCameraParams`, `motion_vector_camera.wgsl`, and renderer-owned layout/buffer/pipeline resources. It stores an independent previous-camera snapshot on each viewport record after successful submissions, carries that snapshot into `ViewportRenderFrame`, reconstructs world position from `scene-depth`, projects through the previous compatible camera, and writes current-minus-previous UV velocity into raw `scene-motion-vector`. The object-producer follow-up adds `post.motion-vector-object`, consumes per-viewport dynamic object transform history, and writes non-transparent dynamic mesh object velocity only when a previous transform is available. Queue diagnostics separately count dynamic draw previous/missing transform readiness before that non-transparent executor filter. This state is intentionally separate from temporal color-history validation, so camera movement can invalidate color history while still producing a valid camera/background motion vector from the last submitted camera. The submit diagnostics clear `effect-stack.motion-blur.velocity-prepass` only when `post.motion-vector-camera`, `post.motion-vector-object`, `post.motion-vector-tile-max`, `post.motion-vector-tile-max-coarse`, and `post.motion-vector-neighbor-max` execute. This is still not complete motion blur: skinned/particle velocity writers, a full dynamic multi-level tile-max/neighbor-max pyramid, dedicated velocity-depth GPU readback tests, and richer camera-cut policy remain open. Clear-pass validation passed scoped rustfmt format/check, stale transient motion-vector read scanning, source-contract scanning, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` with expected LF/CRLF warnings only. Final-stack consumer validation passed scoped rustfmt check, source scans for the uniform upload/binding/call-chain/shader gather/source-contract test, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` with expected line-ending warnings only. Camera-producer validation passed scoped `rustfmt --edition 2021 --check`, pass/executor/resource source scans, shader-helper and fallback-rewrite scans, previous-camera threading scans, a stale transient motion-vector read scan with no matches, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` with expected LF/CRLF warnings only; `render_pass_execution_context/gpu.rs` remained below the modularization threshold at 869 lines. Tile-max continuation validation passed scoped rustfmt format/check, tile resource/pass/executor/pipeline/shader source scans, stale raw-to-neighbor source scanning, WGSL tile/neighbor contract scanning, docs/session stale wording scans, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` with expected LF/CRLF warnings only; `render_pass_execution_context/gpu.rs` is now 935 lines in the warning band but still one focused execution-context orchestration file. Coarse continuation validation passed scoped rustfmt format/check, coarse resource/pass/executor/source-contract scans, stale neighbor/readiness docs scans, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` with expected LF/CRLF warnings only. Focused Cargo shader validation did not produce a clean success for the prior shader slice: `cargo test -p zircon_runtime --lib post_process_shader --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never -- --test-threads=1 --nocapture` timed out after 244.7s without compiler/test output, and the Cargo/Rust processes left by the timeout were stopped. No Cargo command was started for the tile-max or coarse continuations because unrelated Cargo/Rust compiler processes were active and the same focused `zircon_runtime` render/postprocess path has repeatedly timed out in this checkout today. Standalone Naga WGSL validation is not claimed because no standalone local WGSL validator command was available.
- The 2026-06-05 motion-vector camera-cut gate follow-up adds deterministic previous-camera reuse checks to `MotionVectorCameraParams`. Camera/background velocity now clears instead of reprojecting when history has large translation relative to the shared far-plane range or rotation beyond the local 60-degree threshold. The projection-shape continuation extends that same neutral-clear policy to large perspective FOV, orthographic-size, and near/far clip-plane jumps. Richer temporal policy, object/skinned/particle velocity ownership, full multi-level tile-max/neighbor-max pyramid reconstruction, and GPU-visible velocity/depth coverage stay open.
- The 2026-06-05 motion-vector invalid-camera guard keeps disabled camera/background producer uniforms finite. Invalid or non-finite FOV/clip ranges disable `post.motion-vector-camera`, and any non-finite generated matrix falls back to identity current/previous clip matrices so bad camera snapshots leave the motion-vector target neutral instead of uploading NaN reprojection data. Scoped rustfmt/check, source-contract scans, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` passed with expected LF/CRLF warnings only; focused `camera_motion_vector_params` Cargo testing timed out after 304.7s without compiler/test output, then leftover validation Cargo/Rust processes were stopped.
- The 2026-06-05 forward mesh shadow-receiver follow-up makes the product shadow map a real Forward+ mesh input while preserving custom pipeline fallback behavior. Forward mesh descriptors and deferred transparent mesh now declare `shadow-map` reads; the mesh executor resolves that name only when the compiled graph classifies it as a transient texture, so descriptors compiled without the Shadows producer use the disabled receiver fallback instead of requiring an imported shadow target. `MeshPipelineCache` owns bind group 4 for forward shadow receiving: layout, writable receiver uniform, immutable disabled fallback uniform, comparison sampler, and fallback depth view. `BaseScenePass` binds that group for all mesh draws, graph execution updates it from the shadow renderer's light-space scene uniform, and the fallback/default PBR shaders use world position plus 3x3 comparison sampling to attenuate direct light only. This is the first directional receiver path for Forward+ meshes; cascades, point/spot families, custom shader reflection, and a full PBR lighting model remain open. Scoped rustfmt/check, source-contract scans, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` passed with expected LF/CRLF warnings only; Cargo validation was deferred because active workspace/runtime lanes were still compiling.
- The 2026-06-05 material receive/cast shadows follow-up keeps shadow authoring below the pipeline cache. `.zmaterial` may set `receive_shadows = false` or `cast_shadows = false` under `[overrides]`; both values default to true, are treated as material-owned overrides rather than shader schema properties, and project through `StandardMaterialDescriptor` into `MaterialRuntime`. Mesh draw construction writes receive-side state into `ModelUniform.shadow_params.z`, while alpha-mask shadow caster data stays in `shadow_params.x/y`; forward PBR shaders check the receive lane before sampling bind group 4. Cast-side state stays on `MeshDraw`, where `MeshDraw::casts_shadow()` combines it with the existing opaque/alpha-mask phase rule before the compiled-scene shadow stage builds `RenderPassMeshDrawLists.shadow_casters`. A no-receive material remains lit by ambient/direct light without shadow attenuation, and a no-cast material still renders/depth-prepasses normally while staying out of the shadow-map writer. Neither flag recompiles a separate pipeline variant. This follows the reference-engine pattern where Bevy's mesh shadow receiver flag gates shadow fetches in PBR WGSL, but Zircon stores the receiver bit in the current per-draw uniform and keeps caster policy in renderer draw metadata until the mesh flag/instance ABI is widened. This does not add cascades, point/spot receivers, per-light layer masks, custom shader reflection, or a fuller PBR BRDF. Validation passed scoped `rustfmt --edition 2021 --check`, material/shader source-contract scans, stale helper/old-parameter/doc wording scans, conflict-marker and trailing-whitespace scans, and path-scoped `git diff --check` with expected LF/CRLF warnings only; focused Cargo validation was deferred because unrelated `zircon_runtime` Cargo/Rust lanes were already compiling.
- 该 M7 LUT request/readiness/shape-contract/cube-import 切片已用 `E:\cargo-targets\zircon-render-main-chain` 跑过 focused validation：`cargo test -p zircon_runtime --lib lut --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never` 在 shape-contract 后通过 16 个 LUT-filtered tests，并在 3D binding follow-up 与 3D sampling follow-up 后通过 19 个 LUT-filtered tests；`runtime_diagnostics_combines_core_render_contract_and_missing_externalized_plugins` 与 `render_framework_stats_report_effect_stack_product_node_when_authored` 也分别通过。首次 LUT 验证暴露的 `register_pipeline_asset` / `reload_pipeline` 测试旧 root import 已改为 `crate::graphics` executor import，不扩大 runtime 根导出面。3D binding follow-up 补了 `effect_stack_lut_texture_status_accepts_3d_lut_for_texture_3d_binding`、`generated_effect_lut_3d_is_identity_cube`、WGSL parse 和 3D sampling contract tests；3D sampling follow-up 补了 binding 13 与 sampler-backed `textureSampleLevel(...)` contract，并通过 `post_process_shader_samples_bound_effect_lut_texture_3d` 单测。`.cube` asset ingress 的 pre-shaper run 通过 `cargo test -p zircon_runtime --lib cube_lut --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never` 的 5 个 cube-LUT tests、`texture_importer` 的 14 个 tests 和 importer capability 单测。`cargo check -p zircon_runtime --lib --locked --jobs 1 --target-dir E:\cargo-targets\zircon-render-main-chain --message-format short --color never` 通过，仍只有既有 warning。新增 1D shaper 拒绝测试后的 Windows `cube_lut` rerun 被 target-dir dep-info fingerprint path 消失问题挡在测试执行前；隔离 WSL rerun `wsl -e sh -lc 'cd /mnt/e/Git/ZirconEngine && CARGO_TARGET_DIR=/tmp/zircon-render-main-chain-cube-lut-0603 cargo test -p zircon_runtime --lib cube_lut --locked --jobs 1 --message-format short --color never'` 通过 6 个 cube-LUT tests，2500 filtered out，仍只有既有 warning。
- `zircon_runtime` 的 render diagnostics bridge 现在也覆盖高级槽位：`collect_runtime_diagnostics(...)` 把 `RenderStats` 中的 AA fallback、GPU particle feedback、VG/HGI runtime counters 与 source/debug rows、advanced provider availability/report/degradation、Solari requested/status/degradation 投射到 `render.anti_alias.*`、`render.particle.gpu.*`、`render.virtual_geometry.*`、`render.hybrid_gi.*`、`render.advanced_provider.*` 与 `render.solari.*`，并通过 `render.capability.neural_compute_supported` 暴露 neural compute 能力门。`BuiltinRenderFeature::NeuralCompute` 现在也有 descriptor-only SRP slot，默认不进产品 graph，显式 feature opt-in 只声明能力要求；未来插件 neural pass 仍必须通过 capability opt-in、显式 executor 注册和 backend capability validation 三段接入，不能由 descriptor-only topology 自动获得 runtime no-op。该激活边界已由 `render_framework_rejects_neural_compute_plugin_descriptor_without_executor_registration` 和 `render_framework_rejects_neural_compute_plugin_pipeline_when_backend_capability_is_missing` 覆盖，focused direct binary validation 分别通过 2 个 bridge tests 与 6 个 `neural_compute` filtered tests，`cargo check -p zircon_runtime --lib --locked` 也在 `E:\cargo-targets\zircon-render-main-chain` 通过且仅有既有 warning。M8 descriptor-only 后续专项现在由 `builtin_render_feature/advanced_slots.rs` 统一列出 slot token、descriptor name、neutral extract section、可选 capability requirement 与 SparseTexture 的 capability opt-in 双门控，`descriptor_for(...)`、`requires_explicit_opt_in()`、compile options 和 `advanced_followup_slots` tests 都读取同一份 catalog，避免 SkinnedMesh/MeshLod/ReflectionProbes/BakedLighting/SparseTexture/Particle/Decal 等入口在 descriptor dispatch、显式 opt-in 和测试数组之间漂移。`TextureResidency::SparseReserved` 现在把 sparse resource 从单纯 feature gate 推进到 RHI/RenderGraph 资源合同：descriptor 保留 virtual extent、array/depth、mip、format 和 usage，WGPU headless backend 在 capability false 时拒绝创建，RenderGraph lifecycle 能识别 sparse reserved texture 并把它排除在 dense transient aliasing slots 之外，另用 `sparse_texture_slot_count` 记录未来 residency manager 需要接管的保留资源数。`update_base_stats(...)` 会把 sparse lifetime 与 sparse slot 计数写入 `RenderStats.last_graph_sparse_texture_lifetime_count` / `last_graph_sparse_texture_slot_count`，runtime diagnostics 再投射为 `render.graph.sparse_texture_lifetime_count` / `render.graph.sparse_texture_slot_count`，因此工具侧可以看到 sparse virtual resource reservation 是否仍在主链内，而不用读取 RHI 或 WGPU 私有对象。catalog 中其他 descriptor-only 槽仍不添加 pass/executor/history/capability；renderer data 已能声明这些 source 和 quality gate，但实际 reflection-probe/baked-lighting composite、sparse page table、tile upload/residency、terrain/tree、decal/projector、halo sprite/glow、lens flare、trail/billboard、tilemap/text shaping 算法仍必须走后续专项 descriptor 或插件 executor。该 slot slice 已通过 direct binary `advanced_followup --nocapture` 的 3 个 focused tests、`pipeline_compile --nocapture` 的 48 个 SRP compile tests、scoped rustfmt 与 `cargo check -p zircon_runtime --lib --locked`，仍只有既有 warning。graph-owned pass 现在还会插入并记录 `zircon::RenderGraphPass::<pass-name>`，再通过 `render.graph.debug_marker_count` 暴露 marker 覆盖数量，所以 async-compute 声明 pass 即使 fallback 到 graphics queue，也有 pass-level RenderDoc/debug 证据。除这些 backend/graph truth 之外，诊断仍是中立 DTO 投射，不让 runtime 反向依赖 VG/HGI/Solari 或未来 neural 插件私有状态。
- 当前 M8 descriptor-only 扩展又给内置 `Decal` 增加了同样的主链入口：`Decal` 必须显式 opt-in，启用后只把 `decals` neutral extract section 纳入 compiled pipeline，不添加 pass、executor、history binding 或 backend capability。这个 token 只服务 renderer data source、profile gating 和后续专项接入点；可执行 `decal-projector-composite` pass、`decals.projector-composite` executor 与 `rendering.Component.DecalProjector` authoring surface 仍由 `rendering.decals` 插件显式注册。
- `ReflectionProbes` 与 `BakedLighting` 也已收束为 M8 descriptor-only token：显式 opt-in 后分别只把 `reflection_probes` / `baked_lighting` neutral extract section 纳入 compiled pipeline，不添加 `reflection-probe-composite` / `baked-lighting-composite` pass、executor、history binding 或 backend capability。旧 `feature_descriptors/reflection_probes.rs` 与 `feature_descriptors/baked_lighting.rs` 已删除；真实 composite pass 仍由 rendering 插件 descriptor 声明，并由 `lighting.reflection-probes` / `lighting.baked-composite` executor registration 证明运行时实现存在。`runtime_features_from_pipeline(...)` 现在只根据插件 feature 名打开 reflection/baked/particle 的提交期 runtime flag，descriptor-only built-in opt-in 不会误开可执行状态。
- M8 follow-up 还把 renderer-data authoring 名称收束到声明枚举自身：`BuiltinRenderFeature::authoring_name()` 是 `source` / `quality_gate` 的唯一 feature 字符串合同，`RenderPassStage::authoring_name()` 与 `RENDERER_DATA_AUTHORING_STAGES` 是 stage 字符串合同，RendererData 解析层不再维护第二份手写 match 表。`RendererDataDocument::to_renderer_asset(...)` 现在先校验 `version == RENDERER_DATA_DOCUMENT_VERSION`，避免未来 document shape 被旧运行时半解析；renderer `name` 必须非空且不带首尾空白，`stages` 与 `features` 列表必须各至少包含一个条目，feature `name` 也必须等于 canonical built-in `source`，因为当前 `RendererFeatureAsset` 不保存独立 display label，alias 会在 runtime projection 前被拒绝而不是在反向投影时静默覆盖；`quality_gate` 可以指向不同内置 feature 作为 compile-option gate，但必须是非空、无首尾空白的 canonical built-in feature name；重复 stage、重复 feature source，以及单个 feature 内重复、空白或带首尾空白的 `required_entry_points` / `expected_properties` / `expected_texture_slots` contract reference 也会在 RendererData 边界被拒绝，不再等到 downstream renderer validation 或 compile-report diagnostics 才暴露；这些 shader contract expectation 还必须携带 `shader` reference，否则 asset-aware compile 没有 shader asset 可检查。`local_config` 仍作为 renderer feature 的 opaque string map 保留，但 key 是 authoring identifier，必须非空且不带首尾空白，value 不做语义解释。`RendererDataDocument::from_renderer_asset(...)` 也通过同一合同把可表达的 runtime `RendererAsset` 投影回 TOML-facing 文档，并显式拒绝空/带 padding 的 renderer name、空 stage / feature 列表、plugin feature、descriptor override、运行时-only capability requirement、重复 stage / feature、重复/空白/padding 的 runtime feature reference list、没有 shader reference 的 shader contract expectation、空/带 padding 的 local config key 与 `Opaque` / `Transparent` 这类内部 aggregate stage，避免编辑器/资产导出路径静默丢失 graph/runtime 状态或导出无效 RendererData。RendererData 不从 URI 后缀推断 asset kind，因为项目资产可以使用 compound resource locator，`.zshader` / `.zmaterial` 解析仍归 asset system。`renderer_data_document_uses_builtin_feature_authoring_name_contract`、`renderer_data_document_uses_render_pass_stage_authoring_name_contract`、`renderer_data_projection`、`renderer_data_version`、`renderer_data_feature_names`、`renderer_data_local_config`、`renderer_data_quality_gate`、`renderer_data_names`、`renderer_data_required_lists`、`renderer_data_uniqueness` 和 `renderer_data_references` 测试分别遍历中心列表并覆盖反向投影/版本门禁/name-source/local-config-key/quality-gate/renderer-name/stage-feature 必填与唯一性/reference-list 唯一性、空值、padding 和 shader-reference 依赖边界，保证新增内置 token、descriptor-only 槽、显式 stage 词汇、文档版本和 RendererData authoring 同步演进；`Opaque` / `Transparent` legacy aggregate stage 仍只保留给内部 compile validation，不进入 RendererData 文档词汇。
- 2026-06-07 的 `MeshLod` follow-up 把普通 mesh LOD 也接入同一 M8 descriptor-first 主链；2026-06-08 的 scene-extract follow-up 又把第一个可执行 conventional mesh LOD 输入面接到 runtime 场景。`BuiltinRenderFeature::MeshLod` 仍必须显式 feature opt-in，启用后只把 `mesh_lod` neutral extract section 纳入 compiled pipeline，不添加 pass、executor、history binding 或 backend capability。`SceneMeshInstanceAsset.lods` / `MeshRenderer.lods` 现在可以保存按 `min_distance` 触发的 conventional LOD level，每个 level 复用 model、optional direct mesh、material 与 primitive mesh/material binding 形状；`World::from_scene_asset(...)` / `to_scene_asset(...)` 保留这些 level，固定反射和 property access 暴露只读 inspection/count surface。render extract 会按当前 scene camera 和 mesh world translation 的距离选择满足阈值的最高 `min_distance` level，并把选中的 model/direct mesh/material 或 primitive bindings 展平成普通 `RenderMeshSnapshot`，因此后续 ResourceStreamer 和 mesh draw path 不需要知道 LOD 容器。screen-error 选择、LOD group 资产结构、cross-fade、streaming residency、编辑器 authoring UI 以及与 Virtual Geometry/Nanite 路径的互斥/协作策略仍是后续工作。
- 同日 `SkinnedMesh` follow-up 也把骨骼蒙皮 mesh renderer 接入同一 descriptor-first 主链。`BuiltinRenderFeature::SkinnedMesh` 必须显式 feature opt-in，启用后只把 `skinned_mesh` neutral extract section 纳入 compiled pipeline；renderer data 可以声明 `SkinnedMesh` source / quality gate，默认 forward/deferred product pipelines 仍不嵌入它。当前 mesh draw preparation 已有 renderer-private `SkinnedMeshJointPalette`，用 skeleton bind transforms 与 animation pose locals 计算 joint matrices，并复用于 CPU skinning fallback；同一 palette 现在通过 mesh-level `SkinnedMeshJointPaletteUniform` ABI 打包成固定 256 矩阵的 POD uniform，并在符合当前 ABI 时上传为 renderer-owned per-draw WGPU uniform buffer。超过 256 矩阵的 skeleton 会继续保留 CPU-skinned fallback draw，只跳过 palette uniform upload；`fallback_mesh.wgsl` 也声明了 mesh vertex layout 已经提供的 joint index / joint weight 输入通道。fallback/deferred geometry/normal prepass/shadow map WGSL 现在都声明同一个 group 1 binding 1 palette ABI，并只在 `ModelUniform.motion_params.y` draw flag 打开且 joint index 位于 palette `params.x` 范围内时执行 palette skinning。fallback 产生的 draw 会被标记为 skinned，并通过 `RenderStats.last_mesh_skinned_draw_count` / `render.mesh.queue.skinned_draw_count` 暴露给诊断；成功准备 palette buffer 的 draw 另通过 `RenderStats.last_mesh_skinned_palette_upload_count` / `render.mesh.queue.skinned_palette_upload_count` 暴露；同时具备 palette uniform 与可 shader-skinning 的源几何时，draw 会通过 `RenderStats.last_mesh_skinned_gpu_source_candidate_count` / `render.mesh.queue.skinned_gpu_source_candidate_count` 暴露为 GPU skinning source candidate。非 morphed prepared/model path 继续使用原始 prepared mesh；direct `MeshAsset` active morph path 会先 CPU morph 成未 skin 的 source primitive，再让 fallback shader 做 GPU skinning，并通过 `RenderStats.last_mesh_skinned_gpu_cpu_morphed_source_candidate_count` / `render.mesh.queue.skinned_gpu_cpu_morphed_source_candidate_count` 暴露这个 subset。只有内置 fallback shader pipeline 会实际切到 shader skinning，并通过 `RenderStats.last_mesh_skinned_gpu_skinning_draw_count` / `render.mesh.queue.skinned_gpu_skinning_draw_count` 暴露实际 shader-skinning draw selection；`MeshPipelineCache` 会把该 fallback shader id 解析到 renderer fallback WGSL source，确保选中的源码声明 skinning ABI；自定义 material shader 的非空 authored pipeline layout 现在会被 `ResourceStreamer` 诊断为需要同一 group 1 model/skinning ABI，但实际 custom shader GPU skinning 执行仍继续走 CPU fallback，直到自定义 shader execution/velocity policy 落地。现有 model bind group 已预留 vertex-stage uniform binding 1/2，并且每个 draw 都绑定 per-draw current/previous palette buffer 或 `SceneRendererCore` 的 shared empty palette buffer，所以 forward/deferred/prepass/shadow 路径继续共用同一个 model group index。GPU-skinned prepared draw 会继续计入 prepared geometry；CPU-morphed shader-skinning source 计入 dynamic geometry，并且二者都不会进入普通 direct prepared dynamic batch / GPU instancing candidate，因为当前 batch key 不包含 per-draw palette 身份。CPU fallback draw 即使有 palette upload diagnostics 也不会打开 shader-skinning flag，避免 double skinning。这个 token 仍不添加 graph pass、executor、backend capability、完整 GPU morph deformation、storage-buffer large-skeleton 路径、custom material shader GPU-skinning execution policy、full WGSL source reflection 或粒子/custom-shader velocity writer，后续专项需要把已有 skeleton/skin asset metadata、animation pose extract、StandardMaterial GPU ABI 和 WGPU mesh draw path 继续收束到完整 skinned renderer。
- 2026-06-07 的 previous-palette velocity follow-up 把 GPU-skinned fallback draw 的 object motion-vector readiness 从“无动画速度”推进到受控可用。提交成功后，`ViewportMotionVectorObjectHistory` 会只为动态 mesh 记录上一帧 skeleton、pose 和 morph weights；下一帧 draw build 会在当前/上一帧 skeleton 相同、上一帧 transform 存在，且 morph weights 都为空或 direct CPU-morphed GPU-skinning source 的当前/上一帧有限 morph weights 匹配时重建 previous `SkinnedMeshJointPaletteUniform`。model bind group binding 2 绑定这个 previous palette 或 shared empty palette，`ModelUniform.motion_params.z` 标记 previous palette 可用，fallback mesh motion-vector shader 用 current palette 计算当前 clip position、用 previous palette 计算 previous clip position。队列诊断新增 `render.mesh.queue.skinned_previous_palette_upload_count` 和 `render.mesh.queue.skinned_gpu_motion_vector_draw_count`；direct mesh changed morph velocity 仍不覆盖，custom material shader、大 skeleton storage-buffer 和粒子 velocity 仍留在后续专项。
- 2026-06-07 的 mesh vertex attribute follow-up 把 M6 普通 mesh 顶点属性从 asset validation 推进到 WGPU vertex ABI。`MeshVertex` / `GpuMeshVertex` 现在稳定携带 tangent 和 vertex color，旧 model/mesh payload 通过单位切线与白色顶点色默认值继续可读；glTF importer 读取 primitive `TANGENT` / `COLOR_0`，`MeshAsset::from_model_primitive(...)` / `to_model_primitive(...)` 保留 tangent/color，CPU morph source 会应用 glTF-style tangent.xyz 与 vertex-color deltas 并保留 handedness，GPU vertex layout 在既有 joint location 3/4 后追加 `@location(5)` tangent 和 `@location(6)` color。CPU skinning fallback 会旋转 tangent.xyz 并保留 handedness/color；fallback mesh 与 deferred geometry shader 已声明新输入并把 vertex color 乘入 albedo，`GpuMeshResource` order signature 也纳入 tangent/color。后续 normal-map slice 先把 material texture binding 从单 albedo 提升为 base-color/normal mesh texture set，并让 `ResourceStreamer` 提供 neutral `NormalMap` fallback；standard material ABI follow-up 又把 renderer group 2 扩到 base-color、normal、metallic-roughness、occlusion、emissive 五组 texture/sampler，fallback mesh 用 skinned tangent frame 采样 normal map 并消费 metallic/roughness/occlusion/emissive，deferred geometry 写出 material G-buffer channels。随后 UV-transform follow-up 让 `.zmaterial` 标准 texture slots 保存 scale/offset，`StandardMaterialDescriptor` / `MaterialRuntime` / standard material uniform 都携带五个标准槽的 transform，fallback/deferred/normal-prepass/shadow 内置 WGSL 在采样前应用对应 transform。full GPU morph deformation、full WGSL source reflection、custom texture-array policy、bindless material allocator、UV-channel selection 和完整 PBR tangent/BRDF families 仍是后续 renderer 工作；custom material shader authored pipeline layout 的 group 1/2/3 renderer ABI readiness diagnostics 已由 `ResourceStreamer` 覆盖。
- 2026-08-27 PFO-4d1k skinned palette arena hard cut 以当前合同替代上方 2026-06-05 与 2026-06-09 的逐 draw palette WGPU buffer/bind-group 描述，以及 2026-06-24 对这些字段仍为 live 的记录。`GpuScene` 现在拥有两个 grow-only 全局 matrix arena buffer 与相反 current/previous 方向的 scene bind group；frame build 按 stable draw key 将 active current palette 打包一次，在 192-byte `GpuInstanceData` 中写入 current/previous base+count，并将单个 arena payload 合入 `GpuScenePreparedUpload`/`FrameBufferUpload`。draw-local palette buffer、逐 draw queue write 和 skinned command-local group3 override 已从当前实现移除；previous arena side/span 仅在 scene submit 成功后提交，失败帧继续引用 last-successful history。当前仅有 source/rustfmt/static evidence，real-adapter WGPU、截图、RenderDoc 与 CPU/GPU/profile/power 数据仍待里程碑验收。
- 2026-06-24 Material runtime PBR projection tests owner split 把 `graphics/scene/render_product_streamer_tests/material_runtime.rs` 保持为 572 行 material runtime parent，并把 standard PBR runtime key projection test 与 `RenderMaterialTextureTransform` helper 移入 200 行 `graphics/scene/render_product_streamer_tests/material_runtime/pbr_projection.rs`。`runtime_15_material_runtime_pbr_projection_tests_are_child_owner` 锁定 moved-test/helper ownership、父/子 800 行预算和文档状态锚 `render_plan08_material_runtime_pbr_projection_tests_owner_split_static_passed_cargo_deferred_implementation_cadence`；本切片只记录 scoped rustfmt/static/line-count/docs-anchor/stale-path/diff-check 证据，Cargo/WGPU/RenderDoc 按 implementation cadence 暂缓。
- 2026-06-24 PipelineKey receive-shadows shader feature foundation 把 `receive_shadows` 从 `MaterialRuntime` 调试/提交状态推进到 runtime shader variant key 维度。`ResourceStreamer::ensure_material(...)` 现在把 `StandardMaterialDescriptor.receive_shadows` 写入 `PipelineKey.receive_shadows`，`PipelineKey::shader_feature_bits()` 将其映射为 `ShaderFeatureBits::RECEIVE_SHADOWS`，`material_runtime/pbr_projection.rs` 与 `runtime_15_material_runtime_pbr_projection_tests_are_child_owner` 锁定 `material.pipeline_key.receive_shadows` true/false 投影。状态锚为 `render_plan08_pipeline_key_receive_shadows_shader_feature_static_passed_cargo_deferred_implementation_cadence`；该切片不切换 shader source，也不声明 Cargo/WGPU/RenderDoc 通过。
- The 2026-06-15 Plan 07 PP-M2-S3 hard cut makes scene extract an upstream authoring source for postprocess without moving resolution into scene code. Runtime-only `PostProcessSettingsComponent` instances seed base bloom/color-grading/effect-stack settings from the selected scene camera only, while explicit request cameras stay on neutral defaults. Runtime-only `PostProcessVolumeComponent` instances live in fixed scene component storage, are filtered by active hierarchy plus camera render layers, and are forwarded as `PostProcessExtract.volumes`; local volumes project only box/sphere planned shapes in this slice, and `VolumeEvaluator` computes influence at submit time from camera position.
- The neutral volume evaluator coverage now locks active/layer filtering, priority order, global/box/sphere influence, saturation through weight/influence, unset override preservation, and unknown-component errors. That keeps scene extract as snapshot owner while preserving submit as the single per-camera settings resolver.
- `BuiltinRenderFeature::Particle` 现在也按 M8 descriptor-first 规则处理：built-in token 必须显式 feature opt-in，启用后只保留 `particles` neutral extract section，不注册 graph pass、executor、history binding 或 backend capability。可执行粒子渲染仍由插件 descriptor 声明透明阶段 pass，并由显式 `particle.transparent` executor registration 证明 runtime pass body 存在；built-in slot 只服务 renderer-data authoring、profile gating 和后续粒子专项接入点。
- 2026-06-24 Plugin feature compile particle tests owner split 把 `graphics/tests/plugin_feature_compile.rs` 保持为 614 行 generic plugin/advanced/SMAA compile parent，并把 particle plugin transparent pass、core-scene particle descriptor-only pass、particle disable options 与 particle pass IO assertions 移入 153 行 `graphics/tests/plugin_feature_compile/particle.rs`。`runtime_15_plugin_feature_compile_particle_tests_are_child_owner` 锁定 moved-test/helper ownership、父/子 800 行预算和文档状态锚 `render_plugin_feature_compile_particle_tests_owner_split_static_passed_cargo_deferred_implementation_cadence`；本切片只记录 scoped rustfmt/static/line-count/docs-anchor/stale-path/diff-check 证据，Cargo/WGPU/RenderDoc 按 implementation cadence 暂缓。
- 2026-06-24 Render framework bridge tests owner split 把 `graphics/tests/render_framework_bridge.rs` 保持为 457 行 shared WGPU framework fixture/root module，并把 stats/postprocess、history/UI、pipeline/profile/capability/registration、neural compute、VG/HGI advanced provider coverage 分别移入 `graphics/tests/render_framework_bridge/stats.rs`、`history.rs`、`pipeline_profiles.rs`、`neural_compute.rs` 与 `advanced_providers.rs`。`runtime_15_render_framework_bridge_tests_are_child_owners` 锁定 moved-test ownership、六文件 800 行预算和文档状态锚 `render_framework_bridge_tests_owner_split_static_passed_cargo_deferred_implementation_cadence`；本切片只记录 scoped rustfmt/static/line-count/docs-anchor/stale-path/diff-check 证据，Cargo/WGPU/RenderDoc 按 implementation cadence 暂缓。
...
- Plan 02 的 VG execution projection 统计现在从 MeshDraw 提交面进入同一框架统计面。`CompiledSceneDraws::virtual_geometry_execution_stats()` 用 `MeshDraw::virtual_geometry_execution_draw(...)` 生成 `PreparedMeshVirtualGeometryExecutionStats`，`render_compiled_scene(...)` 把它并入 `PreparedMeshQueueStats`，`update_stats/virtual_geometry_stats.rs` 再与既有 context/runtime 统计取 max 后写入 public `RenderStats`。这让 VG execution draw/segment/page/resident/pending/missing/repeated 计数以 compiled mesh execution evidence 为先，而普通 indirect draw 因没有 VG execution-selection key 不会污染 VG 口径；对应 projection/getter 不再需要 `#[allow(dead_code)]` 维持脚手架。
- Plan 02 的 mesh dead-code suppression cleanup 继续把 skinned/VG 剩余脚手架变成真实数据面或删除。`MeshDraw` 不再保存创建 palette buffer 后未使用的 joint-count 缓存，也不再暴露 `skinned_joint_count()`；current/previous palette WGPU buffer 字段仍通过 prepared queue 的 palette upload stats 保持 live。VG indirect draw-ref 只保留 submission detail 需要的 `segment_key`，未消费的 `mesh_index_count` / `mesh_signature` scratch 字段和 `mesh_signature_for_pending_draw(...)` 已删除；GPU metadata buffer 里的 `VirtualGeometryIndirectDrawRefInput.mesh_index_count` 仍由 pending draw index count 生成。`mesh_pass/mod.rs` 不再用模块级 `allow(dead_code, unused_imports)` 遮盖 re-export 面，`PreparedMeshQueueStats` 也不再用 non-test dead-code cfg_attr 维持统计字段；当前 mesh 生产子树不再保留 dead-code suppression。
- Plan 04 的 visibility static-index suppression cleanup(`render_plan04_visibility_static_index_suppression_cleanup_static_passed_cargo_timeout_no_result`)把 static-index 观测面收敛到生产 report contract。`VisibilityStaticIndex::indexed_entity_count()` 删除后,本地测试读取 `VisibilityStaticIndexReport.indexed_entity_count`;`graphics::visibility` 根对 `VisibilityStaticIndex` 的 crate-private re-export 已由 render-framework history/viewport-record/visibility-context 路径消费,不再需要 `allow(unused_imports)`。
- Plan 06 的 TemporalHistoryTexture lifetime-owner cleanup(`render_plan06_temporal_history_texture_lifetime_owner_suppression_coremin_passed`)把 TAA scene-color history store 的剩余 F12 pocket 收口。`TemporalHistoryTexture` 不再用 `#[allow(dead_code)]` 保存底层 `wgpu::Texture`;字段名改为 `_texture`,明确它只负责让 paired `TextureView` 在 `previous_view()` / `current_view()` 生命周期内保持有效,而不是暴露新的生产 accessor。
- Plan 14 的 PreparedSpriteQueueStats suppression cleanup(`render_plan14_sprite_queue_stats_suppression_cleanup_static_passed_cargo_deferred_active_lanes`)确认 sprite queue stats 是生产诊断 DTO。`PreparedSpriteQueueStats` 继续由 `prepare_sprite_queue_stats(...)` 和 compiled-scene outputs 汇总相邻纹理 batching、image slice、expanded slice、vertex 与 per-phase batch 计数，再进入 `RenderStats.last_sprite_*` / `render.sprite.queue.*`;因此不再需要 non-test dead-code cfg_attr。
- Plan 14 的 UI font/attachment test-surface cleanup(`render_plan14_ui_font_attachment_test_surface_suppression_static_passed_cargo_deferred_active_lanes`)把 UI renderer 剩余 suppression 收口到测试边界。`load_ui_font_manifest(...)` 只作为无项目资产管理器的 font manifest contract helper 编译给测试,生产路径继续通过 `load_ui_font_manifest_with_asset_manager(...)`;`ScreenSpaceUiRenderer::last_attachment_ops()` 只保留给 graph executor attachment-op focused tests。该切片后 `zircon_runtime/src/graphics` suppression scan 为零命中。
- Plan 05 的 shadow dead-code suppression cleanup(`render_plan05_shadow_dead_code_suppression_cleanup_static_passed_cargo_deferred_active_lanes`)把 shadow root 和 atlas root 收成薄声明面。`shadow/mod.rs` 不再对 atlas/cascade/plan/slot 使用模块级 `allow(dead_code)`,`shadow/atlas/mod.rs` 不再用 `allow(unused_imports)` 维持宽 re-export,只导出当前 forward/deferred/plan/slot/construct 路径实际消费的 allocator、resource 与 binding 合同。`ShadowFramePlan` 删除未消费的 atlas allocation 存储和 getter;分配器测试观察 helper 收入 test cfg,而 live atlas allocation 仍在 `build_shadow_frame_plan(...)` 内用于生成 slot/pass/light assignment。
- Plan 03 的 GPUScene root façade cleanup(`render_plan03_gpu_scene_root_facade_suppression_cleanup_static_passed_cargo_timeout_active_compile`)把 GPUScene 根模块收回薄 façade:`gpu_scene/mod.rs` 不再用整棵子树级 `#![allow(dead_code, unused_imports)]`,也不再 re-export child-owned binding helper、allocator、dirty queue、capacity 常量、layout offset 常量或 roll-report 类型。跨边界 surface 只保留当前 mesh/HZB/stats 路径实际消费的 `GpuScene`、entry/stats/upload report、Pod layout struct/stride/flag 和 previous skinned state;内部上传、绑定、分配、dirty merge 仍归各 child owner。
- Plan 01 的 advanced plugin resource/readback suppression cleanup(`render_plan01_advanced_plugin_resource_readback_suppression_cleanup_static_passed_cargo_deferred_active_lanes`)把 runtime-prepare/plugin graph resource handoff 的测试观察面收进 test cfg。`SceneRendererAdvancedPluginReadbacks::is_empty(...)` 与 `SceneRendererAdvancedPluginResources::register_runtime_prepare_collector(...)` 不再作为生产 dead-code surface 存活;当前未被生产消费的 HGI resource capability 字段与 getter 也只在 tests 中保留,避免用 `#[allow(dead_code)]` 维持未接线 façade。
- Plan 01 的 RgResourceResolver physical test-surface cleanup(`render_plan01_rg_resource_resolver_physical_test_surface_static_passed_cargo_deferred_active_lanes`)把 resolver 的生产职责重新限定为 compiled pass declaration/access gate。只服务 focused tests 的 `with_physical(...)`、resolver-owned texture/buffer 直查 helper、`physical_resources(...)` 与 handle-level require helper 已进入 `#[cfg(test)]`;真实 WGPU resource lookup 仍在 `RenderPassExecutionContext` / `RenderPassGpuExecutionContext` 和 `gpu/resource_lookup.rs` 中完成,并且继续先经过 resolver 的声明访问校验。
- Plan 01 的 RenderPassExecutionContext suppression cleanup(`render_plan01_execution_context_suppression_cleanup_static_passed_cargo_deferred_active_lanes`)把执行上下文构造和队列 fallback helper 从 `cfg_attr(not(test), allow(dead_code))` 中移出。公开构造面继续服务 graph execution/plugin focused tests，`require_buffer_by_name(...)` 继续作为生产 buffer resource lookup helper；`render_pass_execution_context.rs` 与 `resource_resolver.rs` 当前不再保留 dead-code suppression。
- Plan 01 的 RenderGraphExecutionResources owned texture descriptor cleanup(`render_plan01_execution_resources_owned_texture_desc_suppression_static_passed_cargo_deferred_active_lanes`)确认 `owned_texture_desc(...)` 是 GI history copy 和 graph-owned texture readback 的生产 descriptor lookup。该 helper 不再通过 dead-code suppression 存活，execution resource registry 的 texture descriptor owner 仍保持在 graph execution 内部。
- Plan 01 的 RenderGraphExecutionRecord observation cleanup(`render_plan01_execution_record_observation_suppression_cleanup_static_passed_cargo_deferred_active_lanes`)把 legacy/simple pass push helpers、测试读回 setter、raw staged/resource/dependency/compute inspection accessors 收进 test cfg,不再依赖 dead-code suppression;生产 stats/product graph 仍消费的 `executed_post_process_nodes(...)` 与 `executed_stage_count(...)` 保持 live observation surface。
...
## 2026-05-19 M9B Solari Experimental Contract

M9B adds Solari as an explicit experimental render contract without adding a visual raytraced lighting pass. The neutral owner is `zircon_runtime::core::framework::render::solari`: `SolariCapabilityRequirement` mirrors the Bevy Solari feature set, `SolariSettings` carries the explicit experimental gate, and `SolariRuntimeReport` records whether the product profile is not requested, capability-missing, provider-missing, experimental-disabled, provider-unavailable, or ready.

The backend capability vocabulary now includes the binding-array requirements needed by Solari: `BufferBindingArray`, `TextureBindingArray`, `NonUniformResourceIndexing`, and `PartiallyBoundBindingArray`. These are exposed through `RenderCapabilityKind`, `RenderCapabilitySummary`, `RenderFeatureCapabilityRequirement`, `RenderBackendCaps`, and `rhi_wgpu::wgpu_backend_caps(...)`, so profile validation and runtime status reporting share the same backend truth.
...
## 2026-08-26 Surface Source Contract Publication

Surface source shape is classified before mesh pipeline resolution. `ShaderAsset::surface_source_contract()` returns the typed `MaterialFunction` or transitional `LegacyFullPass` contract. The material form requires exactly one `ZrVertexOutput` parameter (or its public `ZrSurfaceInput` alias) and a `ZrSurfaceOutput` return; missing, duplicate, signature-mismatched, mixed material/executable, and non-canonical full-pass shapes are rejected. Readiness and resource streaming consume the same classifier; `ShaderRuntime` stores the accepted result, so mesh pipeline source selection compares an enum instead of rescanning WGSL. The scan is comment-aware, allocation-free, and O(source bytes) at classification; the published lookup is O(1). Reflection-derived stage IO, binding/layout hashes, and the eventual migration or removal of `LegacyFullPass` remain open P0 work.
