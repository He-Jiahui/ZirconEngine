...
tests:
  ...
  - D:\cargo-targets\zircon-editor-appearance-toolbar-0702\debug\deps\zircon_editor-2ac1fe4cc1fe2ea7.exe style_selector::workbench_selection_control --nocapture --test-threads=1 (2026-07-02: passed 4/4 after selection-control preference-route palette projection)
  - D:\cargo-targets\zircon-editor-appearance-toolbar-0702\debug\deps\zircon_editor-2ac1fe4cc1fe2ea7.exe selection_control_palette_projects_from_host_appearance_tokens --nocapture --test-threads=1 (2026-07-02: passed 1/1)
  - cargo test -p zircon_editor --lib status_control_palette_projects_from_host_appearance_tokens --locked --jobs 1 --target-dir D:\cargo-targets\zircon-editor-appearance-status-0702 --message-format short --color never -- --nocapture --test-threads=1 (2026-07-02: passed 1/1)
  - cargo test -p zircon_editor --lib workbench_status_metrics_project_from_host_control_metrics --locked --jobs 1 --target-dir D:\cargo-targets\zircon-editor-appearance-status-0702 --message-format short --color never -- --nocapture --test-threads=1 (2026-07-02: passed 1/1)
  - cargo test -p zircon_editor --lib chrome_palette_projects_from_host_appearance_tokens --locked --jobs 1 --target-dir D:\cargo-targets\zircon-editor-appearance-chrome-0702 --message-format short --color never (2026-07-02: passed 1/1)
  - cargo test -p zircon_editor --lib shell_panel_frame_metrics_project_from_host_control_metrics --locked --jobs 1 --target-dir D:\cargo-targets\zircon-editor-appearance-chrome-0702 --message-format short --color never (2026-07-02: passed 1/1)
  - cargo check -p zircon_editor --lib --locked --jobs 1 --target-dir D:\cargo-targets\zircon-editor-appearance-chrome-0702 --message-format short --color never (2026-07-02: passed with existing warnings after Chrome palette/shell-panel metrics preference-route consumers)
  ...
  - zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/tests/actions.rs::runtime_component_projection_projects_popup_option_state_metadata_for_native_painter
  - zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/tests/actions.rs::runtime_component_projection_projects_popup_menu_loading_flags_for_native_painter
  ...
  - rustfmt --edition 2021 --check zircon_editor/src/ui/layouts/views/view_projection.rs zircon_editor/src/ui/retained_host/ui/component_contract_metadata.rs zircon_editor/src/ui/retained_host/host_contract/template_component_family.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/popup_frame/mod.rs zircon_editor/src/ui/retained_host/host_contract/template_popup_layout.rs zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/template_popup_rows.rs zircon_editor/src/ui/retained_host/host_contract/surface_hit_test/template_node.rs zircon_editor/src/ui/retained_host/host_contract/native_keyboard.rs zircon_editor/src/ui/retained_host/host_contract/native_popup_dismiss.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/tests/actions.rs (2026-06-14: passed after popup shell role/projected frame geometry baseline)
  ...
  - cargo fmt -p zircon_editor --check (2026-07-02 passed after retained appearance palette/TextField preference slice)
  ...
  - cargo test -p zircon_editor capture_m3_gui_acceptance_visual_artifacts --locked --jobs 1 --target-dir D:\cargo-targets\zircon-editor-appearance-0702-rerun --message-format short --color never -- --ignored --test-threads=1 --nocapture (2026-07-02 passed 1/1)
  ...
  - cargo test -p zircon_editor capture_m3_gui_acceptance_visual_artifacts --locked --jobs 1 --target-dir D:\cargo-targets\zircon-editor-appearance-toolbar-0702 --message-format short --color never -- --ignored --test-threads=1 --nocapture (2026-07-02 passed 1/1)
  - cargo test -p zircon_editor table_row_palette_projects_from_host_appearance_tokens --lib --locked --jobs 1 --target-dir D:\cargo-targets\zircon-editor-appearance-toolbar-0702 --message-format short --color never -- --test-threads=1 --nocapture (2026-07-02 passed 1/1)
  - D:\cargo-targets\zircon-editor-appearance-toolbar-0702\debug\deps\zircon_editor-2ac1fe4cc1fe2ea7.exe style_selector::workbench_table_row --nocapture --test-threads=1 (2026-07-02 passed 5/5)
  - D:\cargo-targets\zircon-editor-appearance-toolbar-0702\debug\deps\zircon_editor-2ac1fe4cc1fe2ea7.exe style_selector::workbench_list_row --nocapture --test-threads=1 (2026-07-02 passed 2/2)
  - D:\cargo-targets\zircon-editor-appearance-toolbar-0702\debug\deps\zircon_editor-2ac1fe4cc1fe2ea7.exe style_selector::workbench_tree_row --nocapture --test-threads=1 (2026-07-02 passed 2/2)
  - D:\cargo-targets\zircon-editor-appearance-toolbar-0702\debug\deps\zircon_editor-2ac1fe4cc1fe2ea7.exe style_selector::workbench_popup_row --nocapture --test-threads=1 (2026-07-02 passed 3/3)
...
The 2026-07-02 toolbar preference-route pass keeps Button/TextField/Search style selectors as consumers of global appearance owners. Workbench button normal/interactive/unavailable states and Asset Browser toolbar command/chip/tab variants read `current_host_palette()`, while TextField/Search resolves toolbar surface, border, placeholder, disabled, and error colors through `workbench_text_field_palette_from_host(...)`. Search toolbar fields intentionally ignore legacy declared background/border chrome so the composite toolbar can change with the global color theme/style density instead of with stale local `.zui` values. Button label metrics still choose only semantic strong/default text style; no concrete font family is selected in the component selector.

The 2026-07-03 Asset Browser utility-tab refinement keeps tab-like Workbench buttons on the same global appearance route. `workbench_button/selection.rs` now separates utility tabs such as Preview/References/Metadata/Plugins from toolbar chips: selected utility tabs use transparent surface plus primary text so `template_buttons/surface.rs` can express selection with the shared accent underline, while toolbar chips keep their framed low-emphasis selected surface. `template_buttons/surface.rs` reads underline color from `current_host_palette()` and underline height/inset from `current_host_metrics()`. The slice does not choose a concrete font family or local code/mono text style; full editor screenshot refresh is still pending because editor-host build was blocked by concurrent Rust build lanes.
...
The 2026-07-02 retained appearance Chrome slice moves shell chrome and shell-panel frame consumers onto the global preference route. `workbench_chrome/palette.rs` projects `WorkbenchChromePalette` from `current_host_palette()`, and production fill/separator/selection helpers consume that projected palette instead of reading static Workbench Chrome colors or `PALETTE` directly. Test-only chrome constants remain under `#[cfg(test)]` for legacy selector assertions. `template_shell_panels/frame.rs` projects frame border width and corner radius from `current_host_metrics()`, so content-panel framing follows the active host control metrics. Chrome and shell-panel owners do not choose a concrete font family or code/mono text route; text continues to resolve through the retained text bridge and installed host text preferences. The focused regressions `chrome_palette_projects_from_host_appearance_tokens` and `shell_panel_frame_metrics_project_from_host_control_metrics` lock the palette and metrics projection route.
...
The 2026-07-02 Asset Browser toolbar-chip refinement keeps filter/view controls inside the button selector but separates their visual role from true utility tabs. `workbench_button/tab_like.rs` classifies Asset Browser kind/view controls such as `All`, `Texture`, `Material`, `List`, and `Thumb` as toolbar chips, while Preview/References/Metadata/Plugins remain utility tabs. `workbench_button/selection.rs` gives selected toolbar chips a low-emphasis segmented surface and 1 px neutral border; `template_buttons/surface.rs` then suppresses the tab underline for that toolbar-chip class only. The refinement does not set a concrete font family: labels still choose UI text semantics and the retained text layer resolves the actual family through `EditorTypographyTokens -> HostTextPreferences -> fontdb`.

Validation for this refinement used focused `asset_browser_toolbar_chip` 4/4, focused `asset_browser_utility_tab` 4/4, focused hover/density coverage 2/2, editor-host build, the ignored M3 screenshot harness, and screenshot/crop metadata under `docs/tests/editor` with repo `target` same-name scan returning 0.

The 2026-07-03 utility-tab visual follow-up narrows the selected Preview/References/Metadata/Plugins treatment to underline-only active state. The button selector still uses `current_host_palette()` for surface/text decisions, but selected utility tabs now keep a transparent surface instead of the older pressed-surface pill. Toolbar chips are explicitly tested to retain their framed surface, preventing filter/view controls from losing their selected affordance. `template_buttons/surface.rs` also moved tab-like indicator color and height off the static `PALETTE`/`METRICS` aliases and onto `current_host_palette()`/`current_host_metrics()`, keeping future theme and density preference changes global.

The 2026-07-02 Asset Browser Import command refinement moves command visual-role classification into `style_selector/workbench_command.rs`, so ordinary `Button` and `IconButton` controls consume the same semantic command role. Compile commands remain muted prominent actions through neutral surfaces and accent text, while Import commands now map to the primary import role: normal state uses the shared accent token, hover/active/pressed use the shared focus-ring token, and foreground/glyph uses the theme shell-background token for contrast. This keeps the Asset Browser toolbar `Import` button visually closer to the reference primary action without adding a concrete font family, RGB literal, local palette, or component-local theme override. The actual font family still resolves through `EditorTypographyTokens -> HostTextPreferences -> fontdb`; full preference UI/theme persistence remains a higher-level task.

Validation for this refinement used focused `asset_import_command_button` 2/2, focused `asset_import_icon_button` 2/2, `cargo fmt -p zircon_editor --check`, scoped `git diff --check`, editor-host build, the ignored M3 screenshot harness, no font-family literal matches in the touched style slice, screenshot/crop metadata under `docs/tests/editor`, and repo/external-target same-name screenshot scans returning 0.
...
The 2026-07-03 segmented/tab metrics slice keeps geometry preference routing beside the segmented-control painter instead of adding selector-side layout policy. `template_segmented_control_geometry/metrics.rs` now projects `WorkbenchSegmentedControlMetrics` from `current_host_metrics()`, covering segment and tab font size, line height, text inset, group-label height/gap, selected inset, divider width/inset, and tab underline height. `template_segmented_control_geometry/segmented/item.rs` consumes the divider width/inset helpers instead of hardcoding local divider geometry. The slice does not choose a concrete font family or force tab labels into code/mono style; actual font selection continues through global typography preferences.
...
- enabled checkbox and radio fallback labels use `PALETTE.text_muted`, not `PALETTE.text_disabled`; disabled/loading remain the only states that force label text to the disabled tone. Toggle labels continue to use the primary selection text lane unless unavailable state overrides them.
...
The selector-local regression `selection_controls_loading_state_uses_unavailable_visuals` locks loading-state precedence over checked/selected, press/drop-hover, and declared colors. The 2026-07-01 regression `selection_controls_enabled_labels_keep_readable_muted_tone` locks enabled checkbox/radio labels to muted readable text instead of disabled text. The template regression `selection_control_loading_state_mutes_active_checked_visuals` keeps the retained painter helper path aligned with the shared selector while preserving existing checked-control geometry tests.

The 2026-07-02 selection-control preference-route slice moves production checkbox, radio, and toggle colors to `WorkbenchSelectionControlPalette`, projected from `current_host_palette()` instead of a production-local static `PALETTE`. `select_workbench_selection_control_style(...)` reads the palette once and passes it into surface, border, and text color helpers; disabled, loading, hover, focus, checked, selected, toggle thumb, radio dot, and fallback label colors all resolve from the installed host appearance palette. Legacy selection constants remain available only under `#[cfg(test)]` for selector assertions, so changing the global engine appearance preference can update the component family without hardcoding a font family, code-style text route, RGB theme, or widget-local color table.

The 2026-07-03 selection-control metrics slice adds `WorkbenchSelectionControlMetrics` in `template_selection_control_geometry/metrics.rs`. Checkbox, radio, and toggle production paths now derive label font size, line height, mark inset/size, label gap, radio dot size, and toggle track/thumb geometry from `current_host_metrics()` instead of local leaf constants. The default projection preserves the existing Slate-like baseline, while global typography, spacing, border, and row-height preference changes can flow into the whole selection-control family. The slice does not introduce a concrete font family or `UiTextRunPaintStyle::code`; validation covers touched-file rustfmt, diff check, font/code-style scans, `cargo check -p zircon_editor --lib --no-default-features`, the focused metrics projection regression, editor-host build, the M3 screenshot harness, and the component atlas screenshot harness. Screenshot evidence was refreshed under `docs/tests/editor`, and same-name target scans returned `NO_MATCHING_SCREENSHOTS_IN_TARGETS`.
...
The 2026-07-02 retained row preference-route slice moves production row and popup colors to the installed host appearance palette instead of static local token tables. `workbench_table_row/palette.rs` projects `WorkbenchTableRowPalette` from `current_host_palette()`, while table-row background, action, border, text, selection, list-row, tree-row, popup-row, and shared row-selection selectors read the current host palette for selected, hover, focus, border, disabled, shortcut, adornment, and danger-role colors. Test constants remain under `#[cfg(test)]` for older selector assertions; production row owners do not hardcode font families, RGB literals, or component-local themes. This keeps rows and popup menus on the same `EditorAppearancePreferences -> EditorDesignTokens -> HostMaterialPalette` route as TextField, Button, and toolbar consumers.
...
The 2026-07-02 retained appearance slice keeps Slider on the global preference route instead of a component-local font/color table. `workbench_slider/palette.rs` projects `WorkbenchSliderPalette` from `current_host_palette()`, and production track/thumb/text/value helpers receive that palette through the selector. `template_slider_geometry/metrics.rs` projects `WorkbenchSliderMetrics` from `current_host_metrics()`, so track thickness, thumb size, halo size, label/value lanes, value gap, tick size, font size, and line height follow the active host control metrics. Slider text commands keep `UiTextRunPaintStyle::default()` and do not select a concrete font family or code/mono style inside the control. The focused regressions `slider_palette_projects_from_host_appearance_tokens` and `workbench_slider_metrics_project_from_host_control_metrics` lock the palette/metrics projection route.
...
The 2026-07-02 retained appearance status slice keeps Status Controls on the global preference route instead of a component-local font/color table. `workbench_status_control/palette.rs` projects `WorkbenchStatusControlPalette` from `current_host_palette()`, and production chip/icon/signal helpers receive that palette through the selector instead of reading static `PALETTE`. `template_status_control_geometry/metrics.rs` projects `WorkbenchStatusMetrics` from `current_host_metrics()`, so status font size, line height, chip inset, chip value gap, border width, signal marker size, and signal text gap follow active host control metrics. Status chip text uses `measure_runtime_text_width(...)` and emits `UiTextRunPaintStyle::default()`, so the control does not bind a concrete font family or code/mono style. Focused regressions `status_control_palette_projects_from_host_appearance_tokens` and `workbench_status_metrics_project_from_host_control_metrics` lock this route.
...
The 2026-07-02 retained appearance palette slice changes the palette owner without changing TextField geometry. `workbench_text_field/palette.rs` now builds its production `WorkbenchTextFieldPalette` from `current_host_palette()`, while the retained host installs that palette from `EditorAppearancePreferences::design_tokens()` during startup. Search fields and generic Workbench text fields therefore read the active global palette instead of a component-local color table. Test-only constants remain only for older selector assertions; production code paths use the palette accessor so future theme swaps do not require editing TextField/Search owners.
