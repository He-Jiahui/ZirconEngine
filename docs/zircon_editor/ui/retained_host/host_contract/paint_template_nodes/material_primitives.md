...
related_code:
  ...
  - zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives/skeleton/geometry.rs
  - zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives/skeleton/style.rs
...
tests:
  ...
  - zircon_runtime/src/ui/tests/asset_mui_web_style.rs
  - zircon_runtime/src/ui/tests/asset_mui_web_badge_style.rs
  - rustfmt --edition 2021 --check zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives.rs zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives/avatar.rs zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives/badge.rs zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives/skeleton.rs zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives/timeline.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/mod.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/surface_defaults/mod.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/tests/actions.rs zircon_editor/src/tests/host/retained_window/native_material_painter_mui_primitives.rs zircon_runtime/src/ui/template/asset/compiler/style_apply/mui_display_surface_classes.rs zircon_runtime/src/ui/tests/asset_mui_web_style.rs
  - rustfmt --edition 2021 --check zircon_runtime/src/ui/template/asset/compiler/style_apply/mui_display_surface_classes.rs zircon_runtime/src/ui/tests/asset_mui_web_badge_style.rs zircon_runtime/src/ui/tests/mod.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/surface_defaults/mod.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/tests/actions.rs
  - rustfmt --edition 2021 --check zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives.rs zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives/chip.rs zircon_editor/src/tests/host/retained_window/native_material_painter_mui_primitives.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/surface_defaults/mod.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/tests/actions.rs zircon_runtime/src/ui/template/asset/compiler/style_apply/mui_display_surface_classes.rs zircon_runtime/src/ui/tests/asset_mui_web_style.rs
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; chip style ownership scan; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Chip style responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; chip geometry ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Chip geometry responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; alert style ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Alert style responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; alert geometry ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Alert geometry responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; divider style ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Divider style responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; divider geometry ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Divider geometry responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; avatar style ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Avatar style responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; avatar geometry ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Avatar geometry responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; badge style ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Badge style responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; badge geometry ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Badge geometry responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; timeline style ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Timeline style responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; skeleton style ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Skeleton style responsibility split: passed with existing warning noise only)
  - cargo fmt -p zircon_editor; cargo fmt -p zircon_editor --check; skeleton geometry ownership scan; touched-file whitespace scan; scoped git diff --check; cargo check -p zircon_editor --lib --locked --jobs 1 --message-format short --color never (2026-06-18 after Material Skeleton geometry responsibility split: passed with existing warning noise only)
  - rustfmt --edition 2021 --check zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives/alert.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/surface_defaults/mod.rs zircon_editor/src/ui/retained_host/ui/pane_data_conversion/pane_component_projection/tests/actions.rs zircon_editor/src/tests/host/retained_window/native_material_painter_alert.rs zircon_runtime/src/ui/template/asset/compiler/style_apply/mui_display_surface_classes.rs zircon_runtime/src/ui/tests/asset_mui_web_style.rs
  - rustfmt --edition 2021 --check --config skip_children=true zircon_editor/src/ui/retained_host/host_contract/paint_template_nodes/material_primitives.rs zircon_editor/src/tests/host/retained_window/mod.rs
...
The 2026-06-18 Avatar style responsibility split moves color-default fallback tone, disabled surface/text routing, explicit style-color lookup, text-tone palette fallback, border color, and border width into `material_primitives/avatar/style.rs`. The follow-up Avatar geometry responsibility split moves default frame sizing, rounded/circular radius resolution, fallback child centering, text font fallback, and text frame sizing into `material_primitives/avatar/geometry.rs`. `material_primitives/avatar.rs` stays focused on Avatar recognition, image/icon rasterization, alpha masking, fallback glyph emission, and image/text/border command sequencing.
...
The 2026-06-18 Badge style responsibility split moves root background, root border, root text color, overlay palette token resolution, overlay contrast text, overlay border color, and badge style border widths into `material_primitives/badge/style.rs`. The follow-up Badge geometry responsibility split moves standard/dot sizing constants, root label frame calculation, overlay frame placement, standard/dot radius selection, overlay text frame calculation, and anchor-origin overlap calculations into `material_primitives/badge/geometry.rs`. `material_primitives/badge.rs` stays focused on Badge root/slot recognition, root label extraction, invisible/dot state checks, root/overlay/text command sequencing, and root surface radius resolution.
...
The 2026-06-18 Chip style responsibility split moves MUI palette constants, filled/outlined foreground and background resolution, border color/width, avatar color, delete icon color, and color-token parsing into `material_primitives/chip/style.rs`. The follow-up Chip geometry responsibility split moves compact frame sizing, pill radius, font fallback, label padding/width, avatar/icon/delete slot frames, and negative slot margins into `material_primitives/chip/geometry.rs`. `material_primitives/chip.rs` stays focused on Chip recognition, slot consumption, label/delete glyph emission, and command sequencing.
...
The 2026-06-18 Alert style responsibility split moves MUI severity palette constants, standard/filled/outlined surface resolution, border color/width, corner radius, foreground/icon/action/cutout color, and severity token parsing into `material_primitives/alert/style.rs`. The follow-up Alert geometry responsibility split moves pixel alignment, message/action bounds, icon/action frames, icon mark frame, font fallback, and text width estimation into `material_primitives/alert/geometry.rs`. `material_primitives/alert.rs` stays focused on Alert root/slot recognition, icon and close glyph emission, and command sequencing.
...
The 2026-06-18 Skeleton style responsibility split moves default background, wave highlight color, disabled opacity, resolved background/border lookup, and style border width calculation into `material_primitives/skeleton/style.rs`. The follow-up Skeleton geometry responsibility split moves text/circular frame calculation, rectangular/circular/rounded corner-radius resolution, wave-frame placement, and configured radius lookup into `material_primitives/skeleton/geometry.rs`. `material_primitives/skeleton.rs` stays focused on Skeleton root/child recognition, wave-state detection, surface/wave command sequencing, and style/geometry dispatch.
...
The 2026-06-18 Timeline style responsibility split moves outlined-state lookup, dot background/border/tone resolution, connector color fallback, dot border width, local MUI grey/secondary constants, and timeline dot color-token parsing into `material_primitives/timeline/style.rs`. `material_primitives/timeline.rs` stays focused on Timeline primitive kind routing, separator consumption, dot/connector command emission, centered dot geometry, and connector strip geometry.
...
The 2026-06-18 Divider style responsibility split moves divider line color, text color, disabled color routing, explicit style-color lookup, and text-tone palette fallback into `material_primitives/divider/style.rs`. The follow-up Divider geometry responsibility split moves line thickness, horizontal/vertical insets, wrapper padding, font-size clamp, orientation detection, line frames, label bounds, text frames, text alignment, and pixel alignment into `material_primitives/divider/geometry.rs`. `material_primitives/divider.rs` stays focused on Divider recognition, label extraction, line command emission, and text command sequencing.
