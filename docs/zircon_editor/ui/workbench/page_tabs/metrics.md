...
- `main_page_tab_preferred_width(...)` clamps authored titles between min and max width.
...
- Host page pointer geometry and Workbench chrome projection consume the same constants and tier policy.
