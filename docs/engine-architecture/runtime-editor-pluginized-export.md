...
- plugin workspace runtime-package behavior tests for physics, sound, net, navigation, particles, texture, animation, virtual geometry, and hybrid GI, including render feature pass/capability metadata for the advanced render plugins
