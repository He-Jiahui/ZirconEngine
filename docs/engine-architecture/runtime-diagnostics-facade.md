...
implementation_files:
  ...
  - zircon_editor/assets/ui/editor/host/runtime_diagnostics_body.ui.toml
plan_sources:
  - user: 2026-04-25 开始执行 runtime diagnostics façade and editor diagnostics pane cut
...
`zircon_runtime::core::diagnostics` is the read-only inspection surface for editor and tooling code. It collects runtime health from the existing manager façades instead of giving editor panes direct ownership of renderer, physics, or animation internals.
