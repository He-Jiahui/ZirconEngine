...
- [Runtime Asset Pack](../zircon_runtime/asset/pack.md): `zrpack` writer/reader/dedup/trim 基础、`ZRPD` delta chunk 差集包、共享 `ZrPackManifest/ZrChunkEntry` DTO、资产路径索引、依赖闭包裁剪报告和 M2 无锁文件哈希占位策略。
