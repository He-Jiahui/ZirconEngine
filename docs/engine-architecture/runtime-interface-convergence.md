...
- Runtime 05 plan-status owner-budget current mirror (2026-06-20) records Runtime 07 owner-budget 30-hotspot current audit sync, large_file_hotspot_count = 30, runtime-other=13, and editor-retained-host=3 as the current status metadata anchors. Older 36/37/38/39/42-hotspot rows remain only as historical drift evidence.
...
- large retained-host, editor UI, runtime UI/RHI/asset/render/scene, runtime framework render, and hub support files: current audit output reports 30 hotspots above 1000 lines, M1 gate status `migration-debt-present`, 5 migration-debt owner groups, and zero unclassified hotspots. The detailed decision table is in `docs/engine-architecture/large-file-ownership-m1.md`.
