...
- Frameworks 02 M3 Plugin SDK locked/default validation: the locked compile gate later passed as `frameworks_02_m3_plugin_sdk_locked_check_passed`; native-only helper tests passed as `frameworks_02_m3_plugin_sdk_native_feature_tests_passed`; and the default `runtime` feature package test now passes as `frameworks_02_m3_plugin_sdk_default_feature_tests_passed` with 10/10 SDK unit tests and 0/0 doc-tests.
