...
Runtime 15 module-convention update: `Runtime 15 M3 asset-pipeline route-owner split` / `runtime_15_asset_pipeline_route_owner_split_static_passed_cargo_deferred` keeps `zircon_runtime/src/tests/runtime_absorption/asset_pipeline.rs` as a route owner. Runtime 04 source/guard/behavior/doc/cargo anchor inventory now lives in `zircon_runtime/src/tests/runtime_absorption/asset_pipeline/inventory.rs`, the real Cargo-pending and document-mirror gate lives in `zircon_runtime/src/tests/runtime_absorption/asset_pipeline/cargo_gate.rs`, mirror-doc checks live in `zircon_runtime/src/tests/runtime_absorption/asset_pipeline/mirror_docs.rs`, shared file-existence helpers live in `zircon_runtime/src/tests/runtime_absorption/asset_pipeline/support.rs`, and split ownership lives in `zircon_runtime/src/tests/runtime_absorption/asset_pipeline/split_layout.rs::runtime_15_asset_pipeline_route_owner_is_folder_backed`.
