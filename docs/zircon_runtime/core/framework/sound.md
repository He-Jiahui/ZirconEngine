...
tests:
  ...
  - sound_channel_layout_contract_rejects_ambiguous_speaker_metadata
  - sound_channel_layout_option_uses_framework_named_layout_vocabulary
  - clip_source_defaults_to_master_track_and_neutral_spatial_contract
  - external_source_block_carries_explicit_channel_layout_contract
