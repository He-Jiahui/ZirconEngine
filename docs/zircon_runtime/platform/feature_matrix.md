...
- gamepad rumble backend declaration: future desktop gilrs force-feedback, future browser haptics, feature-disabled, or unavailable;
...
- gamepad rumble diagnostics distinguish desktop gilrs input support from the still-missing host-request/force-feedback output path;
