...
use super::hybrid_gi::{
    build_hybrid_gi_prepare, build_hybrid_gi_runtime, collect_hybrid_gi_evictable_probe_ids,
};
...
pub(in crate::runtime::render_framework::submit_frame_extract) fn prepare_runtime_submission(
    ...
    let hybrid_gi_resolve_runtime = hybrid_gi_runtime
        .as_ref()
        .map(crate::runtime::HybridGiRuntimeState::build_resolve_runtime);
