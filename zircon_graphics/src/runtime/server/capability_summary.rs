...
use super::queue_capability::queue_capability;
...
pub(in crate::runtime::server) fn capability_summary(
    ...
    RenderCapabilitySummary {
        ...
        virtual_geometry_supported: caps.supports_async_compute && caps.supports_pipeline_cache,
        hybrid_global_illumination_supported: caps.acceleration_structures.supported
            && (caps.acceleration_structures.inline_ray_query
                || caps.acceleration_structures.ray_tracing_pipeline),
    }
}
