...
pub(crate) struct VirtualGeometryRuntimeState {
    pub(in crate::runtime::virtual_geometry) page_budget: usize,
    pub(in crate::runtime::virtual_geometry) page_sizes: BTreeMap<u32, u64>,
    ...
    pub(in crate::runtime::virtual_geometry) evictable_pages: Vec<u32>,
    pub(in crate::runtime::virtual_geometry) free_slots: BTreeSet<u32>,
    pub(in crate::runtime::virtual_geometry) next_slot: u32,
}
