use super::super::super::core::DEPTH_FORMAT;
use super::super::super::primitives::LineVertex;

const LINE_SHADER: &str = include_str!("../shaders/line.wgsl");

pub(in crate::scene::scene_renderer::overlay::viewport_overlay_renderer) fn create_line_pipeline(
    device: &wgpu::Device,
