...
fn build_shared_indirect_args_layout(
    ...
    for authoritative_draw_ref in authoritative_ordered_draw_refs {
        ...
        let occurrence_rank = next_occurrence_rank(
            &mut authoritative_occurrence_ranks,
            group_key,
        );
...
mod tests {
    ...
    use crate::scene::scene_renderer::mesh::mesh_draw::VirtualGeometrySubmissionDetail;
