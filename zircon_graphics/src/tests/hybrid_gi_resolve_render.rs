...
fn hybrid_gi_resolve_uses_descendant_scene_driven_runtime_irradiance_for_parent_probe_after_schedule_clears(
    ...
    let warm_runtime =
        descendant_scene_driven_parent_irradiance_runtime_for_resolve([240, 96, 48]);
    let cool_runtime =
        descendant_scene_driven_parent_irradiance_runtime_for_resolve([48, 96, 240]);
...
fn trace_region(region_id: u32) -> RenderHybridGiTraceRegion {
    trace_region_with_bounds(region_id, zircon_math::Vec3::ZERO, 1.0, 1.0)
}
