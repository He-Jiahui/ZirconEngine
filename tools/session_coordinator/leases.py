...
class LeaseService:
    ...
    def acquire(
        ...
        *,
        ...
        with self.database.transaction() as connection:
            return self.acquire_in_connection(
                connection, session_id, paths, now=now
            )
    ...
    def acquire_in_connection(
        ...
        *,
        ...
        """Acquire paths within a caller-owned transaction.

        Cross-table ownership transitions need the lease, attribution, and
        Session scope to commit or roll back together. Keeping the same
        conflict and expiry rules here avoids a second, weaker lease path.
        """
