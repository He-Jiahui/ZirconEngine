...
test("control navigation has eleven stable routes", () => assert.equal(routes.length, 11));
test("control navigation maps controlled actions", () => assert.equal(routeForPath("/ui/actions"), "actions"));
