...
STATUS_ID = "plugins_13_m5_t1_structure_audit_layout_coordinates_guard"
...
class PluginDocsCurrentStatusStructureAuditLayoutCoordinatesGuardTests(unittest.TestCase):
    def test_current_status_records_layout_coordinates_structure_audit_guard(self):
        ...
        required_phrases = [
            ...
            "tools/plugin_structure_audits/manifest_schema_layout_coordinates.py",
            ...
            "test_manifest_schema_rejects_partial_package_coordinate_set",
            "test_manifest_schema_rejects_package_coordinate_segment_drift",
