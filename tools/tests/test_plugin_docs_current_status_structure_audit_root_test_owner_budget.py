...
STATUS_ID = (
    "plugins_13_m5_t1_structure_audit_manifest_schema_root_test_owner_budget_recovered"
)
...
class PluginDocsCurrentStatusStructureAuditRootTestOwnerBudgetTests(
    unittest.TestCase
):
    def test_current_status_records_structure_audit_root_test_owner_budget(self):
        ...
        required_phrases = [
            STATUS_ID,
            "tools/tests/test_plugin_structure_audit_manifest_schema.py=324",
            "tools/tests/test_plugin_structure_audit_manifest_schema_modules.py",
            "test_manifest_schema_accepts_module_descriptor_projection_fields",
            "test_manifest_schema_rejects_module_descriptor_projection_drift",
            "tools/tests/test_plugin_structure_audit_manifest_schema_layout_roots_owner_boundaries.py",
            "test_manifest_schema_rejects_layout_root_drive_separator",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record structure-audit root test "
