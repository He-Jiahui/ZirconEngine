...
STATUS_ID = "plugins_13_m5_t1_plugin_validate_feature_provider_manifest_metadata_projection_gate"
...
class PluginDocsCurrentStatusFeatureProviderManifestMetadataProjectionGateTests(
    unittest.TestCase
):
    def test_current_status_docs_record_feature_provider_manifest_metadata_projection_gate(
        self,
    ):
        ...
        required_phrases = [
            STATUS_ID,
            "generated manifest metadata projection consistency",
            ...
            "must match generated feature_extensions[0].capabilities",
            "must match generated distribution.default_packaging",
