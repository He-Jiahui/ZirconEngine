...
class PluginDocsCurrentStatusManifestSchemaFeatureExtensionDistributionSchemaGuardTests(
    unittest.TestCase
):
    def test_current_status_records_manifest_schema_feature_extension_distribution_schema_guard(
        self,
    ):
        ...
        required_phrases = [
            ...
            "collect_feature_extension_distribution_schema_violations",
        ...
        if failures:
            self.fail(
                ...
                "extension distribution schema guard:\n" + "\n".join(failures)
            )
