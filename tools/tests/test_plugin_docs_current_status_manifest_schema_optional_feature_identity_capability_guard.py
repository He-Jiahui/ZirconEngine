...
class PluginDocsCurrentStatusManifestSchemaOptionalFeatureIdentityCapabilityGuardTests(
    unittest.TestCase
):
    def test_current_status_records_manifest_schema_optional_feature_identity_capability_guard(
        self,
    ):
        ...
        required_phrases = [
            ...
            "optional_features[0].capabilities[3] runtime.feature.sound.preview duplicates capabilities capabilities[2]",
            ...
            "plugin_validate_optional_features.py",
        ...
        if failures:
            self.fail(
                ...
                "feature identity/capability guard:\n" + "\n".join(failures)
            )
