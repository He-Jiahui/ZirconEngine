...
class PluginDocsCurrentStatusAssetImporterResourceKindGateTests(unittest.TestCase):
    def test_current_status_records_asset_importer_resource_kind_gate(self):
        repo_root = Path(__file__).resolve().parents[2]
        status_id = (
            "plugins_13_m5_t1_plugin_validate_asset_importer_output_kind_"
            "resource_kind_gate"
        )
        ...
        required_phrases = [
            status_id,
            "plugin_validate_asset_importer_resource_kinds.py",
            "output_kind",
