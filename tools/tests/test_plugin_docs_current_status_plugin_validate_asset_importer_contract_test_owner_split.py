...
class PluginDocsCurrentStatusPluginValidateAssetImporterContractTestOwnerSplitTests(
    unittest.TestCase
):
    def test_current_status_records_asset_importer_contract_test_owner_split(self):
        repo_root = Path(__file__).resolve().parents[2]
        status_id = (
            "plugins_13_m5_t1_plugin_validate_asset_importer_contract_test_owner_split"
        )
        ...
        required_phrases = [
            status_id,
            "tools/zircon_export/tests/test_plugin_validate.py=922",
            "tools/zircon_export/tests/test_plugin_validate_asset_importer_contract.py=720",
            ...
            "python -m unittest tools.zircon_export.tests.test_plugin_validate_asset_importer_contract",
            "13/13",
            "py_compile",
        ]
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record PluginValidate asset_importer "
