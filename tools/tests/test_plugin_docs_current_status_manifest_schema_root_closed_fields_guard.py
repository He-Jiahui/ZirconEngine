...
STATUS_ID = "plugins_13_m5_t1_manifest_schema_root_closed_fields_guard"
...
class PluginDocsCurrentStatusManifestSchemaRootClosedFieldsGuardTests(
    unittest.TestCase
):
    def test_current_status_records_manifest_schema_root_closed_fields_guard(self):
        ...
        required_phrases = [
            ...
            "collect_manifest_root_known_field_violations",
            "is not a known manifest root field",
            "package_kind",
            "geometry_sources",
            "shader_permutation",
            "test_manifest_schema_rejects_unknown_root_field",
