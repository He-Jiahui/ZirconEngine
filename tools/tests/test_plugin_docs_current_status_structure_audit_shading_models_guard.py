...
STATUS_ID = "plugins_13_m5_t1_structure_audit_shading_models_guard"
...
class PluginDocsCurrentStatusStructureAuditShadingModelsGuardTests(unittest.TestCase):
    def test_current_status_records_shading_models_structure_audit_guard(self):
        ...
        required_phrases = [
            STATUS_ID,
            "tools/plugin_structure_audits/manifest_schema_shading_models.py",
            ...
            "custom:<name>",
            "test_manifest_schema_rejects_shading_model_descriptor_shape",
            "test_manifest_schema_rejects_shader_permutation_shading_model_id_mismatch",
