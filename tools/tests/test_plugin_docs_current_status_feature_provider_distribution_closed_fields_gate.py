...
STATUS_ID = "plugins_13_m5_t1_plugin_validate_feature_provider_distribution_closed_fields_gate"
...
class PluginDocsCurrentStatusFeatureProviderDistributionClosedFieldsGateTests(
    unittest.TestCase
):
    def test_current_status_docs_record_feature_provider_distribution_closed_fields_gate(
        self,
    ):
