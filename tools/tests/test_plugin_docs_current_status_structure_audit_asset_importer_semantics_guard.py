...
STATUS_ID = "plugins_13_m5_t1_structure_audit_asset_importer_semantics_guard"
...
class PluginDocsCurrentStatusStructureAuditAssetImporterSemanticsGuardTests(
    unittest.TestCase
):
    def test_current_status_records_asset_importer_semantics_structure_audit_guard(
        self,
    ):
        ...
        required_phrases = [
            ...
            "must fit i32",
            "test_manifest_schema_rejects_asset_importer_id_and_resource_kind_drift",
        ...
        if failures:
            self.fail(
                ...
                "asset importer semantics guard:\n" + "\n".join(failures)
            )
