...
STATUS_ID = "plugins_13_m5_t1_plugin_validate_single_retired_ui_asset_guard"
...
class PluginDocsCurrentStatusPluginValidateSingleRetiredUiAssetGuardTests(
    unittest.TestCase
):
    def test_current_status_records_plugin_validate_single_retired_ui_asset_guard(
        self,
    ):
        ...
        required_phrases = [
            ...
            "plugin validate native_dynamic_fixture",
            "test_plugin_validate_single_reports_retired_ui_asset_files",
            "test_plugin_validate_target_retired_ui_asset_files_reports_plugin_relative_paths",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record plugin validate single-target "
                "retired UI asset guard:\n" + "\n".join(failures)
            )
