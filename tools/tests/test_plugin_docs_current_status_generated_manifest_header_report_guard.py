...
STATUS_ID = "plugins_13_m5_t1_generated_manifest_header_report_guard"
...
class PluginDocsCurrentStatusGeneratedManifestHeaderReportGuardTests(unittest.TestCase):
    def test_current_status_records_generated_manifest_header_report_guard(self):
        ...
        required_phrases = [
            ...
            "Generated manifest header violations",
            "tools/tests/test_audit_plugin_structure_report.py",
            "test_report_exposes_generated_manifest_header_status",
            "missing generated manifest header",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record generated manifest header "
                "report guard:\n" + "\n".join(failures)
            )
