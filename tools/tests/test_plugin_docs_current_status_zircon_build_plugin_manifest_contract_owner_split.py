...
class PluginDocsCurrentStatusZirconBuildPluginManifestContractOwnerSplitTests(
    unittest.TestCase
):
    def test_current_status_records_zircon_build_plugin_manifest_contract_owner_split(
        self,
    ):
        repo_root = Path(__file__).resolve().parents[2]
        status_id = (
            "plugins_13_m5_t1_zircon_build_plugin_manifest_contract_owner_split"
        )
        ...
        required_phrases = [
            status_id,
            "zircon_build_plugin_manifest_contract.py",
            ...
            "optional_features",
            "feature_extensions",
            "test_plugin_manifest_contract_lives_in_plugin_manifest_contract_owner",
            "test_zircon_build_rejects_plugin_manifest_missing_distribution_forms",
            "test_zircon_build_rejects_plugin_manifest_unknown_distribution_form",
        ]
        ...
        self.assertFalse(
            failures,
            "Current status docs do not record the zircon_build plugin manifest "
