...
STATUS_ID = "plugins_13_m5_t1_manifest_schema_feature_dependency_closed_fields_guard"
...
class PluginDocsCurrentStatusManifestSchemaFeatureDependencyClosedFieldsGuardTests(
    unittest.TestCase
):
    def test_current_status_records_feature_dependency_closed_fields_guard(self):
        ...
        if failures:
            self.fail(
                ...
                "dependency closed-fields guard:\n" + "\n".join(failures)
            )
