...
class PluginDocsCurrentStatusFeatureProviderExtensionClosedFieldsGateTests(
    unittest.TestCase
):
    def test_current_status_docs_record_feature_provider_extension_closed_fields_gate(
        self,
    ):
        ...
        required_phrases = [
            ...
            "feature-provider",
            "generated feature_extensions[0]",
            "id",
            "display_name",
            "owner_plugin_id",
            "capabilities",
