...
STATUS_ID = "plugins_13_m5_t1_structure_audit_dependencies_guard"
...
class PluginDocsCurrentStatusStructureAuditDependenciesGuardTests(unittest.TestCase):
    def test_current_status_records_dependencies_guard(self):
        ...
        required_phrases = [
            ...
            "tools/plugin_structure_audits/manifest_schema_dependencies.py",
            "collect_dependencies_schema_violations",
            "DEPENDENCY_FIELDS",
            "dependencies",
            "interfaces",
            "capability",
            ...
            "test_manifest_schema_rejects_malformed_dependency_row",
            "test_manifest_schema_rejects_missing_dependency_interfaces",
