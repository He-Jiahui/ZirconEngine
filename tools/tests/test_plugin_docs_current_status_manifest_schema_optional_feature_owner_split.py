...
class PluginDocsCurrentStatusManifestSchemaOptionalFeatureOwnerSplitTests(
    unittest.TestCase
):
    def test_current_status_records_manifest_schema_optional_feature_owner_split(
        self,
    ):
        repo_root = Path(__file__).resolve().parents[2]
        status_id = "plugins_13_m5_t1_manifest_schema_optional_feature_owner_split"
        ...
        required_phrases = [
            ...
            "manifest_schema.py=593",
            "manifest_schema_optional_features.py=424",
            "test_optional_feature_schema_owner_exists",
            "test_manifest_schema_dispatches_to_optional_feature_owner",
            "test_manifest_schema_and_optional_feature_owner_stay_under_line_budgets",
