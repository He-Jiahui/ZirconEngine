...
STATUS_ID = "plugins_13_m5_t1_structure_audit_layout_targets_guard"
...
class PluginDocsCurrentStatusStructureAuditLayoutTargetsGuardTests(unittest.TestCase):
    def test_current_status_records_layout_targets_structure_audit_guard(self):
        ...
        required_phrases = [
            ...
            "collect_supported_target_values",
            ...
            "test_manifest_schema_rejects_duplicate_supported_targets",
