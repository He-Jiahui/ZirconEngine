...
STATUS_ID = "plugins_13_m5_t1_manifest_schema_package_kind_guard"
...
class PluginDocsCurrentStatusManifestSchemaPackageKindGuardTests(
    unittest.TestCase
):
    def test_current_status_records_manifest_schema_package_kind_guard(self):
        ...
        required_phrases = [
            ...
            "collect_root_metadata_schema_violations",
            "collect_root_package_kind_violations",
            "root_metadata_table_array_count",
            "package_kind",
            "standard",
            "feature_extension",
            ...
            "test_manifest_schema_rejects_package_kind_row_mismatch",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record manifest schema package_kind "
                "guard:\n" + "\n".join(failures)
            )
