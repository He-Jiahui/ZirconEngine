...
STATUS_ID = "plugins_13_m5_t1_structure_audit_feature_provider_package_projection_guard"
...
class PluginDocsCurrentStatusStructureAuditFeatureProviderPackageProjectionGuardTests(
    unittest.TestCase
):
    def test_current_status_records_feature_provider_package_projection_guard(self):
        ...
        required_phrases = [
            STATUS_ID,
            "tools/plugin_structure_audits/manifest_schema_feature_provider_packages.py",
            ...
            "tools/tests/test_plugin_structure_audit_manifest_schema_feature_provider_packages.py",
            "test_manifest_schema_audits_feature_provider_generated_package_projection",
        ...
        if failures:
            self.fail(
                ...
                "feature-provider package projection guard:\n" + "\n".join(failures)
            )
