...
STATUS_ID = "plugins_13_m5_t1_structure_audit_global_manifest_identities_guard"
...
class PluginDocsCurrentStatusStructureAuditGlobalIdentitiesGuardTests(
    unittest.TestCase
):
    def test_current_status_records_global_identity_structure_audit_guard(self):
        ...
        required_phrases = [
            STATUS_ID,
            "tools/plugin_structure_audits/manifest_schema_global_identities.py",
            "collect_global_manifest_identity_violations",
            "loaded_manifests",
            "plugin validate asset_importers id",
            "plugin validate options key",
            "test_manifest_schema_rejects_global_asset_importer_id_duplicates",
            "test_manifest_schema_rejects_global_option_key_duplicates",
        ...
        if failures:
            self.fail(
                ...
                "global manifest identities guard:\n" + "\n".join(failures)
            )
