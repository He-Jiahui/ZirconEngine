...
class PluginDocsCurrentStatusDistributionAssetsZuiDocumentGateTests(
    unittest.TestCase
):
    def test_current_status_records_distribution_assets_zui_document_gate(
        self,
    ):
        repo_root = Path(__file__).resolve().parents[2]
        status_id = (
            "plugins_13_m5_t1_plugin_validate_distribution_assets_zui_document_gate"
        )
