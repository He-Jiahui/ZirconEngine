...
STATUS_ID = "plugins_13_m5_t1_plugin_validate_feature_provider_module_projection_gate"
...
class PluginDocsCurrentStatusFeatureProviderModuleProjectionGateTests(
    unittest.TestCase
):
    def test_current_status_docs_record_feature_provider_module_projection_gate(
        self,
    ):
        ...
        required_phrases = [
            STATUS_ID,
            "plugin_validate_feature_provider_modules.py",
            ...
            "generated feature_extensions[0].modules",
            "must contain exactly one runtime module table",
            "must equal generated distribution.dist_crate",
            "must match owner optional feature runtime module.target_modes",
            ...
            "test_feature_provider_modules_lives_in_modules_owner",
