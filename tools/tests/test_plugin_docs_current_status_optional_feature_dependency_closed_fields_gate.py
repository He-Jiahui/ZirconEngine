...
STATUS_ID = "plugins_13_m5_t1_plugin_validate_optional_feature_dependency_closed_fields_gate"
...
class PluginDocsCurrentStatusOptionalFeatureDependencyClosedFieldsGateTests(
    unittest.TestCase
):
    def test_current_status_docs_record_optional_feature_dependency_closed_fields_gate(
        self,
    ):
