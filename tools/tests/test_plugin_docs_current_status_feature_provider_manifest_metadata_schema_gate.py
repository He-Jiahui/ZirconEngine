...
STATUS_ID = "plugins_13_m5_t1_plugin_validate_feature_provider_manifest_metadata_schema_gate"
...
class PluginDocsCurrentStatusFeatureProviderManifestMetadataSchemaGateTests(
    unittest.TestCase
):
    def test_current_status_docs_record_feature_provider_manifest_metadata_schema_gate(
        self,
    ):
        ...
        required_phrases = [
            ...
            "present generated manifest metadata",
