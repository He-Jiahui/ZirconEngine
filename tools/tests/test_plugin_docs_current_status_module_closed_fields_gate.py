...
STATUS_ID = "plugins_13_m5_t1_plugin_validate_module_closed_fields_gate"
...
class PluginValidateModuleClosedFieldsStatusTests(unittest.TestCase):
    def test_current_status_docs_record_module_closed_fields_gate(self):
        required_phrases = [
            STATUS_ID,
        ...
        self.assertFalse(
            missing,
            "PluginValidate module closed-fields status is incomplete:\n"
            + "\n".join(missing),
        )
