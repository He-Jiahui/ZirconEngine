...
STATUS_ID = "plugins_13_m5_t1_structure_audit_options_guard"
...
class PluginDocsCurrentStatusStructureAuditOptionsGuardTests(unittest.TestCase):
    def test_current_status_records_options_guard(self):
        ...
        required_phrases = [
            ...
            "tools/plugin_structure_audits/manifest_schema_options.py",
            "collect_options_schema_violations",
            "OPTION_FIELDS",
            "OPTION_VALUE_TYPES",
            "options",
            "enum_values",
            ...
            "test_manifest_schema_rejects_malformed_option_row",
            "test_manifest_schema_rejects_enum_option_drift",
            "test_manifest_schema_rejects_malformed_option_default_values",
