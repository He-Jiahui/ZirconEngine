...
class PluginDocsCurrentStatusFeatureProviderManifestDescriptionTests(
    unittest.TestCase
):
    def test_current_status_docs_record_manifest_description_gate(self) -> None:
        ...
        required_phrases = [
            STATUS_ID,
            "plugin_validate_feature_provider_manifest_description.py",
            ...
            "test_plugin_validate_rejects_generated_feature_provider_manifest_description_drift",
