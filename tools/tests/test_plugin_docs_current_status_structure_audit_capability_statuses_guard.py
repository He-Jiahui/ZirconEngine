...
STATUS_ID = "plugins_13_m5_t1_structure_audit_capability_statuses_guard"
...
class PluginDocsCurrentStatusStructureAuditCapabilityStatusesGuardTests(
    unittest.TestCase
):
    def test_current_status_records_capability_statuses_guard(self):
        ...
        required_phrases = [
            ...
            "tools/plugin_structure_audits/manifest_schema_capability_statuses.py",
            ...
            "test_manifest_schema_rejects_malformed_capability_status_row",
            "test_manifest_schema_rejects_capability_status_target_modes",
            "test_manifest_schema_rejects_capability_status_bevy_references",
