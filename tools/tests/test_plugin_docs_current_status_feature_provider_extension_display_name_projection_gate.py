...
class PluginDocsCurrentStatusFeatureProviderExtensionDisplayNameTests(
    unittest.TestCase
):
    def test_current_status_docs_record_feature_provider_display_name_gate(
        self,
    ) -> None:
        ...
        required_phrases = [
            STATUS_ID,
            "plugin_validate_feature_provider_extension_metadata.py",
            "validate_plugin_feature_provider_extension_display_name",
            "test_plugin_validate_feature_provider_extension_metadata.py",
            "generated feature_extensions[0].display_name",
            "must match owner optional feature display_name",
            "test_plugin_validate_rejects_generated_feature_provider_display_name_drift",
