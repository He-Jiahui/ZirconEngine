...
class PluginDocsCurrentStatusManifestSchemaFeatureExtensionClosedFieldsGuardTests(
    unittest.TestCase
):
    def test_current_status_records_manifest_schema_feature_extension_closed_fields_guard(
        self,
    ):
