...
STATUS_ID = "plugins_13_m5_t1_structure_audit_root_manifest_shape_guard"
...
class PluginDocsCurrentStatusStructureAuditRootManifestShapeGuardTests(
    unittest.TestCase
):
    def test_current_status_records_root_manifest_shape_guard(self):
        ...
        required_phrases = [
            ...
            "collect_root_manifest_identity_violations",
            "collect_root_manifest_version_violations",
            "MANIFEST_VERSION_FIELDS",
            "MANIFEST_SEMVER_COMPONENTS",
            "MANIFEST_U32_MAX",
            "must start with a lowercase ASCII letter",
            "must use MAJOR.MINOR.PATCH form",
            "must not use leading zeroes",
            "must fit in u32",
            "test_plugin_structure_audit_manifest_schema_root_shape.py",
            "test_manifest_schema_rejects_root_id_semantics",
            "test_manifest_schema_rejects_root_version_shape",
            "test_manifest_schema_rejects_root_version_numeric_boundaries",
