...
STATUS_ID = (
    ...
    "default_packaging_projection_gate"
)
...
class PluginDocsCurrentStatusFeatureProviderExtensionDefaultPackagingTests(
    unittest.TestCase
):
    def test_current_status_docs_record_feature_provider_default_packaging_gate(
        self,
    ) -> None:
        ...
        if failures:
            self.fail(
                ...
                "default_packaging projection gate:\n" + "\n".join(failures)
            )
