...
class PluginDocsCurrentStatusFeatureProviderManifestDisplayNameTests(
    unittest.TestCase
):
    def test_current_status_docs_record_manifest_display_name_gate(self) -> None:
        ...
        required_phrases = [
            ...
            "generated manifest.display_name",
            "feature_extensions[0].display_name + Provider",
            "test_plugin_validate_rejects_generated_feature_provider_manifest_display_name_drift",
            "test_feature_provider_manifest_display_name_projection_stays_in_schema_owner",
