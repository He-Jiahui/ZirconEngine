...
STATUS_ID = "plugins_13_m5_t1_structure_audit_feature_distribution_contract_guard"
...
class PluginDocsCurrentStatusStructureAuditFeatureDistributionContractGuardTests(
    unittest.TestCase
):
    def test_current_status_records_feature_distribution_contract_guard(self):
        ...
        required_phrases = [
            ...
            "tools/plugin_structure_audits/manifest_schema_optional_features.py",
            ...
            "test_plugin_structure_audit_manifest_schema_feature_distribution_contract.py",
            "test_manifest_schema_rejects_optional_feature_distribution_contract",
            "test_manifest_schema_rejects_feature_extension_distribution_contract",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record structure-audit feature "
                "distribution contract guard:\n" + "\n".join(failures)
            )
