...
class PluginDocsCurrentStatusSourceTemplateBuildValidationStatusOwnerSplitTests(
    unittest.TestCase
):
    def test_current_status_records_source_template_build_validation_status_owner_split(
        self,
    ):
        repo_root = Path(__file__).resolve().parents[2]
        status_id = (
            "plugins_13_m5_t1_source_template_build_validation_status_owner_split"
        )
        ...
        required_phrases = [
            status_id,
            "tools/zircon_export/pipeline_report_source_template_build_status.py",
            "tools/zircon_export/pipeline_report_source_template_build_handoff.py=413",
            "tools/zircon_export/tests/test_pipeline_report_source_template_build_validation.py=793",
            ...
            "test_source_template_build_validation_status_tests_live_in_status_owner",
            "python -m unittest tools.zircon_export.tests.test_pipeline_report_source_template_build_validation",
            "tools.zircon_export.tests.test_pipeline_report_source_template_build_validation_status",
            "tools.tests.test_zircon_export_source_template_build_handoff_owner_boundaries",
            "32/32",
            "py_compile",
        ]
