...
STATUS_ID = "plugins_13_m5_t1_structure_audit_option_required_capability_gate"
...
class PluginDocsCurrentStatusStructureAuditOptionCapabilityGateGuardTests(
    unittest.TestCase
):
    def test_current_status_records_option_required_capability_gate(self):
        ...
        required_phrases = [
            STATUS_ID,
            "tools/plugin_structure_audits/manifest_schema_option_capability_gates.py",
            ...
            "test_manifest_schema_rejects_undeclared_option_required_capability",
            "test_manifest_schema_accepts_optional_feature_option_required_capability",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record structure-audit option "
