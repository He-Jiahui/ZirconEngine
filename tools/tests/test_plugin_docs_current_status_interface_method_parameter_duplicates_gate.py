...
class PluginDocsCurrentStatusInterfaceMethodParameterDuplicatesGateTests(
    unittest.TestCase
):
    def test_current_status_records_interface_method_parameter_duplicates_gate(
        self,
    ) -> None:
        repo_root = Path(__file__).resolve().parents[2]
        status_id = "plugins_13_m5_t1_plugin_validate_interface_method_parameter_duplicates_gate"
        ...
        required_phrases = [
            ...
            "test_plugin_validate_rejects_duplicate_interface_method_parameters",
