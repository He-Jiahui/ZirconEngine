...
STATUS_ID = "plugins_13_m5_t1_structure_audit_distribution_closed_fields_guard"
...
class PluginDocsCurrentStatusStructureAuditDistributionClosedFieldsGuardTests(
    unittest.TestCase
):
    def test_current_status_records_distribution_closed_fields_guard(self):
        ...
        required_phrases = [
            ...
            "test_distribution_section_rejects_unknown_root_distribution_field",
            "test_distribution_section_rejects_unknown_feature_distribution_field",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record structure-audit distribution "
                "closed-fields guard:\n" + "\n".join(failures)
            )
