...
class PluginDocsCurrentStatusFeatureProviderManifestRequiredMetadataTests(
    unittest.TestCase
):
    def test_current_status_docs_record_manifest_required_metadata_gate(self) -> None:
        ...
        required_phrases = [
            STATUS_ID,
            "plugin_validate_feature_provider_manifest_required_metadata.py",
            ...
            "manifest.supported_platforms is required",
            "test_plugin_validate_rejects_generated_feature_provider_manifest_missing_metadata",
            "test_feature_provider_manifest_required_metadata_stays_in_required_metadata_leaf",
