...
class PluginBuildDocsStatusOwnerSplitDocsTests(unittest.TestCase):
    def test_plugin_build_docs_status_owner_split_is_recorded(self) -> None:
        ...
        required_phrases = [
            ...
            "test_plugin_docs_current_status_plugin_build_owner_splits.py",
            "test_plugin_docs_current_status_plugin_build_owner_boundaries.py",
