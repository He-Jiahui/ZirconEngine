...
STATUS_ID = (
    "plugins_13_m5_t1_plugin_validate_feature_provider_manifest_"
    "supported_targets_projection_gate"
)
...
class PluginDocsCurrentStatusFeatureProviderManifestSupportedTargetsTests(
    unittest.TestCase
):
    def test_current_status_docs_record_manifest_supported_targets_gate(self) -> None:
        ...
        required_phrases = [
            STATUS_ID,
            "plugin_validate_feature_provider_manifest_schema.py",
            "plugin_validate_feature_provider_manifest_supported_targets_projection",
            "test_plugin_validate_feature_provider_manifest_metadata.py",
            "generated manifest.supported_targets",
            "feature_extensions[0].modules[0].target_modes",
            "test_plugin_validate_rejects_generated_feature_provider_manifest_supported_targets_drift",
            "test_feature_provider_manifest_supported_targets_projection_stays_in_schema_owner",
        ...
        if failures:
            self.fail(
                ...
                "supported_targets projection gate:\n" + "\n".join(failures)
            )
