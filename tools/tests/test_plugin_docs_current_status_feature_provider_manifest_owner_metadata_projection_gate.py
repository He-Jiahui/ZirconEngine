...
STATUS_ID = (
    ...
    "owner_metadata_projection_gate"
)
...
class PluginDocsCurrentStatusFeatureProviderManifestOwnerMetadataTests(
    unittest.TestCase
):
    def test_current_status_docs_record_manifest_owner_metadata_gate(self) -> None:
        ...
        required_phrases = [
            STATUS_ID,
            "plugin_validate_feature_provider_manifest_owner_metadata.py",
            "validate_plugin_feature_provider_manifest_owner_metadata",
            "generated manifest.version",
            "owner manifest.version",
            "generated manifest.sdk_api_version",
            "owner manifest.sdk_api_version",
            "generated manifest.supported_platforms",
            "owner manifest.supported_platforms",
            "test_plugin_validate_rejects_generated_feature_provider_manifest_owner_metadata_drift",
            "test_feature_provider_manifest_owner_metadata_projection_stays_in_owner_metadata_leaf",
        ...
        if failures:
            self.fail(
                ...
                "owner metadata projection gate:\n" + "\n".join(failures)
            )
