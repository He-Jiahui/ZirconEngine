...
STATUS_ID = "plugins_13_m5_t1_plugin_validate_feature_provider_test_owner_budget_recovered"
...
class PluginDocsCurrentStatusFeatureProviderTestOwnerBudgetTests(unittest.TestCase):
    def test_current_status_docs_record_feature_provider_test_owner_budget(self):
        ...
        required_phrases = [
            STATUS_ID,
            "tools/zircon_export/tests/test_plugin_validate_feature_provider.py<=380",
            "test_plugin_validate_feature_provider_manifest_schema.py",
            "test_plugin_validate_feature_provider_module_schema.py",
            ...
            "python -m unittest tools.tests.test_plugin_validate_feature_provider_test_owner_boundaries",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record feature-provider test owner "
                "budget recovery:\n" + "\n".join(failures)
            )
