...
STATUS_ID = "plugins_13_m5_t1_structure_audit_asset_importers_zui_suffix_guard"
...
class PluginDocsCurrentStatusStructureAuditAssetImportersZuiSuffixGuardTests(
    unittest.TestCase
):
    def test_current_status_records_asset_importers_zui_suffix_guard(self):
        ...
        required_phrases = [
            ...
            "ASSET_IMPORTER_FIELDS",
            "asset_importers",
            "full_suffixes",
            "source_extensions",
            "declares retired UI asset suffix",
            ...
            "test_manifest_schema_rejects_asset_importer_missing_source_selector",
        ...
        if failures:
            self.fail(
                ...
                "asset_importers .zui suffix guard:\n" + "\n".join(failures)
            )
