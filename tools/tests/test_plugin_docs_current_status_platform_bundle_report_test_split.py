...
class PluginDocsCurrentStatusPlatformBundleReportTestSplitTests(unittest.TestCase):
    def test_current_status_records_platform_bundle_report_test_split(self):
        repo_root = Path(__file__).resolve().parents[2]
        status_id = "plugins_09_e1_platform_bundle_report_test_owner_split"
        ...
        required_phrases = [
            status_id,
            "tools/zircon_export/tests/test_pipeline_report_platform_bundle.py=456",
            "tools/zircon_export/tests/test_pipeline_report_platform_bundle_native_plugins_payload.py=594",
            ...
            "python -m unittest tools.zircon_export.tests.test_pipeline_report_platform_bundle tools.zircon_export.tests.test_pipeline_report_platform_bundle_native_plugins_payload",
            "41/41",
            "python -m unittest tools.tests.test_zircon_export_platform_bundle_report_test_owner_boundaries",
            "3/3",
            "py_compile",
        ]
