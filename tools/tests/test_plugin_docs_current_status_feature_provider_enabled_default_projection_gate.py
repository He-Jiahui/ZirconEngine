...
STATUS_ID = (
    "plugins_13_m5_t1_plugin_validate_feature_provider_enabled_default_"
    "projection_gate"
)
...
class PluginDocsCurrentStatusFeatureProviderEnabledDefaultProjectionGateTests(
    unittest.TestCase
):
    def test_current_status_docs_record_feature_provider_enabled_default_gate(
        self,
    ) -> None:
        ...
        required_phrases = [
            ...
            "generated feature_extensions[0].enabled_by_default",
            "must be a bool",
        ...
        if failures:
            self.fail(
                ...
                "enabled_by_default projection gate:\n" + "\n".join(failures)
            )
