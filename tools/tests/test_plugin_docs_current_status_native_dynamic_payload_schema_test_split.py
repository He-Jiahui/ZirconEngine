...
class PluginDocsCurrentStatusNativeDynamicPayloadSchemaTestSplitTests(
    unittest.TestCase
):
    def test_current_status_records_native_dynamic_payload_schema_test_split(
        self,
    ):
        repo_root = Path(__file__).resolve().parents[2]
        status_id = (
            "plugins_13_m5_t1_native_dynamic_payload_schema_test_owner_split"
        )
        ...
        required_phrases = [
            status_id,
            "tools/zircon_export/tests/test_pipeline_report_native_dynamic_payload_schema.py=879",
            "tools/zircon_export/tests/test_pipeline_report_native_dynamic_payload_package_report_schema.py=192",
            ...
            "test_payload_package_report_schema_tests_have_dedicated_owner",
            "python -m unittest tools.zircon_export.tests.test_pipeline_report_native_dynamic_payload_schema tools.zircon_export.tests.test_pipeline_report_native_dynamic_payload_package_report_schema",
            "38/38",
            "python -m unittest tools.tests.test_zircon_export_native_dynamic_payload_schema_test_owner_boundaries",
            "4/4",
            "py_compile",
        ]
