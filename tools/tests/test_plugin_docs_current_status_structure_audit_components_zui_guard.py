...
STATUS_ID = "plugins_13_m5_t1_structure_audit_components_zui_guard"
...
class PluginDocsCurrentStatusStructureAuditComponentsZuiGuardTests(unittest.TestCase):
    def test_current_status_records_components_zui_guard(self):
        ...
        required_phrases = [
            ...
            "tools/plugin_structure_audits/manifest_schema_components.py",
            "collect_components_schema_violations",
            "COMPONENT_FIELDS",
            ...
            "duplicates component type_id",
            "test_manifest_schema_rejects_malformed_component_row",
            "test_manifest_schema_rejects_duplicate_component_identity",
            "test_manifest_schema_rejects_ui_component_retired_document_path",
