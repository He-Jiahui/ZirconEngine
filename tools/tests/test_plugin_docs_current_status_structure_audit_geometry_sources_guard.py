...
STATUS_ID = "plugins_13_m5_t1_structure_audit_geometry_sources_guard"
...
class PluginDocsCurrentStatusStructureAuditGeometrySourcesGuardTests(unittest.TestCase):
    def test_current_status_records_geometry_sources_structure_audit_guard(self):
        ...
        required_phrases = [
            STATUS_ID,
            "tools/plugin_structure_audits/manifest_schema_geometry_sources.py",
            ...
            "custom:<name>",
            "test_manifest_schema_rejects_geometry_source_descriptor_shape",
            "test_manifest_schema_rejects_shader_permutation_geometry_source_id_mismatch",
