...
STATUS_ID = "plugins_13_m5_t1_manifest_schema_root_capabilities_guard"
...
class PluginDocsCurrentStatusManifestSchemaRootCapabilitiesGuardTests(
    unittest.TestCase
):
    def test_current_status_records_manifest_schema_root_capabilities_guard(self):
        ...
        required_phrases = [
            ...
            "collect_root_capability_violations",
            ...
            "test_manifest_schema_rejects_root_capability_semantics",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record manifest schema root "
                "capabilities guard:\n" + "\n".join(failures)
            )
