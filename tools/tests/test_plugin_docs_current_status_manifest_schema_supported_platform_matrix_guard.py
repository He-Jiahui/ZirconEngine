...
STATUS_ID = "plugins_13_m5_t1_manifest_schema_supported_platform_matrix_guard"
...
class PluginDocsCurrentStatusManifestSchemaSupportedPlatformMatrixGuardTests(
    unittest.TestCase
):
    def test_current_status_records_manifest_schema_supported_platform_matrix_guard(
        self,
    ):
        ...
        required_phrases = [
            ...
            "collect_supported_platform_values",
            "supported_platforms",
            "android",
            "ios",
            "web_gpu",
            ...
            "test_manifest_schema_accepts_extended_supported_platform_values",
            "test_manifest_schema_rejects_supported_platform_alias_duplicates",
        ...
        if failures:
            self.fail(
                "Current plugin docs do not record manifest schema supported "
                "platform matrix guard:\n" + "\n".join(failures)
            )
