...
STATUS_ID = "plugins_13_m5_t1_structure_audit_root_category_guard"
...
class PluginDocsCurrentStatusStructureAuditRootCategoryGuardTests(unittest.TestCase):
    def test_current_status_records_root_category_guard(self):
        ...
        required_phrases = [
            ...
            "test_plugin_structure_audit_manifest_schema_root_classification.py",
            "test_manifest_schema_rejects_unknown_root_category",
