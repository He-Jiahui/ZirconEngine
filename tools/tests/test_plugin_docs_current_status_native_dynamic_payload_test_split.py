...
class PluginDocsCurrentStatusNativeDynamicPayloadTestSplitTests(unittest.TestCase):
    def test_current_status_records_native_dynamic_payload_test_split(self):
        repo_root = Path(__file__).resolve().parents[2]
        status_id = "plugins_13_m5_t1_native_dynamic_payload_test_owner_split"
        ...
        required_phrases = [
            status_id,
            "tools/zircon_export/tests/test_pipeline_report_native_dynamic_payload.py=562",
            "tools/zircon_export/tests/test_pipeline_report_native_dynamic_payload_package_report.py=604",
            ...
            "test_payload_package_report_tests_have_dedicated_owner",
            "python -m unittest tools.zircon_export.tests.test_pipeline_report_native_dynamic_payload tools.zircon_export.tests.test_pipeline_report_native_dynamic_payload_package_report",
            "23/23",
            "python -m unittest tools.tests.test_zircon_export_native_dynamic_payload_test_owner_boundaries",
            "3/3",
            "py_compile",
        ]
