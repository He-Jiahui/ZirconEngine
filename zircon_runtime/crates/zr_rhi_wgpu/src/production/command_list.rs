...
/// Production-owned neutral command recording. This intentionally owns no
/// native WGPU references: submit validates handles against the active device
/// generation immediately before encoding.
#[derive(Clone, Debug)]
pub(crate) struct WgpuCommandList {
