...
pub(crate) struct NativeBitmapAtlasSourceCacheFrameReport {
    ...
    pub(crate) worker_completion_stale_page_generation_count: usize,
...
impl NativeBitmapAtlasSourceCache {
    ...
    pub(crate) fn discard_all_for_idle_frame(&mut self) -> NativeBitmapAtlasSourceCacheFrameReport {
        self.begin_frame();
    ...
    pub(crate) fn has_pending_worker_request(&self, cache_key: CacheKey) -> bool {
        let cache_key = native_bitmap_atlas_stable_raster_cache_key(cache_key);
