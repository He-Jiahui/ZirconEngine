...
use crate::text::{
    BackendShapeRequest, FontFaceId, InstancedFaceId, ShapedGlyph, ShapedGlyphRun, TextOrientation,
};

use super::backend::{shape_horizontal_run, HorizontalBackendRun};
use crate::text::shaping::vertical::source_cluster_text;
...
pub(in crate::text::shaping) fn apply_horizontal_backend_shaping(
...
fn segment_source_range(segment: &[SourceCluster<'_>]) -> TextRange {
    TextRange {
        start: segment
            .iter()
