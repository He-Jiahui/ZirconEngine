    ...
    device
        .create_pipeline(
            &PipelineDesc::new("viewport-pipeline", PipelineKind::Raster)
                ...
                .with_raster_state(
                    crate::rhi::RasterPipelineStateDesc::single_color(
...
fn command_list_records_viewport_and_scissor_inside_render_pass() {
    ...
    assert_eq!(
        ...
        &[
            ...
            crate::rhi::CommandListCommand::SetViewport { viewport },
            crate::rhi::CommandListCommand::SetScissorRect { rect: scissor },
