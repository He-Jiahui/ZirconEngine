...
pub use vm::{
    ...
    VmPluginSlotState, VmStateBlob, ZrVmBackend, ZrVmBackendFamily, ZrVmExecutionMode,
    ZrVmPluginProjectSource, BRIDGE_HOST_CAPABILITY, BRIDGE_HOST_MODULE, PLUGIN_HOST_DRIVER_NAME,
