...
pub use vm::{
    ...
    HostHandle, HostRegistry, HotReloadCoordinator, PluginHostDriver, PluginSlotId, ScriptModule,
    ...
    VmPluginPackageSource, VmPluginSlotLifecycle, VmPluginSlotRecord, VmStateBlob,
