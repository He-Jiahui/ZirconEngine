...
pub use vm::{
    ...
    discover_vm_plugin_package_with_limits, discover_vm_plugin_packages,
    discover_vm_plugin_packages_with_limits, migrate_vm_state_blob, module_descriptor,
    register_bridge_host_module, register_builtin_host_modules, register_gameplay_host_module,
    render_script_host_modules_markdown, script_float, write_script_host_modules_markdown,
    ...
    ScriptSceneRuntimeSystem, UnavailableVmBackend, VmBackend, VmBackendFamily, VmBackendRegistry,
    ...
    VmPluginDiscoveryLimits, VmPluginDiscoveryRequest, VmPluginGarbageCollectionMode,
    ...
    VmPluginManagementPolicyResult, VmPluginManager, VmPluginManifest, VmPluginMemoryPolicy,
    VmPluginPackage, VmPluginPackageSource, VmPluginSlotLifecycle, VmPluginSlotRecord,
