...
impl RenderFramework for FakeRenderFramework {
    ...
    fn query_stats(&self) -> Result<RenderStats, RenderFrameworkError> {
        Ok(RenderStats {
            ...
            last_motion_vector_previous_object_history_count: 3,
            last_motion_vector_current_object_history_count: 4,
            last_motion_vector_matched_object_history_count: 2,
            last_motion_vector_missing_object_history_count: 2,
