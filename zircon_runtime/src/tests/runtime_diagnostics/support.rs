...
impl RenderFramework for FakeRenderFramework {
    ...
    fn query_stats(&self) -> Result<RenderStats, RenderFrameworkError> {
        Ok(RenderStats {
            ...
            last_hzb_occlusion_readback_pending_count: 2,
            last_hzb_occlusion_readback_dropped_count: 1,
            last_hzb_occlusion_readback_oldest_pending_age_frames: Some(3),
            ...
            last_hybrid_gi_radiance_cache_resident_probe_count: 11,
            last_hybrid_gi_radiance_cache_update_probe_count: 12,
            last_hybrid_gi_radiance_cache_truncated_demand_count: 12,
            last_hybrid_gi_radiance_cache_generation: 13,
            last_hybrid_gi_radiance_cache_scroll_count: 14,
            last_hybrid_gi_radiance_cache_history_clear_count: 15,
            last_hybrid_gi_radiance_cache_gpu_stage_dispatch_counts: [1, 2, 3, 4, 5, 6],
            ...
            last_hybrid_gi_global_sdf_cpu_prepare_time_us: 1500,
            last_hybrid_gi_global_sdf_cpu_mesh_object_collection_time_us: 200,
            last_hybrid_gi_global_sdf_cpu_mesh_scene_sync_time_us: 300,
            last_hybrid_gi_global_sdf_cpu_residency_time_us: 400,
            last_hybrid_gi_global_sdf_cpu_influence_update_time_us: 100,
            last_hybrid_gi_global_sdf_cpu_candidate_build_time_us: 500,
            last_hybrid_gi_global_sdf_mesh_projection_cache_hit: true,
            last_hybrid_gi_global_sdf_object_count: 24,
            last_hybrid_gi_global_sdf_resident_page_count: 25,
            last_hybrid_gi_global_sdf_sampleable_page_count: 26,
            last_hybrid_gi_global_sdf_dirty_page_count: 27,
            last_hybrid_gi_global_sdf_dispatched_page_count: 28,
            last_hybrid_gi_global_sdf_uploaded_page_count: 29,
            last_hybrid_gi_global_sdf_deferred_page_count: 30,
            last_hybrid_gi_global_sdf_candidate_overflow_page_count: 31,
            last_hybrid_gi_global_sdf_candidate_contributor_count: 32,
            last_hybrid_gi_global_sdf_clipmap_fallback_count: 2,
            last_hybrid_gi_global_sdf_candidate_bucket_capacity_bytes: 768,
            last_hybrid_gi_global_sdf_persistent_resource_byte_count: 4096,
            last_hybrid_gi_global_sdf_transient_buffer_creation_count: 7,
            last_hybrid_gi_global_sdf_transient_bind_group_creation_count: 1,
            last_hybrid_gi_global_sdf_transient_parameter_upload_byte_count: 16,
            last_hybrid_gi_global_sdf_transient_page_upload_byte_count: 36,
            last_hybrid_gi_global_sdf_transient_mesh_upload_byte_count: 432,
            last_hybrid_gi_global_sdf_transient_completion_upload_byte_count: 4,
            last_hybrid_gi_global_sdf_transient_upload_byte_count: 488,
