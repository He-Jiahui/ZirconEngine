use super::{assert_contains_all, runtime_numbered_archive_sources};
...
const CHILD_PATHS: &[&str] = &[
    ...
    "plan_status/support/runtime_plan_archives.rs",
...
fn runtime_15_plan_status_support_helpers_are_folder_backed() {
    ...
    let child_sources = [
        ...
        include_str!("runtime_plan_archives.rs"),
    ...
    assert_contains_all(
        ...
        &[
            ...
            "runtime_numbered_archive_sources",
    ...
    for moved_helper in [
        ...
        "fn runtime_numbered_archive_source",
    ] {
        assert!(
    ...
    for (path, source, max_lines) in [
        ...
        (CHILD_PATHS[5], child_sources[5], 80),
