...
pub(super) const STRUCTURE_GUARD_CHILDREN_BUDGET_STATUS_CHILD_SPLIT: &[&str] = &[
...
pub(super) const STRUCTURE_GUARD_CHILDREN_ROOT_INVENTORY_CHILD_SPLIT: &[&str] = &[
    "runtime_15_code_review_findings_structure_guard_children_root_inventory_child_split_static_passed_cargo_deferred",
