...
pub(super) const RUNTIME_03_MODULE_DOC_STATUS_INDEX_ANCHOR_SYNC: Slice = (
...
pub(super) const RUNTIME_07_SCENE_ASSET_STATUS_ANCHOR_SYNC: Slice = (
...
pub(super) const RUNTIME_07_OWNER_BUDGET_STATUS_ANCHOR_SYNC: Slice = (
...
pub(super) const RUNTIME_02_GENERATED_STATUS_ANCHOR_SYNC: Slice = (
...
pub(super) const RUNTIME_10_BEHAVIOR_STATUS_ANCHOR_SYNC: Slice = (
