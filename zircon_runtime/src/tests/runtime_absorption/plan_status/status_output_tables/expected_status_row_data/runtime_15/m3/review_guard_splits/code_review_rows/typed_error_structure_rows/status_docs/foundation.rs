pub(in super::super) const STATUS_DOC_GUARD_FOLDER_BACKED_SPLIT: &[&str] = &[
...
pub(in super::super) const DOC_MIRRORS_FOLDER_BACKED_SPLIT: &[&str] = &[
...
pub(in super::super) const DOC_MIRRORS_SOURCE_HELPER_CHILD_SPLIT: &[&str] = &[
    ...
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_child_owners/status_docs/doc_mirrors.rs",
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_child_owners/status_docs/doc_mirrors/child_inventory.rs",
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_child_owners/status_docs/doc_mirrors/metadata.rs",
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_child_owners/status_docs/doc_mirrors/source_helper_ownership.rs",
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_child_owners/status_docs/doc_mirrors/source_helper_status.rs",
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_child_owners/status_docs/doc_mirrors/sources.rs",
    "runtime_15_typed_error_status_doc_mirrors_source_helpers_are_child_backed",
    "runtime_15_typed_error_status_doc_mirrors_source_helper_status_is_current",
    "Cargo gate deferred",
];

pub(in super::super) const STATUS_DOC_SOURCE_HELPER_CHILD_SPLIT: &[&str] = &[
