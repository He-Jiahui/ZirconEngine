...
pub(super) const EXPECTED_STATUS_OUTPUT_SLICES: &[Slice] = &[
    ...
    (
        ...
        &[
            ...
            "tests/runtime_absorption/performance_hotspots/hotspot_inventory/split_layout/source_inventory.rs",
            "tests/runtime_absorption/performance_hotspots/hotspot_inventory/split_layout/status_docs.rs",
    ...
    (
        ...
        &[
            ...
            "runtime_15_runtime_07_owner_budget_split_layout_guard_folder_backed_split",
            "expected_test_file_count = 57",
        ],
    ),
    (
