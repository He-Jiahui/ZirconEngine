pub(super) fn expected_date_for_slice(slice: &str) -> Option<&'static str> {
    match slice {
        ...
        "Runtime 15 M3 priority plan docs row-data guard folder-backed split" => Some("2026-07-04"),
        "Runtime 15 M3 priority plan docs status-mirror child split" => Some("2026-07-05"),
        "Runtime 15 M3 priority plan docs root inventory child split" => Some("2026-07-06"),
        ...
        "Runtime 15 M3 asset-budget row-data source/status-map sync" => Some("2026-07-08"),
        "Runtime 15 M3 asset-budget asset-tests row-data child split" => Some("2026-07-07"),
        "Runtime 15 M3 asset-budget asset-tests guard folder-backed split" => Some("2026-07-07"),
        ...
        "Runtime 15 M3 scene-script plugin-extension row-data child split" => Some("2026-07-07"),
        "Runtime 15 M3 scene-script plugin-extension guard folder-backed split" => {
            Some("2026-07-07")
        }
        "Runtime 15 M3 review status-sync row-data child split" => Some("2026-07-07"),
        "Runtime 15 M3 UI tests first row-data child split" => Some("2026-07-07"),
        "Runtime 15 M3 UI tests second row-data child split" => Some("2026-07-07"),
        _ => None,
    }
}
