pub(super) fn expected_status_for_slice(slice: &str) -> Option<&'static str> {
    match slice {
        "Runtime 15 M3 generated-code guard folder-backed split" => {
            Some("runtime_15_generated_code_guard_folder_backed_static_passed_cargo_deferred")
        }
        "Runtime 15 M3 input-stack absorption guard folder-backed split" => Some(
            "runtime_15_input_stack_absorption_guard_folder_backed_static_passed_cargo_deferred",
        ),
        "Runtime 15 M3 input-stack inventory guard folder-backed split" => Some(
        ...
        "Runtime 15 M3 ECS kernel data guard folder-backed split" => {
            Some("runtime_15_ecs_kernel_data_guard_folder_backed_static_passed_cargo_deferred")
        }
        "Runtime 15 M3 script host ledger guard folder-backed split" => {
            Some("runtime_15_script_host_ledger_guard_folder_backed_static_passed_cargo_deferred")
        }
        "Runtime 15 M3 dynamic API session shared data folder-backed split" => Some(
            "runtime_15_dynamic_api_session_shared_data_folder_backed_static_passed_cargo_deferred",
        ),
        "Runtime 15 M3 plugin surface lifecycle guard folder-backed split" => Some(
