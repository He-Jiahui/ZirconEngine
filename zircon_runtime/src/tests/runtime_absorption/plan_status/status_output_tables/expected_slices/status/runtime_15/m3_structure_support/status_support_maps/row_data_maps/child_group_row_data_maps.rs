...
pub(super) fn expected_status_for_slice(slice: &str) -> Option<&'static str> {
    status_doc_maps::expected_status_for_slice(slice)
        .or_else(|| row_data_maps::expected_status_for_slice(slice))
        .or_else(|| status_row_doc_maps::expected_status_for_slice(slice))
        .or_else(|| moved_row_maps::expected_status_for_slice(slice))
