...
pub(super) fn expected_status_for_slice(slice: &str) -> &'static str {
    if let Some(value) = runtime_01_05::expected_status_for_slice(slice) {
        value
    } else if let Some(value) = runtime_06_10::expected_status_for_slice(slice) {
        value
    } else if let Some(value) = runtime_11_14::expected_status_for_slice(slice) {
        value
    } else {
