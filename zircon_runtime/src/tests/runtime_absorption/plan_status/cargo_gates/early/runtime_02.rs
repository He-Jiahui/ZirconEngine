...
fn runtime_02_core_spine_root_surface_cargo_gate_stays_visible_until_validation() {
    ...
    assert_contains_all(
        ...
        runtime_02_plan,
        &[
            r".\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_runtime -LibTests -TestFilter core::",
            r".\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_runtime -SkipBuild -LibTests -TestFilter runtime_absorption",
            r".\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_app",
            r".\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_editor -SkipTest",
            r".\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -ManifestPath zircon_plugins/Cargo.toml -SkipTest",
            r".\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_runtime -LibTests -TestFilter generated",
            r".\.codex\skills\zircon-dev\scripts\validate-matrix.ps1 -Package zircon_runtime -SkipBuild -LibTests -TestFilter export_build_plan",
