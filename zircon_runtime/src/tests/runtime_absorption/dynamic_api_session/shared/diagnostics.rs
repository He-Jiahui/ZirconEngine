pub(in super::super) const EXPECTED_RUNTIME_10_RUNTIME_DIAGNOSTICS_ANCHORS: &[(&str, &str)] = &[
    (
...
pub(in super::super) const EXPECTED_RUNTIME_10_SCENE_ASSET_RELOAD_DIAGNOSTIC_PATH_ANCHORS: &[(
    &str,
    &str,
)] = &[
    (
