...
const STATUS: &str = "runtime_15_asset_dynamic_texture_container_guard_child_owner_split_static_passed_cargo_deferred";
const SLICE: &str = "Runtime 15 M3 asset-dynamic naming texture-container guard child-owner split";
const GUARD: &str = "runtime_15_asset_dynamic_texture_container_guards_are_child_owner";

#[test]
fn runtime_15_asset_dynamic_texture_container_guards_are_child_owner() {
    let parent =
    ...
    assert_contains_all(
        "Runtime 15 asset-dynamic naming parent mounts texture-container child owner",
        &parent,
        &[
    ...
    for moved_test in [
        ...
        assert!(
            ...
            "runtime_15_m2/asset_dynamic.rs should mount texture_containers child instead of defining {moved_test}"
        );
    }
    for moved_test in [
    ...
    assert_contains_all(
        "Runtime 15 asset-dynamic texture-container child owns texture/DDS naming guards",
        &child,
        &[
            "use super::*;",
            "fn runtime_15_asset_texture_upload_readiness_container_fixtures_uses_owner_name",
            "fn runtime_15_dds_upload_policy_uses_classic_container_names",
            "container_fixtures.rs",
    ...
    assert_contains_all(
        "Runtime 15 status/date maps record asset-dynamic texture-container child owner",
        &format!("{status_map}\n{date_map}"),
