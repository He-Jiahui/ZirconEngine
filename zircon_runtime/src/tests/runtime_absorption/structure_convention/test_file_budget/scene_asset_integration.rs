...
fn runtime_15_scene_asset_integration_tests_are_folder_backed() {
    ...
    let status_map = [
        ...
        read_runtime_src(
            "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/status/runtime_15/m3_structure_support/scene_ecs_maps.rs",
        ),
    ]
    .join("\n");
    let date_map = [
        ...
        read_runtime_src(
            "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/date/runtime_15/m3_structure_support/scene_ecs_maps.rs",
        ),
    ]
    .join("\n");
