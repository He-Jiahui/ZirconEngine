...
#[path = "runtime_15_m3_row_data/budgets.rs"]
mod budgets;
#[path = "runtime_15_m3_row_data/delegation.rs"]
mod delegation;
#[path = "runtime_15_m3_row_data/row_ownership.rs"]
mod row_ownership;
#[path = "runtime_15_m3_row_data/status_mirrors.rs"]
mod status_mirrors;
...
pub(super) const RUNTIME_15_M3_ROW_DATA_GUARD_PATH: &str =
...
pub(super) const FOLDER_BACKED_GUARD_NAME: &str = "runtime_15_m3_row_data_guard_is_folder_backed";

pub(super) const RUNTIME_15_M3_ROW_DATA_GUARD_CHILDREN: &[(&str, &str, &str)] = &[
    (
        "delegation",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_m3_row_data/delegation.rs",
    ...
    (
        "status_mirrors",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_m3_row_data/status_mirrors.rs",
        "runtime_15_m3_row_data_guard_folder_backed_status_mirrors_are_current",
    ),
    (
        "budgets",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_m3_row_data/budgets.rs",
        "runtime_15_m3_row_data_guard_children_stay_focused",
    ),
];

pub(super) const RUNTIME_15_M3_ROW_OWNER_PATHS: &[(&str, &str, usize)] = &[
    (
        "structure_convention/test_file_budget/status_output_row_data/runtime_15_m3_row_data.rs",
        RUNTIME_15_M3_ROW_DATA_GUARD_PATH,
        120,
    ),
    (
...
pub(super) fn runtime_15_m3_row_data_guard_child_source_blob() -> String {
    let mut blob = String::new();
    for (_, path, _) in RUNTIME_15_M3_ROW_DATA_GUARD_CHILDREN {
