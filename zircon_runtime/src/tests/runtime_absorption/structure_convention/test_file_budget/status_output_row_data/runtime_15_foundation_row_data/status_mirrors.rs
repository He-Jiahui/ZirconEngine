...
#[test]
fn runtime_15_foundation_row_data_folder_backed_status_mirrors_are_current() {
    ...
    assert_contains_all(
        "Runtime 15 status-support map records foundation row-data folder-backed split",
        &expected_status_map,
        &[FOLDER_BACKED_STATUS_NAME, FOLDER_BACKED_STATUS_ID],
    );
    assert_contains_all(
        "Runtime 15 status-support date map records foundation row-data folder-backed split",
        &expected_date_map,
