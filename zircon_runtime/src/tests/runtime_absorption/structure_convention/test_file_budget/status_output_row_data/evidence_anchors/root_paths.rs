...
pub(super) const ROOT_PATHS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/evidence_anchors/root_paths.rs";
pub(super) const ROOT_STATUSES_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/evidence_anchors/root_statuses.rs";
pub(super) const ROOT_CHILD_ROWS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/evidence_anchors/root_child_rows.rs";
pub(super) const ROOT_OWNER_PATHS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/evidence_anchors/root_owner_paths.rs";
pub(super) const ROOT_INVENTORY_GUARD_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/evidence_anchors/root_inventory.rs";
