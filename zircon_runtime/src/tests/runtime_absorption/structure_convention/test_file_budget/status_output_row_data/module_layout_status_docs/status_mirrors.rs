...
const CHILD_SPLIT_STATUS_MIRROR_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/module_layout_status_docs/status_mirrors/child_split_status.rs";
...
fn runtime_15_module_layout_status_doc_status_mirror_children_are_folder_backed() {
    ...
    for forbidden in [
        ...
        assert!(
            ...
            "module_layout_status_docs/status_mirrors.rs should delegate status mirror groups"
        );
    }
}
