...
#[path = "runtime_15_m4_row_data/budgets.rs"]
mod budgets;
#[path = "runtime_15_m4_row_data/delegation.rs"]
mod delegation;
#[path = "runtime_15_m4_row_data/row_ownership.rs"]
mod row_ownership;
#[path = "runtime_15_m4_row_data/status_mirrors.rs"]
mod status_mirrors;
...
pub(super) const FOLDER_BACKED_GUARD_NAME: &str = "runtime_15_m4_row_data_guard_is_folder_backed";
...
pub(super) fn runtime_15_m4_row_data_guard_child_source_blob() -> String {
    let mut blob = String::new();
    for (_, path, _) in RUNTIME_15_M4_ROW_DATA_GUARD_CHILDREN {
