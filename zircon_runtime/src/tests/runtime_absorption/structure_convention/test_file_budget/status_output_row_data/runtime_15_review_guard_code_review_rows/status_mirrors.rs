...
#[path = "status_mirrors/code_review_owner.rs"]
mod code_review_owner;
#[path = "status_mirrors/folder_backed.rs"]
mod folder_backed;
#[path = "status_mirrors/structure_guard_rows.rs"]
...
const CHILD_SPLIT_STATUS_MIRROR_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/status_mirrors/child_split_status.rs";
const CODE_REVIEW_OWNER_STATUS_MIRROR_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/status_mirrors/code_review_owner.rs";
const STRUCTURE_GUARD_STATUS_MIRROR_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/status_mirrors/structure_guard_rows.rs";
const FOLDER_BACKED_STATUS_MIRROR_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/status_mirrors/folder_backed.rs";
