...
const PLUGIN_IMPORTER_STATUS_OUTPUT_GUARD_CHILDREN: &[(&str, &str, &str)] = &[
    (
        "budgets",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/plugin_importer_rows/budgets.rs",
        "runtime_15_plugin_importer_rows_status_output_guard_children_line_budgets_are_current",
    ),
    (
        "child_split_status",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/plugin_importer_rows/child_split_status.rs",
        "runtime_15_plugin_importer_status_output_guard_folder_backed_status_is_current",
    ),
    (
        "delegation",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/plugin_importer_rows/delegation.rs",
        PLUGIN_IMPORTER_ROWS_ROW_DATA_GUARD_NAME,
    ),
    (
        "row_children",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/plugin_importer_rows/row_children.rs",
        "assert_plugin_importer_row_data_children_are_current",
    ),
    (
        "row_data_status",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/plugin_importer_rows/row_data_status.rs",
        "assert_plugin_importer_row_data_owner_status_row_is_current",
    ),
    (
        "status_mirrors",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_output_row_data/runtime_15_review_guard_code_review_rows/plugin_importer_rows/status_mirrors.rs",
...
fn runtime_15_plugin_importer_rows_status_output_guard_is_folder_backed() {
    ...
    for (module_name, path, guard_name) in PLUGIN_IMPORTER_STATUS_OUTPUT_GUARD_CHILDREN {
        ...
        assert_contains_all(
            ...
            &route_source,
            &[module_mount.as_str(), *guard_name],
        );
