...
fn runtime_15_m3_child_group_status_docs_root_inventory_is_child_owned() {
    ...
    assert_contains_all(
        ...
        &parent,
        &[
            "#[path = \"runtime_15_m3_child_group_status/root_paths.rs\"]",
            "#[path = \"runtime_15_m3_child_group_status/root_statuses.rs\"]",
            "#[path = \"runtime_15_m3_child_group_status/root_child_rows.rs\"]",
            "#[path = \"runtime_15_m3_child_group_status/root_source_blobs.rs\"]",
            "#[path = \"runtime_15_m3_child_group_status/root_inventory.rs\"]",
        ],
    );
