...
pub(super) const DIRECT_ASSERTION_GUARD_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_direct_assertion_rows.rs";
pub(super) const ROOT_PATHS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_direct_assertion_rows/root_paths.rs";
pub(super) const ROOT_STATUSES_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_direct_assertion_rows/root_statuses.rs";
pub(super) const ROOT_CHILD_ROWS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_direct_assertion_rows/root_child_rows.rs";
pub(super) const ROOT_SOURCE_BLOBS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_direct_assertion_rows/root_source_blobs.rs";
...
pub(super) const DIRECT_ASSERTION_CORE_ROWS_PATH: &str =
...
pub(super) const DIRECT_ASSERTION_F12_ROWS_PATH: &str =
...
pub(super) const DIRECT_ASSERTION_ROOT_PARENT_ROWS_PATH: &str =
...
pub(super) const DIRECT_ASSERTION_RENDER_ROWS_PATH: &str =
...
pub(super) const DIRECT_ASSERTION_F8_ROWS_PATH: &str =
...
pub(super) const DIRECT_ASSERTION_P0_ROWS_PATH: &str =
...
pub(super) const DIRECT_ASSERTION_ROW_DATA_OWNER_ROWS_PATH: &str =
