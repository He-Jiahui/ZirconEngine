...
const STATUS_SUPPORT_ROWS_PATH: &str = "tests/runtime_absorption/plan_status/status_output_tables/expected_status_row_data/runtime_15/m3/production_guard_support/review_guard.rs";
...
const STATUS_MIRRORS_ROUTE_PATH: &str = "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_row_data/status_mirrors.rs";
const CHILD_SPLIT_STATUS_PATH: &str = "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_row_data/mirrors/child_split_status.rs";
const FOLDER_BACKED_STATUS_PATH: &str = "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_row_data/mirrors/folder_backed_status.rs";
...
const STATUS_MIRROR_CHILDREN: &[(&str, &str, &str)] = &[
    (
        ...
        "runtime_15_review_guard_row_data_status_mirror_status_rows_are_current",
    ),
    (
...
#[test]
fn runtime_15_review_guard_row_data_status_mirror_children_are_child_owned() {
    ...
    for (module_name, path, guard_name) in STATUS_MIRROR_CHILDREN {
        ...
        assert_contains_all(
            "Runtime 15 M3 review-guard row-data status-mirror route mounts child",
            &route_source,
    ...
    for forbidden in [
        ...
        ["let runtime_", "index ="].concat(),
        ["let review_", "findings ="].concat(),
        ["let structure_", "convention ="].concat(),
        ["let module_", "doc ="].concat(),
        ["let session_", "note ="].concat(),
        ["let status_", "support_rows ="].concat(),
        ["let status_", "support_status_map ="].concat(),
        ["let status_", "support_date_map ="].concat(),
    ] {
        assert!(
