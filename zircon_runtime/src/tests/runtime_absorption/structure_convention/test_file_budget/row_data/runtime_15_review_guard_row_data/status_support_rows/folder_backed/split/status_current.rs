...
#[test]
fn runtime_15_review_guard_status_support_folder_backed_guard_status_is_current() {
    ...
    let status_anchors = [
        STATUS_SUPPORT_ROWS_FOLDER_BACKED_GUARD_FOLDER_BACKED_STATUS_NAME,
        STATUS_SUPPORT_ROWS_FOLDER_BACKED_GUARD_FOLDER_BACKED_STATUS_ID,
    ...
    assert_contains_all(
        "review status map records folder-backed guard split",
        &status_map,
        &[
            STATUS_SUPPORT_ROWS_FOLDER_BACKED_GUARD_FOLDER_BACKED_STATUS_NAME,
            STATUS_SUPPORT_ROWS_FOLDER_BACKED_GUARD_FOLDER_BACKED_STATUS_ID,
    ...
    assert_contains_all(
        "review date map records folder-backed guard split",
        &date_map,
        &[
            STATUS_SUPPORT_ROWS_FOLDER_BACKED_GUARD_FOLDER_BACKED_STATUS_NAME,
            "2026-07-06",
