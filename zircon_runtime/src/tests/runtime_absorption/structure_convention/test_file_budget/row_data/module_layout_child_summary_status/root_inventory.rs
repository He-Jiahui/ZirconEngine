...
fn runtime_15_module_layout_child_summary_status_docs_root_inventory_is_child_owned() {
    ...
    assert_contains_all(
        ...
        &parent,
        &[
            "#[path = \"module_layout_child_summary_status/root_paths.rs\"]",
            "#[path = \"module_layout_child_summary_status/root_statuses.rs\"]",
            "#[path = \"module_layout_child_summary_status/root_child_rows.rs\"]",
            "#[path = \"module_layout_child_summary_status/root_source_blobs.rs\"]",
            "#[path = \"module_layout_child_summary_status/root_inventory.rs\"]",
        ],
    );
