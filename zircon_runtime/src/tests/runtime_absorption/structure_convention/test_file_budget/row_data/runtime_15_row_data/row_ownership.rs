...
const ROW_OWNERSHIP_CHILDREN: &[(&str, &str, &str)] = &[
    (
        "foundation_rows",
        "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_row_data/row_ownership/foundation_rows.rs",
    ...
    (
        "owner_budgets",
        "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_row_data/row_ownership/owner_budgets.rs",
        "runtime_15_row_data_owner_budgets_are_child_owned",
    ),
    (
        "status_support",
        "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_row_data/row_ownership/status_support.rs",
...
fn runtime_15_runtime_15_row_data_row_ownership_children_are_child_owned() {
    ...
    let row_data = read_runtime_src(RUNTIME_15_ROW_DATA_STATUS_ROWS_PATH);
