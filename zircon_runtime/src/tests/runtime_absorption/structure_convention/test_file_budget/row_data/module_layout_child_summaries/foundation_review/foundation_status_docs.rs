...
fn runtime_15_module_layout_child_summary_foundation_status_docs_are_child_owned() {
    ...
    let runtime_15_foundation_row_data_status_doc_root_statuses = read_runtime_src(
    ...
    let runtime_15_foundation_row_data_status_doc_delegation = read_runtime_src(
        "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_foundation_row_data_status/delegation.rs",
    );
    let runtime_15_foundation_row_data_status_doc_status_maps = read_runtime_src(
        "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_foundation_row_data_status/status_maps.rs",
    );
    let runtime_15_foundation_row_data_status_doc_doc_mirrors = read_runtime_src(
        "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_foundation_row_data_status/doc_mirrors.rs",
    );
    ...
    assert_contains_all(
        ...
        &(runtime_15_foundation_row_data_status_docs
            + "\n"
            + &runtime_15_foundation_row_data_status_doc_root_statuses),
        &[
