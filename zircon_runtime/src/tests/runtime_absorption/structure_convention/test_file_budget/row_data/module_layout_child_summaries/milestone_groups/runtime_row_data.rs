...
fn runtime_15_module_layout_child_summary_runtime_row_data_groups_are_child_owned() {
    ...
    let runtime_15_m4_row_data = format!(
        ...
        read_runtime_src(
            "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_m4_row_data/row_ownership.rs",
        )
    );
    ...
    let runtime_15_m2_row_data = format!(
        ...
        read_runtime_src(
            "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_m2_row_data/row_ownership.rs",
        ),
        read_runtime_src(
    ...
    let runtime_15_m3_row_data_parent = read_runtime_src(
        "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_m3_row_data.rs",
    );
    let runtime_15_m3_row_data = format!(
        "{}\n{}",
        runtime_15_m3_row_data_parent,
        read_runtime_src(
            "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_m3_row_data/row_ownership.rs",
        )
    );
