...
const STATUS_MIRRORS_ROUTE_PATH: &str = "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_asset_budget_row_data/status_mirrors.rs";
const CHILD_SPLIT_STATUS_PATH: &str = "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_asset_budget_row_data/mirrors/child_split_status.rs";
const HISTORICAL_STATUS_PATH: &str = "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_asset_budget_row_data/mirrors/historical_status.rs";
const FOLDER_BACKED_STATUS_PATH: &str = "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_asset_budget_row_data/mirrors/folder_backed_status.rs";
...
const STATUS_MIRROR_CHILDREN: &[(&str, &str, &str)] = &[
    (
        ...
        "runtime_15_asset_budget_row_data_status_mirror_status_rows_are_current",
    ),
    (
        "historical_status",
        HISTORICAL_STATUS_PATH,
        "runtime_15_asset_budget_row_data_historical_status_is_current",
    ),
    (
...
#[test]
fn runtime_15_asset_budget_row_data_status_mirror_children_are_child_owned() {
    ...
    for (module_name, path, guard_name) in STATUS_MIRROR_CHILDREN {
        ...
        assert_contains_all(
            "asset-budget row-data status-mirror route mounts child",
            &route_source,
