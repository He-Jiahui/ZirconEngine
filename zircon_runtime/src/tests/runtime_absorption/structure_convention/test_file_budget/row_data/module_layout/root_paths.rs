...
pub(super) const ROOT_PATHS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/module_layout/root_paths.rs";
pub(super) const ROOT_STATUSES_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/module_layout/root_statuses.rs";
pub(super) const ROOT_CHILD_ROWS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/module_layout/root_child_rows.rs";
pub(super) const ROOT_OWNER_PATHS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/module_layout/root_owner_paths.rs";
...
pub(super) const MODULE_LAYOUT_CHILD_SUMMARY_DELEGATION_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/module_layout_child_summaries/delegation.rs";
