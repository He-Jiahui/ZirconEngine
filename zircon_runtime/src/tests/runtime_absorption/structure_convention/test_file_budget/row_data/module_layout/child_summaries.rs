...
fn runtime_15_status_output_row_data_module_layout_child_summaries_stay_delegated() {
    ...
    let module_layout_child_summary_status_rows =
        read_runtime_src(PRODUCTION_GUARD_SUPPORT_MODULE_LAYOUT_CHILD_SUMMARY_ROWS_PATH);
    let module_layout_child_summaries = format!(
        "{}\n{}",
        read_runtime_src(MODULE_LAYOUT_CHILD_SUMMARIES_PATH),
        module_layout_child_summary_status_rows
    );
