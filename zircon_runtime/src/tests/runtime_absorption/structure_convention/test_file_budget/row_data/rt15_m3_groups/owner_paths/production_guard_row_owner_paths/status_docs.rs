...
pub(in super::super::super) const PRODUCTION_GUARD_STATUS_DOCS_OWNER_PATHS: &[(
    &str,
    &str,
    usize,
)] = &[
    (
        ...
        PRODUCTION_GUARD_SUPPORT_STATUS_DOCS_FOUNDATION_M2_ROWS_PATH,
        140,
    ),
    (
        ...
        PRODUCTION_GUARD_SUPPORT_STATUS_DOCS_CHILD_GROUP_STATUS_DOC_ROWS_PATH,
        90,
    ),
    (
        ...
        PRODUCTION_GUARD_SUPPORT_STATUS_DOCS_CHILD_GROUP_STATUS_ROW_DOC_ROWS_PATH,
        90,
    ),
    (
        ...
        PRODUCTION_GUARD_SUPPORT_STATUS_DOCS_CHILD_GROUP_MOVED_ROW_ROWS_PATH,
        90,
    ),
];
