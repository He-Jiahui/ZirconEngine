...
fn runtime_15_m3_child_group_moved_module_convention_rows_are_child_owned() {
    ...
    let module_convention_status = MODULE_CONVENTION_STATUS_ROW_CHILD_PATHS
        .iter()
    ...
    for moved_module_convention_row in [
        ...
        assert!(
            ...
            "module_convention_status child row owners should own moved module-convention status row {moved_module_convention_row}"
        );
    }
}
