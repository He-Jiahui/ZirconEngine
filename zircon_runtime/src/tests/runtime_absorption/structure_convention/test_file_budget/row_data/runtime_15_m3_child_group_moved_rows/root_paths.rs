...
pub(super) const ROOT_PATHS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_m3_child_group_moved_rows/root_paths.rs";
...
pub(super) const ROOT_CHILD_ROWS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_m3_child_group_moved_rows/root_child_rows.rs";
pub(super) const ROOT_SOURCE_BLOBS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_m3_child_group_moved_rows/root_source_blobs.rs";
