...
pub(super) const CODE_REVIEW_ROWS_GUARD_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_code_review_rows.rs";
pub(super) const ROOT_PATHS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_code_review_rows/root_paths.rs";
pub(super) const ROOT_STATUSES_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_code_review_rows/root_statuses.rs";
pub(super) const ROOT_CHILD_ROWS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_code_review_rows/root_child_rows.rs";
pub(super) const ROOT_SOURCE_BLOBS_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_code_review_rows/root_source_blobs.rs";
pub(super) const ROOT_INVENTORY_GUARD_PATH: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/row_data/runtime_15_review_guard_code_review_rows/root_inventory.rs";
...
pub(super) const REVIEW_GUARD_ROW_DATA_OWNER_PATH: &str =
...
pub(super) const TYPED_ERROR_STRUCTURE_ROW_DATA_OWNER_PATH: &str =
...
pub(super) const PLUGIN_IMPORTER_REVIEW_GUARDS_PATH: &str =
...
pub(super) const PLUGIN_IMPORTER_STATUS_DOCS_PATH: &str =
...
pub(super) const PLUGIN_IMPORTER_SOURCE_INVENTORY_PATH: &str =
...
pub(super) const PLUGIN_IMPORTER_STRUCTURE_ASSERTIONS_PATH: &str =
...
pub(super) const PLUGIN_IMPORTER_ROW_DATA_OWNER_PATH: &str =
...
pub(super) const STATUS_SUPPORT_REVIEW_GUARD_CODE_REVIEW_ROWS_PATH: &str =
...
pub(super) const STATUS_SUPPORT_REVIEW_GUARD_ROW_DATA_ROWS_PATH: &str =
