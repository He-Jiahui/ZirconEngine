...
fn runtime_15_test_file_budget_root_layout_status_scan_is_child_owner() {
    ...
    for path in [
        ...
        "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/module_layout/body/budgets.rs",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/module_layout/body/child_ownership.rs",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/module_layout/body/folder_backed.rs",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/module_layout/body/paths.rs",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/module_layout/body/route_mounts.rs",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/module_layout/body/status_mirrors.rs",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/maps.rs",
        "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/maps/guard_body.rs",
