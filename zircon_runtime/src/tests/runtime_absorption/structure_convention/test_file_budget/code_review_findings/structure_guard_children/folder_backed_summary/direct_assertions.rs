...
fn folder_backed_summary_direct_assertion_child_tree() -> String {
    [
        ...
        read_runtime_src(
            FOLDER_BACKED_SUMMARY_DIRECT_ASSERTIONS_CHILD_OWNERSHIP_DELEGATION_CHILD_OWNER,
        ),
        read_runtime_src(
            FOLDER_BACKED_SUMMARY_DIRECT_ASSERTIONS_CHILD_OWNERSHIP_PARENT_ABSENCE_CHILD_OWNER,
        ),
        read_runtime_src(
            FOLDER_BACKED_SUMMARY_DIRECT_ASSERTIONS_CHILD_OWNERSHIP_ENTRY_POINTS_CHILD_OWNER,
        ),
        read_runtime_src(
        ...
        read_runtime_src(FOLDER_BACKED_SUMMARY_F8_DIRECT_ASSERTIONS_PARENT_MOUNTS_CHILD_OWNER),
        read_runtime_src(FOLDER_BACKED_SUMMARY_P0_DIRECT_ASSERTIONS_CHILD_OWNER),
        read_runtime_src(FOLDER_BACKED_SUMMARY_P0_DIRECT_ASSERTIONS_PARENT_MOUNTS_CHILD_OWNER),
        read_runtime_src(FOLDER_BACKED_SUMMARY_RENDER_DIRECT_ASSERTIONS_CHILD_OWNER),
        read_runtime_src(FOLDER_BACKED_SUMMARY_RENDER_DIRECT_ASSERTIONS_REVIEW_GUARD_CHILD_OWNER),
