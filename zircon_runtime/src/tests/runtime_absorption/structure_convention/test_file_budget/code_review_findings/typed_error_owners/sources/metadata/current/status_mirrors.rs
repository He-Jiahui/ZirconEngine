...
pub(in super::super) fn assert_typed_error_source_inventory_metadata_status_current_mirrors_are_current(
    ...
    let status_rows = super::super::super::typed_error_source_inventory_status_rows_source();
    let status_map = super::super::super::typed_error_source_inventory_status_map_source();
    let date_map = super::super::super::typed_error_source_inventory_date_map_source();
    let runtime_15_plan =
