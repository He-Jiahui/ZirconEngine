...
use super::super::super::super::super::super::{
    ...
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_CHILD_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_CHILD_SPLIT_GUARD,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_CHILD_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_CHILD_SPLIT_NAME,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_CURRENT_CHILDREN_CHILD,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_GUARD,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_GUARD_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_GUARD_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_GUARD_SPLIT_NAME,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_SOURCE_SPLIT_CHILD,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_SOURCES_SPLIT_LAYOUT_CHILDREN_CHILD,
};
use super::source_tree::typed_error_status_mirrors_split_layout_sources_guard_children;
...
pub(super) fn assert_sources_child_split_status_is_current() {
    ...
    assert_status_documents_contain(
        "typed-error status mirrors split-layout sources child split",
        &anchors,
    );
...
pub(super) fn assert_sources_guard_folder_backed_status_is_current() {
    ...
    assert_status_documents_contain(
        "typed-error status mirrors split-layout sources guard folder-backed split",
        &anchors,
    );
    let status_rows = typed_error_status_row_source();
    for path in typed_error_status_mirrors_split_layout_sources_guard_children() {
        assert! (
            status_rows.contains(path),
            "typed-error status mirrors split-layout sources guard row should include child source {path}"
        );
    }
    assert_status_maps_contain(
        "typed-error status mirrors split-layout sources guard folder-backed split",
...
fn assert_status_maps_contain(label: &str, split_name: &str, split_id: &str, split_date: &str) {
    let status_map = format!(
        ...
        read_runtime_src(TYPED_ERROR_STATUS_DOC_STATUS_MIRRORS_STATUS_MAP_PATH)
    );
    let date_map = format!(
        "{}\n{}\n{}",
        read_runtime_src(REVIEW_GUARD_DATE_MAP_PATH),
        read_runtime_src(REVIEW_GUARD_TYPED_ERROR_DATE_MAP_PATH),
        read_runtime_src(TYPED_ERROR_STATUS_DOC_STATUS_MIRRORS_DATE_MAP_PATH)
    );
