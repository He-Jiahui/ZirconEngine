...
pub(in super::super) const TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SPLIT_LAYOUT_CHILDREN: &[(
    &str,
    &str,
    &str,
)] = &[
    (
        "budgets",
        TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SPLIT_LAYOUT_BUDGETS_CHILD,
        "assert_typed_error_status_doc_delegation_status_current_split_layout_children_line_budgets",
    ),
    (
        "child_inventory",
        TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SPLIT_LAYOUT_CHILD_INVENTORY_CHILD,
        "assert_typed_error_status_doc_delegation_status_current_split_layout_child_inventory",
    ),
    (
        "parent_backflow",
        TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SPLIT_LAYOUT_PARENT_BACKFLOW_CHILD,
        "assert_typed_error_status_doc_delegation_status_current_split_layout_parent_has_no_moved_checks",
    ),
    (
        "parent_mounts",
        TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SPLIT_LAYOUT_PARENT_MOUNTS_CHILD,
...
pub(in super::super) fn typed_error_status_doc_delegation_status_current_split_layout_child_sources(
...
pub(in super::super) fn typed_error_status_doc_delegation_status_current_split_layout_child_source_blob(
) -> String {
    let mut blob = String::new();
    for (_, source) in typed_error_status_doc_delegation_status_current_split_layout_child_sources()
    {
