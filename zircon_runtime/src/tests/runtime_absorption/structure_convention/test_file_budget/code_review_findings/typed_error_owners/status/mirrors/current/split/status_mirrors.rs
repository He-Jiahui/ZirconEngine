...
use super::super::super::super::{
    ...
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_ID,
    ...
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_DATE,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_GUARD,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_ID,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_NAME,
    ...
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_NAME,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_STATUS_SYNC_CHILD,
};

pub(super) fn assert_typed_error_status_mirror_status_current_status_is_current() {
    assert_status_documents_contain(
        ...
        TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_NAME,
        TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_ID,
        "M3 review date map records typed-error status-doc status mirrors status-current split",
        TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_DATE,
    );
}

pub(super) fn assert_typed_error_status_mirror_status_current_split_layout_guard_status_is_current()
{
    assert_status_documents_contain(
        &[
            TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_NAME,
        ...
        "M3 review status map records typed-error status-doc status mirrors status-current split-layout guard split",
        TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_NAME,
        TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_ID,
        "M3 review date map records typed-error status-doc status mirrors status-current split-layout guard split",
        TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SPLIT_LAYOUT_DATE,
    );
}
