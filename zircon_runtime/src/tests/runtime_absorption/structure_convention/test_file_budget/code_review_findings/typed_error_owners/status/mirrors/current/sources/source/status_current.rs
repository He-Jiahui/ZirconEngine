...
use super::super::super::super::super::{
    ...
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SOURCES_CHILD_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SOURCES_CHILD_SPLIT_GUARD,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SOURCES_CHILD_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SOURCES_CHILD_SPLIT_NAME,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SOURCES_GUARD,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SOURCES_GUARD_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SOURCES_GUARD_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_SOURCES_GUARD_SPLIT_NAME,
...
pub(super) fn assert_sources_child_split_status_is_current() {
    ...
    assert_status_documents_contain(
        "typed-error status mirrors status-current sources child split",
        &anchors,
    );
...
pub(super) fn assert_sources_guard_folder_backed_status_is_current() {
    ...
    assert_status_documents_contain(
        "typed-error status mirrors status-current sources guard folder-backed split",
        &anchors,
    );
    let status_rows = typed_error_status_row_source();
    for path in typed_error_status_mirrors_status_current_sources_guard_children() {
        assert!(
            status_rows.contains(path),
            "typed-error status mirrors status-current sources guard row should include child source {path}"
        );
    }
    assert_status_maps_contain(
        "typed-error status mirrors status-current sources guard folder-backed split",
