...
pub(super) const TYPED_ERROR_NATIVE_STRUCTURE_CHILD_INVENTORY_CHILD: &str = "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_owners/structure/native_plugin_loader/child_inventory.rs";
pub(super) const TYPED_ERROR_NATIVE_STRUCTURE_DELEGATION_CHILD: &str = "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_owners/structure/native_plugin_loader/delegation.rs";
pub(super) const TYPED_ERROR_NATIVE_STRUCTURE_METADATA_CHILD: &str = "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_owners/structure/native_plugin_loader/metadata.rs";
pub(super) const TYPED_ERROR_NATIVE_STRUCTURE_ROUTES_CHILD: &str = "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_owners/structure/native_plugin_loader/routes.rs";
