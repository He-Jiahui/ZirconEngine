...
pub(in super::super) fn typed_error_source_inventory_child_sources() -> Vec<(&'static str, String)>
{
    TYPED_ERROR_SOURCE_INVENTORY_CHILDREN
        ...
        .chain(TYPED_ERROR_SOURCE_INVENTORY_METADATA_CHILDREN.iter())
        .chain(TYPED_ERROR_SOURCE_INVENTORY_METADATA_STATUS_CURRENT_CHILDREN.iter())
...
pub(in super::super) fn typed_error_source_inventory_source_helper_child_sources(
...
pub(in super::super) fn typed_error_source_inventory_source_helper_child_source_blob() -> String {
    super::source_blobs::source_blob_from(typed_error_source_inventory_source_helper_child_sources())
}

pub(in super::super) fn typed_error_source_inventory_child_inventory_child_sources(
) -> Vec<(&'static str, String)> {
...
pub(in super::super) fn typed_error_source_inventory_child_inventory_child_source_blob() -> String {
