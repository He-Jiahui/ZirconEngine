...
use super::super::{
    TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_FOLDER_BACKED_GUARD,
    TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_FOLDER_BACKED_GUARD_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_FOLDER_BACKED_GUARD_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_FOLDER_BACKED_GUARD_SPLIT_NAME,
    TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_GUARD, TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_SPLIT_NAME,
};
...
pub(super) fn assert_status_slices_folder_backed_status_is_current() {
    let anchors = [
        TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_SPLIT_NAME,
        TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_SPLIT_ID,
        TYPED_ERROR_STATUS_DOCS_PATHS_STATUS_SLICES_CHILD,
        TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_GUARD,
        "Cargo gate deferred",
    ];

    assert_status_documents_contain("typed-error status-slices folder-backed split", &anchors);
    ...
    for path in typed_error_status_doc_status_slices_child_source_paths() {
        assert!(
            ...
            "typed-error status-slices status row should include child source {path}"
        );
    }
    assert_status_maps_contain(
        "typed-error status-slices folder-backed split",
        TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_SPLIT_NAME,
        TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_SPLIT_ID,
        TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_SPLIT_DATE,
    );
}

pub(super) fn assert_status_slices_folder_backed_guard_status_is_current() {
    let anchors = [
        TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_FOLDER_BACKED_GUARD_SPLIT_NAME,
        TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_FOLDER_BACKED_GUARD_SPLIT_ID,
        TYPED_ERROR_STATUS_DOCS_STATUS_SLICES_FOLDER_BACKED_CHILD,
    ...
    assert_status_documents_contain(
        "typed-error status-slices folder-backed guard folder-backed split",
        &anchors,
    );
    let status_rows = typed_error_status_row_source();
    for path in typed_error_status_doc_status_slices_folder_backed_guard_children() {
        assert!(
            status_rows.contains(path),
            "typed-error status-slices folder-backed guard row should include child source {path}"
        );
    }
    assert_status_maps_contain(
        "typed-error status-slices folder-backed guard folder-backed split",
