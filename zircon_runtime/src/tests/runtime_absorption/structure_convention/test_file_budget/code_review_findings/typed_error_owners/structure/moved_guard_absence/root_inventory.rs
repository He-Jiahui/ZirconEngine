...
fn runtime_15_typed_error_moved_guard_absence_root_inventory_is_child_owned() {
    ...
    let status_anchors = [
        TYPED_ERROR_MOVED_GUARD_ABSENCE_ROOT_INVENTORY_SLICE,
    ...
    assert_contains_all(
        "M3 review status map records moved-guard absence root inventory split",
        &status_map,
        &[
            TYPED_ERROR_MOVED_GUARD_ABSENCE_ROOT_INVENTORY_SLICE,
            TYPED_ERROR_MOVED_GUARD_ABSENCE_ROOT_INVENTORY_STATUS,
    ...
    assert_contains_all(
        "M3 review date map records moved-guard absence root inventory split",
        &date_map,
        &[
            TYPED_ERROR_MOVED_GUARD_ABSENCE_ROOT_INVENTORY_SLICE,
            TYPED_ERROR_MOVED_GUARD_ABSENCE_ROOT_INVENTORY_DATE,
        ],
    );
}
