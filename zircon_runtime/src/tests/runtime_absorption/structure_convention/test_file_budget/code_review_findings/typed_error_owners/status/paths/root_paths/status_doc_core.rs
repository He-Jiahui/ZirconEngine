...
pub(in super::super::super) const TYPED_ERROR_STATUS_DOCS_DOC_MIRRORS_CHILD: &str =
...
pub(in super::super::super) const TYPED_ERROR_STATUS_DOCS_PATHS_CHILD: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/typed_error_owners/status/paths.rs";
pub(in super::super::super) const TYPED_ERROR_STATUS_DOCS_SOURCE_HELPER_OWNERSHIP_CHILD: &str =
...
pub(in super::super::super) const TYPED_ERROR_STATUS_DOCS_SOURCE_HELPER_STATUS_CHILD: &str =
...
pub(in super::super::super) const TYPED_ERROR_STATUS_DOCS_SOURCES_CHILD: &str =
