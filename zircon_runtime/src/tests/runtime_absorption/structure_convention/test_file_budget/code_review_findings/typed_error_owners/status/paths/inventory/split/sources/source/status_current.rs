...
use super::super::super::super::super::super::sources::typed_error_status_row_source;
use super::super::super::super::super::review_guard_paths::{
...
use super::super::super::super::super::status_slices::{
    TYPED_ERROR_STATUS_DOCS_PATHS_CHILD_INVENTORY_SPLIT_LAYOUT_SOURCES_CHILD_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_PATHS_CHILD_INVENTORY_SPLIT_LAYOUT_SOURCES_CHILD_SPLIT_GUARD,
    TYPED_ERROR_STATUS_DOCS_PATHS_CHILD_INVENTORY_SPLIT_LAYOUT_SOURCES_CHILD_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_PATHS_CHILD_INVENTORY_SPLIT_LAYOUT_SOURCES_CHILD_SPLIT_NAME,
    TYPED_ERROR_STATUS_DOCS_PATHS_CHILD_INVENTORY_SPLIT_LAYOUT_SOURCES_GUARD,
    TYPED_ERROR_STATUS_DOCS_PATHS_CHILD_INVENTORY_SPLIT_LAYOUT_SOURCES_GUARD_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_PATHS_CHILD_INVENTORY_SPLIT_LAYOUT_SOURCES_GUARD_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_PATHS_CHILD_INVENTORY_SPLIT_LAYOUT_SOURCES_GUARD_SPLIT_NAME,
};
use super::source_tree::typed_error_paths_child_inventory_split_layout_sources_guard_children;
...
pub(super) fn assert_sources_child_split_status_is_current() {
    ...
    assert_status_documents_contain(
        "typed-error paths child-inventory split-layout sources child split",
        &anchors,
    );
...
pub(super) fn assert_sources_guard_folder_backed_status_is_current() {
    ...
    assert_status_documents_contain(
        "typed-error paths child-inventory split-layout sources guard folder-backed split",
        &anchors,
    );
    let status_rows = typed_error_status_row_source();
    for path in typed_error_paths_child_inventory_split_layout_sources_guard_children() {
        assert!(
            status_rows.contains(path),
            "typed-error status-sources guard row should include child source {path}"
        );
    }
    assert_status_maps_contain(
        "typed-error paths child-inventory split-layout sources guard folder-backed split",
