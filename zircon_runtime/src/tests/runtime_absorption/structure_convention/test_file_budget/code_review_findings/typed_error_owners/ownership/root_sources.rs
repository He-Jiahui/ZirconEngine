...
pub(super) fn typed_error_child_ownership_sources() -> TypedErrorChildOwnershipSources {
    ...
    let moved_guard_absence_child_ownership_child =
        read_runtime_src(MOVED_GUARD_ABSENCE_CHILD_OWNERSHIP_CHILD);
    ...
    let moved_guard_absence_child_tree = [
        ...
        moved_guard_absence_child_ownership_child.as_str(),
