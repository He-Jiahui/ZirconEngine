...
pub(super) const TYPED_ERROR_STRUCTURE_ASSERTIONS_CHILD: &str =
...
pub(super) const TYPED_ERROR_STRUCTURE_CONVERGENCE_MOUNTS_CHILD: &str =
...
pub(super) const TYPED_ERROR_STRUCTURE_DELEGATION_CHILD: &str =
...
pub(super) const TYPED_ERROR_STRUCTURE_CHILD_OWNERSHIP_CHILD: &str =
...
pub(super) const TYPED_ERROR_STRUCTURE_STATUS_MIRRORS_CHILD: &str =
...
pub(super) const TYPED_ERROR_STRUCTURE_MOVED_GUARD_ABSENCE_CHILD: &str =
...
pub(super) const TYPED_ERROR_NATIVE_STRUCTURE_CHILD: &str =
...
pub(super) const STRUCTURE_GUARD_TYPED_ERROR_CHILD: &str =
