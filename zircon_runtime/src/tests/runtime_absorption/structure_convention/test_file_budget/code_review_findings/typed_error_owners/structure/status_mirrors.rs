...
fn runtime_15_typed_error_structure_assertions_guard_folder_backed_status_is_current() {
    let status_rows = typed_error_structure_assertion_status_row_source();
    let status_map = typed_error_structure_assertion_status_map_source();
    let date_map = typed_error_structure_assertion_date_map_source();
    let runtime_15_plan =
