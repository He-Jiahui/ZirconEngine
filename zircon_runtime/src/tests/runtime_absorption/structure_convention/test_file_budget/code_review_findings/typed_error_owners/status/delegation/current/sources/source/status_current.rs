...
use super::super::super::super::super::{
    ...
    TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SOURCES_CHILD_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SOURCES_CHILD_SPLIT_GUARD,
    TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SOURCES_CHILD_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SOURCES_CHILD_SPLIT_NAME,
    TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SOURCES_DELEGATION_CHILDREN_CHILD,
    TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SOURCES_GUARD,
    TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SOURCES_GUARD_SPLIT_DATE,
    TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SOURCES_GUARD_SPLIT_ID,
    TYPED_ERROR_STATUS_DOCS_DELEGATION_STATUS_CURRENT_SOURCES_GUARD_SPLIT_NAME,
...
const TYPED_ERROR_STATUS_DOC_DELEGATION_STATUS_MAP_PATH: &str = "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/status/runtime_15/m3_structure_support/review_guard_maps/typed_error_maps/status_doc_rows/delegation_rows.rs";
const TYPED_ERROR_STATUS_DOC_DELEGATION_DATE_MAP_PATH: &str = "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/date/runtime_15/m3_structure_support/review_guard_maps/typed_error_maps/status_doc_rows/delegation_rows.rs";
...
pub(super) fn assert_sources_child_split_status_is_current() {
    ...
    assert_status_documents_contain(
        "typed-error delegation status-current sources child split",
        &anchors,
    );
...
pub(super) fn assert_sources_guard_folder_backed_status_is_current() {
    ...
    assert_status_documents_contain(
        "typed-error delegation status-current sources guard folder-backed split",
        &anchors,
    );
    ...
    for path in typed_error_delegation_status_current_sources_guard_children() {
        assert!(
            ...
            "typed-error delegation status-current sources guard row should include child source {path}"
        );
    }
    assert_status_maps_contain(
        "typed-error delegation status-current sources guard folder-backed split",
