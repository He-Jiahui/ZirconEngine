...
pub(in super::super) const TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_CHILDREN: &[(
    &str,
    &str,
    &str,
)] = &[
    (
        "ownership",
        TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_OWNERSHIP_CHILD,
        "assert_typed_error_status_mirrors_are_child_backed",
    ),
    (
        "status_sync",
        TYPED_ERROR_STATUS_DOCS_STATUS_MIRRORS_STATUS_CURRENT_STATUS_SYNC_CHILD,
...
pub(in super::super) fn typed_error_status_mirror_status_current_child_sources(
...
pub(in super::super) fn typed_error_status_mirror_status_current_child_source_blob() -> String {
