...
pub(super) const PLUGIN_IMPORTER_D13_PARENT_MOUNTS_CHILD_OWNERSHIP_GUARD: &str =
    "assert_plugin_importer_d13_sdk_parent_mounts_guard_is_child_backed";
...
pub(super) const PLUGIN_IMPORTER_D13_PARENT_MOUNTS_CHILDREN: &[(&str, &str, &str)] = &[
    ...
    (
        ...
        PLUGIN_IMPORTER_D13_PARENT_MOUNTS_CHILD_OWNERSHIP_GUARD,
    ),
];
