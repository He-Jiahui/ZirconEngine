...
#[test]
fn runtime_15_plugin_importer_dx_review_mounts_guard_folder_backed_status_is_current() {
    ...
    assert_contains_all(
        "M3 review status map records plugin-importer DX review mounts folder-backed split",
        &status_map,
        &[
            PLUGIN_IMPORTER_DX_REVIEW_MOUNTS_FOLDER_BACKED_SLICE,
            PLUGIN_IMPORTER_DX_REVIEW_MOUNTS_FOLDER_BACKED_STATUS,
    ...
    assert_contains_all(
        "M3 review date map records plugin-importer DX review mounts folder-backed split",
        &date_map,
        &[
            PLUGIN_IMPORTER_DX_REVIEW_MOUNTS_FOLDER_BACKED_SLICE,
            PLUGIN_IMPORTER_DX_REVIEW_MOUNTS_FOLDER_BACKED_DATE,
        ],
    );
}
