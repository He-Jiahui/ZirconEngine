...
pub(super) const P0_NATIVE_FIXTURE_BUDGETS_CHILD: &str =
...
pub(super) const P0_NATIVE_FIXTURE_DELEGATION_CHILD: &str =
...
pub(super) const P0_NATIVE_FIXTURE_LEAF_OWNERSHIP_CHILD: &str =
...
pub(super) const P0_NATIVE_FIXTURE_STATUS_MIRRORS_CHILD: &str =
...
pub(super) const P0_NATIVE_FIXTURE_ROOT_PATHS_CHILD: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/p0_native_fixture_leaf_owners/root_paths.rs";
pub(super) const P0_NATIVE_FIXTURE_ROOT_STATUSES_CHILD: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/p0_native_fixture_leaf_owners/root_statuses.rs";
pub(super) const P0_NATIVE_FIXTURE_ROOT_CHILD_ROWS_CHILD: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/p0_native_fixture_leaf_owners/root_child_rows.rs";
pub(super) const P0_NATIVE_FIXTURE_ROOT_SOURCES_CHILD: &str =
...
pub(super) const P0_NATIVE_FIXTURE_ROOT_INVENTORY_CHILD: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/code_review_findings/p0_native_fixture_leaf_owners/root_inventory.rs";

pub(super) const PARENT: &str =
    "tests/runtime_absorption/code_review_findings/p0_robustness/native_fixture.rs";
pub(super) const SDK_MACRO_LEAF: &str =
    "tests/runtime_absorption/code_review_findings/p0_robustness/native_fixture/sdk_macro_manifest.rs";
pub(super) const IMPORTER_LEAF: &str =
...
pub(super) const REVIEW_GUARD_P0_DATE_MAP: &str =
    "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/date/runtime_15/m3_structure_support/review_guard_maps/foundation_review_maps/p0_rows.rs";
