...
pub(super) fn metadata_child_source_blob() -> String {
    source_blob_from(metadata_child_sources())
}

pub(super) fn metadata_child_sources() -> Vec<(&'static str, String)> {
...
pub(super) fn metadata_status_current_child_source_blob() -> String {
    source_blob_from(metadata_status_current_child_sources())
}

pub(super) fn metadata_status_current_child_sources() -> Vec<(&'static str, String)> {
