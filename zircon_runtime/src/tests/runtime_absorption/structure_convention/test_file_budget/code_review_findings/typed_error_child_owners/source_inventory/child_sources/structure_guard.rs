...
pub(super) const TYPED_ERROR_SOURCE_INVENTORY_CHILD_SOURCES_STRUCTURE_GUARD_CHILDREN: &[(
    &str,
    &str,
    &str,
)] = &[
    (
        ...
        "pub(super) fn assert_typed_error_source_inventory_child_sources_structure_guard_is_child_backed",
    ),
    (
        "status_mirrors",
        TYPED_ERROR_SOURCE_INVENTORY_CHILD_SOURCES_STRUCTURE_GUARD_STATUS_MIRRORS_CHILD,
        "pub(super) fn assert_typed_error_source_inventory_child_sources_structure_guard_status_is_current",
    ),
    (
        "budgets",
        TYPED_ERROR_SOURCE_INVENTORY_CHILD_SOURCES_STRUCTURE_GUARD_BUDGETS_CHILD,
        "pub(super) fn assert_typed_error_source_inventory_child_sources_structure_guard_budgets_are_current",
    ),
];

pub(super) fn assert_typed_error_source_inventory_child_sources_are_folder_backed() {
