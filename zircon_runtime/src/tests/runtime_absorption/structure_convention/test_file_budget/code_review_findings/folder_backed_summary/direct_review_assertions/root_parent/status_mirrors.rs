...
#[test]
fn runtime_15_code_review_findings_root_parent_direct_assertions_guard_folder_backed_status_is_current(
) {
    ...
    assert_contains_all(
        "M3 review status map records root-parent direct assertions folder-backed split",
        &status_map,
        &[
            ROOT_PARENT_DIRECT_ASSERTIONS_FOLDER_BACKED_SLICE,
            ROOT_PARENT_DIRECT_ASSERTIONS_FOLDER_BACKED_STATUS,
    ...
    assert_contains_all(
        "M3 review date map records root-parent direct assertions folder-backed split",
        &date_map,
        &[
            ROOT_PARENT_DIRECT_ASSERTIONS_FOLDER_BACKED_SLICE,
            ROOT_PARENT_DIRECT_ASSERTIONS_FOLDER_BACKED_DATE,
        ],
    );
}
