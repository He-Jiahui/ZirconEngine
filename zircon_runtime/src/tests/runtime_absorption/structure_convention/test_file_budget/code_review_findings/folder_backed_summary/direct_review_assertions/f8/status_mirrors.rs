...
#[test]
fn runtime_15_code_review_findings_f8_direct_assertions_guard_folder_backed_status_is_current() {
    ...
    assert_contains_all(
        "M3 review status map records F8 direct assertions folder-backed split",
        &status_map,
        &[
            F8_DIRECT_ASSERTIONS_FOLDER_BACKED_SLICE,
            F8_DIRECT_ASSERTIONS_FOLDER_BACKED_STATUS,
    ...
    assert_contains_all(
        "M3 review date map records F8 direct assertions folder-backed split",
        &date_map,
        &[
            F8_DIRECT_ASSERTIONS_FOLDER_BACKED_SLICE,
            F8_DIRECT_ASSERTIONS_FOLDER_BACKED_DATE,
        ],
    );
}
