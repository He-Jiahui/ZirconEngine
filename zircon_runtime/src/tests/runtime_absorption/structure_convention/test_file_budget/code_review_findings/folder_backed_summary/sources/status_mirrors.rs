...
fn assert_source_inventory_status_mirrors_are_current() {
    let status_rows = source_inventory_status_rows_source();
    let status_map = source_inventory_status_map_source();
    let date_map = source_inventory_date_map_source();
    let runtime_15_plan =
    ...
    for (label, source) in [
        ...
        assert_contains_all(
            ...
            &[
                ...
                SOURCE_INVENTORY_MAP_SOURCE_SYNC_SPLIT_NAME,
                SOURCE_INVENTORY_MAP_SOURCE_SYNC_SPLIT_ID,
                ...
                REVIEW_GUARD_SOURCE_INVENTORY_STATUS_MAP_PATH,
    ...
    assert_contains_all(
        ...
        &[
            ...
            SOURCE_INVENTORY_MAP_SOURCE_SYNC_SPLIT_NAME,
            SOURCE_INVENTORY_MAP_SOURCE_SYNC_DATE,
        ],
    );
}
