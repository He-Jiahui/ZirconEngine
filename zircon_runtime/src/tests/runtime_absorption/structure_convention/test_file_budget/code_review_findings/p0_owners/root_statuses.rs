...
pub(super) const P0_ROOT_INVENTORY_SLICE: &str =
    "Runtime 15 M3 P0 robustness root inventory child split";
pub(super) const P0_ROOT_INVENTORY_STATUS: &str =
    "runtime_15_p0_robustness_root_inventory_child_split_static_passed_cargo_deferred";
pub(super) const P0_ROOT_INVENTORY_DATE: &str = "2026-07-04";
pub(super) const P0_ROOT_INVENTORY_GUARD: &str =
    "runtime_15_p0_robustness_root_inventory_is_child_owned";

pub(super) const P0_ROOT_CHILD_LINE_BUDGET: usize = 120;
