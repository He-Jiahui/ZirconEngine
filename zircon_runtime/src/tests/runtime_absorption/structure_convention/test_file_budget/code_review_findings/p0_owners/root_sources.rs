...
pub(in crate::tests::runtime_absorption::structure_convention::test_file_budget::code_review_findings) fn p0_structure_guard_child_source_blob(
) -> String {
    let mut blob = String::new();
    ...
    blob.push_str(&read_runtime_src(P0_ROOT_STATUSES_CHILD));
    blob.push('\n');
