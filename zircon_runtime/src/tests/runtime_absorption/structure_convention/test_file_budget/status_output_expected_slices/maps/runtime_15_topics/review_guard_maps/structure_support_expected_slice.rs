...
fn runtime_15_structure_support_expected_slice_maps_are_child_owners() {
    ...
    let status_review_typed_error_child = read_runtime_src(STATUS_REVIEW_TYPED_ERROR_CHILD);
    ...
    let date_review_typed_error_child = read_runtime_src(DATE_REVIEW_TYPED_ERROR_CHILD);
