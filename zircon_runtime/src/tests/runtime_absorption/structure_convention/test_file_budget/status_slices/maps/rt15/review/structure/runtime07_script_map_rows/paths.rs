...
pub(super) const ROWS_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_runtime_07_script_expected_slice_maps_folder_backed_static_passed_cargo_deferred";
...
pub(super) const GUARD_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_runtime_07_script_expected_slice_maps_guard_folder_backed_static_passed_cargo_deferred";
