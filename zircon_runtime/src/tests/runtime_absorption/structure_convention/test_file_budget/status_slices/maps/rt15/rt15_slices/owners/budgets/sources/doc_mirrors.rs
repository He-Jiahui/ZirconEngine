...
#[test]
fn runtime_15_status_output_runtime_15_expected_slice_child_owner_budget_sources_docs_are_synced() {
    ...
    assert_contains_all(
        "Frameworks 02 child-owner budget source inventory mirror",
        &frameworks_02,
        &[BUDGET_SOURCE_FRAMEWORKS_STATUS],
    );
}
