...
pub(super) const ROWS_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_status_support_priority_plan_doc_maps_folder_backed_static_passed_cargo_deferred";
...
pub(super) const GUARD_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_status_support_priority_plan_doc_maps_guard_folder_backed_static_passed_cargo_deferred";
pub(super) const GUARD_GUARD: &str =
    "runtime_15_status_support_priority_plan_doc_maps_guard_is_folder_backed";

pub(super) const ROWS_STATUS_PARENT: &str = "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/status/runtime_15/m3_structure_support/status_support_maps/plan_doc_support_maps/priority_plan_doc_maps.rs";
pub(super) const ROWS_DATE_PARENT: &str = "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/date/runtime_15/m3_structure_support/status_support_maps/plan_doc_support_maps/priority_plan_doc_maps.rs";

pub(super) const STRUCTURE_GUARD_PATH: &str = "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/maps/rt15/review/status/priority_plan_doc_map_rows.rs";
