pub(in super::super) const PARENT_ROUTE_GUARD_BODY_ROUTE_PATH: &str = "structure_convention/test_file_budget/status_slices/maps/rt15/review/structure/parent_routes/guard_body.rs";
pub(in super::super) const PARENT_ROUTE_GUARD_BODY_CHILDREN: &[&str] = &[
...
pub(in super::super) const PARENT_ROUTE_METADATA_ROUTE_PATH: &str = "structure_convention/test_file_budget/status_slices/maps/rt15/review/structure/parent_routes/route_metadata.rs";
pub(in super::super) const PARENT_ROUTE_METADATA_CHILDREN: &[&str] = &[
