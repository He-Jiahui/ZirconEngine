...
#[test]
fn runtime_15_status_output_runtime_15_expected_slice_child_owner_guard_body_docs_are_synced() {
    super::super::status_mirrors::assert_status_docs_for_child_owner_split();
    ...
    assert_contains_all(
        "Frameworks 02 child-owner guard-body mirror",
        &frameworks_02,
