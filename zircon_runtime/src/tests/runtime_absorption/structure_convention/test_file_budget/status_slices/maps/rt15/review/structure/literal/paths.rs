...
pub(super) const LITERAL_OWNERSHIP_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_structure_support_expected_slice_literal_ownership_folder_backed_static_passed_cargo_deferred";
...
pub(super) const LITERAL_OWNERSHIP_PARENT_PATH: &str =
...
pub(super) const LITERAL_OWNERSHIP_CHILDREN: &[&str] = &[
    ...
    "structure_convention/test_file_budget/status_slices/maps/rt15/review/structure/literal/folder_backed.rs",
    "structure_convention/test_file_budget/status_slices/maps/rt15/review/structure/literal/naming_literals.rs",
    "structure_convention/test_file_budget/status_slices/maps/rt15/review/structure/literal/paths.rs",
    "structure_convention/test_file_budget/status_slices/maps/rt15/review/structure/literal/review_literals.rs",
    "structure_convention/test_file_budget/status_slices/maps/rt15/review/structure/literal/sources.rs",
...
pub(super) const STATUS_SUPPORT_PLAN_DOC_ROUTE_CHILDREN: &[&str] = &[
    ...
    "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/status/runtime_15/m3_structure_support/status_support_maps/plan_doc_support_maps/render_shader_support_maps.rs",
];
pub(super) const DATE_SUPPORT_PLAN_DOC_ROUTE_CHILDREN: &[&str] = &[
    ...
    "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/date/runtime_15/m3_structure_support/status_support_maps/plan_doc_support_maps/render_shader_support_maps.rs",
];
