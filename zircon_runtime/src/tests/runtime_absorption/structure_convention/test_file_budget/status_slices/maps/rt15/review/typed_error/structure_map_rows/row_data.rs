...
fn runtime_15_review_guard_typed_error_structure_maps_row_data_is_synced() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "plan_status/status_output_tables/expected_slices/status/runtime_15/m3_structure_support/review_guard_maps/typed_error_structure_maps/expected_slice_map_rows.rs",
            ...
            "plan_status/status_output_tables/expected_slices/date/runtime_15/m3_structure_support/review_guard_maps/typed_error_structure_maps/moved_guard_absence_maps.rs",
            GUARD_ROUTE_PATH,
            ROWS_GUARD,
            "Cargo gate deferred",
        ],
