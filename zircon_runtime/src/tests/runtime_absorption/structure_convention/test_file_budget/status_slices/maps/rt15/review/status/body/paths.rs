...
pub(super) const GUARD_BODY_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_status_support_expected_slice_guard_body_folder_backed_static_passed_cargo_deferred";
pub(super) const GUARD_BODY_GUARD: &str =
    "runtime_15_status_support_expected_slice_guard_body_is_folder_backed";
pub(super) const GUARD_BODY_STATUS_MIRRORS_SLICE: &str =
    "Runtime 15 M3 status-support expected-slice guard body status mirrors folder-backed split";
pub(super) const GUARD_BODY_STATUS_MIRRORS_STATUS: &str =
    "runtime_15_status_support_expected_slice_guard_body_status_mirrors_folder_backed_static_passed_cargo_deferred";
pub(super) const GUARD_BODY_STATUS_MIRRORS_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_status_support_expected_slice_guard_body_status_mirrors_folder_backed_static_passed_cargo_deferred";
...
pub(super) const GUARD_BODY_STATUS_MIRROR_CHILDREN: &[&str] = &[
...
pub(super) const GUARD_BODY_STATUS_MAP_PATH: &str =
