...
#[test]
fn runtime_15_review_guard_typed_error_structure_maps_docs_are_synced() {
    ...
    for (label, source) in [
        ...
        assert_contains_all(
            ...
            &[
                ROWS_SLICE,
                ROWS_STATUS,
                "typed_error_structure_maps.rs",
                "typed_error_structure_maps/top_level_maps.rs",
                "typed_error_structure_maps/expected_slice_map_rows.rs",
                ROWS_GUARD,
                GUARD_SLICE,
                GUARD_STATUS,
    ...
    assert_contains_all(
        "Frameworks 02 typed-error structure guard mirror",
        &frameworks_02,
