...
pub(super) const ROWS_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_structure_route_status_date_maps_folder_backed_static_passed_cargo_deferred";
pub(super) const ROWS_GUARD: &str = "runtime_15_structure_route_status_date_maps_are_folder_backed";
...
pub(super) const GUARD_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_structure_route_status_date_maps_guard_folder_backed_static_passed_cargo_deferred";
pub(super) const GUARD_GUARD: &str =
    "runtime_15_structure_route_status_date_maps_guard_is_folder_backed";

pub(super) const ROWS_STATUS_PARENT: &str =
...
pub(super) const STRUCTURE_GUARD_PATH: &str = "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/maps/rt15/review/structure/structure_route_maps.rs";
