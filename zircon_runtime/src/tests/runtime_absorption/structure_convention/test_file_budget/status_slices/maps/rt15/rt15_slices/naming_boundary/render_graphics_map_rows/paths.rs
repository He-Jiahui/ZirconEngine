...
pub(super) const MAP_ROWS_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_naming_boundary_render_graphics_expected_slice_map_rows_folder_backed_static_passed_cargo_deferred";
...
pub(super) const MAP_ROWS_GUARD_STATUS: &str =
    "runtime_15_naming_boundary_render_graphics_map_rows_guard_folder_backed_static_passed_cargo_deferred";
pub(super) const MAP_ROWS_GUARD_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_naming_boundary_render_graphics_map_rows_guard_folder_backed_static_passed_cargo_deferred";
...
pub(super) const MAP_ROWS_GUARD_PARENT: &str =
    "structure_convention/test_file_budget/status_slices/maps/rt15/rt15_slices/naming_boundary/render_graphics_map_rows.rs";
pub(super) const NAMING_BOUNDARY_ROUTE_PARENT: &str =
    "tests/runtime_absorption/structure_convention/test_file_budget/status_slices/maps/rt15/rt15_slices/naming_boundary.rs";
