...
pub(super) const LITERAL_OWNERSHIP_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_status_output_runtime_15_expected_slice_child_owner_literal_ownership_folder_backed_static_passed_cargo_deferred";
pub(super) const LITERAL_OWNERSHIP_GUARD: &str =
    "runtime_15_status_output_runtime_15_expected_slice_child_owner_literal_ownership_is_folder_backed";

pub(super) const LITERAL_OWNERSHIP_ROUTE_PATH: &str = "structure_convention/test_file_budget/status_slices/maps/rt15/rt15_slices/owners/literal_ownership.rs";
pub(super) const LITERAL_OWNERSHIP_CHILDREN: &[&str] = &[
...
pub(super) const STATUS_CHILD_SOURCE_PATHS: &[&str] = &[
...
pub(super) const DATE_CHILD_SOURCE_PATHS: &[&str] = &[
...
pub(super) const BASE_EXPECTED_SLICE_ROWS: &str =
