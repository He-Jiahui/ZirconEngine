...
const STRUCTURE_ROUTE_STATUS_MAP_CHILDREN: &[&str] = &[
...
const STRUCTURE_ROUTE_DATE_MAP_CHILDREN: &[&str] = &[
...
pub(in super::super) fn read_status_structure_route_map_sources() -> String {
    read_structure_route_map_sources(
        ...
        STRUCTURE_ROUTE_STATUS_MAP_CHILDREN,
    )
}

pub(in super::super) fn read_date_structure_route_map_sources() -> String {
    read_structure_route_map_sources(
        STRUCTURE_ROUTE_DATE_MAP_PATH,
        STRUCTURE_ROUTE_DATE_MAP_CHILDREN,
    )
}
