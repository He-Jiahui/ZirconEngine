pub(in super::super::super) const SOURCES_SLICE: &str =
...
pub(in super::super::super) const SOURCES_CHILDREN: &[&str] = &[
...
pub(in super::super::super) const SOURCE_METADATA_GUARD_SLICE: &str =
    "Runtime 15 M3 review-guard source metadata folder-backed split";
pub(in super::super::super) const SOURCE_METADATA_GUARD_STATUS: &str =
    "runtime_15_review_guard_source_metadata_folder_backed_static_passed_cargo_deferred";
pub(in super::super::super) const SOURCE_METADATA_GUARD_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_review_guard_source_metadata_folder_backed_static_passed_cargo_deferred";
pub(in super::super::super) const SOURCE_METADATA_GUARD_GUARD: &str =
    "runtime_15_review_guard_source_metadata_is_folder_backed";
pub(in super::super::super) const SOURCE_METADATA_GUARD_ROUTE_PATH: &str =
    "structure_convention/test_file_budget/status_slices/maps/rt15/review/sources/metadata.rs";
pub(in super::super::super) const SOURCE_METADATA_GUARD_CHILDREN: &[&str] = &[
