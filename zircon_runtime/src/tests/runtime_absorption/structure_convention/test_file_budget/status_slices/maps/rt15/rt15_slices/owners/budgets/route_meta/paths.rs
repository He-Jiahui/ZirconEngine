...
pub(super) const BUDGET_ROUTE_METADATA_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_status_output_runtime_15_expected_slice_child_owner_budget_route_metadata_folder_backed_static_passed_cargo_deferred";
pub(super) const BUDGET_ROUTE_METADATA_GUARD: &str =
    "runtime_15_status_output_runtime_15_expected_slice_child_owner_budget_route_metadata_is_folder_backed";
