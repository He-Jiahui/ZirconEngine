...
pub(super) const GUARD_BODY_STATUS: &str = "runtime_15_review_guard_typed_error_expected_slice_guard_body_folder_backed_static_passed_cargo_deferred";
pub(super) const GUARD_BODY_FRAMEWORKS_STATUS: &str = "frameworks_02_m3_review_guard_typed_error_expected_slice_guard_body_folder_backed_static_passed_cargo_deferred";
pub(super) const GUARD_BODY_GUARD: &str =
    "runtime_15_review_guard_expected_slice_typed_error_guard_body_is_folder_backed";

pub(super) const GUARD_BODY_ROUTE_PATH: &str = "structure_convention/test_file_budget/status_slices/maps/rt15/review/typed_error/guard_body.rs";
