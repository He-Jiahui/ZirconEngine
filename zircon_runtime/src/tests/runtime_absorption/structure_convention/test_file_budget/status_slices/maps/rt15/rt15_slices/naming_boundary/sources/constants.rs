...
pub(in super::super) const STATUS: &str =
...
pub(in super::super) const SOURCES_FRAMEWORKS_STATUS: &str =
    "frameworks_02_m3_naming_boundary_expected_slice_sources_folder_backed_static_passed_cargo_deferred";
...
pub(in super::super) const SOURCES_PARENT_PATH: &str =
...
pub(in super::super) const TOP_LEVEL_SUPPORT_ROWS_PATH: &str =
...
pub(in super::super) const STRUCTURE_ROUTE_DATE_MAP_PATH: &str =
    "tests/runtime_absorption/plan_status/status_output_tables/expected_slices/date/runtime_15/m3_structure_support/structure_route_maps.rs";
