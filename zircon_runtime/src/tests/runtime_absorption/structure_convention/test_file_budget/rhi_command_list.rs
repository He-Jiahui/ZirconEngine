...
fn runtime_15_rhi_command_list_tests_are_folder_backed() {
    let parent = read_repo("zircon_runtime/crates/zr_rhi_wgpu/src/tests/command_list.rs");
    let basic_commands =
        read_repo("zircon_runtime/crates/zr_rhi_wgpu/src/tests/command_list/basic_commands.rs");
    let bind_groups =
        read_repo("zircon_runtime/crates/zr_rhi_wgpu/src/tests/command_list/bind_groups.rs");
    let raster_draws =
        read_repo("zircon_runtime/crates/zr_rhi_wgpu/src/tests/command_list/raster_draws.rs");
    let vertex_index_state =
        read_repo("zircon_runtime/crates/zr_rhi_wgpu/src/tests/command_list/vertex_index_state.rs");
    let runtime_15_plan =
