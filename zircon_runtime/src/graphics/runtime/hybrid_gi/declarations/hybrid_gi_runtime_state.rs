...
pub(in crate::graphics::runtime::hybrid_gi) struct HybridGiRuntimeProbeSceneData {
    pub(in crate::graphics::runtime::hybrid_gi) position_x_q: u32,
    pub(in crate::graphics::runtime::hybrid_gi) position_y_q: u32,
    pub(in crate::graphics::runtime::hybrid_gi) position_z_q: u32,
    pub(in crate::graphics::runtime::hybrid_gi) radius_q: u32,
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::graphics::runtime::hybrid_gi) struct HybridGiRuntimeTraceRegionSceneData {
    pub(in crate::graphics::runtime::hybrid_gi) center_x_q: u32,
    pub(in crate::graphics::runtime::hybrid_gi) center_y_q: u32,
    pub(in crate::graphics::runtime::hybrid_gi) center_z_q: u32,
    pub(in crate::graphics::runtime::hybrid_gi) radius_q: u32,
    pub(in crate::graphics::runtime::hybrid_gi) coverage_q: u32,
...
pub(crate) struct HybridGiRuntimeState {
    ...
    pub(in crate::graphics::runtime::hybrid_gi) probe_scene_data:
        BTreeMap<u32, HybridGiRuntimeProbeSceneData>,
    pub(in crate::graphics::runtime::hybrid_gi) probe_irradiance_rgb: BTreeMap<u32, [u8; 3]>,
    pub(in crate::graphics::runtime::hybrid_gi) probe_rt_lighting_rgb: BTreeMap<u32, [u8; 3]>,
    pub(in crate::graphics::runtime::hybrid_gi) trace_region_scene_data:
        BTreeMap<u32, HybridGiRuntimeTraceRegionSceneData>,
    pub(in crate::graphics::runtime::hybrid_gi) resident_slots: BTreeMap<u32, u32>,
    pub(in crate::graphics::runtime::hybrid_gi) pending_updates: Vec<HybridGiProbeUpdateRequest>,
    pub(in crate::graphics::runtime::hybrid_gi) pending_probes: BTreeSet<u32>,
