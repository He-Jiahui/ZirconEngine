...
impl HybridGiRuntimeState {
    pub(in crate::graphics::runtime::hybrid_gi) fn scene_representation(
        &self,
    ) -> &HybridGiSceneRepresentation {
        &self.scene_representation
    }

    pub(in crate::graphics::runtime::hybrid_gi) fn scene_representation_mut(
        &mut self,
    ) -> &mut HybridGiSceneRepresentation {
        &mut self.scene_representation
    }

    pub(in crate::graphics::runtime::hybrid_gi) fn scene_representation_owns_runtime(
        &self,
    ) -> bool {
