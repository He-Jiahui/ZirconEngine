...
pub(in crate::graphics::runtime::render_framework) struct ViewportRecord {
    ...
    pub(in crate::graphics::runtime::render_framework) quality_profile: Option<RenderQualityProfile>,
    pub(in crate::graphics::runtime::render_framework) compiled_pipeline: Option<CompiledRenderPipeline>,
    ...
    pub(in crate::graphics::runtime::render_framework) hybrid_gi_runtime: Option<HybridGiRuntimeState>,
