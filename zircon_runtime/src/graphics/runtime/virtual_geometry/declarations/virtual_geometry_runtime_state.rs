...
pub(crate) struct VirtualGeometryRuntimeState {
    ...
    pub(in crate::graphics::runtime::virtual_geometry) current_requested_page_order: BTreeMap<u32, usize>,
    ...
    pub(in crate::graphics::runtime::virtual_geometry) pending_requests: Vec<VirtualGeometryPageRequest>,
