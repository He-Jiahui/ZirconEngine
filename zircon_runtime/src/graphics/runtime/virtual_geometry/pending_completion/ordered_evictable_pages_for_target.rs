...
impl VirtualGeometryRuntimeState {
    pub(in crate::graphics::runtime::virtual_geometry) fn page_or_lineage_is_hot_in(
        &self,
        page_id: u32,
    ...
    pub(in crate::graphics::runtime::virtual_geometry) fn ordered_evictable_pages_for_target(
        &self,
        target_page_id: u32,
        evictable_pages: &[u32],
    ) -> Vec<u32> {
    ...
    pub(in crate::graphics::runtime::virtual_geometry) fn page_or_lineage_is_hot(
        &self,
        page_id: u32,
    ) -> bool {
