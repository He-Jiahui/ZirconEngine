...
fn parse_builtin_render_feature(value: &str) -> Result<BuiltinRenderFeature, String> {
    match value {
        ...
        "NeuralCompute" => Ok(BuiltinRenderFeature::NeuralCompute),
        ...
        "Trail" => Ok(BuiltinRenderFeature::Trail),
        "Billboard" => Ok(BuiltinRenderFeature::Billboard),
        "Tilemap" => Ok(BuiltinRenderFeature::Tilemap),
        "TextShaping" => Ok(BuiltinRenderFeature::TextShaping),
        "Skybox" => Ok(BuiltinRenderFeature::Skybox),
        "Cubemap" => Ok(BuiltinRenderFeature::Cubemap),
        "Texture2dArray" => Ok(BuiltinRenderFeature::Texture2dArray),
        "NormalMap" => Ok(BuiltinRenderFeature::NormalMap),
        "Mipmap" => Ok(BuiltinRenderFeature::Mipmap),
        "ColorSpace" => Ok(BuiltinRenderFeature::ColorSpace),
