...
use crate::core::framework::render::{
    ...
    ShaderVariantKey, ShaderVariantPrewarmExecutionBudget, ShaderVariantPrewarmManifest,
...
#[path = "tests/combined_validation_tests.rs"]
...
fn render_shader_variant_prewarm_records_wgpu_pipeline_validation_success() {
    ...
    let report =
        prewarm_shader_variants_to_disk_with_pipeline_validation(&manifest, &root, |_, _| Ok(()));
