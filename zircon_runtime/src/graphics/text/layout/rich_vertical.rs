use crate::core::framework::render::{InlineObjectRef, RichParseResult};
    ...
    F: FnMut((u32, u32), usize) -> f32,
{
    ...
    for forced_range in rich_forced_line_ranges(&parsed.text) {
        ...
        let chunks = if matches!(style.wrap, UiTextWrap::WordSmart) {
...
fn inline_size(inline: &InlineObjectRef, style: &UiResolvedStyle) -> (f32, f32) {
