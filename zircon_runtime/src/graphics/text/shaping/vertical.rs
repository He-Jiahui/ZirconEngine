use crate::core::framework::render::{
    ShapedGlyph, ShapedGlyphRun, TextOrientation, TextShapeRequest,
};
...
pub(crate) fn vertical_glyph_rotation(
    mode: crate::core::framework::render::VerticalMode,
    cluster_text: &str,
) -> crate::core::framework::render::ShapedGlyphRotation {
