...
use zircon_runtime_interface::ui::surface::normalize_ui_text_language_tag;
...
impl LocaleFontSystemCache {
    fn new() -> Self {
        ...
        let fallback_locale = normalize_ui_text_language_tag(Some(font_system.locale()))
    ...
    fn with_font_system<R>(
        ...
        let locale = normalize_ui_text_language_tag(language)
