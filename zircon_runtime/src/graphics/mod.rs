...
pub use scene::{
    ...
    RenderPassExecutorRegistration, RenderPassGpuExecutionContext, SceneRenderer,
    ...
    SceneViewportSurface, IRRADIANCE_VOLUME_BIND_EXECUTOR_ID, IRRADIANCE_VOLUME_RESOURCE,
