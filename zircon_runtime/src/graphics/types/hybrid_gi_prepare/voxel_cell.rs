...
pub(crate) const HYBRID_GI_VOXEL_CLIPMAP_CELL_RESOLUTION: usize = 4;
pub(crate) const HYBRID_GI_VOXEL_CLIPMAP_CELL_COUNT: usize = HYBRID_GI_VOXEL_CLIPMAP_CELL_RESOLUTION
    * HYBRID_GI_VOXEL_CLIPMAP_CELL_RESOLUTION
    * HYBRID_GI_VOXEL_CLIPMAP_CELL_RESOLUTION;

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(crate) struct HybridGiPrepareVoxelCell {
    pub(crate) clipmap_id: u32,
    pub(crate) cell_index: u32,
    pub(crate) occupancy_count: u32,
    pub(crate) dominant_card_id: u32,
    pub(crate) radiance_present: bool,
    pub(crate) radiance_rgb: [u8; 3],
}

pub(crate) fn hybrid_gi_voxel_clipmap_bounds_cell_ranges(
...
pub(crate) fn hybrid_gi_voxel_clipmap_cell_bit_index(x: usize, y: usize, z: usize) -> usize {
...
pub(crate) fn hybrid_gi_voxel_clipmap_cell_center(
    clipmap: &HybridGiPrepareVoxelClipmap,
    x: usize,
    y: usize,
    z: usize,
