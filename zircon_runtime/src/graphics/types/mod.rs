...
mod viewport_render_frame_resolve_virtual_geometry_cluster_selections;
...
mod viewport_render_frame_with_prepare_derived_virtual_geometry_cluster_selections;
