...
pub(crate) struct VirtualGeometryNodeAndClusterCullChildWorkItem {
    pub(crate) instance_index: u32,
    pub(crate) entity: u64,
    pub(crate) parent_cluster_array_index: u32,
    pub(crate) parent_hierarchy_node_id: Option<u32>,
    pub(crate) child_node_id: u32,
    pub(crate) child_table_index: u32,
...
impl VirtualGeometryNodeAndClusterCullChildWorkItem {
