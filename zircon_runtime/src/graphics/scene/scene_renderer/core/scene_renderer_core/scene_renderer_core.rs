...
pub(crate) struct SceneRendererCore {
    ...
    pub(in crate::graphics::scene::scene_renderer::core) model_bind_group_layout: wgpu::BindGroupLayout,
    ...
    pub(in crate::graphics::scene::scene_renderer::core) screen_space_ui_renderer: ScreenSpaceUiRenderer,
    pub(in crate::graphics::scene::scene_renderer::core) hybrid_gi: HybridGiGpuResources,
    pub(in crate::graphics::scene::scene_renderer::core) virtual_geometry: VirtualGeometryGpuResources,
