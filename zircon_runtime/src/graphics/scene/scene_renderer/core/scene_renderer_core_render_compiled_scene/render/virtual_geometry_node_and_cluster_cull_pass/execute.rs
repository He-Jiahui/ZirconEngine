...
use crate::graphics::scene::scene_renderer::core::scene_renderer_core::SceneRendererAdvancedPluginResources;
...
pub(in crate::graphics::scene::scene_renderer::core::scene_renderer_core_render_compiled_scene::render) fn execute_virtual_geometry_node_and_cluster_cull_pass(
    device: &wgpu::Device,
    ...
    let instance_work_item_buffer = advanced_plugin_resources
        .create_virtual_geometry_node_and_cluster_cull_instance_work_item_buffer(
            device,
            encoder,
