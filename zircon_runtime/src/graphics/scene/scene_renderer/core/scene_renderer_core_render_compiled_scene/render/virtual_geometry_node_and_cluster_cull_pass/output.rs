...
impl VirtualGeometryNodeAndClusterCullPassOutput {
    ...
    pub(in crate::graphics::scene::scene_renderer::core::scene_renderer_core_render_compiled_scene::render) fn instance_work_items(
        &self,
    ) -> &[RenderVirtualGeometryNodeAndClusterCullInstanceWorkItem] {
    ...
    pub(in crate::graphics::scene::scene_renderer::core::scene_renderer_core_render_compiled_scene::render) fn cluster_work_items(
        &self,
    ) -> &[VirtualGeometryNodeAndClusterCullClusterWorkItem] {
    ...
    #[cfg(test)]
    pub(in crate::graphics::scene::scene_renderer::core::scene_renderer_core_render_compiled_scene::render) fn from_test_store_parts(
    ...
    #[cfg(test)]
    pub(in crate::graphics::scene::scene_renderer::core::scene_renderer_core_render_compiled_scene::render) fn clear_instance_work_items_for_test(
        &mut self,
    ) {
    ...
    #[cfg(test)]
    pub(in crate::graphics::scene::scene_renderer::core::scene_renderer_core_render_compiled_scene::render) fn clear_cluster_work_items_for_test(
        &mut self,
    ) {
