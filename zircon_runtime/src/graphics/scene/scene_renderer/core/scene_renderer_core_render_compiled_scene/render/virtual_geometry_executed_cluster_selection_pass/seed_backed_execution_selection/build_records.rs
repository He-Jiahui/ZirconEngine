...
#[cfg(test)]
pub(in crate::graphics::scene::scene_renderer::core::scene_renderer_core_render_compiled_scene::render::virtual_geometry_executed_cluster_selection_pass) fn build_seed_backed_execution_selection_records(
