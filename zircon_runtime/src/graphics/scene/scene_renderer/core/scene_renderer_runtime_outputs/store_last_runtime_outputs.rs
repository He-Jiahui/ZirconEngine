...
pub(in crate::graphics::scene::scene_renderer::core) fn store_last_runtime_outputs(
    ...
    indirect_execution_buffer: Option<Arc<wgpu::Buffer>>,
    indirect_execution_records_buffer: Option<Arc<wgpu::Buffer>>,
    ...
    renderer.last_virtual_geometry_indirect_execution_buffer = indirect_execution_buffer;
    renderer.last_virtual_geometry_indirect_execution_records_buffer =
