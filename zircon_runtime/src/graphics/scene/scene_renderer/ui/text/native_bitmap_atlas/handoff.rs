...
pub(in crate::graphics::scene::scene_renderer::ui::text) enum NativeBitmapAtlasHandoff {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::graphics::scene::scene_renderer::ui) enum NativeBitmapAtlasGlyphonFallbackReason {
    MissingRasterImage,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::graphics::scene::scene_renderer::ui) enum NativeBitmapAtlasFirstFrameDegradation {
    ApproximateBucketReplacement,
    GlyphonFallback,
    TransparentPlaceholder,
}

pub(in crate::graphics::scene::scene_renderer::ui::text) fn native_bitmap_atlas_handoff_for_report(
...
pub(in crate::graphics::scene::scene_renderer::ui::text) fn native_bitmap_atlas_glyphon_fallback_reason_for_report(
    report: &NativeBitmapAtlasPrepareReport,
...
pub(in crate::graphics::scene::scene_renderer::ui::text) fn native_bitmap_atlas_first_frame_degradation_for_report(
    report: &NativeBitmapAtlasPrepareReport,
