...
pub(in crate::graphics::scene::scene_renderer::ui) struct NativeBitmapAtlasPrepareReport {
    ...
    pub(super) background_composite_replacement_ready: bool,
    ...
    pub(super) glyphon_fallback_reason: Option<NativeBitmapAtlasGlyphonFallbackReason>,
    pub(super) first_frame_degradation: Option<NativeBitmapAtlasFirstFrameDegradation>,
    pub(super) replaces_glyphon: bool,
    pub(super) submission: GlyphAtlasBitmapRenderSubmissionReport,
}

pub(super) struct NativeBitmapAtlasTextArea<'a, 'text> {
...
impl NativeBitmapAtlasFrame {
    ...
    pub(super) fn face_validity(&self) -> GlyphAtlasBitmapFaceValidity {
...
impl<'a, 'text> NativeBitmapAtlasTextArea<'a, 'text> {
    pub(super) fn new(text_area: &'a TextArea<'text>, background_color: Option<[f32; 4]>) -> Self {
        Self {
            text_area,
            background_color,
        }
...
pub(super) fn native_bitmap_atlas_idle_prepare_report(
    source_cache: &mut NativeBitmapAtlasSourceCache,
    retry_state: &mut GlyphAtlasBitmapRetryFrameState,
