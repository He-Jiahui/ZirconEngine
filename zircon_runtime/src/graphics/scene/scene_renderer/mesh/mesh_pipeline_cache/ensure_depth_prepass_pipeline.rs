...
use super::shader_source::mesh_pipeline_depth_prepass_template_source_for_geometry;
...
impl MeshPipelineCache {
    fn ensure_depth_prepass_pipeline<'a>(
        ...
        let shader_source = match mesh_pipeline_depth_prepass_template_source_for_geometry(
            key,
    ...
    pub(crate) fn ensure_depth_prepass_pipeline_for_variant<'a>(
        ...
        self.ensure_depth_prepass_pipeline(device, variant_id, &pipeline_key, &shader_variant_key)
    }
}
