...
fn texture_format_tag(format: TextureFormat) -> u8 {
    match format {
        ...
        TextureFormat::Bgra8UnormSrgb => 7,
        TextureFormat::Rgba16Float => 8,
        TextureFormat::Rgba32Float => 9,
        TextureFormat::Depth24Plus => 10,
        TextureFormat::Depth24PlusStencil8 => 11,
        TextureFormat::Depth32Float => 12,
    }
}
