...
pub(in crate::graphics::scene::scene_renderer::virtual_geometry::gpu_resources) struct GpuPendingRequestInput
{
    ...
    pub(in crate::graphics::scene::scene_renderer::virtual_geometry::gpu_resources) frontier_rank:
        u32,
    pub(in crate::graphics::scene::scene_renderer::virtual_geometry::gpu_resources) assigned_slot:
        u32,
    pub(in crate::graphics::scene::scene_renderer::virtual_geometry::gpu_resources) recycled_page_id:
        u32,
}
