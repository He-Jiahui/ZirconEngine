...
pub(in crate::graphics::scene::scene_renderer::post_process) struct PostProcessParams {
    ...
    pub(in crate::graphics::scene::scene_renderer::post_process) hybrid_gi_color_and_intensity: [f32; 4],
    pub(in crate::graphics::scene::scene_renderer::post_process) baked_color_and_intensity: [f32; 4],
}
