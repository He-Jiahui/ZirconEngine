...
impl ScenePostProcessResources {
    ...
    pub(in crate::graphics::scene::scene_renderer) fn execute_depth_of_field(
        &self,
        device: &wgpu::Device,
        ...
        let render_region = frame
            .render_region_for_phase(RenderPipelinePhase::PreReconstructionScenePostProcess)
            .expect("depth of field requires the pre-reconstruction phase");
        ...
        let params_buffer = &self.post_process_pass_parameter_buffers.depth_of_field;
        ...
        pass.set_pipeline(&self.depth_of_field_pipeline);
