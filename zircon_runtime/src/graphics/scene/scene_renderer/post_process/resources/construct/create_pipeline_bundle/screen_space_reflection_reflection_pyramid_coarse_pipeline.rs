...
pub(super) fn screen_space_reflection_reflection_pyramid_coarse_pipeline(
    ...
    let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
        label: Some("zircon-screen-space-reflection-reflection-pyramid-coarse-shader"),
        source: wgpu::ShaderSource::Wgsl(shader_source),
    });
    let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
        label: Some("zircon-screen-space-reflection-reflection-pyramid-coarse-pipeline-layout"),
