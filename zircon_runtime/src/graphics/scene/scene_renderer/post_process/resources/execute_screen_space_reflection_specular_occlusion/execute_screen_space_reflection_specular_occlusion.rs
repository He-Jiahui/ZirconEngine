...
impl ScenePostProcessResources {
    ...
    pub(crate) fn execute_screen_space_reflection_specular_occlusion(
        ...
        let bind_group = create_bind_group(
            ...
            None,
            // The specular-occlusion pass writes binding 22's target, so it
        ...
        let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
            label: Some("ScreenSpaceReflectionSpecularOcclusionPass"),
            color_attachments: &[Some(wgpu::RenderPassColorAttachment {
                view: screen_space_reflection_specular_occlusion_view,
                resolve_target: None,
                depth_slice: None,
                ops: color_attachment_operations(attachment_ops, wgpu::Color::WHITE),
            })],
