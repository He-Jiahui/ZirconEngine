...
impl ScenePostProcessResources {
    ...
    pub(crate) fn execute_screen_space_reflection_depth_pyramid(
        &self,
        device: &wgpu::Device,
        queue: &wgpu::Queue,
        ...
        let bind_group = create_bind_group(
            ...
            None,
            None,
            // The depth-pyramid pass writes binding 23's target, so it binds
            // the neutral fallback instead of sampling the attachment.
            None,
            None,
            None,
            None,
        ...
        let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
            label: Some("ScreenSpaceReflectionDepthPyramidPass"),
            color_attachments: &[Some(wgpu::RenderPassColorAttachment {
                view: screen_space_reflection_depth_pyramid_view,
                resolve_target: None,
                depth_slice: None,
        ...
        pass.set_pipeline(&self.screen_space_reflection_depth_pyramid_pipeline);
