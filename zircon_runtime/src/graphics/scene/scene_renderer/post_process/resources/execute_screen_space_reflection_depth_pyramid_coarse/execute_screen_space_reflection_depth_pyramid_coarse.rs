...
impl ScenePostProcessResources {
    ...
    pub(crate) fn execute_screen_space_reflection_depth_pyramid_coarse(
        &self,
        device: &wgpu::Device,
        queue: &wgpu::Queue,
        ...
        let bind_group = create_bind_group(
            ...
            None,
            // The coarse depth-pyramid pass writes binding 25's target, so it
        ...
        let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
            label: Some("ScreenSpaceReflectionDepthPyramidCoarsePass"),
            color_attachments: &[Some(wgpu::RenderPassColorAttachment {
                view: screen_space_reflection_depth_pyramid_coarse_view,
                resolve_target: None,
                depth_slice: None,
        ...
        pass.set_pipeline(&self.screen_space_reflection_depth_pyramid_coarse_pipeline);
