...
impl ScenePostProcessResources {
    ...
    pub(in crate::graphics::scene::scene_renderer) fn execute_scene_composite(
        &self,
        device: &wgpu::Device,
        ...
        let render_region = frame
            ...
            .expect("scene composite requires the post-reconstruction phase");
        ...
        let params_buffer = &self.post_process_pass_parameter_buffers.scene_composite;
        ...
        pass.set_pipeline(&self.scene_composite_pipeline);
