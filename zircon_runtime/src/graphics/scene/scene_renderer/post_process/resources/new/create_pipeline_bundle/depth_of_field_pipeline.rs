...
pub(super) fn depth_of_field_pipeline(
    device: &wgpu::Device,
    ...
    let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
        label: Some("zircon-depth-of-field-shader"),
        source: wgpu::ShaderSource::Wgsl(shader_source),
    });
    let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
        label: Some("zircon-depth-of-field-pipeline-layout"),
        bind_group_layouts: &[Some(post_process_bind_group_layout)],
        immediate_size: 0,
    });

    device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        label: Some("zircon-depth-of-field-pipeline"),
        ...
        fragment: Some(wgpu::FragmentState {
            module: &shader,
            entry_point: Some("fs_depth_of_field"),
            compilation_options: wgpu::PipelineCompilationOptions::default(),
