...
use crate::graphics::scene::resources::{MaterialCaptureSeed, ResourceStreamer};
use crate::graphics::types::{HybridGiPrepareCardCaptureRequest, HybridGiPrepareVoxelClipmap};
...
fn default_material_capture_seed() -> MaterialCaptureSeed {
    MaterialCaptureSeed {
        base_color: Vec4::ONE,
        emissive: Vec3::ZERO,
        metallic: 0.0,
