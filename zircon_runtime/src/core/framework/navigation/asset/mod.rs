//! Versioned navigation asset DTOs shared by loaders, runtime managers, and plugins.

use serde::{Deserialize, Serialize};
use thiserror::Error;

use super::constants::{NavAreaId, AREA_WALKABLE, DEFAULT_AGENT_TYPE};
use super::off_mesh_link::{NavLinkMotion, NavLinkTraversalMode};
use super::settings::{default_navigation_areas, NavigationAgentSettings, NavigationAreaSettings};
