...
pub use advanced_lighting::{
    ...
    AdvancedPbrMaterialFrameUsage, CookieProjection, CookieWrapMode, FogVolumeData,
    FroxelGridParams, FroxelGridQuality, IrradianceVolumeData, LightCookieData, OitBufferPlan,
    OitCapabilityProfile, OitSettings, OitSupport, PlanarReflectionProbeData,
    ...
    SubsurfaceProfileDiagnostic, SubsurfaceProfileTable, VolumetricFogSettings,
    VolumetricIntegrationStep, MAX_SCREEN_SPACE_TRANSMISSION_STEPS,
    ...
    STANDARD_PBR_TRANSMISSION_RENDER_QUEUE, VOLUMETRIC_FOG_VOLUME_COMPONENT,
