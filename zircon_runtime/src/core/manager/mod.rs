...
pub use resolver::{
    ...
    resolve_navigation_manager, resolve_net_manager, resolve_physics_manager,
    ...
    EventManagerHandle, InputActionManagerHandle, InputManagerHandle, LevelManagerHandle,
