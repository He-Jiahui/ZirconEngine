...
pub(super) fn dependency_slice_contains_service(
    ...
    match dependencies {
        ...
        _ => dependencies
            .iter()
            .any(|dependency| dependency == service_name),
    }
}

pub(super) enum TwoServiceDependencyMatch {
    FirstService,
    SecondService,
}

pub(super) fn first_blocked_two_service_dependency(
    dependencies: &[RegistryName],
...
pub(super) enum ThreeServiceDependencyMatch {
    FirstService,
    SecondService,
    ThirdService,
}

pub(super) fn first_blocked_three_service_dependency(
    dependencies: &[RegistryName],
    first_service_name: &RegistryName,
    second_service_name: &RegistryName,
...
pub(super) enum FourServiceDependencyMatch {
    FirstService,
    SecondService,
    ThirdService,
    FourthService,
...
pub(super) fn first_blocked_four_service_dependency(
    dependencies: &[RegistryName],
    first_service_name: &RegistryName,
    second_service_name: &RegistryName,
    third_service_name: &RegistryName,
...
pub(super) enum FiveServiceDependencyMatch {
    FirstService,
    SecondService,
    ThirdService,
    FourthService,
...
pub(super) fn first_blocked_five_service_dependency(
    dependencies: &[RegistryName],
    first_service_name: &RegistryName,
    second_service_name: &RegistryName,
    third_service_name: &RegistryName,
    ...
    match dependencies {
        ...
        [first_dependency, second_dependency] => {
            ...
            {
                Some(FiveServiceDependencyMatch::FourthService)
            } else if first_dependency == fifth_service_name || second_dependency == fifth_service_name
            {
                Some(FiveServiceDependencyMatch::FifthService)
            } else {
                None
