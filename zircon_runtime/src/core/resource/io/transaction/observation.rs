...
impl DurableCommitReport {
    ...
    pub(crate) fn rollback_restore_attempt_count(self) -> usize {
        self.rollback_restore_attempt_count
    }

    #[cfg(any(test, feature = "profiling"))]
    pub(crate) fn rollback_restore_success_count(self) -> usize {
        self.rollback_restore_success_count
    }

    #[cfg(any(test, feature = "profiling"))]
    pub(crate) fn deferred_cleanup_count(self) -> usize {
        self.deferred_cleanup_count
    }

    #[cfg(any(test, feature = "profiling"))]
    pub(crate) fn deferred_commit_recovery_count(self) -> usize {
        self.deferred_commit_recovery_count
    }

    #[cfg(feature = "profiling")]
    pub(crate) fn has_commit_activity(self) -> bool {
    ...
    #[cfg(test)]
    pub(crate) fn from_activity_counts(
...
impl DurableRecoveryReport {
    ...
    pub(crate) fn intent_orphan_cleanup_count(self) -> usize {
