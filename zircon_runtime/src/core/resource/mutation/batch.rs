...
use crate::core::resource::{
    ResourceData, ResourceDiagnostic, ResourceId, ResourceLocator, ResourceRecord,
};
...
impl ResourceMutationBatch {
    ...
    pub(crate) fn upsert_imported_erased(
        self,
        record: ResourceRecord,
        payload: Arc<dyn ResourceData>,
    ) -> Self {
    ...
    pub(crate) fn store_payload_erased(
        mut self,
        id: ResourceId,
        expected_revision: u64,
        payload: Arc<dyn ResourceData>,
    ...
    pub fn remove_kind(
        ...
        expected_kind: crate::core::resource::ResourceKind,
    ) -> Self {
        self.operations.push(ResourceMutationOperation::Remove {
            locator,
