...
pub(crate) use graphics::{
    ...
    RendererFeatureAsset, SceneRenderer, SolariRuntimeProvider, SolariRuntimeProviderRegistration,
    ViewportFrame, ViewportFrameTextureHandle, VirtualGeometryGpuCompletion,
