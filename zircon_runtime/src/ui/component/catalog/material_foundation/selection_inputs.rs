...
pub(super) fn descriptors() -> Vec<UiComponentDescriptor> {
    vec![
        ...
        .with_prop(string_prop("inputValue"))
        .with_prop(autocomplete_options_prop())
        .with_prop(array_prop("filtered_options"))
        .with_prop(array_prop("filteredOptions"))
        .with_prop(default_string_prop("value", "atlas"))
        .with_prop(value_text_prop())
        .with_prop(array_prop("selected_options"))
        .with_prop(array_prop("selectedOptions"))
        .with_prop(array_prop("disabled_options"))
        .with_prop(array_prop("disabledOptions"))
        .with_prop(array_prop("focused_options"))
        .with_prop(array_prop("focusedOptions"))
        .with_prop(array_prop("hovered_options"))
        .with_prop(array_prop("hoveredOptions"))
        .with_prop(array_prop("pressed_options"))
        .with_prop(array_prop("pressedOptions"))
        .with_prop(array_prop("matched_options"))
        .with_prop(array_prop("matchedOptions"))
        .with_prop(default_string_prop("size", "medium"))
        .with_prop(bool_prop("multiple", false))
        .with_prop(bool_prop("free_solo", false))
        .with_prop(bool_prop("freeSolo", false))
        .with_prop(bool_prop("popup_open", false))
        .with_prop(bool_prop("popupOpen", false))
        .with_prop(bool_prop("fullWidth", false))
        .with_prop(bool_prop("disableClearable", false))
        .with_prop(bool_prop("disablePortal", false))
        .with_prop(bool_prop("inputFocused", false))
        .with_prop(bool_prop("loading", false))
        .with_prop(bool_prop("readOnly", false))
        .with_prop(default_string_prop("forcePopupIcon", "auto"))
        .slot(UiSlotSchema::new("inputRoot"))
        .slot(UiSlotSchema::new("input"))
        .slot(UiSlotSchema::new("tag").multiple(true))
        .slot(UiSlotSchema::new("endAdornment"))
        .slot(UiSlotSchema::new("clearIndicator"))
        .slot(UiSlotSchema::new("popupIndicator"))
        .slot(UiSlotSchema::new("popper"))
        .slot(UiSlotSchema::new("paper"))
        .slot(UiSlotSchema::new("listbox").multiple(true))
        .slot(UiSlotSchema::new("loading"))
        .slot(UiSlotSchema::new("noOptions"))
