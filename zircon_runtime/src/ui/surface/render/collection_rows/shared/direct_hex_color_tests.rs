...
#[test]
fn optimization_batch_20260826ee_runtime174_hex_color_preserves_supported_forms() {
    assert_eq!(
...
#[test]
fn optimization_batch_20260826ee_runtime174_hex_color_uses_direct_byte_decoder() {
...
fn optimization_batch_20260826ee_runtime174_collection_row_direct_hex_color_bench() {
    let color = " #31A7d9c0 ";
    ...
    println!(
        "RUNTIME174_COLLECTION_ROW_DIRECT_HEX_COLOR_BENCH_V1 sample_pairs={SAMPLE_PAIRS} \
