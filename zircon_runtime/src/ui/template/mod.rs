...
pub use asset::{
    ...
    UiAssetCompileCache, UiAssetCompileCacheEvictionReport, UiAssetDependencyIndex,
    ...
    UiHotReloadAssetKind, UiInvalidationGraph, UiLocalizationTableCatalog, UiNodeParent,
    UiPrototypeStore, UiPrototypeStoreBuilder, UiPrototypeStoreFileCache,
