...
pub use asset::{
    ...
    component_contract_diagnostic, component_contract_fingerprint, declared_imports_fingerprint,
    document_import_fingerprints, fingerprint_document, localization_table_keys_from_toml_str,
    resource_dependencies_fingerprint, validate_asset_bindings, validate_document_action_policy,
    validate_document_localization, validate_localization_report_against_catalog,
    validate_resource_dependency_files, UiAssetCompileCache, UiAssetDocumentRuntimeExt,
    UiAssetLoader, UiAssetNodeIter, UiAssetSchemaMigrator, UiAssetSchemaVersionPolicy,
    UiCompileCacheOutcome, UiCompiledDocument, UiDocumentCompiler, UiInvalidationGraph,
    UiLocalizationTableCatalog, UiNodeParent, UiPrototypeStore, UiPrototypeStoreBuilder,
    UiPrototypeStoreFileCache, UiPrototypeStoreLoadOutcome, UiResourcePathResolver,
