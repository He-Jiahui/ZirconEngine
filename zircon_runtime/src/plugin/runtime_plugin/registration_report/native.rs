...
use super::{
    ...
    validation::validate_runtime_plugin_package_manifest,
};
...
mod optimization_batch_20260830bw_runtime_tests {
    ...
    #[test]
    fn native_package_report_reserves_module_diagnostic_capacity() {
    ...
    #[test]
    fn native_package_report_validates_before_registration() {
        let source = include_str!("native.rs");
        let implementation = source
            .split("#[cfg(test)]")
            .next()
        ...
        let validation = implementation
            .find("drop(validate_runtime_plugin_package_manifest(")
            .expect("validation");
        let registration = implementation
            .find("register_native_package_runtime_modules(")
    ...
    fn optimization_batch_20260830bw_runtime_native_package_report_capacity_p95() {
        ...
        println!(
            "RUNTIME375_NATIVE_PACKAGE_REPORT_CAPACITY_BENCH_V1 sample_pairs={SAMPLE_PAIRS} modules_per_sample={MODULES_PER_SAMPLE} legacy_p95_ns={legacy_p95_ns} optimized_p95_ns={optimized_p95_ns} legacy_raw_ns={} optimized_raw_ns={}",
            sample_csv(&legacy),
