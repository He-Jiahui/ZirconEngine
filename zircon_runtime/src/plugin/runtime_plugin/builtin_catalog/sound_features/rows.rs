...
pub(super) struct SoundFeatureRow {
    ...
    pub provider_package_id: &'static str,
    pub dist_crate: &'static str,
    pub dist_runtime_entry: &'static str,
...
pub(super) const SOUND_FEATURE_ROWS: &[SoundFeatureRow] = &[
    SoundFeatureRow {
        ...
        dist_runtime_entry: "zircon_plugin_sound_timeline_animation_runtime_entry_v3",
    ...
    SoundFeatureRow {
        ...
        provider_package_id: "sound_ray_traced_convolution_reverb",
        dist_crate: "zircon_plugin_sound_ray_traced_convolution_dist",
        dist_runtime_entry: "zircon_plugin_sound_ray_traced_convolution_runtime_entry_v3",
        runtime_target_modes: CLIENT_EDITOR_TARGETS,
