use crate::{
    ExportPackagingStrategy, ExportProfile, ExportTargetPlatform, ProjectPluginSelection,
    RuntimeTargetMode,
};
...
fn selection_template(selection: &ProjectPluginSelection) -> String {
    format!(
        "ProjectPluginSelection {{ id: {:?}.to_string(), enabled: {}, required: {}, target_modes: vec![{}], packaging: {}, runtime_crate: {}, editor_crate: {} }}",
        selection.id,
        selection.enabled,
        selection.required,
        selection
