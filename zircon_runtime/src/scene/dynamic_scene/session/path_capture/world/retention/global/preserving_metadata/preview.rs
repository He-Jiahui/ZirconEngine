...
impl RuntimeSessionArchive {
    pub fn preview_capture_world_selected_slot_preserving_metadata_with_retention_to_path(
        ...
        io::load_or_empty_from_path(path)?
            .preview_capture_world_selected_slot_preserving_metadata_with_retention(
