...
impl RuntimeSessionArchive {
    pub fn capture_level_selected_slot_with_tag_retention_to_path_atomically(
        ...
        let report =
            archive.capture_level_selected_slot_with_tag_retention(tag, selector, level, policy)?;
