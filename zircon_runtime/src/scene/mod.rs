...
pub use module::{
    ...
    module_descriptor, DefaultLevelManager, SceneModule, WorldDriver, DEFAULT_LEVEL_MANAGER_NAME,
    WORLD_DRIVER_NAME,
};
pub use navigation::{
...
pub use dynamic_scene::{
    ...
    ScenePatchPreviewResource, MAX_RUNTIME_SESSION_ARCHIVE_ARTIFACT_BYTES,
