...
fn scene_project_serialization_sources_do_not_store_editor_authoring_state() {
    ...
    for relative in [
        ...
        "src/scene/dynamic_scene/document/migration/mod.rs",
        "src/scene/dynamic_scene/document/migration/project_world.rs",
        ...
        "src/scene/dynamic_scene/scene/spawn/mod.rs",
        "src/scene/dynamic_scene/scene/spawn/preview.rs",
        "src/scene/dynamic_scene/scene/spawn/resource.rs",
        "src/scene/dynamic_scene/scene/spawn/transaction.rs",
