...
pub(in crate::asset::pipeline::manager) fn resource_manager_with_builtins() -> ResourceManager {
    ...
    for (locator_text, asset) in builtin_resources() {
        ...
        let kind = match &asset {
            ...
            crate::asset::ImportedAsset::MaterialGraph(_) => AssetKind::MaterialGraph,
            crate::asset::ImportedAsset::Sound(_) => AssetKind::Sound,
            crate::asset::ImportedAsset::Font(_) => AssetKind::Font,
            crate::asset::ImportedAsset::Data(_) => AssetKind::Data,
            crate::asset::ImportedAsset::Terrain(_) => AssetKind::Terrain,
            crate::asset::ImportedAsset::TerrainLayerStack(_) => AssetKind::TerrainLayerStack,
            crate::asset::ImportedAsset::TileSet(_) => AssetKind::TileSet,
            crate::asset::ImportedAsset::TileMap(_) => AssetKind::TileMap,
            crate::asset::ImportedAsset::Prefab(_) => AssetKind::Prefab,
            crate::asset::ImportedAsset::NavMesh(_) => AssetKind::NavMesh,
