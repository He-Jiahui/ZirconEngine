...
mod reconcile_project_resources;
...
pub(in crate::asset::pipeline::manager) use reconcile_project_resources::{
    project_resource_identities, reconcile_project_resources,
};
