...
pub use assets::{
    ...
    SceneTileMapAsset, ShaderAsset, ShaderDependencyAsset, ShaderEntryPointAsset,
    ShaderSourceLanguage, SoundAsset, TerrainAsset, TerrainLayerAsset, TerrainLayerStackAsset,
    TextureAsset, TexturePayload, TileMapAsset, TileMapLayerAsset, TileMapProjectionAsset,
    TileSetAsset, TileSetTileAsset, TransformAsset, UiAssetDocumentError, UiLayoutAsset,
    UiStyleAsset, UiV2AssetDocumentError, UiV2ComponentAsset, UiV2StyleAsset, UiV2ViewAsset,
    UiWidgetAsset, VirtualGeometryAsset, VirtualGeometryClusterHeaderAsset,
