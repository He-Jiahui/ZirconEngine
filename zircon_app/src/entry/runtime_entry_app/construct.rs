    ...
    pub(in crate::entry) fn new(
        ...
        Self {
            ...
            application_lifecycle:
                super::application_lifecycle::ApplicationLifecycleMachine::default(),
            window_lifecycle_policy: config.window_lifecycle_policy,
            presenter: None,
            reference_cpu_presenter_enabled: config.reference_cpu_presenter,
            ...
            unhandled_ui_action_count: 0,
            unhandled_ui_host_request_count: 0,
            failure_state,
            session,
