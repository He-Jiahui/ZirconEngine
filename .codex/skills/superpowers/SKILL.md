...
- Keep this parent `SKILL.md` short and navigational.
- Keep category `SKILL.md` files short and focused on routing.
- Put the actual skill folders under the category directories; do not leave leaf skills at the root.
- Treat the moved category paths as the source of truth.
