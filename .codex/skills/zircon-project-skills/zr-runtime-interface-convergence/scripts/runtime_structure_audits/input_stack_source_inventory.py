...
INPUT_RUNTIME_MODULES = (
    ...
    "zircon_runtime/src/input/camera_controller/free/mod.rs",
    "zircon_runtime/src/input/camera_controller/free/controller.rs",
    "zircon_runtime/src/input/camera_controller/orbit/mod.rs",
    "zircon_runtime/src/input/camera_controller/orbit/controller.rs",
    "zircon_runtime/src/input/camera_controller/pan/mod.rs",
...
FRAMEWORK_INPUT_MODULES = (
    ...
    "zircon_runtime/src/core/framework/input/gamepad/axis/axis.rs",
    "zircon_runtime/src/core/framework/input/gamepad/axis/input.rs",
    "zircon_runtime/src/core/framework/input/gamepad/axis/mod.rs",
    "zircon_runtime/src/core/framework/input/gamepad/axis/settings.rs",
    "zircon_runtime/src/core/framework/input/gamepad/axis/state.rs",
    "zircon_runtime/src/core/framework/input/gamepad/axis/transition.rs",
    "zircon_runtime/src/core/framework/input/gamepad/button/axis_settings.rs",
    "zircon_runtime/src/core/framework/input/gamepad/button/button.rs",
    "zircon_runtime/src/core/framework/input/gamepad/button/mod.rs",
    "zircon_runtime/src/core/framework/input/gamepad/button/settings.rs",
    "zircon_runtime/src/core/framework/input/gamepad/button/value_state.rs",
    "zircon_runtime/src/core/framework/input/gamepad/device/connection_info.rs",
    "zircon_runtime/src/core/framework/input/gamepad/device/id.rs",
    "zircon_runtime/src/core/framework/input/gamepad/device/mod.rs",
    "zircon_runtime/src/core/framework/input/gamepad/rumble/intensity.rs",
    "zircon_runtime/src/core/framework/input/gamepad/rumble/mod.rs",
    "zircon_runtime/src/core/framework/input/gamepad/rumble/request.rs",
    "zircon_runtime/src/core/framework/input/gamepad/value_scaling.rs",
