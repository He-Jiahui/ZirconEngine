...
fn ui_asset_wrappers_parse_and_validate_kind() {
    ...
    assert_eq!(layout.document.asset.kind, zircon_ui::UiAssetKind::Layout);
    assert_eq!(widget.document.asset.kind, zircon_ui::UiAssetKind::Widget);
    assert_eq!(style.document.asset.kind, zircon_ui::UiAssetKind::Style);
