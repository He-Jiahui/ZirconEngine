...
use zircon_resource::{ResourceData, ResourceHandle, ResourceLease, ResourceMarker};
...
impl ProjectAssetManager {
    pub(in crate::pipeline::manager::project_asset_manager::loading) fn acquire_typed<
        TMarker,
        TAsset,
    >(
        &self,
