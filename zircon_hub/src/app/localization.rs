...
pub(super) fn ui_text(language: HubLanguage) -> UiTextData {
    UiTextData {
        ...
        current_project: text(language, "Current Project", "当前项目"),
        ...
        team_empty_global_detail: text(
            ...
            "已检查当前 Source Engine 仓库和本地 fallback 仓库。",
        ),
