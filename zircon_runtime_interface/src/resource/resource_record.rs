...
impl ResourceRecord {
    ...
    pub fn with_importer_id(mut self, importer_id: impl Into<String>) -> Self {
        self.importer_id = importer_id.into();
        self
    }
    ...
    pub fn with_diagnostics(mut self, diagnostics: Vec<ResourceDiagnostic>) -> Self {
