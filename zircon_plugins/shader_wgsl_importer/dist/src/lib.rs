...
const PLUGIN_ID: &[u8] = b"shader_wgsl_importer\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_shader_wgsl_importer_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] =
    b"runtime.plugin.shader_wgsl_importer\nruntime.asset.importer.shader.wgsl\0";
const NEGOTIATED_CAPABILITIES: &[u8] = REQUESTED_CAPABILITIES;
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"shader_wgsl_importer dist entry ready; importer remains hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"shader_wgsl_importer dist entry requires runtime.plugin.shader_wgsl_importer host capability\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.plugin.shader_wgsl_importer\", \"runtime.asset.importer.shader.wgsl\"]\n[[modules]]\nname = \"runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.asset.importer.shader\"\ncontribution = \"plugin.shader_wgsl_importer.runtime\"\nschema = \"zircon.runtime.asset-importer.shader/1\"\n\0";
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime_entry: zircon_plugin_shader_wgsl_importer_runtime_entry_v3,
    runtime_entry_name: RUNTIME_ENTRY,
    requested_capabilities: REQUESTED_CAPABILITIES,
    missing_host_diagnostics: MISSING_HOST_DIAGNOSTICS,
    runtime: {
        required_capabilities: ["runtime.plugin.shader_wgsl_importer"],
        denied_capabilities: [],
...
mod tests {
    ...
    #[test]
    fn shader_wgsl_importer_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn shader_wgsl_importer_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.shader_wgsl_importer\0";
        ...
        let report = zircon_plugin_shader_wgsl_importer_runtime_entry_v3(&host);
