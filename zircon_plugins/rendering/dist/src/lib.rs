...
const PLUGIN_ID: &[u8] = b"rendering\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_rendering_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"runtime.plugin.rendering\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"runtime.plugin.rendering\0";
