...
#[derive(Clone, Debug)]
pub struct RenderingOitRuntimeFeature;

impl zircon_runtime::plugin::RuntimePluginFeature for RenderingOitRuntimeFeature {
...
pub fn runtime_plugin_feature() -> RenderingOitRuntimeFeature {
...
pub fn feature_manifest() -> zircon_runtime::plugin::PluginFeatureBundleManifest {
    zircon_plugin_rendering_runtime::feature_manifest(
        zircon_plugin_rendering_runtime::RenderingFeatureKind::Oit,
    )
}
