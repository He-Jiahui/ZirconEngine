...
#[derive(Clone, Debug)]
pub struct RenderingVolumetricFogRuntimeFeature;

impl zircon_runtime::plugin::RuntimePluginFeature for RenderingVolumetricFogRuntimeFeature {
...
pub fn runtime_plugin_feature() -> RenderingVolumetricFogRuntimeFeature {
...
pub fn feature_manifest() -> zircon_runtime::plugin::PluginFeatureBundleManifest {
    zircon_plugin_rendering_runtime::feature_manifest(
        zircon_plugin_rendering_runtime::RenderingFeatureKind::VolumetricFog,
    )
}
