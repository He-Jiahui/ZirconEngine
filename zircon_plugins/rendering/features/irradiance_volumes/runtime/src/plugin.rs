...
#[derive(Clone, Debug)]
pub struct RenderingIrradianceVolumesRuntimeFeature;

impl zircon_runtime::plugin::RuntimePluginFeature for RenderingIrradianceVolumesRuntimeFeature {
...
pub fn runtime_plugin_feature() -> RenderingIrradianceVolumesRuntimeFeature {
...
pub fn feature_manifest() -> zircon_runtime::plugin::PluginFeatureBundleManifest {
    zircon_plugin_rendering_runtime::feature_manifest(
        zircon_plugin_rendering_runtime::RenderingFeatureKind::IrradianceVolumes,
    )
}
