...
#[derive(Clone, Debug)]
pub struct RenderingPlanarReflectionsRuntimeFeature;

impl zircon_runtime::plugin::RuntimePluginFeature for RenderingPlanarReflectionsRuntimeFeature {
...
pub fn runtime_plugin_feature() -> RenderingPlanarReflectionsRuntimeFeature {
...
pub fn feature_manifest() -> zircon_runtime::plugin::PluginFeatureBundleManifest {
    zircon_plugin_rendering_runtime::feature_manifest(
        zircon_plugin_rendering_runtime::RenderingFeatureKind::PlanarReflections,
    )
}
