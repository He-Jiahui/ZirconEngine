...
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"neural dist entry ready; neural model and compute services remain hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"neural dist entry requires runtime.plugin.neural host capability\0";
...
mod tests {
    ...
    #[test]
    fn neural_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn neural_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.neural\nruntime.asset.neural_model\0";
        ...
        let report = zircon_plugin_neural_runtime_entry_v3(&host);
