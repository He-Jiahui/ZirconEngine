...
const PLUGIN_ID: &[u8] = b"navigation\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_navigation_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] =
    b"runtime.plugin.navigation\nruntime.plugin.navigation.recast\0";
const NEGOTIATED_CAPABILITIES: &[u8] =
    b"runtime.plugin.navigation\nruntime.plugin.navigation.recast\0";
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"navigation dist entry ready; navmesh and Recast services remain hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"navigation dist entry requires runtime.plugin.navigation host capability\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.plugin.navigation\", \"runtime.plugin.navigation.recast\"]\n[[modules]]\nname = \"runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.navigation.backend\"\ncontribution = \"plugin.navigation.recast\"\nschema = \"zircon.runtime.navigation-backend/1\"\n\0";
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime_entry: zircon_plugin_navigation_runtime_entry_v3,
    runtime_entry_name: RUNTIME_ENTRY,
    requested_capabilities: REQUESTED_CAPABILITIES,
    missing_host_diagnostics: MISSING_HOST_DIAGNOSTICS,
    runtime: {
        required_capabilities: ["runtime.plugin.navigation"],
        denied_capabilities: [],
