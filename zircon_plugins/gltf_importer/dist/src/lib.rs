...
const PLUGIN_ID: &[u8] = b"gltf_importer\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_gltf_importer_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] =
    b"runtime.plugin.gltf_importer\nruntime.asset.importer.model.gltf\0";
