...
use super::readback::ParticleGpuReadbackDecodeError;
...
impl ParticleGpuBackend {
    pub fn new(
        ...
        #[cfg(test)]
        let debug_readback_usage = wgpu::BufferUsages::MAP_READ | wgpu::BufferUsages::COPY_DST;
        #[cfg(not(test))]
        let debug_readback_usage = wgpu::BufferUsages::COPY_SRC | wgpu::BufferUsages::COPY_DST;
