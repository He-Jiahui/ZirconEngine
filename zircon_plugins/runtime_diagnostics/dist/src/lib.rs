...
const PLUGIN_ID: &[u8] = b"runtime_diagnostics\0";
const EDITOR_ENTRY: &[u8] = b"zircon_plugin_runtime_diagnostics_editor_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"editor.extension.runtime_diagnostics\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"editor.extension.runtime_diagnostics\0";
const EDITOR_DIAGNOSTICS: &[u8] =
    b"runtime_diagnostics editor dist entry ready; editor views remain hosted by the editor plugin module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"runtime_diagnostics dist entry requires editor.extension.runtime_diagnostics host capability\0";
...
zircon_plugin_sdk::native_dist_editor_plugin_v3! {
    ...
    editor_entry: zircon_plugin_runtime_diagnostics_editor_entry_v3,
    editor_entry_name: EDITOR_ENTRY,
    requested_capabilities: REQUESTED_CAPABILITIES,
    missing_host_diagnostics: MISSING_HOST_DIAGNOSTICS,
    editor: {
        required_capabilities: ["editor.extension.runtime_diagnostics"],
        denied_capabilities: [],
...
mod tests {
    ...
    #[test]
    fn runtime_diagnostics_dist_descriptor_exports_editor_entry_only() {
    ...
    #[test]
    fn runtime_diagnostics_dist_editor_entry_reports_behavior() {
        let granted = b"editor.extension.runtime_diagnostics\0";
        ...
        let report = zircon_plugin_runtime_diagnostics_editor_entry_v3(&host);
