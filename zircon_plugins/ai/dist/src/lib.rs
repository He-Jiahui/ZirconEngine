...
const PLUGIN_ID: &[u8] = b"ai\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_ai_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"runtime.plugin.ai\nruntime.feature.ai.behavior_tree\nruntime.feature.ai.blackboard\nruntime.feature.ai.perception\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"runtime.plugin.ai\nruntime.feature.ai.behavior_tree\nruntime.feature.ai.blackboard\nruntime.feature.ai.perception\0";
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"ai dist entry ready; AI runtime services remain hosted by the embedded runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"ai dist entry requires runtime.plugin.ai host capability\0";
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime: {
        required_capabilities: ["runtime.plugin.ai"],
        denied_capabilities: [],
