...
const PLUGIN_ID: &[u8] = b"ui_document_importer\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_ui_document_importer_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] =
    b"runtime.plugin.ui_document_importer\nruntime.asset.importer.ui_document\0";
const NEGOTIATED_CAPABILITIES: &[u8] = REQUESTED_CAPABILITIES;
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"ui_document_importer dist entry ready; importer remains hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"ui_document_importer dist entry requires runtime.plugin.ui_document_importer host capability\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.plugin.ui_document_importer\", \"runtime.asset.importer.ui_document\"]\n[[modules]]\nname = \"runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.asset.importer.ui_document\"\ncontribution = \"plugin.ui_document_importer.runtime\"\nschema = \"zircon.runtime.asset-importer.ui_document/1\"\n\0";
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime_entry: zircon_plugin_ui_document_importer_runtime_entry_v3,
    runtime_entry_name: RUNTIME_ENTRY,
    requested_capabilities: REQUESTED_CAPABILITIES,
    missing_host_diagnostics: MISSING_HOST_DIAGNOSTICS,
    runtime: {
        required_capabilities: ["runtime.plugin.ui_document_importer"],
        denied_capabilities: [],
