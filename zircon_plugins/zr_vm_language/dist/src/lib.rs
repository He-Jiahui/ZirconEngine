...
mod tests {
    ...
    #[test]
    fn zr_vm_language_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn zr_vm_language_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.zr_vm_language\nruntime.script.backend.zr_vm_project\0";
        ...
        let report = zircon_plugin_zr_vm_language_runtime_entry_v3(&host);
