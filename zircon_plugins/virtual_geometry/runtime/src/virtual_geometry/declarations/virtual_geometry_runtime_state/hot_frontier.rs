...
impl VirtualGeometryRuntimeState {
    pub(in crate::virtual_geometry) fn current_hot_resident_page_ids(
        &self,
    ) -> impl Iterator<Item = u32> + '_ {
        self.current_hot_resident_pages.iter().copied()
    }

    pub(in crate::virtual_geometry) fn recent_hot_resident_page_ids(
        &self,
    ) -> impl Iterator<Item = u32> + '_ {
        self.recent_hot_resident_pages.keys().copied()
    }

    pub(in crate::virtual_geometry) fn insert_current_hot_resident_page(
        &mut self,
        page_id: u32,
    ) -> bool {
    ...
    pub(in crate::virtual_geometry) fn extend_current_hot_resident_pages(
        &mut self,
    ...
    pub(in crate::virtual_geometry) fn extend_recent_hot_resident_pages(
        &mut self,
    ...
    pub(in crate::virtual_geometry) fn replace_current_hot_resident_pages(
        &mut self,
    ...
    pub(in crate::virtual_geometry) fn remove_hot_resident_page(&mut self, page_id: u32) {
        self.current_hot_resident_pages.remove(&page_id);
        self.recent_hot_resident_pages.remove(&page_id);
    }

    pub(in crate::virtual_geometry) fn retain_current_hot_resident_pages(
        &mut self,
    ...
    pub(in crate::virtual_geometry) fn retain_recent_hot_resident_pages(
        &mut self,
