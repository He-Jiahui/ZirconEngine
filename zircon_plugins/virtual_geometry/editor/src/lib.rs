...
pub const PLUGIN_ID: &str = zircon_plugin_virtual_geometry_runtime::PLUGIN_ID;
pub const VIRTUAL_GEOMETRY_AUTHORING_VIEW_ID: &str = "virtual_geometry.authoring";
pub const VIRTUAL_GEOMETRY_DRAWER_ID: &str = "virtual_geometry.drawer";
pub const VIRTUAL_GEOMETRY_TEMPLATE_ID: &str = "virtual_geometry.authoring";
...
pub fn editor_plugin_descriptor() -> zircon_editor::EditorPluginDescriptor {
    ...
    .with_capability("editor.extension.virtual_geometry_authoring")
}
...
mod tests {
    ...
    fn virtual_geometry_editor_plugin_contributes_authoring_extensions() {
        ...
        assert!(registration
            .capabilities
            .contains(&"editor.extension.virtual_geometry_authoring".to_string()));
        assert!(registration
            .extensions
            .views()
            .iter()
