...
const PLUGIN_ID: &[u8] = b"virtual_geometry\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_virtual_geometry_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] =
    b"runtime.plugin.virtual_geometry\nruntime.render.advanced.virtual_geometry\0";
const NEGOTIATED_CAPABILITIES: &[u8] =
    b"runtime.plugin.virtual_geometry\nruntime.render.advanced.virtual_geometry\0";
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"virtual_geometry dist entry ready; render feature execution remains hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"virtual_geometry dist entry requires runtime.plugin.virtual_geometry host capability\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.plugin.virtual_geometry\", \"runtime.render.advanced.virtual_geometry\"]\n[[modules]]\nname = \"runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.render.feature\"\ncontribution = \"plugin.virtual_geometry.render_feature\"\nschema = \"zircon.runtime.render-feature/1\"\n[[extensions]]\npoint = \"runtime.render.virtual_geometry_provider\"\ncontribution = \"plugin.virtual_geometry.runtime\"\nschema = \"zircon.runtime.virtual-geometry-provider/1\"\n[[extensions]]\npoint = \"runtime.render.prepare_collector\"\ncontribution = \"plugin.virtual_geometry.runtime_prepare\"\nschema = \"zircon.runtime.render-prepare-collector/1\"\n\0";
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime: {
        required_capabilities: ["runtime.plugin.virtual_geometry"],
        denied_capabilities: [],
...
mod tests {
    ...
    #[test]
    fn virtual_geometry_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn virtual_geometry_dist_runtime_entry_reports_registration_manifest() {
        let granted =
            b"runtime.plugin.virtual_geometry\nruntime.render.advanced.virtual_geometry\0";
        ...
        let report = zircon_plugin_virtual_geometry_runtime_entry_v3(&host);
