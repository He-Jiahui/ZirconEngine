...
const PLUGIN_ID: &[u8] = b"plugin_sdk_examples\0";
const EDITOR_ENTRY: &[u8] = b"zircon_plugin_sdk_examples_editor_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"editor.extension.plugin_sdk_examples\neditor.extension.plugin_sdk_examples.window\neditor.extension.plugin_sdk_examples.asset_fixture\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"editor.extension.plugin_sdk_examples\neditor.extension.plugin_sdk_examples.window\neditor.extension.plugin_sdk_examples.asset_fixture\0";
const EDITOR_DIAGNOSTICS: &[u8] =
    b"plugin_sdk_examples editor dist entry ready; SDK example extension registration remains hosted by the editor plugin module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"plugin_sdk_examples dist entry requires editor.extension.plugin_sdk_examples host capability\0";
...
zircon_plugin_sdk::native_dist_editor_plugin_v3! {
    ...
    editor_entry: zircon_plugin_sdk_examples_editor_entry_v3,
...
mod tests {
    ...
    #[test]
    fn sdk_examples_dist_descriptor_exports_editor_entry_only() {
    ...
    #[test]
    fn sdk_examples_dist_editor_entry_reports_behavior() {
        let granted = b"editor.extension.plugin_sdk_examples\neditor.extension.plugin_sdk_examples.window\neditor.extension.plugin_sdk_examples.asset_fixture\0";
        ...
        let report = zircon_plugin_sdk_examples_editor_entry_v3(&host);
