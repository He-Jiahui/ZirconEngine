...
pub use capability::{
    ASSET_FIXTURE_CAPABILITY, CAPABILITY, EDITOR_CAPABILITIES, EDITOR_CRATE_NAME,
    NATIVE_EDITOR_ENTRY, NATIVE_EDITOR_REGISTRATION_MANIFEST, NATIVE_PLUGIN_ID,
    NATIVE_REQUESTED_CAPABILITIES, PLUGIN_ID, PLUGIN_SDK_EXAMPLES_DECLARATION, WINDOW_CAPABILITY,
};
