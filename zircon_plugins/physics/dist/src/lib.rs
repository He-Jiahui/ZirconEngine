...
const PLUGIN_ID: &[u8] = b"physics\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_physics_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"runtime.plugin.physics\nruntime.capability.physics.raycast\nruntime.capability.physics.overlap\nruntime.capability.physics.shape_cast\nruntime.capability.physics.trigger_events\nruntime.capability.physics.constraints\nruntime.capability.physics.skeletal_joints\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"runtime.plugin.physics\nruntime.capability.physics.raycast\nruntime.capability.physics.overlap\nruntime.capability.physics.shape_cast\nruntime.capability.physics.trigger_events\nruntime.capability.physics.constraints\nruntime.capability.physics.skeletal_joints\0";
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"physics dist entry ready; physics world and query services remain hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"physics dist entry requires runtime.plugin.physics host capability\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.plugin.physics\", \"runtime.capability.physics.raycast\", \"runtime.capability.physics.overlap\", \"runtime.capability.physics.shape_cast\", \"runtime.capability.physics.trigger_events\", \"runtime.capability.physics.constraints\", \"runtime.capability.physics.skeletal_joints\"]\n[[modules]]\nname = \"runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.physics.backend\"\ncontribution = \"plugin.physics.runtime\"\nschema = \"zircon.runtime.physics-backend/1\"\n\0";
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime_entry: zircon_plugin_physics_runtime_entry_v3,
    runtime_entry_name: RUNTIME_ENTRY,
    requested_capabilities: REQUESTED_CAPABILITIES,
    missing_host_diagnostics: MISSING_HOST_DIAGNOSTICS,
    runtime: {
        required_capabilities: ["runtime.plugin.physics"],
        denied_capabilities: [],
...
mod tests {
    ...
    #[test]
    fn physics_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn physics_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.physics\nruntime.capability.physics.raycast\nruntime.capability.physics.overlap\nruntime.capability.physics.shape_cast\nruntime.capability.physics.trigger_events\nruntime.capability.physics.constraints\nruntime.capability.physics.skeletal_joints\0";
        ...
        let report = zircon_plugin_physics_runtime_entry_v3(&host);
