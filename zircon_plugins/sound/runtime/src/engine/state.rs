...
use zircon_runtime::core::framework::sound::{
    SoundAutomationBinding, SoundAutomationBindingId, SoundClipId, SoundDynamicEventCatalog,
    SoundError, SoundImpulseResponseId, SoundListenerDescriptor, SoundListenerId, SoundMixerGraph,
    SoundMixerSnapshot, SoundParameterId, SoundPlaybackId, SoundRayTracingConvolutionStatus,
...
impl SoundEngineState {
    ...
    pub(crate) fn snapshot(&self) -> SoundMixerSnapshot {
        ...
        graph.dynamic_events = SoundDynamicEventCatalog::empty();
        SoundMixerSnapshot {
            graph,
