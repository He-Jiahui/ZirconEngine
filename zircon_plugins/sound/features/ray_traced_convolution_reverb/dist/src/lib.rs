...
const FEATURE_PROVIDER_MANIFEST: &str = concat!(
    r#"id = "sound_ray_traced_convolution_reverb"
version = "0.1.0"
package_kind = "feature_extension"
display_name = "Sound Ray Traced Convolution Reverb Provider"
description = "Native dynamic provider for the Sound ray-traced convolution optional feature."
sdk_api_version = "0.1.0"
category = "runtime"
maturity = "beta"
supported_targets = ["client_runtime", "editor_host"]
supported_platforms = ["windows", "linux", "macos"]
capabilities = ["runtime.feature.sound.ray_traced_convolution_reverb"]
...
dist_crate = "zircon_plugin_sound_ray_traced_convolution_dist"
descriptor_symbol = "zircon_native_plugin_descriptor_v3"
runtime_entry = "zircon_plugin_sound_ray_traced_convolution_runtime_entry_v3"

[[feature_extensions]]
id = "sound.ray_traced_convolution_reverb"
...
name = "sound.ray_traced_convolution_reverb.runtime"
kind = "runtime"
crate_name = "zircon_plugin_sound_ray_traced_convolution_dist"
...
const PLUGIN_ID: &[u8] = b"sound_ray_traced_convolution_reverb\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_sound_ray_traced_convolution_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] =
    b"runtime.plugin.sound\nruntime.feature.sound.ray_traced_convolution_reverb\0";
const NEGOTIATED_CAPABILITIES: &[u8] = REQUESTED_CAPABILITIES;
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"sound ray-traced convolution feature dist entry ready; feature implementation remains hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"sound ray-traced convolution feature dist entry requires runtime.plugin.sound and runtime.feature.sound.ray_traced_convolution_reverb host capabilities\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.feature.sound.ray_traced_convolution_reverb\"]\n[[modules]]\nname = \"sound.ray_traced_convolution_reverb.runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.plugin_feature\"\ncontribution = \"sound.ray_traced_convolution_reverb\"\nschema = \"zircon.runtime.plugin-feature/1\"\n\0";
...
mod tests {
    ...
    #[test]
    fn ray_traced_convolution_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn ray_traced_convolution_dist_runtime_entry_reports_registration_manifest() {
        let granted =
            b"runtime.plugin.sound\nruntime.feature.sound.ray_traced_convolution_reverb\0";
        ...
        let report = zircon_plugin_sound_ray_traced_convolution_runtime_entry_v3(&host);
