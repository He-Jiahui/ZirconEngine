...
const PLUGIN_ID: &[u8] = b"sound\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_sound_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"runtime.plugin.sound\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"runtime.plugin.sound\0";
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"sound dist entry ready; sound components, options, and event catalogs remain hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"sound dist entry requires runtime.plugin.sound host capability\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.plugin.sound\"]\n[[modules]]\nname = \"runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.component_type\"\ncontribution = \"plugin.sound.components\"\nschema = \"zircon.runtime.component-type/1\"\n[[extensions]]\npoint = \"runtime.plugin_option\"\ncontribution = \"plugin.sound.options\"\nschema = \"zircon.runtime.plugin-options/1\"\n[[extensions]]\npoint = \"runtime.plugin_event_catalog\"\ncontribution = \"plugin.sound.dynamic_events\"\nschema = \"zircon.runtime.event-catalog/1\"\n\0";
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime: {
        required_capabilities: ["runtime.plugin.sound"],
        denied_capabilities: [],
...
mod tests {
    ...
    #[test]
    fn sound_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn sound_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.sound\0";
        ...
        let report = zircon_plugin_sound_runtime_entry_v3(&host);
