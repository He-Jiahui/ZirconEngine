...
pub const SOUND_AUTHORING_VIEW_ID: &str = "sound.authoring";
pub const SOUND_DRAWER_ID: &str = "sound.drawer";
pub const SOUND_TEMPLATE_ID: &str = "sound.authoring";
    ...
    fn register_editor_extensions(
        ...
        register_authoring_extensions(
            ...
            EditorAuthoringExtensions {
                ...
                drawer_display_name: "Sound Tools",
                template_id: SOUND_TEMPLATE_ID,
                template_document: "plugins://sound/editor/authoring.ui.toml",
...
mod tests {
    ...
    fn sound_editor_plugin_contributes_authoring_extensions() {
        ...
        assert!(registration
            ...
            .menu_items()
            .iter()
            .any(|menu| menu.operation().as_str() == "View.sound.authoring.Open"));
        assert!(registration
            .extensions
            .operations()
            .descriptors()
            .any(|operation| operation.path().as_str() == "View.sound.authoring.Open"));
    }
}
