...
const PLUGIN_ID: &[u8] = b"hybrid_gi\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_hybrid_gi_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] =
    b"runtime.plugin.hybrid_gi\nruntime.render.advanced.hybrid_gi\0";
const NEGOTIATED_CAPABILITIES: &[u8] =
    b"runtime.plugin.hybrid_gi\nruntime.render.advanced.hybrid_gi\0";
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"hybrid_gi dist entry ready; render feature execution remains hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"hybrid_gi dist entry requires runtime.plugin.hybrid_gi host capability\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.plugin.hybrid_gi\", \"runtime.render.advanced.hybrid_gi\"]\n[[modules]]\nname = \"runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.render.feature\"\ncontribution = \"plugin.hybrid_gi.render_feature\"\nschema = \"zircon.runtime.render-feature/1\"\n[[extensions]]\npoint = \"runtime.render.hybrid_gi_provider\"\ncontribution = \"plugin.hybrid_gi.runtime\"\nschema = \"zircon.runtime.hybrid-gi-provider/1\"\n[[extensions]]\npoint = \"runtime.render.prepare_collector\"\ncontribution = \"plugin.hybrid_gi.runtime_prepare\"\nschema = \"zircon.runtime.render-prepare-collector/1\"\n\0";
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime_entry: zircon_plugin_hybrid_gi_runtime_entry_v3,
    runtime_entry_name: RUNTIME_ENTRY,
    requested_capabilities: REQUESTED_CAPABILITIES,
    missing_host_diagnostics: MISSING_HOST_DIAGNOSTICS,
    runtime: {
        required_capabilities: ["runtime.plugin.hybrid_gi"],
        denied_capabilities: [],
...
mod tests {
    ...
    #[test]
    fn hybrid_gi_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn hybrid_gi_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.hybrid_gi\nruntime.render.advanced.hybrid_gi\0";
        ...
        let report = zircon_plugin_hybrid_gi_runtime_entry_v3(&host);
