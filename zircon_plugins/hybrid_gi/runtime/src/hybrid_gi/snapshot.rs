...
impl HybridGiRuntimeState {
    pub(crate) fn snapshot(&self) -> HybridGiRuntimeSnapshot {
        ...
        HybridGiRuntimeSnapshot::new(
            ...
            scene_representation.radiance_cache_resident_probe_count(),
            scene_representation.radiance_cache_update_probe_count(),
            scene_representation.radiance_cache_truncated_demand_count(),
            scene_representation.radiance_cache_generation(),
            scene_representation.radiance_cache_scroll_count(),
            scene_representation.radiance_cache_history_clear_count(),
