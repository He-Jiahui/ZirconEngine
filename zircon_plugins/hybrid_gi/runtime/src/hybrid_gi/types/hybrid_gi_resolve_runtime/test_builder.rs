...
#[derive(Default)]
pub struct HybridGiResolveRuntimeTestBuilder {
...
impl HybridGiResolveRuntime {
    pub fn fixture() -> HybridGiResolveRuntimeTestBuilder {
...
impl HybridGiResolveRuntimeTestBuilder {
    ...
    pub fn with_trace_region_scene_data(
        mut self,
        trace_region_scene_data: BTreeMap<u32, HybridGiResolveTraceRegionSceneData>,
    ) -> Self {
    ...
    pub fn with_probe_parent_probes(mut self, probe_parent_probes: BTreeMap<u32, u32>) -> Self {
        self.probe_parent_probes = probe_parent_probes;
        self
    }

    pub fn with_probe_rt_lighting_rgb(
        mut self,
        probe_rt_lighting_rgb: BTreeMap<u32, [u8; 3]>,
    ) -> Self {
    ...
    pub fn with_probe_hierarchy_resolve_weight_q8(
        mut self,
        probe_hierarchy_resolve_weight_q8: BTreeMap<u32, u16>,
    ) -> Self {
    ...
    pub fn with_probe_hierarchy_irradiance_rgb_and_weight(
        mut self,
        probe_hierarchy_irradiance_rgb_and_weight: BTreeMap<u32, [u8; 4]>,
    ) -> Self {
    ...
    pub fn with_probe_hierarchy_rt_lighting_rgb_and_weight(
        mut self,
        probe_hierarchy_rt_lighting_rgb_and_weight: BTreeMap<u32, [u8; 4]>,
    ) -> Self {
    ...
    pub fn with_probe_scene_driven_hierarchy_irradiance_ids(
        mut self,
        probe_scene_driven_hierarchy_irradiance_ids: BTreeSet<u32>,
    ) -> Self {
    ...
    pub fn with_probe_scene_driven_hierarchy_rt_lighting_ids(
        mut self,
        probe_scene_driven_hierarchy_rt_lighting_ids: BTreeSet<u32>,
    ) -> Self {
    ...
    pub fn with_probe_scene_driven_hierarchy_irradiance_quality_q8(
        mut self,
    ...
    pub fn with_probe_scene_driven_hierarchy_irradiance_freshness_q8(
        mut self,
    ...
    pub fn with_probe_scene_driven_hierarchy_irradiance_revision(
        mut self,
    ...
    pub fn with_probe_scene_driven_hierarchy_rt_lighting_quality_q8(
        mut self,
        quality_q8: BTreeMap<u32, u8>,
    ) -> Self {
    ...
    pub fn with_probe_scene_driven_hierarchy_rt_lighting_freshness_q8(
        mut self,
        freshness_q8: BTreeMap<u32, u8>,
    ) -> Self {
    ...
    pub fn with_probe_scene_driven_hierarchy_rt_lighting_revision(
        mut self,
        revision: BTreeMap<u32, u32>,
    ) -> Self {
    ...
    pub fn build(self) -> HybridGiResolveRuntime {
