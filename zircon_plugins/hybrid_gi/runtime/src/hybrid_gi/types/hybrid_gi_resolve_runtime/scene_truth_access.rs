...
impl HybridGiResolveRuntime {
    pub fn scene_truth_irradiance_probe_ids(&self) -> impl Iterator<Item = u32> + '_ {
        self.probe_scene_driven_hierarchy_irradiance_ids
            .iter()
            .copied()
    }

    pub fn scene_truth_rt_lighting_probe_ids(&self) -> impl Iterator<Item = u32> + '_ {
        self.probe_scene_driven_hierarchy_rt_lighting_ids
            .iter()
            .copied()
    }

    pub fn hierarchy_resolve_weight(&self, probe_id: u32) -> Option<f32> {
        self.probe_hierarchy_resolve_weight_q8
            .get(&probe_id)
            .map(|weight_q8| *weight_q8 as f32 / 256.0)
    }

    pub fn has_hierarchy_resolve_weight(&self, probe_id: u32) -> bool {
        self.probe_hierarchy_resolve_weight_q8
            .contains_key(&probe_id)
    }

    pub fn hierarchy_irradiance(&self, probe_id: u32) -> Option<[f32; 4]> {
    ...
    pub fn hierarchy_irradiance_includes_scene_truth(&self, probe_id: u32) -> bool {
        self.probe_scene_driven_hierarchy_irradiance_ids
            .contains(&probe_id)
    }
    ...
    pub fn hierarchy_irradiance_scene_truth_freshness(&self, probe_id: u32) -> f32 {
    ...
    pub fn hierarchy_rt_lighting(&self, probe_id: u32) -> Option<[f32; 4]> {
    ...
    pub fn hierarchy_rt_lighting_includes_scene_truth(&self, probe_id: u32) -> bool {
        self.probe_scene_driven_hierarchy_rt_lighting_ids
            .contains(&probe_id)
    }

    pub fn hierarchy_rt_lighting_scene_truth_quality(&self, probe_id: u32) -> f32 {
    ...
    pub fn hierarchy_rt_lighting_scene_truth_freshness(&self, probe_id: u32) -> f32 {
    ...
    pub fn hierarchy_rt_lighting_scene_truth_revision(&self, probe_id: u32) -> u32 {
    ...
    #[cfg(test)]
    pub fn remove_hierarchy_irradiance_for_test(&mut self, probe_id: u32) {
        self.probe_hierarchy_irradiance_rgb_and_weight
            .remove(&probe_id);
    }

    #[cfg(test)]
    pub fn remove_hierarchy_rt_lighting_for_test(&mut self, probe_id: u32) {
        self.probe_hierarchy_rt_lighting_rgb_and_weight
            .remove(&probe_id);
    }

    #[cfg(test)]
    pub fn remove_hierarchy_resolve_weight_for_test(&mut self, probe_id: u32) {
