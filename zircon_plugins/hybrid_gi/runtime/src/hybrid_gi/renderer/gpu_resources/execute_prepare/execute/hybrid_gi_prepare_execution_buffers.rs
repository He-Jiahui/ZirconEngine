...
pub(super) struct HybridGiPrepareExecutionBuffers {
    ...
    pub(super) radiance_cache_update_buffer: wgpu::Buffer,
    pub(super) radiance_cache_consume_buffer: wgpu::Buffer,
    ...
    pub(super) voxel_cell_descriptor_offset: usize,
    pub(super) voxel_cell_descriptor_count: usize,
    pub(super) voxel_cell_lookup_buffer: wgpu::Buffer,
    pub(super) voxel_cell_lookup_complete: bool,
    pub(super) voxel_cell_lookup_clipmap_count: usize,
