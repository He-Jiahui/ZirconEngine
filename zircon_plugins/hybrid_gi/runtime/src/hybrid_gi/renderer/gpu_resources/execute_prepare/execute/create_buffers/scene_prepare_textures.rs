...
fn occupied_slots(
    ...
    projection: impl Fn(&crate::hybrid_gi::types::HybridGiPrepareCardCaptureRequest) -> u32,
) -> Vec<u32> {
...
fn occupied_surface_cache_page_slots(
    page_contents: &[crate::hybrid_gi::types::HybridGiPrepareSurfaceCachePageContent],
    presence: impl Fn(&crate::hybrid_gi::types::HybridGiPrepareSurfaceCachePageContent) -> bool,
    projection: impl Fn(&crate::hybrid_gi::types::HybridGiPrepareSurfaceCachePageContent) -> u32,
) -> Vec<u32> {
