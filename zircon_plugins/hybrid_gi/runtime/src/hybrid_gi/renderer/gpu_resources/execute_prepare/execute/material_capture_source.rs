...
pub(in crate::hybrid_gi::renderer) struct HybridGiMaterialCaptureTextureKey {
    pub(in crate::hybrid_gi::renderer) id: ResourceId,
    pub(in crate::hybrid_gi::renderer) revision: u64,
}

impl HybridGiMaterialCaptureTextureKey {
    pub(in crate::hybrid_gi::renderer) const fn new(id: ResourceId, revision: u64) -> Self {
        Self { id, revision }
    }
}
...
pub(in crate::hybrid_gi::renderer) struct HybridGiMaterialCaptureSeed {
    ...
    pub(in crate::hybrid_gi::renderer) normal_scale: f32,
    ...
    pub(in crate::hybrid_gi::renderer) base_color_texture:
        Option<HybridGiMaterialCaptureTextureKey>,
    pub(in crate::hybrid_gi::renderer) normal_texture: Option<HybridGiMaterialCaptureTextureKey>,
    pub(in crate::hybrid_gi::renderer) metallic_roughness_texture:
        Option<HybridGiMaterialCaptureTextureKey>,
    pub(in crate::hybrid_gi::renderer) occlusion_texture: Option<HybridGiMaterialCaptureTextureKey>,
