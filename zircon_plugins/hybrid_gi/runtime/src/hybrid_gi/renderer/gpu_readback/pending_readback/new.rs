...
impl HybridGiGpuPendingReadback {
    pub(in crate::hybrid_gi::renderer) fn new(
        ...
        trace_diagnostic_word_count: usize,
        trace_diagnostic_buffer: wgpu::Buffer,
        radiance_cache_dispatch_counter_buffer: wgpu::Buffer,
        radiance_cache_dispatch_counter_word_offset: usize,
        radiance_cache_dispatch_counter_word_count: usize,
        ...
        Self {
            ...
            trace_diagnostic_word_count,
            trace_diagnostic_buffer,
            radiance_cache_dispatch_counter_buffer,
