...
pub(in crate::hybrid_gi::renderer) struct HybridGiGpuPendingReadback {
    ...
    pub(super) _scene_prepare_probe_trace_tile_buffer: Option<wgpu::Buffer>,
    pub(super) scene_prepare_probe_trace_tile_readback: Option<wgpu::Buffer>,
    pub(super) _scene_prepare_probe_trace_indirect_args_buffer: Option<wgpu::Buffer>,
    pub(super) scene_prepare_probe_trace_indirect_args_readback: Option<wgpu::Buffer>,
