...
fn runtime_probe_has_scene_truth(
    runtime: &crate::hybrid_gi::types::HybridGiResolveRuntime,
    probe_id: u32,
) -> bool {
...
fn farther_resident_ancestor_budget_support<'a>(
    probes_by_id: &BTreeMap<u32, impl HybridGiProbeSource>,
    resident_prepare_by_id: &BTreeMap<u32, &'a crate::hybrid_gi::types::HybridGiPrepareProbe>,
    probe_id: u32,
) -> f32 {
    let mut current_probe_id = probe_id;
...
mod tests {
    ...
    use zircon_runtime::core::framework::render::{
        ...
        RenderHybridGiExtract, RenderHybridGiProbe, RenderOverlayExtract,
