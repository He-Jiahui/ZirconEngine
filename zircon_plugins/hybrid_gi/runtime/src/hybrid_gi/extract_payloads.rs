...
pub(in crate::hybrid_gi) struct HybridGiExtractProbePayload {
    pub(in crate::hybrid_gi) probe_id: u32,
    pub(in crate::hybrid_gi) position: Vec3,
    pub(in crate::hybrid_gi) radius: Real,
    pub(in crate::hybrid_gi) parent_probe_id: Option<u32>,
    pub(in crate::hybrid_gi) resident: bool,
    pub(in crate::hybrid_gi) ray_budget: u32,
}

#[derive(Clone, Copy, Debug, PartialEq)]
pub(in crate::hybrid_gi) struct HybridGiExtractTraceRegionPayload {
    pub(in crate::hybrid_gi) region_id: u32,
    pub(in crate::hybrid_gi) bounds_center: Vec3,
    pub(in crate::hybrid_gi) bounds_radius: Real,
    pub(in crate::hybrid_gi) screen_coverage: Real,
    pub(in crate::hybrid_gi) rt_lighting_rgb: [u8; 3],
}

pub(in crate::hybrid_gi) fn first_hybrid_gi_runtime_probe_payloads(
...
pub(in crate::hybrid_gi) fn first_hybrid_gi_runtime_trace_region_payloads(
    extract: &RenderHybridGiExtract,
