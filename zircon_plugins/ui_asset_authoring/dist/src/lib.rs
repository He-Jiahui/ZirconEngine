...
const PLUGIN_ID: &[u8] = b"ui_asset_authoring\0";
const EDITOR_ENTRY: &[u8] = b"zircon_plugin_ui_asset_authoring_editor_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"editor.extension.ui_asset_authoring\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"editor.extension.ui_asset_authoring\0";
...
mod tests {
    ...
    #[test]
    fn ui_asset_authoring_dist_descriptor_exports_editor_entry_only() {
    ...
    #[test]
    fn ui_asset_authoring_dist_editor_entry_reports_behavior() {
        let granted = b"editor.extension.ui_asset_authoring\0";
        ...
        let report = zircon_plugin_ui_asset_authoring_editor_entry_v3(&host);
