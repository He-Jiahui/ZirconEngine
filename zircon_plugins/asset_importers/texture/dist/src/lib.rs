use zircon_plugin_asset_importer_texture_runtime::{
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime: {
        required_capabilities: ["runtime.plugin.asset_importer.texture"],
        denied_capabilities: [],
...
mod tests {
    ...
    #[test]
    fn texture_asset_importer_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn texture_asset_importer_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.asset_importer.texture\0";
        ...
        let report = zircon_plugin_asset_importer_texture_runtime_entry_v3(&host);
