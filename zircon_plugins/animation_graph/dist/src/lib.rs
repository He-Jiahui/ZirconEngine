...
const PLUGIN_ID: &[u8] = b"animation_graph\0";
const EDITOR_ENTRY: &[u8] = b"zircon_plugin_animation_graph_editor_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"editor.extension.animation_graph_authoring\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"editor.extension.animation_graph_authoring\0";
const EDITOR_DIAGNOSTICS: &[u8] =
    b"animation_graph editor dist entry ready; animation graph authoring remains hosted by the editor plugin module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"animation_graph dist entry requires editor.extension.animation_graph_authoring host capability\0";
...
zircon_plugin_sdk::native_dist_editor_plugin_v3! {
    ...
    editor_entry: zircon_plugin_animation_graph_editor_entry_v3,
    editor_entry_name: EDITOR_ENTRY,
    requested_capabilities: REQUESTED_CAPABILITIES,
    missing_host_diagnostics: MISSING_HOST_DIAGNOSTICS,
    editor: {
        required_capabilities: ["editor.extension.animation_graph_authoring"],
        denied_capabilities: [],
