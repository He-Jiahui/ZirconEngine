...
const PLUGIN_ID: &[u8] = b"solari\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_solari_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] =
    b"runtime.plugin.solari\nruntime.render.experimental.solari\0";
const NEGOTIATED_CAPABILITIES: &[u8] =
    b"runtime.plugin.solari\nruntime.render.experimental.solari\0";
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"solari dist entry ready; realtime raytraced lighting provider remains unavailable\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"solari dist entry requires runtime.plugin.solari host capability\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.plugin.solari\", \"runtime.render.experimental.solari\"]\n[[modules]]\nname = \"runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.render.solari_provider\"\ncontribution = \"plugin.solari.runtime\"\nschema = \"zircon.runtime.solari-provider/1\"\n\0";
...
zircon_plugin_sdk::native_dist_runtime_plugin_v3! {
    ...
    runtime_entry: zircon_plugin_solari_runtime_entry_v3,
    runtime_entry_name: RUNTIME_ENTRY,
    requested_capabilities: REQUESTED_CAPABILITIES,
    missing_host_diagnostics: MISSING_HOST_DIAGNOSTICS,
    runtime: {
        required_capabilities: ["runtime.plugin.solari"],
        denied_capabilities: [],
...
mod tests {
    ...
    #[test]
    fn solari_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn solari_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.solari\nruntime.render.experimental.solari\0";
        ...
        let report = zircon_plugin_solari_runtime_entry_v3(&host);
