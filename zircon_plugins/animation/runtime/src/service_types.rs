...
use crate::sequence_runtime::AnimationChannelSampleExt;
...
fn sample_vec3(value: &zircon_runtime::asset::AnimationChannelValueAsset) -> Result<Vec3, String> {
    match value {
        zircon_runtime::asset::AnimationChannelValueAsset::Vec3(value)
...
fn sample_quaternion(
    value: &zircon_runtime::asset::AnimationChannelValueAsset,
) -> Result<Quat, String> {
    match value {
        zircon_runtime::asset::AnimationChannelValueAsset::Quaternion(value)
