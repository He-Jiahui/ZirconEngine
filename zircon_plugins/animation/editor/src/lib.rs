...
pub const ANIMATION_AUTHORING_VIEW_ID: &str = "animation.authoring";
...
pub fn editor_plugin_descriptor() -> zircon_editor::EditorPluginDescriptor {
    ...
    .with_capability("editor.extension.animation_authoring")
}
...
mod tests {
    ...
    fn animation_editor_plugin_contributes_authoring_extensions() {
        ...
        assert!(registration
            .capabilities
            .contains(&"editor.extension.animation_authoring".to_string()));
        assert!(registration
            .extensions
            .views()
            .iter()
