...
const PLUGIN_ID: &[u8] = b"native_window_hosting\0";
const EDITOR_ENTRY: &[u8] = b"zircon_plugin_native_window_hosting_editor_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"editor.extension.native_window_hosting\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"editor.extension.native_window_hosting\0";
const EDITOR_DIAGNOSTICS: &[u8] =
    b"native_window_hosting editor dist entry ready; native surfaces remain hosted by the editor plugin module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"native_window_hosting dist entry requires editor.extension.native_window_hosting host capability\0";
...
zircon_plugin_sdk::native_dist_editor_plugin_v3! {
    ...
    editor_entry: zircon_plugin_native_window_hosting_editor_entry_v3,
    editor_entry_name: EDITOR_ENTRY,
    requested_capabilities: REQUESTED_CAPABILITIES,
    missing_host_diagnostics: MISSING_HOST_DIAGNOSTICS,
    editor: {
        required_capabilities: ["editor.extension.native_window_hosting"],
        denied_capabilities: [],
...
mod tests {
    ...
    #[test]
    fn native_window_hosting_dist_descriptor_exports_editor_entry_only() {
    ...
    #[test]
    fn native_window_hosting_dist_editor_entry_reports_behavior() {
        let granted = b"editor.extension.native_window_hosting\0";
        ...
        let report = zircon_plugin_native_window_hosting_editor_entry_v3(&host);
