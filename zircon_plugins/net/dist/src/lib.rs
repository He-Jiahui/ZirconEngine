...
const PLUGIN_ID: &[u8] = b"net\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_net_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"runtime.plugin.net\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"runtime.plugin.net\0";
const RUNTIME_DIAGNOSTICS: &[u8] =
    b"net dist entry ready; transport services remain hosted by the runtime module\0";
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"net dist entry requires runtime.plugin.net host capability\0";
const EMPTY_MANIFEST: &[u8] = b"\0";
const RUNTIME_REGISTRATION_MANIFEST: &[u8] = b"schema = \"zircon.native.registration-manifest/3\"\ncapabilities = [\"runtime.plugin.net\"]\n[[modules]]\nname = \"runtime\"\nkind = \"runtime\"\n[[extensions]]\npoint = \"runtime.net.transport\"\ncontribution = \"plugin.net.runtime\"\nschema = \"zircon.runtime.net-transport/1\"\n\0";
...
mod tests {
    ...
    #[test]
    fn net_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn net_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.net\0";
        ...
        let report = zircon_plugin_net_runtime_entry_v3(&host);
