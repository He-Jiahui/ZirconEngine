...
const PLUGIN_ID: &[u8] = b"audio_importer\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_audio_importer_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"runtime.plugin.audio_importer\nruntime.asset.importer.audio.wav\nruntime.asset.importer.audio.codec\0";
...
mod tests {
    ...
    #[test]
    fn audio_importer_dist_descriptor_exports_runtime_entry() {
    ...
    #[test]
    fn audio_importer_dist_runtime_entry_reports_registration_manifest() {
        let granted = b"runtime.plugin.audio_importer\0";
        ...
        let report = zircon_plugin_audio_importer_runtime_entry_v3(&host);
