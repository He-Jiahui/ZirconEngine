...
const MISSING_HOST_DIAGNOSTICS: &[u8] =
    b"editor_build_export_desktop dist entry requires editor.extension.build_export_desktop host capability\0";
...
mod tests {
    ...
    #[test]
    fn desktop_export_dist_descriptor_exports_editor_entry_only() {
    ...
    #[test]
    fn desktop_export_dist_editor_entry_reports_behavior() {
        let granted = b"editor.extension.build_export_desktop\neditor.extension.build_export_desktop.diagnostics\neditor.extension.build_export_desktop.native_dynamic_report\0";
        ...
        let report = zircon_plugin_editor_build_export_desktop_editor_entry_v3(&host);
