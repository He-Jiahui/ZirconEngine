...
const PLUGIN_ID: &[u8] = b"tilemap_2d\0";
const RUNTIME_ENTRY: &[u8] = b"zircon_plugin_tilemap_2d_runtime_entry_v3\0";
const REQUESTED_CAPABILITIES: &[u8] = b"runtime.plugin.tilemap_2d\0";
const NEGOTIATED_CAPABILITIES: &[u8] = b"runtime.plugin.tilemap_2d\0";
