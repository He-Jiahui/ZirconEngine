...
impl SceneViewportController {
    ...
    pub(in crate::scene::viewport::controller) fn set_projection_mode(
        &mut self,
    ...
    pub(in crate::scene::viewport::controller) fn apply_viewport_size(
        &mut self,
        viewport_size: UVec2,
    ) {
    ...
    pub(in crate::scene::viewport::controller) fn reset_camera_from_scene(
        &mut self,
        scene: Option<&Scene>,
    ) {
    ...
    pub(in crate::scene::viewport::controller) fn align_view(
        &mut self,
