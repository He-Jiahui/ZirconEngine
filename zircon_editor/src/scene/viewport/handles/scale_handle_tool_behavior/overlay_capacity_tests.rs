...
const PERF_MARKER: &str = "EDITOR312_SCALE_OVERLAY_CAPACITY_BENCH_V1";

#[test]
fn optimization_batch_20260830bn_editor_scale_overlay_capacity_preserves_results() {
...
#[test]
fn optimization_batch_20260830bn_editor_scale_overlay_capacity_source_contract() {
    let source = include_str!("../scale_handle_tool_behavior.rs");
    assert!(source.contains("let mut elements = Vec::with_capacity(4)"));
}

#[test]
#[ignore = "release performance evidence"]
fn optimization_batch_20260830bn_editor_scale_overlay_capacity_p95() {
