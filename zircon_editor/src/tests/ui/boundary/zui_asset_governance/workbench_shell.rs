...
const L4_SHELL_TOPOLOGY_SNAPSHOTS: &[L4ShellTopologySnapshot] = &[
    ...
    L4ShellTopologySnapshot {
        ...
        node_count: 97,
        root_children: &["drawer_tabs", "component_body", "console_body"],
    },
    L4ShellTopologySnapshot {
    ...
    L4ShellTopologySnapshot {
        ...
        node_count: 19,
        root_children: &["scene_tabs", "scene_search_row", "scene_tree"],
    },
    L4ShellTopologySnapshot {
    ...
    L4ShellTopologySnapshot {
        ...
        node_count: 89,
        root_children: &["viewport_toolbar", "viewport_surface"],
    },
];
