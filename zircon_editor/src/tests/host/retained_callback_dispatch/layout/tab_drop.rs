...
fn tab_drop_dispatch_attaches_view_and_reopens_target_drawer_from_normalized_route() {
    ...
    let harness = EventRuntimeHarness::new("zircon_retained_tab_drop_dispatch");
...
fn tab_drop_dispatch_does_not_reopen_drawer_when_target_is_already_visible() {
    ...
    let harness = EventRuntimeHarness::new("zircon_retained_tab_drop_attach_visible");
...
fn tab_drop_dispatch_preserves_auto_hide_drawer_mode() {
    ...
    let harness = EventRuntimeHarness::new("zircon_retained_tab_drop_attach_autohide");
    dispatch_layout_command(
        &harness.runtime,
        LayoutCommand::SetDrawerMode {
            slot: ActivityDrawerSlot::RightTop,
...
fn tab_drop_dispatch_creates_split_for_document_edge_route() {
    ...
    let harness = EventRuntimeHarness::new("zircon_retained_tab_drop_split_dispatch");
...
fn tab_drop_dispatch_detaches_drawer_tab_to_independent_drawer_window() {
    ...
    let harness = EventRuntimeHarness::new("zircon_retained_tab_drop_detach_drawer_window");
