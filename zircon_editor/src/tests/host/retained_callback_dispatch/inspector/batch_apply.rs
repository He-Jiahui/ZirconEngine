...
fn builtin_inspector_surface_apply_batch_matches_direct_batch_dispatch() {
    ...
    let legacy_harness = EventRuntimeHarness::new("zircon_retained_parity_inspector_apply_legacy");
    ...
    let builtin_harness =
        EventRuntimeHarness::new("zircon_retained_parity_inspector_apply_builtin");
