...
fn builtin_inspector_surface_name_field_matches_direct_binding_dispatch() {
    ...
    let legacy_harness = EventRuntimeHarness::new("zircon_retained_parity_inspector_name_legacy");
    ...
    let builtin_harness = EventRuntimeHarness::new("zircon_retained_parity_inspector_name_builtin");
...
fn builtin_inspector_surface_delete_selected_matches_legacy_binding_dispatch() {
    ...
    let legacy_harness = EventRuntimeHarness::new("zircon_retained_parity_inspector_delete_legacy");
    ...
    let builtin_harness =
        EventRuntimeHarness::new("zircon_retained_parity_inspector_delete_builtin");
    let bridge = BuiltinInspectorSurfaceTemplateBridge::new().unwrap();
    let builtin_effects = dispatch_builtin_inspector_surface_control(
        &builtin_harness.runtime,
        &bridge,
