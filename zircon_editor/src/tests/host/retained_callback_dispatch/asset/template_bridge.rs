...
fn builtin_asset_surface_view_mode_dispatches_dynamic_binding_from_template() {
    ...
    let harness = EventRuntimeHarness::new("zircon_retained_template_bridge_asset_view_mode");
    ...
    let effects = dispatch_builtin_asset_surface_control(
        ...
        UiEventKind::Change,
        vec![
            UiBindingValue::string("browser"),
            UiBindingValue::string("thumbnail"),
        ],
    )
...
fn builtin_asset_surface_open_browser_dispatches_static_binding_from_template() {
    ...
    let harness = EventRuntimeHarness::new("zircon_retained_template_bridge_asset_open_browser");
    let bridge = BuiltinAssetSurfaceTemplateBridge::new().unwrap();
...
fn builtin_asset_surface_import_model_dispatches_host_request_from_template() {
    ...
    let harness = EventRuntimeHarness::new("zircon_retained_template_bridge_asset_import_model");
    let bridge = BuiltinAssetSurfaceTemplateBridge::new().unwrap();
...
fn builtin_asset_surface_search_matches_legacy_asset_search_dispatch() {
    ...
    let legacy_harness = EventRuntimeHarness::new("zircon_retained_parity_asset_search_legacy");
    ...
    let builtin_harness = EventRuntimeHarness::new("zircon_retained_parity_asset_search_builtin");
    let bridge = BuiltinAssetSurfaceTemplateBridge::new().unwrap();
    let builtin_effects = dispatch_builtin_asset_surface_control(
        ...
        "SearchEdited",
        UiEventKind::Change,
        vec![UiBindingValue::string("cube")],
    )
