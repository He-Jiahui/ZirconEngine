...
fn rust_owned_host_window_snapshot_draws_debug_reflector_overlay_from_host_data() {
    ...
    with_overlay.host_scene_data.document_dock = runtime_diagnostics_dock(vec![
        crate::ui::retained_host::UiDebugOverlayPrimitiveData {
            kind: UiDebugOverlayPrimitiveKind::DamageRegion,
            frame: host_frame(20.0, 18.0, 44.0, 28.0),
            label: "damage".into(),
            severity: "warning".into(),
            ..crate::ui::retained_host::UiDebugOverlayPrimitiveData::default()
        },
    ]);
...
fn runtime_diagnostics_dock(
    overlay_primitives: Vec<crate::ui::retained_host::UiDebugOverlayPrimitiveData>,
