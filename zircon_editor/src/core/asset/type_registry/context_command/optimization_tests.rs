...
use super::AssetContextCommandDescriptor;
...
fn operation_path() -> EditorOperationPath {
    EditorOperationPath::parse("fixture.asset.context").expect("valid fixture operation")
}

fn legacy_descriptor(capabilities: &[String]) -> AssetContextCommandDescriptor {
    let mut descriptor = AssetContextCommandDescriptor::new(
        "fixture.context",
...
fn optimized_descriptor(capabilities: &[String]) -> AssetContextCommandDescriptor {
...
#[test]
fn editor04_type_registry_context_command_capability_order_is_unchanged() {
...
#[test]
fn editor04_type_registry_context_command_source_contract() {
    let source = include_str!("../context_command.rs");
...
fn editor04_type_registry_context_command_capability_bench() {
    let capabilities = capability_fixture();
    ...
    println!(
        "EDITOR04_TYPE_REGISTRY_CONTEXT_COMMAND_CAPABILITY_BENCH_V1 legacy_p95_ns={} optimized_p95_ns={} samples={} iterations={} capabilities={} unique_capabilities={} stable_sort=1->0 preallocation=0->{}",
        legacy_p95.as_nanos(),
