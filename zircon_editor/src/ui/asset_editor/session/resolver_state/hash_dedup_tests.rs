...
use super::{dedup_resource_diagnostics, UiResourceDiagnostic};
use zircon_runtime_interface::ui::template::UiResourceDiagnosticSeverity;

const MARKER: &str = "EDITOR190_RESOURCE_DIAGNOSTIC_HASH_DEDUP_BENCH_V1";
...
#[test]
fn optimization_batch_20260826gx_editor190_resource_diagnostics_stay_unique_and_sorted() {
    ...
    assert_eq!(
        diagnostics
            ...
            .collect::<Vec<_>>(),
        [
            ("assets/0001", "resource.0001", "diagnostic message 0001"),
            ("assets/0002", "resource.0002", "diagnostic message 0002"),
            ("assets/0003", "resource.0003", "diagnostic message 0003"),
        ]
    );
}

#[test]
fn optimization_batch_20260826gx_editor190_resource_diagnostics_hash_before_sorting() {
    let source = include_str!("../resolver_state.rs");
    ...
    assert!(implementation.contains(".iter()"));
    assert!(implementation.contains(".map(|diagnostic|"));
    assert!(implementation.contains("diagnostics.retain"));
}

#[test]
#[ignore = "managed Windows release performance evidence"]
fn optimization_batch_20260826gx_editor190_resource_diagnostic_hash_dedup_bench() {
