...
pub(crate) fn operation_path_for_menu_action(action: &MenuAction) -> Option<EditorOperationPath> {
    let path = match action {
        ...
        MenuAction::CreateNode(NodeKind::Camera) => "Scene.Node.CreateCamera",
        MenuAction::CreateNode(NodeKind::AmbientLight) => "Scene.Node.CreateAmbientLight",
        MenuAction::CreateNode(NodeKind::DirectionalLight) => "Scene.Node.CreateDirectionalLight",
        MenuAction::CreateNode(NodeKind::PointLight) => "Scene.Node.CreatePointLight",
        MenuAction::CreateNode(NodeKind::RectLight) => "Scene.Node.CreateRectLight",
        MenuAction::CreateNode(NodeKind::SpotLight) => "Scene.Node.CreateSpotLight",
...
fn builtin_view_operation_path(descriptor_id: &str) -> Option<&'static str> {
    match descriptor_id {
        ...
        "editor.performance_timeline" => Some("View.PerformanceTimeline.Open"),
        ...
        "editor.ui_component_showcase" => Some("Window.UiComponentShowcase.Open"),
