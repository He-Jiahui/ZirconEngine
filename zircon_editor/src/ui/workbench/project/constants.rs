...
pub(in crate::ui::workbench::project) const DEFAULT_SCENE_URI: &str =
    "res://scenes/main.scene.toml";
pub(in crate::ui::workbench::project) const DEFAULT_SHADER_URI: &str = "res://shaders/pbr_shader";
...
pub(in crate::ui::workbench::project) const DEFAULT_PBR_ZSHADER: &str =
    include_str!("assets/default_pbr.zshader");
