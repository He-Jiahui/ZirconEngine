...
impl HostMenuPointerBridge {
    pub(in crate::ui::slint_host::menu_pointer) fn clamp_menu_bar_scroll_offset(&mut self) {
        self.state.menu_bar_scroll_offset =
            clamped_menu_bar_scroll_offset(&self.layout, self.state.menu_bar_scroll_offset);
    }
