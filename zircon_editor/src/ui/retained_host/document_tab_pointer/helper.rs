...
pub(in crate::ui::retained_host::document_tab_pointer) fn tab_node_id(
    surface_index: usize,
    item_index: usize,
) -> UiNodeId {
...
pub(in crate::ui::retained_host::document_tab_pointer) fn close_node_id(
    surface_index: usize,
    item_index: usize,
) -> UiNodeId {
...
pub(in crate::ui::retained_host::document_tab_pointer) fn root_frame(
...
pub(in crate::ui::retained_host::document_tab_pointer) fn base_state(
    interactive: bool,
) -> UiStateFlags {
    UiStateFlags {
        visible: true,
