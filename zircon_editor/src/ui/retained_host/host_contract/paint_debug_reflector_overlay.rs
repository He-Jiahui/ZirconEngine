use super::data::{FrameRect, UiDebugOverlayPrimitiveData};
use super::paint_frame::HostRgbaFrame;
use super::paint_geometry::{intersect, is_visible_frame, translated};
use super::paint_primitives::{draw_border_clipped, draw_rect_clipped, draw_text_bars_clipped};
...
pub(super) fn draw_debug_reflector_overlay(
