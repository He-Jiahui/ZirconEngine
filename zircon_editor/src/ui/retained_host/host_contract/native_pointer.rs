...
fn route_host_page_tabs(
    tabs: &crate::ui::retained_host::primitives::ModelRc<super::data::HostChromeTabData>,
    x: f32,
    y: f32,
) -> Option<ChromePointerRoute> {
...
fn route_activity_rail(
    ...
    rail_width: f32,
    buttons: &crate::ui::retained_host::primitives::ModelRc<
        super::data::HostChromeControlFrameData,
    >,
    x: f32,
    y: f32,
) -> Option<ChromePointerRoute> {
