...
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_SURFACE: [u8;
    4] = [16, 22, 26, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_HOVER_SURFACE:
    [u8; 4] = [20, 27, 31, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_FOCUSED_SURFACE:
    [u8; 4] = [15, 24, 28, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_DISABLED_SURFACE:
    [u8; 4] = [36, 41, 45, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_BORDER: [u8;
    4] = [50, 63, 71, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_FOCUSED_BORDER:
    [u8; 4] = [27, 152, 160, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_DISABLED_BORDER:
    [u8; 4] = [48, 56, 62, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_TEXT: [u8; 4] =
    [205, 216, 221, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_PLACEHOLDER:
    [u8; 4] = [122, 134, 142, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TEXT_FIELD_DISABLED_TEXT:
    [u8; 4] = [125, 135, 141, 255];

#[derive(Clone, Copy, Debug, PartialEq)]
pub(in crate::ui::retained_host::host_contract::painter) struct WorkbenchTextFieldStyle {
    pub surface: [u8; 4],
    pub border: [u8; 4],
    pub text: [u8; 4],
    pub stepper: [u8; 4],
...
pub(in crate::ui::retained_host::host_contract::painter) fn select_workbench_text_field_style(
    node: &TemplatePaneNodeData,
    label_is_placeholder: bool,
) -> WorkbenchTextFieldStyle {
    let mut painter_state = painter_state_for_node(node);
