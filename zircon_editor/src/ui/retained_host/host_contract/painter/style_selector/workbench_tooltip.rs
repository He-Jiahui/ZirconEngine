...
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TOOLTIP_SURFACE: [u8; 4] =
    [23, 28, 32, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TOOLTIP_BORDER: [u8; 4] =
    [37, 45, 50, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TOOLTIP_TITLE: [u8; 4] =
    [208, 217, 221, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TOOLTIP_BODY: [u8; 4] =
    [168, 179, 184, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TOOLTIP_ICON: [u8; 4] =
    [37, 156, 167, 255];
pub(in crate::ui::retained_host::host_contract::painter) const WORKBENCH_TOOLTIP_SHADOW: [u8; 4] =
    [0, 0, 0, 96];

#[derive(Clone, Copy, Debug, PartialEq)]
pub(in crate::ui::retained_host::host_contract::painter) struct WorkbenchTooltipStyle {
    pub surface: [u8; 4],
    pub border: [u8; 4],
    pub title: [u8; 4],
    pub body: [u8; 4],
...
pub(in crate::ui::retained_host::host_contract::painter) fn select_workbench_tooltip_style(
    node: &TemplatePaneNodeData,
) -> WorkbenchTooltipStyle {
    let state = painter_state_for_node(node).resolved_state_for_family(UiPainterFamily::Tooltip);
    ...
    if let Some(title) = resolved_style_color(node.button_style.element.foreground_color.as_ref()) {
        style.title = title;
    }
...
fn tooltip_state_style(state: UiPainterResolvedState) -> WorkbenchTooltipStyle {
    match state {
        UiPainterResolvedState::Disabled => WorkbenchTooltipStyle {
