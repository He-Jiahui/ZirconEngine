...
const MIN_CONTENT_EXTENT: f32 = 1.0;
...
pub(super) fn button_content_layout(
    ...
    let max_text_width = min_extent(max_content_width - glyph_width - chevron_width);
...
fn min_extent(extent: f32) -> f32 {
    extent.max(MIN_CONTENT_EXTENT)
}
