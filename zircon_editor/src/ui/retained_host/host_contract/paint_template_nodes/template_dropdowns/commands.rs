...
use super::geometry::{
    dropdown_chevron_fits, dropdown_paint_rect, frame_is_within, has_paintable_dropdown_extent,
};
...
pub(in crate::ui::retained_host::host_contract::paint_template_nodes) fn push_dropdown_commands(
    ...
    if !has_paintable_dropdown_extent(&rect) || !frame_is_within(clip, &rect) {
        return true;
    }
