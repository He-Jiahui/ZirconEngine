...
const BODY_FONT_MIX: f32 = 0.5;
const BODY_BORDER_FONT_BIAS: f32 = 0.5;
...
pub(in crate::ui::retained_host::host_contract::paint_template_nodes) fn dialog_metrics_from_host(
    ...
    let title_font_size = metrics.font_large + metrics.border_width;
    let body_font_size = (metrics.font_body + metrics.font_large) * BODY_FONT_MIX
        + metrics.border_width * BODY_BORDER_FONT_BIAS;
    let body_line_height = metrics.line_height(body_font_size) + metrics.border_width;
    WorkbenchDialogMetrics {
        ...
        action_bottom: metrics.gap_l + metrics.gap_m,
        ...
        action_font_size: body_font_size,
        action_line_height: body_line_height,
    }
}
