...
pub(in crate::ui::retained_host::host_contract::paint_template_nodes) use colors::{
    DialogActionPaint, cancel_action_paint, confirm_action_paint, dialog_action_paint,
    dialog_body_color, dialog_border_color, dialog_surface_color, dialog_title_color,
};
#[cfg(test)]
