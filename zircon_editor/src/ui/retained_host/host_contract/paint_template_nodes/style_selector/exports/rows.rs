pub(in crate::ui::retained_host::host_contract::paint_template_nodes) use super::super::workbench_list_row::{
    select_workbench_list_row_style, WorkbenchListRowStyle,
};
...
pub(in crate::ui::retained_host::host_contract::paint_template_nodes) use super::super::workbench_tree_row::{
    select_workbench_tree_row_style, WorkbenchTreeRowStyle,
};
