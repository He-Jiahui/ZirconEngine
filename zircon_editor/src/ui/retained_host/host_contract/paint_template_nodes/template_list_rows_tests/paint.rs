...
#[test]
fn selected_list_row_paints_muted_selected_fill_teal_outline_and_navigation_adornment() {
    ...
    assert!(matching_pixel_count(&bytes, 160, 4, 4, 148, 32, PALETTE.accent) > 300);
