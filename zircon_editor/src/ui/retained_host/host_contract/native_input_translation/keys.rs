...
pub(in crate::ui::retained_host::host_contract) fn keyboard_state(
    state: ElementState,
    repeat: bool,
...
pub(in crate::ui::retained_host::host_contract) fn physical_key_name(
...
pub(in crate::ui::retained_host::host_contract) fn logical_key_name(key: &Key) -> String {
    match key {
...
pub(in crate::ui::retained_host::host_contract) fn legacy_key_code(key: &Key) -> u32 {
    match key {
...
pub(in crate::ui::retained_host::host_contract) fn native_scan_code(
    physical_key: PhysicalKey,
) -> Option<u32> {
    match physical_key {
