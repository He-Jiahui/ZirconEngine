...
impl BuiltinWorkbenchWindowTemplateSurfaceBridge {
            ...
            action_id if is_workbench_module_action(action_id) => {
                if let Some(control_id) = workbench_module_tab_control_id(action_id) {
                    ...
                    if action_id == "InvokeWorkbenchModuleBrowse" {
                        ...
                        self.apply_workbench_module_workspace("SelectWorkbenchModuleAssets")?;
                    }
    ...
    fn apply_workbench_module_workspace(
        ...
        let scene_active = action_id == "SelectWorkbenchModuleScene";
    ...
    fn should_open_dropdown_for_module_field_action(
        &self,
        source_control_id: &str,
        action_id: &str,
    ) -> bool {
        action_id.starts_with("EditWorkbench")
            && !self
