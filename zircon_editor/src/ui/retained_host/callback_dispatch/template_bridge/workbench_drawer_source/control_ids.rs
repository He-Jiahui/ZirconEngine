...
pub(super) const WORKBENCH_DRAWER_TOP_BAR_CONTROL_ID: &str = "WorkbenchDrawerTopBarRoot";
pub(super) const WORKBENCH_DRAWER_STATUS_BAR_CONTROL_ID: &str = "WorkbenchDrawerStatusBarRoot";
