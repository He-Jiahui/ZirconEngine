...
use super::constants::{CLOSE_NODE_ID_BASE, HOST_PAGE_ROUTE_ID_BASE, TAB_NODE_ID_BASE};
...
pub(super) fn close_node_id(item_index: usize) -> UiNodeId {
    UiNodeId::new(CLOSE_NODE_ID_BASE + item_index as u64)
}

pub(super) fn close_route_id(item_index: usize) -> UiRouteId {
    UiRouteId::new(HOST_PAGE_ROUTE_ID_BASE + CLOSE_NODE_ID_BASE + item_index as u64)
}
