...
pub(in crate::ui::retained_host::menu_pointer) struct PopupGridLayout {
    pub frame: UiFrame,
...
pub(in crate::ui::retained_host::menu_pointer) fn popup_content_frame(
    popup_frame: UiFrame,
) -> UiFrame {
    UiFrame::new(
...
pub(in crate::ui::retained_host::menu_pointer) fn menu_button_frame(
    layout: &HostMenuPointerLayout,
    menu_index: usize,
...
pub(in crate::ui::retained_host::menu_pointer) fn clipped_menu_button_frame(
    layout: &HostMenuPointerLayout,
    menu_index: usize,
    menu_bar_scroll_offset: f32,
) -> Option<UiFrame> {
...
pub(in crate::ui::retained_host::menu_pointer) fn menu_bar_viewport_frame(
    layout: &HostMenuPointerLayout,
) -> UiFrame {
...
pub(in crate::ui::retained_host::menu_pointer) fn menu_bar_contains_point(
    layout: &HostMenuPointerLayout,
    point: UiPoint,
) -> bool {
...
pub(in crate::ui::retained_host::menu_pointer) fn menu_bar_max_scroll_offset(
    layout: &HostMenuPointerLayout,
) -> f32 {
    (layout.menu_bar_content_width - layout.shell_frame.width.max(0.0)).max(0.0)
}

pub(in crate::ui::retained_host::menu_pointer) fn clamped_menu_bar_scroll_offset(
    layout: &HostMenuPointerLayout,
    offset: f32,
) -> f32 {
...
pub(in crate::ui::retained_host::menu_pointer) fn submenu_popup_grid_layout(
    layout: &HostMenuPointerLayout,
