...
use zircon_scene::{ProjectionMode, TransformSpace, ViewportCameraSnapshot};

use crate::editing::viewport::handles::handle_basis::HandleBasis;

pub(in crate::editing::viewport::handles) fn build_handle_basis(
    transform: Transform,
...
pub(in crate::editing::viewport::handles) fn handle_extent(
    camera: &ViewportCameraSnapshot,
    origin: Vec3,
) -> f32 {
