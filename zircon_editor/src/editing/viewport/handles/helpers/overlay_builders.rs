...
use zircon_scene::{HandleElementExtract, OverlayAxis};

use crate::editing::viewport::handles::{constants::CENTER_COLOR, handle_basis::HandleBasis};

use super::axis_color;

pub(in crate::editing::viewport::handles) fn center_anchor(
    basis: &HandleBasis,
...
pub(in crate::editing::viewport::handles) fn push_axis_line(
...
pub(in crate::editing::viewport::handles) fn push_axis_ring(
    elements: &mut Vec<HandleElementExtract>,
    axis: OverlayAxis,
    center: Vec3,
    normal: Vec3,
...
pub(in crate::editing::viewport::handles) fn push_axis_scale(
    elements: &mut Vec<HandleElementExtract>,
    axis: OverlayAxis,
    origin: Vec3,
    direction: Vec3,
