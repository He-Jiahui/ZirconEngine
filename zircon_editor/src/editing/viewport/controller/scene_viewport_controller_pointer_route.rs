...
use crate::editing::viewport::pointer::ViewportPointerRoute;

use super::SceneViewportController;

impl SceneViewportController {
    pub(in crate::editing::viewport::controller) fn sync_pointer_bridge(
        &mut self,
        scene: &Scene,
    ...
    pub(in crate::editing::viewport::controller) fn route_at_cursor(
        &mut self,
        scene: &Scene,
        cursor: Vec2,
        press: bool,
    ...
    pub(in crate::editing::viewport::controller) fn set_hover_route(
        &mut self,
...
pub(in crate::editing::viewport::controller) fn route_owner(route: &ViewportPointerRoute) -> u64 {
    match route {
