...
use zircon_scene::{OverlayPickShape, ViewportCameraSnapshot};

use crate::editing::viewport::pointer::constants::{GIZMO_PICK_THRESHOLD_PX, GIZMO_PRIORITY};
...
pub(in crate::editing::viewport::pointer) fn scene_gizmo_candidate(
    owner: u64,
