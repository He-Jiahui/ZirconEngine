...
use zircon_ui::{UiFrame, UiInputPolicy, UiNodeId, UiNodePath, UiSurface, UiTreeId, UiTreeNode};
...
impl ViewportOverlayPointerBridge {
    pub(in crate::editing::viewport::pointer) fn rebuild_surface(&mut self) {
