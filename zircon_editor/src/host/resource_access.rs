...
fn record_kind_matches<TMarker: ResourceMarker>(kind: AssetRecordKind) -> bool {
    match kind {
        AssetRecordKind::Model => TMarker::KIND == ResourceKind::Model,
        AssetRecordKind::Material => TMarker::KIND == ResourceKind::Material,
