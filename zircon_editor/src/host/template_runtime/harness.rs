...
use crate::editor_event::EditorEventJournal;
use crate::host::slint_host::tab_drag::ResolvedWorkbenchTabDropRoute;
...
impl EditorUiCompatibilityHarness {
    ...
    pub fn capture_floating_window_overlay_snapshot(
        floating_windows: &[crate::host::slint_host::FloatingWindowData],
    ) -> EditorUiCompatibilitySnapshot {
        let mut snapshot = EditorUiCompatibilitySnapshot::default();
    ...
    pub(crate) fn capture_resolved_tab_drop_route_snapshot(
        ...
        match &route.target {
            crate::host::slint_host::tab_drag::ResolvedWorkbenchTabDropTarget::Attach(drop) => {
                snapshot
                    .route_result_entries
            ...
            crate::host::slint_host::tab_drag::ResolvedWorkbenchTabDropTarget::Split {
                workspace,
                path,
                axis,
                placement,
