use crate::layout::{DocumentNode, MainHostPageLayout, MainPageId, WorkbenchLayout};

pub(super) fn ensure_workbench_document_root(layout: &mut WorkbenchLayout) -> &mut DocumentNode {
