...
pub(in crate::host::slint_host::menu_pointer) fn menu_button_node_id(index: usize) -> UiNodeId {
    UiNodeId::new(MENU_BUTTON_NODE_ID_BASE + index as u64)
}

pub(in crate::host::slint_host::menu_pointer) fn menu_item_node_id(index: usize) -> UiNodeId {
