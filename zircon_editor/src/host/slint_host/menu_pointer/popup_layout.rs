...
pub(in crate::host::slint_host::menu_pointer) fn popup_frame(
...
pub(in crate::host::slint_host::menu_pointer) fn popup_content_frame(
    popup_frame: UiFrame,
) -> UiFrame {
    UiFrame::new(
...
pub(in crate::host::slint_host::menu_pointer) fn popup_content_height(item_count: usize) -> f32 {
    if item_count == 0 {
        0.0
    } else {
...
pub(in crate::host::slint_host::menu_pointer) fn popup_viewport_extent(
    layout: &WorkbenchMenuPointerLayout,
    menu_index: usize,
) -> f32 {
...
pub(in crate::host::slint_host::menu_pointer) fn popup_scroll_metrics(
    layout: &WorkbenchMenuPointerLayout,
    menu_index: usize,
) -> (f32, f32) {
