...
pub(crate) struct WorkbenchMenuPointerBridge {
    pub(in crate::host::slint_host::menu_pointer) layout: WorkbenchMenuPointerLayout,
    pub(in crate::host::slint_host::menu_pointer) state: WorkbenchMenuPointerState,
    pub(in crate::host::slint_host::menu_pointer) surface: UiSurface,
    pub(in crate::host::slint_host::menu_pointer) dispatcher: UiPointerDispatcher,
    pub(in crate::host::slint_host::menu_pointer) targets:
