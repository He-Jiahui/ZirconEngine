...
pub(crate) use document_tab::{
    ...
    dispatch_builtin_workbench_document_tab_close,
};
pub(crate) use drawer_toggle::dispatch_builtin_workbench_drawer_toggle;
...
pub(crate) use main_page::dispatch_builtin_workbench_host_page_activation;
