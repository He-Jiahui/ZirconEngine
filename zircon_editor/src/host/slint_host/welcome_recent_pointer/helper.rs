...
pub(in crate::host::slint_host::welcome_recent_pointer) fn viewport_frame(
...
pub(in crate::host::slint_host::welcome_recent_pointer) fn content_height(
    item_count: usize,
) -> f32 {
    if item_count == 0 {
        0.0
...
pub(in crate::host::slint_host::welcome_recent_pointer) fn item_node_id(index: usize) -> UiNodeId {
    UiNodeId::new(ITEM_NODE_ID_BASE + index as u64)
}

pub(in crate::host::slint_host::welcome_recent_pointer) fn open_button_node_id(
    index: usize,
) -> UiNodeId {
    UiNodeId::new(OPEN_BUTTON_NODE_ID_BASE + index as u64)
}

pub(in crate::host::slint_host::welcome_recent_pointer) fn remove_button_node_id(
    index: usize,
) -> UiNodeId {
    UiNodeId::new(REMOVE_BUTTON_NODE_ID_BASE + index as u64)
}

pub(in crate::host::slint_host::welcome_recent_pointer) fn button_size() -> (f32, f32) {
    (BUTTON_WIDTH, BUTTON_HEIGHT)
}

pub(in crate::host::slint_host::welcome_recent_pointer) fn base_state(
    interactive: bool,
) -> UiStateFlags {
    UiStateFlags {
        visible: true,
